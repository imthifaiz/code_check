...
<%
String title = "Assign User Location";
%>
...
<script language="javascript">
	var subWin = null;
 	...
 	function onGo()
	{ 
 		document.form1.action ="../userlocation/assignuser"
 	...
 	try{
      ...
      if(locQryList.size()== 0)
      {
        fieldDesc="Data Not Found";
			...
			"ERROR IN JSP PAGE - AssignUserLocation.jsp ", e); }
	}
%>
<center>
...
<div class="container-fluid m-t-20">
	 ...
	 <ul class="breadcrumb backpageul">    
                ...
                <li><label>Assign User Location</label></li>                                   
            </ul>
        <!-- Thanzith Modified on 28.02.2022 --> 
...
// 			form1.setAttribute("target");
				document.form1.action  = "/track/userlocservlet?action=Assignloc";
		   		document.form1.submit();
		}
		...
		function getParameters(){
			return {
				...
				"USER":USER,
				"UI_PKEY":UI_PKEY,
				"action":"GET_USERASSIGNLOC_FOR_SUMMARY"
			}
		}
		function onGo(){
