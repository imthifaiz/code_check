...
function onGo(){
  document.form.action="AttendanceTrackingSummary.jsp?action=View";
  document.form.submit();
}
...
<title>Summary Mobile Registration</title>
</head>
...
if(PGaction.equalsIgnoreCase("View")){
 ...
 try{
       ...
       movQryList = movHisUtil.getMobileRegisterSummaryList(ht,fdate,tdate,DIRTYPE,COMPANY,DESC);
...
movQryList = movHisUtil.getMobileAttendanceList(ht,donovals,COMPANY);
	}catch(Exception e){
		e.printStackTrace();
	}	
}
...
<FORM name="form" method="post" action="AttendanceTrackingSummary.jsp" >
         ...
         <TR>        
          ...
          <TD><SELECT NAME ="ISSUESTATUS" size="1">
            <OPTION selected  value=""> </OPTION>
     		...
     		<OPTION   value='N' <%if(ISSUESTATUS.equalsIgnoreCase("N")){ %>selected<%} %>>UNATTENDED </OPTION>
          </SELECT></TD>
      
           <TH ALIGN="left" >Order Type : </TH>
           <TD><INPUT name="ORDERTYPE" type = "TEXT" value="MOBILE REGISTRATION" size="20"  MAXLENGTH=20></TD>  
