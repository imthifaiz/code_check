...
<%
String title = "Brand Promotion Summary";
%>
...
<%
	...
	{
	displaySummaryEdit = ub.isCheckValAcc("brandpromotionedit", PLANT,USERID);
	displaySummaryNew = ub.isCheckValAcc("brandpromotionnew", PLANT,USERID);

	}
	if(systatus.equalsIgnoreCase("INVENTORY"))
	{
	displaySummaryEdit = ub.isCheckValinv("brandpromotionedit", PLANT,USERID);
	displaySummaryNew = ub.isCheckValinv("brandpromotionnew", PLANT,USERID);
	}
	//IMTIZIAF
...
<div class="container-fluid m-t-20">
	 ...
	 <ul class="breadcrumb backpageul">    
                ...
                <li><label>Brand Promotion Summary</label></li>                                   
            </ul>
        <!-- Thanzith Modified on 23.02.2022 -->     
              ...
              <div class="box-title pull-right">
				...
				<%if(displaySummaryNew){ %>
					<button type="button" class="btn btn-default"
						onclick="window.location.href='../brandpromotion/new'" 
...
<FORM class="form-horizontal" name="form" method="post" action="BrandPromotionSummary.jsp">
...
<script>
		...
		function getParameters(){
			return {
				...
				"PLANT":plant,
				"action":"GET_BRAND_PROMOTION_FOR_SUMMARY"
			}
		}
		function onGo(){
						        	...
						        	if(typeof data.PRDPROMOTION[0].PROMOTION === 'undefined'){
						        		return [];
						        			...
						        			for(var dataIndex = 0; dataIndex < data.PRDPROMOTION.length; dataIndex ++){
						        				...
						        				data.PRDPROMOTION[dataIndex]['EDIT'] = '<a href="../brandpromotion/edit?action=View&ID='+lineno+'"><i class="fa fa-pencil-square-o"></i></a>';
												<%}else{ %>
		...
		$('#PROMOTION_NAME').typeahead({
			...
			},
			{
			  ...
			  source: function (query, process,asyncProcess) {
				...
				data : {
					PLANT : plant,
					ACTION : "GET_BRAND_PROMOTION_DATA",
					QUERY : query
				},
				dataType : "json",
				success : function(data) {
