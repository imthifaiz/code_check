...
<%
String title = "Category Promotion Summary";
%>
...
<%
	...
	{
	displaySummaryEdit = ub.isCheckValAcc("categorypromotionedit", PLANT,USERID);
	displaySummaryNew = ub.isCheckValAcc("categorypromotionnew", PLANT,USERID);

	}
	if(systatus.equalsIgnoreCase("INVENTORY"))
	{
	displaySummaryEdit = ub.isCheckValinv("categorypromotionedit", PLANT,USERID);
	displaySummaryNew = ub.isCheckValinv("categorypromotionnew", PLANT,USERID);
	}
	//IMTIZIAF
...
<div class="container-fluid m-t-20">
	 ...
	 <ul class="breadcrumb backpageul">    
                ...
                <li><label>Category Promotion Summary</label></li>                                   
            </ul>
        <!-- Thanzith Modified on 23.02.2022 -->     
              ...
              <div class="box-title pull-right">
				...
				<%if(displaySummaryNew){ %>
					<button type="button" class="btn btn-default"
						onclick="window.location.href='../categorypromotion/new'" 
...
<FORM class="form-horizontal" name="form" method="post" action="CategoryPromotionSummary.jsp">
...
<!-- end -->
		...
		<INPUT name="PROMOTION_NAME" id="PROMOTION_NAME" type="TEXT" value="<%=PROMOTION_NAME%>" size="20" MAXLENGTH=100 class="ac-selected form-control"> 
...
<script>
		...
		function getParameters(){
			return {
				...
				"PLANT":plant,
				"action":"GET_CATEGORY_PROMOTION_FOR_SUMMARY"
			}
		}
		function onGo(){
						        	...
						        	if(typeof data.PRDPROMOTION[0].PROMOTION === 'undefined'){
						        		return [];
						        			...
						        			for(var dataIndex = 0; dataIndex < data.PRDPROMOTION.length; dataIndex ++){
						        				...
						        				data.PRDPROMOTION[dataIndex]['EDIT'] = '<a href="../categorypromotion/edit?action=View&ID='+lineno+'"><i class="fa fa-pencil-square-o"></i></a>';
												<%}else{ %>
		...
		$('#PROMOTION_NAME').typeahead({
			...
			},
			{
			  ...
			  source: function (query, process,asyncProcess) {
				...
				data : {
					PLANT : plant,
					ACTION : "GET_CATEGORY_PROMOTION_DATA",
					QUERY : query
				},
				dataType : "json",
				success : function(data) {
