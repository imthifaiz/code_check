				...
				<div class="modal-body">	
					...
					<div class="form-group">
						<label class="control-label col-form-label col-sm-4 ">Account Sub Group</label>				
	                     <div class="col-sm-6">
							<input type="text" class="form-control" id="acc_type1" name="acc_type1">
...
function issubclick(){
	if(document.create_form.acc_is_sub.checked)
	{
		...
		$('#create_account_modal #acc_code').attr('readonly',true);
		subacid = $("input[name ='subaccode']").val();
    	$("input[name ='acc_code_show']").val(subacid);
	}
	else{
		document.create_form.acc_subAcct.value="";
		 ...
		 $('#create_account_modal #acc_code').attr('readonly',false);
	}
}
	...
	function create_account() {
		...
		if ($('#create_account_modal #acc_code').val() == "") {
			alert("please fill account code");
			$('#create_account_modal #acc_code').focus();
			return false;
		}
		...
		if ($('#create_account_modal #acc_balance').val() != "") {
			if (parseFloat($('#create_account_modal #acc_balance').val()) != 0) {
			if ($('#create_account_modal #acc_balanceDate').val() == "") {
				if ($('#create_account_modal #coamainid').val() == "1" || $('#create_account_modal #coamainid').val() == "3") {
					alert("Please Fill Balance Date");
				}else if($('#create_account_modal #coamainid').val() == "2"){
