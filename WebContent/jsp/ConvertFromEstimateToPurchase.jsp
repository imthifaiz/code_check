...
<script src="../jsp/js/convertfromPEtoPO.js"></script>
<center>
	<h2>
...
<div class="container-fluid m-t-20">
	...
	<!-- Muruganantham Modified on 16.02.2022 -->
             <ul class="breadcrumb backpageul">      	
                  ...
                  <li><a href="../purchaseorderestimate/summary"><span class="underline-on-hover">Purchase Order Summary</span></a></li> 
                  <li><a href="../purchaseorderestimate/detail?POESTNO=<%=POESTNO%>"><span class="underline-on-hover"> Purchase Estimate Order Detail</span></a></li>                
     ...
     <!-- Muruganantham Modified on 16.02.2022 --> 	
		...
		<div class="container-fluid">
			<form class="form-horizontal" id="purchaseOrderForm" name="cpoform" autocomplete="off" action="../purchaseorder/convertfromPEtoPO"  method="post"  enctype="multipart/form-data">
...
<!-- 				</div> -->
				...
				<div class="form-group">
						...
						<div class="col-sm-6 ac-box">
						<INPUT class="form-control datepicker" type="TEXT" size="30" MAXLENGTH="10" name="ORDDATE" value="<%=collectionDate%>" <%-- value="<%=poheader.getCollectionDate()%>" --%>/>
						</div>
					    </div>
						</div>
...
<!-- 				</div> -->
				<div class="form-group">
        			...
        			<div class="col-sm-3">
        			<div class="input-group">
      					<INPUT type = "TEXT" size="30"  MAXLENGTH="20" id="DELDATE" name="DELDATE" <%-- value="<%=poheader.getDELDATE()%>" --%> value="" class="form-control"/>
    				</div>
    				</div>
				...
				<div class="col-12 col-sm-12 no-padding">
					...
					<table class="table table-bordered line-item-table po-table">
						<thead>
							<tr>
							<th>Chk</th>
								<th colspan=2 style="width:15%">Product</th>
								<th class="bill-desc"  style="width:10%">Account</th>
								<th  style="width:6%">UOM</th>
								<th style="width:3%">Purchase Estimate Quantity</th>
								<th style="width:3%">Converted Quantity</th>
								<th style="width:7%">Quantity</th>
								<th style="width:8%">Delivery Date</th>
								<!-- <th>Remarks</th> -->
								<!-- <th>Status</th> -->
								<th colspan=2  style="width:8%">Unit Cost</th>
								<!-- <th></th> -->
								<th style="width:3%">Discount</th>
<!-- 								<th style="width:12%">Tax</th> -->
								<th colspan=2 style="width:22%">Amount</th>
								<!-- <th></th> -->
							</tr>
						</thead>
						<tbody>
...
<jsp:include page="../jsp/newProductModalPurchase.jsp" flush="true"></jsp:include>
