...
<%
	String vend = "", deldate = "", jobNum = "", custName = "", ordertype = "", custCode = "",deliverydateformat="",  
	personIncharge = "", contactNum = "", remark1 = "", remark2 = "", address = "", address2 = "", address3 = "",sTAXTREATMENT="",sPURCHASE_LOC="",sREVERSECHARGE="",sGOODSIMPORT="", 
	collectionDate = "", collectionTime = "", contactname = "", telno = "", email = "", currencyid = "", add1 = "", add2 = "", add3 = "", add4 = "", 
	country = "", zip = "", remarks = "", gst = "", shippingid = "", shippingcustomer = "", orderdiscount = "", shippingcost = "", incoterms = "", statusID = "",paymenttype="",localexpenses="";

	String sSaveEnb = "disabled", fullReceive = "", allChecked = "";
	...
	Map checkedPONO = (Map) request.getSession().getAttribute(
			"checkedPONO");
	...
	collectionDate = su.fString(request.getParameter("ORDDATE"));
	collectionTime = su.fString(request.getParameter("TIME"));
	deldate = su.fString(request.getParameter("DElDATE"));
	...
	if (currencyid.length() < 0 || currencyid == null
			|| currencyid.equalsIgnoreCase(""))
		currencyid = "SGD";
	...
	if (action.equalsIgnoreCase("View")) {
		...
		if (m.size() > 0) {
			...
			deldate = (String) m.get("deliverydate");
			remark1 = (String) m.get("remark1");
			remark2 = (String) m.get("remark3");
			//remarks=(String)m.get("remarks");
			//if(remarks.length()<0||remarks==null||remarks.equalsIgnoreCase(""))remarks="";
...
<input type="number" id="numberOfDecimal" style="display:none;" value=<%=numberOfDecimal%>>
				...
				<input type="hidden" name="copytype" value="OBTOIB"> 
...
<div class="form-group">
	<label class="control-label col-sm-2" for="Outbound Order">Order Number:</label>
						...
						<div class="col-sm-3">
							<div class="input-group">
								<INPUT class="form-control" name="CUST_NAME" type="TEXT"
									value="<%=su.forHTMLTag(custName)%>" size="30" MAXLENGTH=100>
								<span class="input-group-addon"
									onClick="javascript:popUpWin('vendor_hdrlist.jsp?CUST_NAME='+form.CUST_NAME.value);">
				...
				<div class="form-group">
					...
					<div class="col-sm-3">
						<INPUT class="form-control" type="TEXT" size="20" MAXLENGTH="20"
							name="JOB_NUM" value="<%=jobNum%>">
					</div>
					<div class="form-inline">
						<label class="control-label col-sm-3" for="Person Incharge">Contact Name:</label>
						<div class="col-sm-3">
							<INPUT type="TEXT" style="width: 100%" class="form-control" MAXLENGTH=100
								name="PERSON_INCHARGE" value="<%=personIncharge%>" readonly>
						</div>
					</div>
				</div>
				...
				<div class="form-group">
					...
					<div class="col-sm-3">
						<div class="input-group">
							<INPUT class="form-control datepicker" type="TEXT" size="30" MAXLENGTH="20"
								name="ORDDATE" value="<%=collectionDate%>" /> 
						</div>
						<INPUT type="Hidden" size="10" MAXLENGTH="20"
							name="COLLECTION_TIME" value="<%=collectionTime%>" /> <INPUT
							type="Hidden" size="20" MAXLENGTH=20 name="CONTACT_NUM"
							value="<%=contactNum%>">
					</div>
					<!-- <div class="form-inline">
        ...
        <INPUT name="PAYMENTTYPE" value="<%=paymenttype%>"  type="TEXT" value="" class="form-control" style="width: 100%" MAXLENGTH=100 readonly>
				...
				<div class="form-group">
					...
					<div class="col-sm-3">
						<div class="input-group">
							<INPUT type="TEXT" size="30" MAXLENGTH=10 <%if(deliverydateformat.equals("1")) {%>readonly class="form-control datepicker"<%} else {%> class=form-control <%}%>
							id="DELDATE"	name="DELDATE" value="<%=deldate%>">
						</div>
					</div>
					<div class="form-inline">
        ...
        <div class="col-sm-3"> -->
 		...
 		<div class="form-inline">
						...
						<div class="col-sm-3">
							<div class="input-group">
								<INPUT class="form-control" name="SHIPPINGCUSTOMER" type="TEXT"
									value="<%=su.forHTMLTag(shippingcustomer)%>" size="30"
									MAXLENGTH=40> <span class="input-group-addon"
									onClick="javascript:popUpWin('shippingdetails_list.jsp?SHIPPINGCUSTOMER='+form.SHIPPINGCUSTOMER.value);">
									<a href="#" data-toggle="tooltip" data-placement="top"
									title="Shipping Customer Details"> <i
				...
				<div class="form-group">
					...
					<div class="col-sm-3">
						<div class="input-group">
							<INPUT class="form-control" type="TEXT" size="20" MAXLENGTH="20"
								name="ORDERTYPE" value="<%=ordertype%>" /> <span
								class="input-group-addon"
								onClick="javascript:popUpWin('OrderType_list.jsp?ORDERTYPE='+form.ORDERTYPE.value+'&FORMTYPE=inbound');">
								<a href="#" data-toggle="tooltip" data-placement="top"
        ...
        <div class="col-sm-3"> -->
 		...
 		<div class="form-inline">
						...
						<div class="col-sm-3">
							<div class="input-group">
								<INPUT class="form-control" name="INCOTERMS" type="TEXT"
									value="<%=incoterms%>" size="30" MAXLENGTH=200> <span
									class="input-group-addon"
									onClick="javascript:popUpWin('incoterms_list.jsp?INCOTERMS='+form.INCOTERMS.value);">
									<a href="#" data-toggle="tooltip" data-placement="top"
        ...
        <div class="col-sm-3"> -->
				...
				<div class="form-group">
					...
					<div class="col-sm-3">
						<div class="input-group">
							<INPUT class="form-control" type="TEXT" size="20" MAXLENGTH=20
								name="DISPLAY" value="<%=currencyid%>"> <span
								class="input-group-addon"
								onClick="javascript:popUpWin('list/ordcurencyLst.jsp?DISPLAY='+form.DISPLAY.value);">
								<a href="#" data-toggle="tooltip" data-placement="top"
						...
						<div class="col-sm-3">
							<div class="input-group">
								<INPUT class="form-control" type="TEXT" size="30"
									MAXLENGTH="100" name="REMARK1" value="<%=remark1%>" /> <span
									class="input-group-addon"
									onClick="javascript:popUpWin('remarks_list.jsp?REMARKS='+form.REMARK1.value+'&TYPE=REMARKS1');">
									<a href="#" data-toggle="tooltip" data-placement="top"
       ...
       <div class="form-group">
        <label class="control-label col-sm-2" for="rcbno" id="TaxLabelOrderManagement"></label>
					<div class="col-sm-3">
						<div class="input-group">
							<INPUT class="form-control" type="TEXT" size="20" MAXLENGTH=20 onkeypress="return isNumberKey(event,this,4)" id="GST" 
								name="GST" value="<%=gst%>"> <span
								class="input-group-addon"
								style="font-size: 20px; color: #0059b3"><b>%</b></span>
						</div>
					</div>
					<!-- <div class="form-inline">
        ...
        <div class="col-sm-3"> -->
 		...
 		<div class="form-inline">
						...
						<div class="col-sm-3">
							<div class="input-group">
								<INPUT class="form-control" type="TEXT" size="30"
									MAXLENGTH="100" name="REMARK3" value="<%=remark2%>" /> <span
									class="input-group-addon"
									onClick="javascript:popUpWin('remarks_list.jsp?REMARKS='+form.REMARK3.value+'&TYPE=REMARKS2');">
									<a href="#" data-toggle="tooltip" data-placement="top"
									title="Remarks Details"> <i
										class="glyphicon glyphicon-log-in" style="font-size: 20px;"></i></a>
								</span>
							</div>
						</div>
	...
	<div class="form-group">
				<label class="control-label col-sm-2" for="Remarks">Shipping Cost:</label>
						<div class="col-sm-3">
							<INPUT class="form-control" type="TEXT" size="30" MAXLENGTH=20 onkeypress="return isNumberKey(event,this,6)" id="SHIPPINGCOST" 
 		...
 		<div class="form-inline">
						...
						<div class="col-sm-3">
						<div class="input-group">
							<INPUT class="form-control" type="TEXT" size="30" MAXLENGTH=20 onkeypress="return isNumberKey(event,this,6)" id="ORDERDISCOUNT" 
								name="ORDERDISCOUNT" value="<%=orderdiscount%>">
								<span
								class="input-group-addon"
								style="font-size: 20px; color: #0059b3"><b>%</b></span>
								</div>
					...
					<!-- <label class="control-label col-sm-2" for="Remarks">Order
						Status:</label>
					<div class="col-sm-3">
						<div class="input-group"> -->
							<INPUT class="form-control" name="STATUS_ID" type="hidden"
								value="<%=statusID%>" size="20" MAXLENGTH=50> 
								<!-- <span class="input-group-addon"
								onClick="javascript:popUpWin('OrderStatusList.jsp?ORDERSTATUS='+form.STATUS_ID.value+'&TYPE=OB');">
								<a href="#" data-toggle="tooltip" data-placement="top"
								title="Order Status Details"> <i
									class="glyphicon glyphicon-log-in" style="font-size: 20px;"></i></a>
							</span>
						</div>
					</div> -->
					<!-- <div class="form-inline">
    	<label class="control-label col-sm-3" for="customer remarks">Supplier Remarks:</label>
        <div class="col-sm-3"> -->
					<INPUT readonly class="form-control" type="hidden" size="30"
						MAXLENGTH="100" name="REMARK2" value="<%=remarks%>">
					<!-- </div>
 		</div> -->
					<!-- <div class="form-inline">
		   ...
		   MasterUtil _MasterUtil=new  MasterUtil();
            ...
            <div class="row">
					<div class="col-12 col-sm-12">
						<INPUT Type=Checkbox class="form-check-input" style="border: 0;"
							name="select" value="select"
							<%if (allChecked.equalsIgnoreCase("true")) {%> checked <%}%>
							onclick="return checkAll(this.checked);"> <strong>
							&nbsp; Select/Unselect All </strong> <INPUT Type=Checkbox
							class="form-check-input" style="border: 0;" name="fullReceive"
							<%if (fullReceive.equalsIgnoreCase("true")) {%> checked <%}%>
							value="fullReceive" onclick="return fullReceiving(this.checked)">
						<strong> &nbsp; Full Conversion </strong>
					</div>
				</div>
				...
				<TABLE style="font-size: 15px" BORDER="0" CELLSPACING="0"
					...
					<tbody>
						...
						<%
							ArrayList al = _dOUtil.listDODETDetailsforcopyfunc(plant, dono);
							...
							if (al.size() > 0) {
								...
								for (int i = 0; i < al.size(); i++) {
									...
									//String cost = _ItemMstDAO.getItemCost(plant, item);
          							String cost = _ItemMstDAO.getLocalCurrencyCost(plant,currencyid,item,uom);

									Map mPrddet = new ItemMstDAO().getProductNonStockDetails(
											plant, item);
									String nonstocktype = StrUtils.fString((String) mPrddet
											.get("NONSTKFLAG"));
									String nonstocktypeDesc = StrUtils.fString((String) mPrddet
											.get("STOCKTYPEDESC"));
									...
									if (nonstocktype.equals("Y")) {
										...
										if (nonstocktypeDesc.equalsIgnoreCase("discount")
												|| nonstocktypeDesc
														.equalsIgnoreCase("Credit/Refund")) {
											cost = "-" + cost;
									...
									if (checkedPONO != null
											&& result.equalsIgnoreCase("catchrerror")) {
									...
									String qtyOrValue =(String)m.get("qtyor");
							          ...
							          double unitCostValue ="".equals(cost) ? 0.0d :  Double.parseDouble(cost);
							          cost = StrUtils.addZeroes(unitCostValue, numberOfDecimal);
						%>


						<TR bgcolor="<%=bgcolor%>">
							<TD width="5%" align="CENTER"><font color="black"><INPUT
									Type=Checkbox style="border: 0;" name="chkdPONO"
									value="<%=lnno%>" <%if (value != null) {%> checked <%}%>
									onclick="setreceivingQty (<%=lnno%>,<%=i%>);"></font></TD>
							...
							<TD align="center" width="12%"><%=new java.math.BigDecimal(cost).toPlainString()%></TD>
							<TD align="center" id="QtyOrdered_<%=lnno%>" width="10%"><%=qtyOrValue%></TD>
							<TD align="center" width="10%"><input class="form-control"
								type="text" name="receivingQty_<%=lnno%>"
								id="receivingQty_<%=lnno%>" size="6" maxlength="10"
								value=<%=receivingQty%>></TD>
						...
						<TR>
							<TD align="center" width="15%">Data's Not Found For
								Receiving</TD>
						</TR>
						<%
							}
				...
				<div class="form-group">
					<div class="col-sm-12" align="center">
						...
						&nbsp;&nbsp;
						<button type="button" class="Submit btn btn-default"
							onClick="if(validatePO(document.form)) {submitForm('copy To Inbound Order');}">
							<b>Confirm</b>
						</button>
						&nbsp;&nbsp;
						<button type="button" class="Submit btn btn-default"
					...
					<INPUT type="hidden" name="ISAUTOGENERATE"
