...
<%
	String title = "Copy Estimate Order";
	...
	String olddono = (String)request.getAttribute("oldestno");
...
<script src="../jsp/js/CopyEstimateOrder.js"></script>
<center>
	<h2>
	...
	<!-- Muruganantham Modified on 16.02.2022 -->
            <ol class="breadcrumb backpageul">      	
               ...
               <li><a href="../salesestimate/summary"><span class="underline-on-hover">Sales Estimate Summary</span> </a></li>
                <li><a href="../salesestimate/detail?estno=<%=esthdr.getJobNum()%>"><span class="underline-on-hover">Sales Estimate Detail</span> </a></li>
                <li><label>Copy Estimate Order</label></li>                                   
            </ol>             
    <!-- Muruganantham Modified on 16.02.2022 -->
		<div class="box-header menu-drop">
			<h1 style="font-size: 20px;" class="box-title"><%=title%></h1>
			<h1 style="font-size: 18px; cursor: pointer;" class="box-title pull-right" onclick="window.location.href='../salesestimate/detail?estno=<%=esthdr.getJobNum()%>'">
		...
		<div class="container-fluid">
			...
			action="../salesestimate/copy" enctype="multipart/form-data" onsubmit="return validateSalesOrder()">
			...
			<input type="hidden" name="CURRENCYUSEQTOLD" value="<%=esthdr.getCURRENCYUSEQT()%>">
				...
				<%} %>
				<input type = "hidden" name="COPYESTNO" value="<%=olddono%>">
				<div class="form-group customer-section">
					...
					<div class="col-sm-6 ac-box">
						<input type="text" class="ac-selected  form-control typeahead" id="CUSTOMER" 
							 name="CUST_NAME" onchange="checkcustomer(this.value)" value="<%=esthdr.getCustName()%>">
...
<!-- 						<div class="input-group"> -->
								...
								onclick="javascript:popUpWin('../jsp/shippingdetails_list.jsp?SHIPPINGCUSTOMER='+form1.SHIPPINGCUSTOMER.value+'&FORMNAME=form1');">
...
<!-- 						</div> -->
				...
				<div class="form-group">
					...
					<div class="col-sm-4">
						<div class="input-group">
							<input type="text" class="form-control" id="ESTNO" name="ESTNO" value="<%=esthdr.getESTNO()%>" onchange="checkorderno(this.value)" onkeypress="return blockSpecialCharOrderNo(event)">
					...
					<div class="col-sm-4">
						<div class="input-group">
							<input type="text" class="form-control datepicker" id="DELDATE" 
								...
								name="DELDATE" value="<%=curDate%>" readonly>
						</div>
					</div>
				...
				<div class="form-group">
					...
					<div class="col-sm-4">
						<div class="input-group">
							<input type="text" class="form-control" id="GST" onchange="changetaxforgst()" onkeypress="return isNumberKey(event,this,4)" name="GST" value="<%=esthdr.getOUTBOUND_GST()%>">
...
<div class="total-section total-row">
				...
				<input type = "hidden" name="CUST_CODE" id="CUST_CODE" value="<%=esthdr.getCustCode()%>">
