...
<script src="../jsp/js/CopyEstimateOrderPro.js"></script>
<center>
	<h2>
...
<div class="container-fluid m-t-20">
	<div class="box">
		<div class="box-header menu-drop">
			...
			<h1 style="font-size: 18px; cursor: pointer;" class="box-title pull-right" onclick="window.location.href='../salesestimate/detailPro?estno=<%=esthdr.getJobNum()%>'">
		...
		<div class="container-fluid">
			...
			<input type="hidden" name="CURRENCYUSEQTOLD" value="<%=esthdr.getCURRENCYUSEQT()%>">
				...
				<div class="form-group customer-section">
					...
					<div class="col-sm-6 ac-box">
						<input type="text" class="ac-selected  form-control typeahead" id="CUSTOMER" 
							 name="CUST_NAME" value="<%=esthdr.getCustName()%>" readonly>
				...
				<div class="form-group">
					...
					<div class="col-sm-4">
							<input type="text" class="form-control" id="ORDERTYPE" name="ORDERTYPE" value="<%=esthdr.getORDERTYPE()%>">
							<span class="select-icon" 
				...
				<div class="form-group">
					...
					<div class="col-sm-4">
						<div class="input-group">
							<input type="text" class="form-control" id="GST" onchange="changetaxforgst()" name="GST" value="<%=esthdr.getOUTBOUND_GST()%>">
				...
				<div class="form-group">
					...
					<div class="col-sm-4">
						<input type="text" class="form-control" id="EMP_NAME" name="EMP_NAME" value="<%=esthdr.getEMPNO()%>">
						<span class="select-icon" 
				...
				<div class="form-group">
					...
					<div class="col-sm-4 ac-box">
						<input type="text" class="ac-selected form-control" id="CURRENCY" name="CURRENCY" value="<%=esthdr.getCURRENCYID()%>" readonly>
					</div>
				</div>
								...
								<td>
									<input type="text" name="QTY" class="form-control text-right" 
									 ...
									 <%--  data-pq="<%=estdet.getQtyPick().doubleValue()%>"  --%>
									  data-iq="<%=estdet.getQTYIS().doubleValue()%>" value="<%=StrUtils.addZeroes(estdet.getQTYOR().doubleValue(), "3")%>" onchange="calculateAmount(this)">
								</td>
								<td>
