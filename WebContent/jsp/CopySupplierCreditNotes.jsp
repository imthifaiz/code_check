...
String creditnote="",creditDate="", payTerms = "",grnumber ="",creditstatus="",sREVERSECHARGE="",sGOODSIMPORT="",orderdiscount="",
discount = "", dicountType = "", discountAccount = "", shippingCharge = "0", adjLabel = "", adjustment = "", notes = "",item_rate="",purchaseloc="",stateprefix="",btname="Save";
...
if(action.equalsIgnoreCase("view")){
    ...
    Map shipDetail = null;
    	...
    	orderdiscount = StrUtils.addZeroes(Double.parseDouble("0.0"), "3");
...
<div class="container-fluid m-t-20">
	...
	<!-- Muruganantham Modified on 16.02.2022 -->
            <ul class="breadcrumb backpageul" >      	
                ...
                <li><label>Copy Debit Note</label></li>                                   
            </ul>             
    <!-- Muruganantham Modified on 16.02.2022 --> 
	...
	<%} %>
		<div class="form-group vendor-section">
			...
			<div class="col-sm-6 ac-box">
				...
				<input type="text" class="ac-selected  form-control typeahead" id="vendname" placeholder="Select a vendor" name="vendname" onchange="checksupplier(this.value)" value="<%=vendName%>">
...
<!-- 				<span class="btn-danger input-group-addon" onclick="javascript:popUpWin('../jsp/vendor_list.jsp?AUTO_SUGG=Y&CUST_NAME='+form.vendno.value);"><span class="glyphicon glyphicon-search" aria-hidden="true"></span></span>	 -->
				<!-- </div> -->
				<SELECT class="form-control taxdropdown" data-toggle="dropdown" style="border: none;" data-placement="right" onchange="OnChkTaxChange(this.value)" id="nTAXTREATMENT" name="nTAXTREATMENT" value="<%=sTAXTREATMENT %>" style="width: 100%">
		...
		<div class="form-group">
			...
			<div class="col-sm-4">				
				<input type="text" class="form-control billno" id="billno" value="" name="billno" readonly>
			</div>
		...
		<div class="form-group">
			...
			<div class="col-sm-4">				
				<input type="text" class="form-control grnno" id="grnno" name="grnno" value="" readonly>
			</div>
		...
		<div class="form-group">
			...
			<div class="col-sm-4">
				<div class="input-group">   
		        		<input class="form-control" name="creditnote" type="text" id="creditnote" onchange="checkorderno(this.value)" onkeypress="return blockSpecialCharOrderNo(event)"
		        			value="" > 
		...
		<div class="form-group">
			...
			<div class="col-sm-4">				
				<input type="text" class="form-control pono" id="pono" name="pono" value="" maxlength ="50">
...
<!-- 				</td>				 -->
	...
	<%-- <%@include file="newProductModalPurchase.jsp" %> --%>
...
//		 End
	...
	if(document.getElementById("GOODSIMPORT").checked == true)
		gd="1";
   var idd = "<%=billHdrId%>";
   document.form1.action  = "/track/CreateSupplierServlet?action=ADD&reurl=CopySupplierCreditNotes.jsp?action=View&BILL_HDR="+idd+"&REVERSECHARGE="+rc+"&GOODSIMPORT="+gd;
...
function onIDGen()
{
	...
	if(document.getElementById("GOODSIMPORT").checked == true)
		gd="1";
	var idd = "<%=billHdrId%>";
 document.form1.action  = "/track/CreateSupplierServlet?action=Auto-ID&reurl=CopySupplierCreditNotes.jsp?action=View&BILL_HDR="+idd+"&REVERSECHARGE="+rc+"&GOODSIMPORT="+gd;
   document.form1.submit();  --%>
