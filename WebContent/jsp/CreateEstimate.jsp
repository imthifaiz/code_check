...
isSaveClicked = true;
  ...
  if(!IsNumeric(form.GST.value))
  {
   ...
   add_attachments();
/* document.form.action = "/track/EstimateServlet?Submit=Save";
...
<form class="form-horizontal" id="Estimateform" name="form" method="post"  action="/track/EstimateServlet?" onSubmit="return validatePO(document.form)">
