...
<script src="../jsp/js/SalesEstimate.js"></script>
<center>
	<h2>
...
<div class="container-fluid m-t-20">
	...
	<!-- Muruganantham Modified on 16.02.2022 -->
            <ol class="breadcrumb backpageul">      	
                ...
                <li><label>Create Estimate Order</label></li>                                   
            </ol>             
    <!-- Muruganantham Modified on 16.02.2022 -->
		...
		<div class="container-fluid">
			<form class="form-horizontal" id="salesOrderForm" name="form1" autocomplete="off"
				method="post" action="../salesestimate/new"
...
<!-- 						<div class="input-group"> -->
							<input type="text" class="ac-selected  form-control typeahead"
								...
								placeholder="Select a customer" name="CUST_NAME" onchange="checkcustomer(this.value)" value="">
...
<!-- 						</div> -->
						<span><a href="#" title="Tax Treatment" id="TAXTREATMENT"
							...
							data-placement="right" name="nTAXTREATMENT" id="nTAXTREATMENT" value="" style="width: 100%">
...
<!-- 						<div class="input-group"> -->
							<input type="text" class="ac-selected  form-control typeahead"
								id="project" placeholder="Select a project" name="project" onchange="checkproject(this.value)"
...
<!-- 						</div> -->
				...
				<div class="form-group">
					<label class="control-label col-form-label col-sm-2">Payment
						Mode:</label>
					<div class="col-sm-4">
						<input type="text" class="form-control" id="PAYMENTTYPE" onchange="checkpaymenttype(this.value)" value=""
				...
				<div class="form-group">
					...
					<div class="col-sm-6 no-padding" style="display:none">
						<label class="control-label col-form-label col-sm-5">Order
							Time:</label>
						<div class="col-sm-6">
							<div class="input-group">
				...
				<div class="form-group">
					<label class="control-label col-form-label col-sm-2">Order
						Type:</label>
					<div class="col-sm-4">
						<input type="text" class="form-control" id="ORDERTYPE" onchange="checkordertype(this.value)" value=""
				...
				<div class="form-group">
					...
					<%} %>
					<div class="col-sm-4">
						<input type="text" class="form-control" id="EMP_NAME" onchange="checkemployeess(this.value)" value="<%=empname%>"
							name="EMP_NAME"> 
				...
				<div class="form-group">
					...
					<div class="col-sm-4">
						<input type="text" class="form-control" id="INCOTERMS" onchange="checkincoterms(this.value)" value=""
				...
				<div class="form-group">
					...
					<div class="col-sm-4 ac-box">
						<input type="text" class="ac-selected form-control typeahead"
							...
							onchange="checkcurrency(this.value)" value="<%=currency%>"> <span class="select-icon"
					...
					<div class="col-sm-4">
						<div class="input-group">
							<input type="text" class="form-control" id="GST" name="GST"
								onchange="changingtaxpercentage()" onkeypress="return isNumberKey(event,this,4)" value="<%=gst%>"> <span
				...
				<div class="form-group">
					...
					<div class="col-sm-4">
						<input type="text" class="form-control" id="Salestax" onchange="checktax(this.value)"
					...
					<table class="table table-bordered line-item-table so-table">
						<thead>
							<tr>
								...
								<th colspan=2 style="width: 8%">Amount</th>
								<!-- <th></th> -->
							</tr>
						</thead>
						<tbody>
							<tr>
								<td class="item-img text-center"><img alt=""
									...
									type="hidden" name="tax" class="taxSearch" value=""></td>
								<td class="bill-item"><input type="text" name="item"
									class="form-control itemSearch" onchange="checkitems(this.value,this)" style="width: 87%"
								...
								<td class="bill-item"><input type="text" name="UOM"
									class="form-control uomSearch" onchange="checkprduom(this.value,this)" placeholder="Select UOM">
								</td>
								<td class="item-qty"><input type="text" name="QTY"
									...
									data-aq="0.000" value="1.000" onchange="calculateAmount(this)" onkeypress="return isNumberKey(event,this,4)">
								</td>
								<td><input type="text" name="PRODUCTDELIVERYDATE"
									class="form-control datepicker" READONLY tabindex="-1"></td>
								<!-- <td>
								...
								<td class="item-amount text-right grey-bg"><input
									...
									value="<%=zeroval%>" readonly="readonly" tabindex="-1"></td>
								<td class="table-icon"><a href="#"
									...
									<div class=" col-lg-6 col-sm-6 col-6">
										<div class="input-group my-group">
											<input class="form-control text-right" type="text"
												...
												onchange="calculateTotal()" onkeypress="return isNumberKey(event,this,4)"> <select
								...
								<div class="row">
									...
									<div class="col-lg-6 col-sm-6 col-6">
										<input class="form-control text-right ember-view" type="text"
											name="shippingcost" onchange="calculateTotal()" onkeypress="return isNumberKey(event,this,4)"
											value="<%=zeroval%>">
									</div>
								</div>
							</div>
				...
				<input id="sub_total" name="sub_total" value="" hidden> <input
					...
					id="taxamount" name="taxamount" value="" hidden> <input
