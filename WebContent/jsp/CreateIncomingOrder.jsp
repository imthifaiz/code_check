...
function isSavedButtonClicked(){
  ...
  /*    if (form.DELDATE.value.length > 1){
    ...
    if(!IsNumeric(form.GST.value))
   {
    ...
    add_attachments();
	 /* document.form.action = "/track/purchaseorderservlet?Submit=Save";
...
function onNew(form)
{
    ...
    document.form.action = "/track/purchaseorderservlet?Submit=Auto-Generate";
    document.form.submit();
...
<%
    ...
    String vend = "",deldate="",jobNum = "",custName = "",custCode="",ordertype="",personIncharge = "",contactNum = "",
    ...
    remarks="",gst="",shippingid="",shippingcustomer="",orderdiscount="",shippingcost="",
    incoterms="",statusID="NOT PAID",paymenttype="",localexpenses="",dateformat="",sTAXTREATMENT="",sPURCHASE_LOC="",sREVERSECHARGE="",sGOODSIMPORT="";
     //contactname="",telno="",email="",add1="",currencyid="",add2="",add3="",add4="",country="",zip="",remarks="",gst="",ordertype="";
    ...
    String isAutoGenerate = "false";
     ...
     if(action.equalsIgnoreCase("View")){
      try{     
      	...
      	Map m=(Map)session.getAttribute("podetVal");
      	fieldDesc=(String)session.getAttribute("RESULT");
       ...
       if(m.size()>0){
		...
		sGOODSIMPORT= (String) m.get("GOODSIMPORT");
		 ...
		 /* shippingcostValue ="".equals(shippingcost) ? 0.0f :  Float.parseFloat(shippingcost);
		 localexpensesValue ="".equals(localexpenses) ? 0.0f :  Float.parseFloat(localexpenses); */
		...
		shippingcostValue ="".equals(shippingcost) ? 0.0d :  Double.parseDouble(shippingcost);
		localexpensesValue ="".equals(localexpenses) ? 0.0d :  Double.parseDouble(localexpenses);     
       }
     ...
     logger.log(0,"Exception ::" + e.getMessage());
		...
		pono = _TblControlDAO.getNextOrder(plant,sUserId,IConstants.INBOUND);
		isAutoGenerate = "true";
     	//pono=_PoHdrDAO.getNextOrder(plant,sUserId);
     	collectionDate=du.getDate();
...
<form class="form-horizontal" id="productform" name="form" method="post"  action="/track/purchaseorderservlet?" onSubmit="return validatePO(document.form)">
...
<div class="form-group">
       ...
       <div class="col-sm-3">
  		...
  		<label class="control-label col-sm-3" for="supplier name">
...
<div class="form-group">
        ...
        <div class="col-sm-3">
		<div class="input-group">
        <INPUT name="PAYMENTTYPE" type="TEXT" value="<%=paymenttype%>"  class="form-control" style="width: 100%" MAXLENGTH=100>
...
<div class="form-group">
     <label class="control-label col-sm-2" for="Shipping Cost">Shipping Cost:</label>
        <div class="col-sm-3">
        <INPUT class="form-control" type = "TEXT" size="20"  onkeypress="return isNumberKey(event,this,6)" MAXLENGTH=20 id="SHIPPINGCOST" name="SHIPPINGCOST" value="<%=new java.math.BigDecimal(shippingcost).toPlainString()%>">
        </div>
 		<!-- <label class="control-label col-sm-2" for="Order Status">Order Status:</label>
        <div class="col-sm-3">
        <div class="input-group"> -->
        <input class="form-control" name="STATUS_ID" type="hidden" value="<%=statusID%>" size="20" MAXLENGTH=50 readonly="readonly"/>
        <%--
        <INPUT class="form-control" name="STATUS_ID" type="TEXT" value="" size="20" MAXLENGTH=50>
        ...
        <div class="form-inline">        
      	...
      	<button type="button" class="Submit btn btn-default" onClick="isSavedButtonClicked()"><b>Save</b></button>&nbsp;&nbsp;
      	</div>
