...
<%
	String title = "Create Product Return";
...
<jsp:include page="header2.jsp" flush="true">
	...
	<jsp:param name="submenu" value="<%=IConstants.PRODUCT_RETURN%>"/>
</jsp:include>
...
<script src="../jsp/js/CreateProductReturn.js"></script>
<center>
	<h2>
...
<div class="container-fluid m-t-20">
		...
		<div class="box" id="inventory">
			...
			<ul class="breadcrumb backpageul">
				...
				<li><a href="../productreturn/summary"><span
						class="underline-on-hover">Product Return Summary</span> </a></li>
				<li><label>Create Product Return</label></li>
			</ul>
			<!-- Muruganantham Modified on 16.02.2022 -->
			<div class="box-header menu-drop">
				...
				<h1 style="font-size: 18px; cursor: pointer;"
					...
					onclick="window.location.href='../productreturn/summary'">
			...
			<div class="container-fluid">
				<input type="number" id="numberOfDecimal" style="display: none;"
					...
					id="PageName" style="display: none;" value="Invoice">
				<form id="createBillForm" class="form-horizontal" name="form1"
					autocomplete="off" action="/track/ItemReturnServlet?Submit=Save"
					method="post" enctype="multipart/form-data"
					onsubmit="return validateInvoice()">

					<input type="hidden" name="PROJECTID" value=""> <input
						type="hidden" name="TRANSPORTID" value="">
					...
					<input type="hidden" name="vendno" id="vendno" value="">
					 <input
						...
						type="hidden" name="taxid" value="0">
					<%-- <input type = "hidden" name="GST" value="<%=gst%>"> --%>
					<input type="hidden" name="custModal"> <INPUT type="hidden"
						name="CURRENCYID" value="<%=DISPLAYID%>"> <INPUT
						type="hidden" name="curency" value="<%=DISPLAYID%>"> <input
						type="hidden" name="numberOfDecimal" value="<%=numberOfDecimal%>">
					<INPUT type="hidden" name="ValidNumber" value="<%=OrdValidNumber%>">
					<INPUT type="hidden" name="BASECURRENCYID" value="<%=curency%>">
					<%--Resvi--%>
					<!-- 		       		IMTHIYAS Modified on 02.03.2022    -->
					<INPUT type="hidden" name="EDUCATION" value="<%=compindustry%>">
					<INPUT type="hidden" name="DOBYEAR" value=""> <INPUT
						type="hidden" name="NATIONAL" value=""> <INPUT
						type="hidden" name="replacePreviousInvoiceCost"
						value="3"> <input
						name="COMP_INDUSTRY" type="hidden" value="<%=COMP_INDUSTRY%>">
					<!-- imti added condition based on product popup -->

					<%if(!ispuloc){ %>
					<input type="hidden" id="SALES_LOC" name="SALES_LOC">
					<%} %>
					<input type="hidden" name="SHIPPINGID" value=""> <input
						type="hidden" name="SHIPPINGCUSTOMER" value="">
					<div class="form-group customer-section" style="display: none;">
						...
						<div class="col-sm-6 ac-box">
							<div class="input-group">
								<input type="text" class="ac-selected  form-control typeahead"
									onclick="removetaxtrestl()" id="CUSTOMER"
									placeholder="Select a customer" name="CUSTOMER"
									onchange="checkcustomer(this.value)" value="<%=CUSTOMER%>">
								<span class="select-icon" style="right: 5px;"
							...
							<SELECT class="form-control taxdropdown" data-toggle="dropdown"
								...
								type="hidden" name="STATE_PREFIX" value="<%=plantstatecode%>" />
							<INPUT type="hidden" name="TAXTREATMENT_VALUE"
        			...
        			<div class="col-sm-6 ac-box">
      	    			<!-- <div class="input-group"> -->
    		 				<INPUT class="ac-selected  form-control typeahead" id="vendname" name="vendname" onchange="checksupplier(this.value)" value="" type="TEXT" MAXLENGTH=100>
       				...
       				<!-- 	</div> -->
        				<SELECT class="form-control taxdropdown" data-toggle="dropdown" style="border: none;" onchange="OnChkTaxChange(this.value)" data-placement="right" id="nTAXTREATMENT" name="nTAXTREATMENT" value="" style="width: 100%" >
        					...
        					<%
		   					...
		   					ArrayList ccList1s =  _MasterUtils.getTaxTreatmentList("",plant,"");
							for(int i=0 ; i<ccList1s.size();i++){
								Map m1=(Map)ccList1.get(i);
								String nTAXTREATMENT = (String)m1.get("TAXTREATMENT"); %>
				...
				<div class="col-sm-4" style="line-height: 7px;font-size: 13px;" id="shipadd"></div>
					...
					<div class="form-group shipCustomer-section" id="shipbilladd" style="display: none;">
					...
					<div class="form-group">
						<label class="control-label col-form-label col-sm-2">Transport
							Mode:</label>
						<div class="col-sm-4 ac-box">
							<input type="text" class="form-control typeahead" id="transport"
								placeholder="Select a transport" name="transport"
								onchange="checktransport(this.value)" value=""> <span
								class="select-icon"
						...
						<div class="col-sm-4 ac-box">
							<div class="input-group">
								<input type="text" class="ac-selected  form-control typeahead"
									...
									onchange="checkproject(this.value)" value=""> <span
									class="select-icon" style="right: 4px;"
					...
					<%} %>
					<div class="form-group">
						<label class="control-label col-form-label col-sm-2 required">Product Return No#</label>
						<div class="col-sm-4">
							<div class="input-group">
								<input type="text" class="form-control" id="invoice"
									name="invoice" onchange="checkorderno(this.value)"
									onkeypress="return blockSpecialCharOrderNo(event)"> <span
									class="input-group-addon" onClick="onNewInvoice()"> <a
					...
					<div class="form-group" style="display: none;">
						...
						<div class="col-sm-4">
							<input type="text" class="form-control" id="gino" name="gino"
								value="" readonly>
						</div>
					</div>
					<div class="form-group" style="display: none;">
					...
					<div class="form-group">
						<label class="control-label col-form-label col-sm-2 required">Return
							Date</label>
						<div class="col-sm-4">
					...
					<div class="form-group">
						<label class="control-label col-form-label col-sm-2">Payment Terms
							</label>
						<div class="col-sm-4">
							<input type="text" class="ac-selected form-control"
									placeholder="Select Payment Terms" id="payment_terms"
									name="payment_terms" onchange="checkpaymentterms(this.value)">
								<span class="select-icon"
									onclick="$(this).parent().find('input[name=\'payment_terms\']').focus()"><i
									class="glyphicon glyphicon-menu-down"></i></span>
						</div>
						<div class="col-sm-6 no-padding" style="display: none;">
							<label class="control-label col-form-label col-sm-5">Due
								Date</label>
							<div class="col-sm-6 ac-box">
								<input type="text" class="form-control datepicker" id="due_date"
								placeholder="Select due date" name="due_date">
							</div>
						</div>
					</div>
					...
					<div class="form-group">
						...
						<div class="col-sm-4">
							<input type="text" class="form-control" id="ORDERTYPE"
								name="ORDERTYPE" onchange="checkordertype(this.value)" value="">
							<span class="select-icon"
					...
					<div class="form-group employee-section">
						...
						<div class="col-sm-4 ac-box">
							<input type="text" class="ac-selected form-control typeahead"
								...
								onchange="checkemployeess(this.value)"
								placeholder="Select a employee" value="<%=empname%>"> <input
								type="hidden" name="ISEMPLOYEEVALIDATESO"
								value="<%=isEmployee%>"> <span class="select-icon"
		   ...
		   ArrayList ccList =  _MasterUtil.getSalesLocationList("",plant,"");
			for(int i=0 ; i<ccList.size();i++)
			 ...
			 %></SELECT>
					...
					<div class="form-group">
						...
						<div class="col-sm-4 ac-box">
							<input type="text" class="ac-selected form-control typeahead"
								...
								onchange="checkcurrency(this.value)" value="<%=DISPLAY%>">
							<span class="select-icon"
						...
						<div class="col-sm-6 no-padding">
							<label class="control-label col-form-label col-sm-5 required"
								id="exchangerate"></label>
							<div class="col-sm-6 ac-box">
								<input type="text" class="form-control" id="CURRENCYUSEQT"
									name="CURRENCYUSEQT" placeholder="Enter Exchange Rate"
									value="<%=CURRENCYUSEQT%>"
									onkeypress="return isNumberKey(event,this,4)" required>
							</div>
						</div>
					</div>
					<!--  Ends  -->
					...
					<div class="form-group">
						<label class="control-label col-form-label col-sm-2">Standard
							<%=taxbylabelordermanagement%> :
						</label>
						<!-- this is dynamic value -->
						<div class="col-sm-4">
							<input type="text" class="form-control" id="GST" name="GST"
								onchange="changingtaxpercentage()"
								onkeypress="return isNumberKey(event,this,4)" value="<%=gst%>">
					...
					<div class="row" style="margin: 0px;">
						<table class="table table-bordered line-item-table bill-table"
							...
							<thead>
								<tr>
									<th class="bill-desc" colspan=2 style="width: 10%">Product
										Details</th>
									...
									<th class="item-amount text-center" 
							...
							<tbody>
								<tr>
									<td class="item-img text-center">
										...
										<input type="hidden" name="lnno" value="1"> <input
										type="hidden" name="nonStkFlag" value=""><input
										type="hidden" name="basecost" value="0.00"> <input
										type="hidden" name="minsp" value=""> <input
										type="hidden" name="customerdiscount" value=""> <input
										type="hidden" name="outgoingqty" value=""> <input
										type="hidden" name="itemprice" value="0.00"> <input
										type="hidden" name="itemcost" value=""> 
										<input type="hidden" name="discounttype" value="">
										<input type="hidden" name="ITEMINVQTY" value="">
									...
									<td class=""><input type="text" name="account_name"
										class="form-control accountSearch" placeholder="Account"
										value="Local sales - retail"></td>
									...
									<td class="invEl"><input type="text" name="loc"
										onchange="checkprdloc(this.value,this)"
										class="form-control locSearch" placeholder="Location"></td>
									...
									<td><input type="text" name="unitcost"
										class="form-control text-right" value="<%=zeroval%>" readonly
										tabindex="-1"></td>
									<td><input type="text" name="addonshow"
										class="form-control text-right"
										value="<%=zeroval+" "+curency%>" readonly tabindex="-1">
									...
									<td class="item-cost text-right"><input name="cost"
										...
										onchange="calculateAmount(this)"
										onkeypress="return isNumberKey(event,this,4)"></td>
					...
					<div class="row">
						...
						<div class="total-section col-sm-6">
									...
									<div class="row">
										...
										<div class=" col-lg-6 col-sm-6 col-6">
											<div class="input-group my-group">
												<input class="form-control text-right oddiscount"
													type="text" value="<%=zerovalper %>" readonly
							...
							<div class="total-row">
								<div class="total-label">
									<div class="row">
										...
										<div class="col-lg-1 col-sm-1 col-1">
											<input type="checkbox" class="form-check-input isdtax"
												checked name="isdtax" Onclick="isdtaxing(this)">
										</div>
										<div class=" col-lg-6 col-sm-6 col-6">
											<div class="input-group my-group">
												<% if(compindustry.equals("Education")){%>
												<input class="form-control text-right" type="text"
													...
													onkeypress="return isNumberKey(event,this,4)" disabled>
							...
							<div class="total-row">
								...
								<div class="total-amount " style="line-height: 2"
									id="adjustment">0.00</div>
							</div>

							<div class="total-section total-row">
								<div class="gross-total-removemargin">
									<!--  Author: Azees  Create date: July 16,2021  Description: Total of Local Currency-->
									<div class="total-label">
...
<!-- 							</div> -->
					...
					<input name="Submit" id="Submit" value="Save" type="hidden">
					<input name="invoice_status" value="Save" type="hidden"> <input
						id="taxamount" name="taxamount" value="" type="hidden">
					<div class="row">
						<div class="col-sm-12 txn-buttons">
							<div class="dropup">
								<%--https://www.w3schools.com/bootstrap/tryit.asp?filename=trybs_dropdown-menu-dropup&stacked=h --%>
								
								<button type="button" class="Submit btn btn-success" id="btnBillOpen" href="#" >Save</button>&nbsp;
						...
						<input type="hidden" value="<%=displayCustomerpop%>"
							...
							type="hidden" name="SHIPCONTACTNAME" value=""> <input
							type="hidden" name="SHIPDESGINATION" value=""> <input
							type="hidden" name="SHIPADDR1" value=""> <input
							type="hidden" name="SHIPADDR2" value=""> <input
							type="hidden" name="SHIPADDR3" value=""> <input
							type="hidden" name="SHIPADDR4" value=""> <input
							type="hidden" name="SHIPSTATE" value=""> <input
							type="hidden" name="SHIPZIP" value=""> <input
							type="hidden" name="SHIPWORKPHONE" value=""> <input
							type="hidden" name="SHIPCOUNTRY" value=""> <input
							type="hidden" name="SHIPHPNO" value=""> <input
							type="hidden" name="SHIPEMAIL" value="">
					</div>
				</form>
			</div>
		</div>
...
<input type="hidden" id="template_subject"
...
<input type="hidden" name="pronumberOfDecimal" id="pronumberOfDecimal"
		...
		<div class="modal-content">
			...
			size="50" MAXLENGTH=50 class="form-control"> --%>
					...
					<div class="form-group">
						...
						<div class="col-sm-6">
							<SELECT class="form-control" data-toggle="dropdown"
								data-placement="right" id="SHIP_STATE" name="SHIP_STATE"
			...
			<div class="modal-content">
				...
				<div class="modal-body">
						...
						<div class="col-sm-4">
							...
							<div class="input-group">
								<INPUT class="form-control" name="CUST_CODE_C" id="CUST_CODE_C"
									...
									value="" onchange="checkitem(this.value)" size="50"
							...
							<INPUT type="hidden" name="CUST_CODE1_C" value=""> <INPUT
								...
								type="hidden" name="COUNTRY_REG" value="<%=region%>"> <INPUT
								type="hidden" name="ValidNumber" value="<%=ValidNumber%>">
							<INPUT type="hidden" name="CURRENCYID_C" value="<%=DISPLAYID%>">
							<!--Resvi -->
							<input type="hidden" name="TRANSPORTSID" value="<%=transports%>">
							<INPUT type="hidden" name="CUST_SHIP_COUNTRY" value=""> <INPUT
								type="hidden" name="CUST_EDUCATION" value="<%=compindustry%>">
					...
					<div class="form-group">
						...
						<div class="form-inline">
							<label class="checkbox-inline"> <input type="checkbox"
								id="APP_SHOWBY_PRODUCT" name="APP_SHOWBY_PRODUCT"
								value="APP_SHOWBY_PRODUCT" />Show APP Products Image
							</label>
						</div>
						<%} %>
					</div>
					...
					<div class="form-group" id="UEN">
						<% if(COMP_INDUSTRY.equals("Education")){%>
						<label class="control-label col-form-label col-sm-2"
							for="Unique Entity Number (UEN)">IC/FIN Number</label>
						<%}else{ %>
						<label class="control-label col-form-label col-sm-2"
							for="Unique Entity Number (UEN)">Unique Entity Number
							(UEN)</label>
						<%} %>
						<div class="col-sm-4">
							<div class="input-group">
								<input class="form-control" name="cus_companyregnumber"
									id="cus_companyregnumber" type="TEXT"
									value="<%=companyregnumber%>" size="50" MAXLENGTH=50>
							</div>
						</div>
						<% if(!COMP_INDUSTRY.equals("Education")){%>
						<div class="form-inline">
							<label class="checkbox-inline"> <input type="checkbox"
								id="APP_SHOWBY_CATEGORY" name="APP_SHOWBY_CATEGORY"
								value="APP_SHOWBY_CATEGORY" />Show APP Category Image
							</label>
						</div>
						<%} %>
					</div>
					...
					<% if(COMP_INDUSTRY.equals("Education")){%>
					<div class="form-group">
						<label class="control-label col-form-label col-sm-2 required">Date
							of Birth</label>
						<div class="col-sm-4">
							<div class="input-group">
								<input type="text" class="form-control datepicker" id="DOB"
									name="DOB" value="" readonly>
						...
						<div class="col-sm-4">
							<div class="input-group">
								<input type="text" name="NATIONALITY" id="NATIONALITY" value=""
									...
									placeholder="SELECT NATIONALITY"> <span
									class="select-icon"
									onclick="$(this).parent().find('input[name=\'NATIONALITY\']').focus()">
									<i class="glyphicon glyphicon-menu-down"></i>
								</span>
							</div>
						</div>
					...
					<div class="form-group" style="display: none;">
						<label class="control-label col-form-label col-sm-2 required">Customer
							Currency</label>
						<div class="col-sm-4">
							<INPUT class="form-control" name="CUS_CURRENCY" id="CUS_CURRENCY"
								type="TEXT" onchange="checkcustomercurrency(this.value)"
								value="<%=curency%>" size="50" MAXLENGTH=100>
						</div>
					</div>
					<%}else{ %>
					<div class="form-group">
					...
					<div class="form-group">
						<label class="control-label col-form-label col-sm-2">Customer
							Group</label>
						<div class="col-sm-4">
							<input name="CUSTOMER_TYPE_C" id="CUSTOMER_TYPE_C" type="TEXT"
								placeholder="Select a Customer Group" value="" size="50"
								MAXLENGTH=50 class="form-control"> <span
								class="select-icon"
								onclick="$(this).parent().find('input[name=\'CUSTOMER_TYPE_C\']').focus()">
								<i class="glyphicon glyphicon-menu-down"></i>
							</span>
						</div>
					</div>
					...
					<div class="form-group">
						<label class="control-label col-form-label col-sm-2"
							for="transmode">Transport Mode</label>
						<div class="col-sm-4">
							<input name="transports" id="transports" type="TEXT"
								placeholder="Select a transport" size="50"
								onchange="checkcustomertransport(this.value)" value=""
								MAXLENGTH=50 class="form-control"> <span
								class="select-icon"
								onclick="$(this).parent().find('input[name=\'transports\']').focus()">
								<i class="glyphicon glyphicon-menu-down"></i>
							</span>
						</div>
					</div>
					...
					<div class="form-group">
						<label class="control-label col-form-label col-sm-2">Customer
							Email</label>
						<div class="col-sm-4">
							<INPUT name="CUSTOMEREMAIL" ID="CUSTOMEREMAIL" type="TEXT"
								value="" size="50" MAXLENGTH=50 class="form-control">
						</div>
					</div>
					...
					<div class="form-group">
						...
						<div class="col-sm-4">
							<label class="checkbox-inline"> <INPUT name="PEPPOL_C"
								type="checkbox" value="PEPPOL_C" id="PEPPOL_C">
							</label>
						</div>
					</div>
					<div class="form-group">
						<label class="control-label col-form-label col-sm-2"
							for="Peppol idc">Peppol Id</label>
						<div class="col-sm-4">
							<INPUT name="PEPPOL_IDC" id="PEPPOL_IDC" type="TEXT" value=""
								size="50" MAXLENGTH=50 class="form-control">
						</div>
					</div>
					<%}else{%>
			...
			for(int i=0 ; i<ccList.size();i++)
			 ...
			 %></SELECT>
							...
							<div class="tab-pane fade" id="profile">
								...
								<div class="form-group">
									<h1 class="col-sm-3"
										style="font-weight: bold; font-size: 16px; right: 16px;">
										Contact Address</h1>
									<% if(!COMP_INDUSTRY.equals("Education")){%>
									<h1
										style="font-weight: bold; font-size: 16px; margin-left: 450px;">
										Shipping Address <label class="checkbox-inline"
											style="margin-left: 50px; margin-top: 2px;"> <input
											type="checkbox" id="SameAsContactAddress"
											name="SameAsContactAddress" value="SameAsContactAddress"
											onclick="shippingAddress();">Same As Contact Address
										</label>
									</h1>
									<%} %>
								</div>
								...
								<div class="form-group">
									...
									<div class="col-sm-4">
										...
										<INPUT name="CUST_SHIP_CONTACTNAME" id="CUST_SHIP_CONTACTNAME"
											type="TEXT" class="form-control" value="" size="50"
											MAXLENGTH="100">
									</div>
								</div>
								...
								<div class="form-group">
									...
									<div class="col-sm-4">
										...
										<INPUT name="DESGINATION" id="DESGINATION" type="TEXT"
											class="form-control" value="" size="50" MAXLENGTH="30">
									</div>

									<div class="col-sm-4">

										<INPUT name="CUST_SHIP_DESGINATION" id="CUST_SHIP_DESGINATION"
											type="TEXT" class="form-control" value="" size="50"
											MAXLENGTH="30">
									</div>
								</div>
								...
								<div class="form-group">
									...
									<div class="col-sm-4">
										<INPUT name="CUST_SHIP_WORKPHONE" id="CUST_SHIP_WORKPHONE"
											type="TEXT" value="" onkeypress="return isNumber(event)"
								...
								<div class="form-group">
									...
									<% if(!COMP_INDUSTRY.equals("Education")){%>
									<div class="col-sm-4">
										<INPUT name="CUST_SHIP_HPNO" id="CUST_SHIP_HPNO" type="TEXT"
								...
								<div class="form-group">
									...
									<% if(!COMP_INDUSTRY.equals("Education")){%>
									<div class="col-sm-4">
										<INPUT name="CUST_SHIP_EMAIL" id="CUST_SHIP_EMAIL" type="TEXT"
											value="" size="50" MAXLENGTH="50" class="form-control">
									</div>
									<%} %>
								</div>
			 ...
			 %>
									...
									<div class="col-sm-4">
										<SELECT class="form-control" data-toggle="dropdown"
											...
											onchange="SHIPCUST_OnCountry(this.value)"
											id="CUST_SHIP_COUNTRY_CODE" name="CUST_SHIP_COUNTRY_CODE"
											value="" style="width: 100%">
											<OPTION style="display: none;">Select Country</OPTION>
											<%
		   ccList1 =  _MasterUtil1.getCountryList("",plant,region);
			...
			size="50" MAXLENGTH=50 class="form-control"> --%>
								...
								<div class="form-group">
									...
									<div class="col-sm-4">
										...
										<INPUT name="CUST_SHIP_ADDR1" id="CUST_SHIP_ADDR1" type="TEXT"
											value="" size="50" MAXLENGTH=50 class="form-control">
									</div>
									<%} %>
								</div>
								...
								<div class="form-group">
									...
									<div class="col-sm-4">
										...
										<INPUT name="CUST_SHIP_ADDR2" id="CUST_SHIP_ADDR2" type="TEXT"
											value="" size="50" MAXLENGTH=50 class="form-control">
									</div>
									<%} %>
								</div>
								<div class="form-group">
									...
									<% if(!COMP_INDUSTRY.equals("Education")){%>
									<div class="col-sm-4">
										<INPUT name="CUST_SHIP_ADDR3" id="CUST_SHIP_ADDR3" type="TEXT"
											value="" size="50" MAXLENGTH=50 class="form-control">
									</div>
									<%} %>
								</div>
								<div class="form-group">
									...
									<% if(!COMP_INDUSTRY.equals("Education")){%>
									<div class="col-sm-4">
										<INPUT name="CUST_SHIP_ADDR4" id="CUST_SHIP_ADDR4" type="TEXT"
											value="" size="50" MAXLENGTH=80 class="form-control">
									</div>
									<%} %>
								</div>
								<div class="form-group">
									...
									<div class="col-sm-4">
										<SELECT class="form-control" data-toggle="dropdown"
											data-placement="right" id="C_STATE" name="STATE" value=""
											style="width: 100%">
											<OPTION style="display: none;">Select State</OPTION>
										</SELECT>
									</div>
									...
									<div class="col-sm-4">
										<SELECT class="form-control" data-toggle="dropdown"
											data-placement="right" id="CUST_SHIP_STATE"
											name="CUST_SHIP_STATE" value="" style="width: 100%">
											<OPTION style="display: none;">Select State</OPTION>
										</SELECT>
			...
			MAXLENGTH=50 class="form-control"> --%>
								...
								<div class="form-group">
									...
									<div class="col-sm-4">
										...
										<INPUT name="ZIP" id="ZIP" type="TEXT" value="" size="50"
											MAXLENGTH=10 class="form-control">
									</div>
									<% if(!COMP_INDUSTRY.equals("Education")){%>
									<div class="col-sm-4">
										<INPUT name="CUST_SHIP_ZIP" id="CUST_SHIP_ZIP" type="TEXT"
											value="" size="50" MAXLENGTH=10 class="form-control">
									</div>
									<%} %>
								</div>
								...
								<div class="form-group" style="display: none;">
									...
									<div class="col-sm-4 ac-box">
										<SELECT class="form-control" data-toggle="dropdown"
											...
											id="TAXTREATMENT" name="TAXTREATMENT"
											value="Non GST Registered" style="width: 100%">
			...
			for(int i=0 ; i<ccList.size();i++)
      		 {
				...
				String vTAXTREATMENT = (String)m.get("TAXTREATMENT"); %>
											<option selected value='Non GST Registered'><%=vTAXTREATMENT %>
											</option>
											<%
       			}
			 %>
			 ...
			 %>
								...
								<div class="form-group">
									<label class="control-label col-form-label col-sm-2">Payment
										Mode</label>
									<div class="col-sm-4">
										<input id="PAYTERMS" name="PAYTERMS" class="form-control"
											type="text" onchange="checkcustomerpaymenttype(this.value)"
											value="" MAXLENGTH=100 placeholder="Select Payment Mode">
										<span class="select-icon"
											onclick="$(this).parent().find('input[name=\'PAYTERMS\']').focus()">
											<i class="glyphicon glyphicon-menu-down"></i>
										</span>
										<!-- <div class="input-group">
								...
								<div class="form-group" style="display: none;">
									<label class="control-label col-form-label col-sm-2">Payment
										Terms</label>
									<div class="col-sm-4">
										<input type="text" class="form-control" id="cpayment_terms"
											name="cpayment_terms"
											onchange="checkcustomerpaymentterms(this.value)" value=""
											placeholder="Select Payment Terms"> <span
											class="select-icon"
											onclick="$(this).parent().find('input[name=\'cpayment_terms\']').focus()">
											<i class="glyphicon glyphicon-menu-down"></i>
										</span>
									</div>
									...
									<div class="form-inline">
										...
										<input name="PMENT_DAYS" type="TEXT" value=""
											class="form-control" size="5" MAXLENGTH=10 readonly>
									</div>
								</div>
								<%}else{ %>
								<div class="form-group">
										...
										<tbody>
											<tr>
												<td class="text-center"><input type="hidden"
													name="customeruserid" value="0"> <input
													class="form-control text-left" name="USER_NAME" type="text"
													placeholder="Enter User Name" maxlength="50"
													autocomplete="off"></td>
												<td class="text-center"><input
													class="form-control text-left" name="USER_HPNO" type="text"
													placeholder="Enter User Phone No" maxlength="30"
													onkeypress="return isNumber(event)" autocomplete="off"></td>
												<td class="text-center"><input
													class="form-control text-left" name="USER_EMAIL"
													type="text" placeholder="Enter User Email" maxlength="50"
													autocomplete="off"></td>
												<td class="text-center"><input
													class="form-control text-left" type="text" name="USER_ID"
													placeholder="Enter User id" maxlength="100"
													autocomplete="off" onchange="checkuser(this.value)">
												</td>
												<td class="text-center grey-bg" style="position: relative;">
													<input name="PASSWORD" class="form-control text-left"
													maxlength="60" placeholder="Enter Password" type="password"
													autocomplete="off"> <span
													class="input-group-btn phideshow"
													onclick="javascript:viewpassword(this);return false;">
														<button class="btn btn-default reveal" type="button"
															style="background: white;">
															<i class="fa fa-fw fa-eye" id="peye"
																style="color: #23527c;"></i>
														</button>
												</span>
												</td>
												<td class="text-center"><input type="hidden"
													name="MANAGER_APP_VAL" value="0" /> <input type="checkbox"
													name="MANAGER_APP" id="MANAGER_APP" value="1"
													onclick="checkManagerApp(this)" />&nbsp;&nbsp;</td>
				...
				<OPTION style="display:none;">Select Bank</OPTION> -->
										<INPUT name="BANKNAME" type="TEXT" value="" id=BANKNAMECUS
											class="form-control" onchange="checkcustomerbank(this.value)"
											value="" placeholder="BANKNAME"> <span
											class="select-icon"
...
<jsp:include page="newProductDepTypeModal.jsp" flush="true"></jsp:include>
<!-- Resvi for add product department -->
<jsp:include page="newProductCategoryModal.jsp" flush="true"></jsp:include>
<!-- Thanzith for add product category -->
<jsp:include page="newProductSubCatgoryModal.jsp" flush="true"></jsp:include><!-- Thanzith for add product Sub Category -->
<jsp:include page="newProductBrandModal.jsp" flush="true"></jsp:include>
<!-- Thanzith for add product Brand -->
<jsp:include page="newProductHsCodeModal.jsp" flush="true"></jsp:include>
<!-- Thanzith for add product HsCode -->
<jsp:include page="newProductCOOModal.jsp" flush="true"></jsp:include>
<!-- Thanzith for add product COO -->
<jsp:include page="newProductUOMmodal.jsp" flush="true"></jsp:include>
<!-- Thanzith for add product UOM -->
...
<jsp:include page="newCustomerTypeModal.jsp" flush="true"></jsp:include>
<!-- Thanzith for add customertype -->
