...
<%
	String title = "Create Purchase Estimate Order";
	...
	PoEstUtil posUtil = new PoEstUtil();
...
<script src="../jsp/js/CreatePurchaseEstimate.js"></script>
<center>
	<h2>
...
<div class="container-fluid m-t-20">
	...
	<!-- Muruganantham Modified on 16.02.2022 -->
            <ul class="breadcrumb backpageul">      	
                ...
                <li><a href="../purchaseorderestimate/summary"><span class="underline-on-hover">Purchase Estimate Summary</span> </a></li>
                <li><label>Create Purchase Estimate Order</label></li>                                   
            </ul>             
    <!-- Muruganantham Modified on 16.02.2022 -->
		<div class="box-header menu-drop">
			<h1 style="font-size: 20px;" class="box-title"><%=title%></h1>
			<h1 style="font-size: 18px; cursor: pointer;" class="box-title pull-right" onclick="window.location.href='../purchaseorderestimate/summary'">
				<i class="glyphicon glyphicon-remove"></i>
			</h1>
		</div>

		<div class="container-fluid">
			<form class="form-horizontal" id="purchaseOrderForm" name="cpoform" autocomplete="off" action="../purchaseorderestimate/save"  method="post"  enctype="multipart/form-data">
...
<!--     				</div> -->
				...
				<div class="form-group">
					...
					<div class="col-sm-4">
						...
						<div class="col-sm-6 ac-box">
							<input type="text" class="form-control" id="CURRENCYUSEQT" name="CURRENCYUSEQT" placeholder="Enter Exchange Rate" onkeypress="return isNumberKey(event,this,4)" value="<%=CURRENCYUSEQT%>" required>	
						</div>
					    </div>
				</div>
...
<!-- 								<th style="width:10%">Tax</th> -->
						...
						<tbody>
							<tr>
								...
								<td class="bill-item">
									<input type="text" name="item" class="form-control itemSearch" style="width:87%" onchange="checkitems(this.value,this)" placeholder="Type or click to select an item.">
						...
						<div class="total-row">
							<div class="total-label">
								<div class="row">
									...
									<input type="checkbox" class="form-check-input isodisctax" checked name="isodisctax" Onclick="isodisctaxing(this)" onkeypress="return isNumberKey(event,this,4)">
									</div>
									<div class=" col-lg-6 col-sm-6 col-6">
										<div class="input-group my-group">
						...
						<div class="total-row">
							<div class="badge-editable total-label">
								<div class="row">
									...
									<div class="col-lg-1 col-sm-1 col-1">
									<input type="checkbox" class="form-check-input isshiptax" checked name="isshiptax" Onclick="isshiptaxing(this)" >
									</div>
									<div class="col-lg-6 col-sm-6 col-6">
