...
<jsp:include page="header2.jsp" flush="true">
	<jsp:param name="title" value="Create Shift" />
...
<div class="container-fluid m-t-20">
	...
	<!-- Thanzith Modified on 23.02.2022 -->
	 <ul class="breadcrumb backpageul">    
                ...
                <li><label>Create Shift</label></li>                                   
            </ul>
        <!-- Thanzith Modified on 23.02.2022 -->
		...
		<div class="box-body">
			...
			action="../shift/new" enctype="multipart/form-data" onsubmit="return validateShift()">
				...
				<div class="form-group">
					...
					<div class="col-sm-4">
							<input type="text" class="form-control" id="SHIFTNAME" name="SHIFTNAME" maxlength="50">
					</div>
				</div>
		...
		<label class="control-label col-form-label col-sm-2"></label>
	 		<div class="col-sm-3">
		  		<label class="radio-inline"> <input type="radio" name="ISHOURBASED" id="ISHOURBASED" value="1" onClick="onISHOURBASED();" >Is Hour Based</label>
				<label class="radio-inline"> <input type="radio" name="ISTIMEBASED" id="ISTIMEBASED" value="0" onClick="onISTIMEBASED();" >Is Time Based</label>
	     	</div>
		</div>
		...
		<div class="form-group">
					...
					<div class="col-sm-4">
							<input type="text" class="form-control" id="ALLOCATEHOUR" name="ALLOCATEHOUR" maxlength="5" placeholder="HH:MM" readonly>
					</div>
		</div>
		...
		<div class="form-group">
					...
					<div class="col-sm-4">
							<input type="text" class="form-control" id="INTIME" name="INTIME" maxlength="5" placeholder="HH:MM" readonly>
					</div>
		</div>
		...
		<div class="form-group">
					...
					<div class="col-sm-4">
							<input type="text" class="form-control" id="OUTTIME" name="OUTTIME" maxlength="5" placeholder="HH:MM" readonly>
					</div>
		</div>
...
<script type="text/javascript">
	...
	$(document).ready(function(){
		document.getElementById("ISHOURBASED").checked = true;   
