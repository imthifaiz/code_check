...
<script src="../jsp/js/creditNoteEdit.js"></script>
<style>
 .sideiconspan {
	color: #23527c;
	position: absolute;
...
<div class="container-fluid m-t-20">
	 ...
	 <!-- Muruganantham Modified on 16.02.2022 -->
            <ul class="breadcrumb backpageul">      	
                ...
                <li><label>Edit Credit Note</label></li>                                   
            </ul>             
    <!-- Muruganantham Modified on 16.02.2022 -->
...
<input type="text" id="PageName" style="display: none;" value="">
	<form id="creditnoteForm" class="form-horizontal" name="form1" autocomplete="off" action="/track/CustomerCreditNoteServlet?Submit=Edit"  method="post" enctype="multipart/form-data" onsubmit="return validateCreditnote()">
	...
	<div class="form-group customer-section">
			...
			<div class="col-sm-6 ac-box">
				...
				<input type="text" class="ac-selected  form-control typeahead" id="CUSTOMER" placeholder="Select a customer" name="CUSTOMER" disabled="disabled" value="<%=CUSTOMER%>">
...
<!-- 				<span class="btn-danger input-group-addon" id="btnpop" onclick="javascript:popUpWin('customer_list_issue_summary.jsp?TYPE=ACCTCUST&CUST_NAME='+form1.CUSTOMER.value);"><span class="glyphicon glyphicon-search" aria-hidden="true"></span></span>	 -->
		...
		<div class="form-group">
			...
			<div class="col-sm-4">
				<input type="text" class="form-control" id="creditnote" name="creditnote" readonly="readonly" >
			</div>
		</div>
		...
		<div class="form-group">
			...
			<div class="col-sm-4">
				<input type="text" class="form-control datepicker" id="creditnote_date" name="creditnote_date">
			</div>
				...
				<div class="total-row"> 
					<div class="total-label">
						<div class="row">
							...
							<div class=" col-lg-6 col-sm-6 col-6">
								<div class="input-group my-group"> 
									<input class="form-control text-right" type="text" id="dediscount" name="discount" onchange="calculateTotal()" onkeypress="return isNumberKey(event,this,4)">
		...
		<div class="row grey-bg">
			<div class="col-sm-4">
				...
				<%if(CustcrdnoteAttachList.size()>0){ %>
						<div id="billAttchNote">
							<small class="text-muted"><div class="attachclass"><a><%=CustcrdnoteAttachList.size()%> files Attached</a>
									<div class="tooltiptext">
										
										<%for(int i =0; i<CustcrdnoteAttachList.size(); i++) {   
									  		Map attach=(Map)CustcrdnoteAttachList.get(i); %>
		...
		<div class="row">
			...
			<%} %>
			<%if(CustcrdnoteHdr.get("CREDIT_STATUS").equals("Open")){ %>
...
//		   END
	 ...
	 var datasend = $('#formCustomer').serialize();
	   ...
	   var urlStr = "/track/CreateCustomerServlet?action=JADD&reurl=CustomerCreditNoteEdit";
		$.ajax( {
		type : "POST",
		url : urlStr,
		async : true,
