...
%>
    <TR>
		<td class="main2" style="font-weight: bold" align="left">&nbsp;<a href="#"
			onClick="window.opener.form1.CUSTOMER_TYPE_ID.value='<%=customertypeid%>';window.opener.form1.CUSTOMER_TYPE_DESC.value='<%=desc%>'; setCheckedValue( window.opener.form1.ACTIVE,'<%=isactive%>');window.close();"><%=customertypeid%></a></td>
		<td align="left" class="main2">&nbsp;<%=desc%></td>
		<td align="left" class="main2">&nbsp;<%=isactive%></td>
