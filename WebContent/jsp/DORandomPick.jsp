...
<title>Random Pick By OutBound Order</title>
  ...
  <table border="1" width="100%" cellspacing="0" cellpadding="0" align="center" bgcolor="#dddddd">
      <TR>
        <TH BGCOLOR="#000066" COLSPAN="11">
          <FONT color="#ffffff">Multi Pick By OutBound Order</FONT>&nbsp;
        </TH></table>
  <br>
  ...
  <div id = "issue"></div>
   <br>
      ...
      function onGo(){
    	    ...
    	    $.ajax({type: "POST",url: urlStr, data: {DONO:orderNO,Submit: "GET_DODET_DETAILS_RANDOMPICK",PLANT:"<%=PLANT%>"},dataType: "json", success: callback });
      ...
      function onResetScanqty()
      {
  	  ...
  	  if(orderNO == ""){
 	    ...
 	    // Call the method of JQuery Ajax provided
 	   	   $.ajax({type: "POST",url: urlStr, data: {DONO:orderNO,LOC_ID :loc,Submit: "RESET_SCANQTY_PICKRANDOM",PLANT:"<%=PLANT%>"},dataType: "json", success: callback });
      ...
      function onPick()
      {
    	    ...
    	    // Call the method of JQuery Ajax provided
    	    $.ajax({type: "POST",url: urlStr, data: {DONO:orderNO,LOC_ID :loc,TRANSACTIONDATE:tranDate,Submit: "PROCESS_MULTI_PICK",PLANT:"<%=PLANT%>"},dataType: "json", success: callback });
    	...
    	function callback(data){
    	        ...
    	        var issueHTML = '<br><br><TABLE WIDTH="20%"  border="0" cellspacing="1" cellpadding = 2 align = "center"> <TR><TD><INPUT  type="button" value="Reset Scan QTY" style="height: 25px; width: 100px" onClick="onResetScanqty();">'
        	        			+'&nbsp;&nbsp;<INPUT  type="button" '
    	        				+ 'value="Pick" style="height: 25px; width: 80px" onClick="onPick();">'
    	...
    	function getTable(){
    	            return '<TABLE id="tabledata" WIDTH="90%"  border="0" cellspacing="1" cellpadding = 2 align = "center">'+
    	                    ...
    	                    '<TH><font color="#ffffff" align="left"><b>Picked Qty</TH>'+
