...
<%
       ...
       CONTACTNAME="",TELNO="",EMAIL="",ADD1="",ADD2="",ADD3="",AVAILABLEQTY="",TRANSACTIONDATE="";
...
<TABLE border="0" CELLSPACING=1 WIDTH="100%" bgcolor="#dddddd">
	...
	<TR>
		...
		<TD width="42%"><INPUT name="ITEMDESC" type="TEXT"
			value="<%=su.forHTMLTag(ITEMDESC)%>" size="35" class="inactivegry" readonly
			MAXLENGTH="80" /></TD>
		...
		<table align="center" width="85%" border="0">
			<tr>
				<td><INPUT type="button" value="ADD NEW PICKING" onclick="addRow();" /> <INPUT type="button"
					...
					name="DYNAMIC_PICKING_SIZE">&nbsp;&nbsp;<b>Transaction Date : </b><INPUT name="TRANSACTIONDATE" id="TRANSACTIONDATE"
	...
	<TR align="center" >
		...
		<INPUT class="Submit" type="BUTTON" value="Cancel"
			onClick="window.location.href='DOSummaryForSingleStepPickIssue.jsp?action=View&DONO='+form.ORDERNO.value+'&PLANT='+form.PLANT.value " />&nbsp;&nbsp;
...
function addRow() {
	...
	batchCell.innerHTML = "<b>Batch : </b><INPUT name=\"BATCH_"+rowCount+"\" id=\"BATCH_"+rowCount+"\" value=\""+defaultBatchForNonStk+"\" type = \"TEXT\" size=\"20\" onkeypress=\"if((event.keyCode=='13') && ( this.value.length > 0)){validateBatch(this.value, "+rowCount+");}\"  MAXLENGTH=\"40\">&nbsp; "+
	...
	availableqtyCell.innerHTML ="<b>Available Qty : </b><INPUT name=\"AVAILABLEQTY_"+rowCount+"\" id=\"AVAILABLEQTY_"+rowCount+"\" type = \"TEXT\"  value=\""+defbalAvlQty+"\" size=\"10\"  MAXLENGTH=\"80\" \> ";
 ...
 if(document.form.SERIAL_SELECTION.checked){
	 ...
	 /*  var orderedQty = document.getElementById("ORDERQTY").value;
	   ...
	   if((totalQtyPick*1)+(pickedQty*1)>(orderedQty*1)){
		   ...
		   document.form.action="/track/DoPickingServlet?action=Pick/Issue Confirm";
