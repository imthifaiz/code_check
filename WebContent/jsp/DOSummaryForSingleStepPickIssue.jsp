...
function onViewToConfirm(form)
{
  ...
  // var TOLOC = document.form.TO_WAREHOUSE.value;
   if(DONO == "" || DONO == null) {alert("Please Select OutBound Order "); document.form.DONO.focus(); return false; }

  document.form.action="DOOutBoundsOrderIssueConfirm.jsp?DONO"+DONO+"&CUST_NAME="+CUST_NAME;
  document.form.submit();
 }
  ...
  <table border="1" width="100%" cellspacing="0" cellpadding="0" align="center" bgcolor="#dddddd">
      <TR>
        <TH BGCOLOR="#000066" COLSPAN="11">
          <FONT color="#ffffff">Pick/Issue By OutBound Order</FONT>&nbsp;
        </TH></table>
  <br>
                   ...
                   <tr>
                     ...
                     <td>
                       <P>
                         ...
                         <a href="#" onClick="javascript:popUpWin('do_list_for_singlepickissue.jsp?DONO='+form.DONO.value);">
...
function viewOutboundOrders(){
	document.form.action="/track/OrderIssuingServlet?action=MultipleView";
    document.form.submit();
}
function submitForm(){
	document.form.action="/track/OrderIssuingServlet?action=SingleStepPick/Issue";
    document.form.submit();
}
