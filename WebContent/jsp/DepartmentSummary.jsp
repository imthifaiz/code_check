...
<%
	...
	String title = "Department Summary";
	...
	if(systatus.equalsIgnoreCase("PAYROLL")){
		displaySummaryExport = ub.isCheckValPay("exportDepartment", plant,username);
		displaySummaryNew = ub.isCheckValPay("newDepartment", plant,username);
		displaySummaryEdit = ub.isCheckValPay("editDepartment", plant,username);
		}
...
<div class="container-fluid m-t-20">
	...
	<!-- Muruganantham Modified on 16.02.2022 -->
            <ul class="breadcrumb backpageul">      	
                ...
                <li><label>Department Summary</label></li>                                   
            </ul>             
    <!-- Muruganantham Modified on 16.02.2022 --> 
		<div class="box-header menu-drop">
			...
			<div class=" pull-right">
				...
				<% if (displaySummaryNew) { %>	
					<button type="button" class="btn btn-default"
						onClick="window.location.href='../payroll/createdepartment'"
		...
		function getParameters(){
			return {
				"CMD":"GET_DEPARTMENT_FOR_SUMMARY"
			}
		}
		function onGo(){
			   ...
			   var groupColumn = 1;	
			    if (tabledepartment){
			    	tabledepartment.ajax.url( urlStr ).load();
			    }else{
						...
						"ajax": {
					        ...
					        "dataSrc": function(data){
					        	if(data.DEPARTMENTLIST.length>0){
						        	if(typeof data.DEPARTMENTLIST[0].ID === 'undefined'){
						        		return [];
						        	}else {				        		
						        			for(var dataIndex = 0; dataIndex < data.DEPARTMENTLIST.length; dataIndex ++){
						        				var lineno = data.DEPARTMENTLIST[dataIndex].ID;
						        				<% if (displaySummaryEdit) { %>		
						        				data.DEPARTMENTLIST[dataIndex]['EDIT'] = '<a href="../payroll/editdepartment?ID=' +lineno+'"><i class="fa fa-pencil-square-o"></i></a>';	
						        				<% } else { %>	
						        				data.DEPARTMENTLIST[dataIndex]['EDIT'] = '<a style="pointer-events: none; cursor: default; color: darkgrey;" href="#"><i class="fa fa-pencil-square-o"></i></a>';	
						        				<% } %>			        				
						        			}
