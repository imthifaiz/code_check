...
<%@page import="com.track.db.object.PosPrd_BrandPromotionHdr"%>
...
<%
	String title = "Edit Brand Promotion";
	...
	BrandPromotionHdrDAO posPromotionHdr= new BrandPromotionHdrDAO();
	...
	String promotion_name = "",promotion_desc = "", by_value = "",outletname="",customer_type_id ="",start_date ="",start_time ="",end_date ="",end_time ="",limit_of_usage ="",notes ="",isactive = "";
	PosPrd_BrandPromotionHdr posheader = posPromotionHdr.getPosHdrById(plant, ID);
    List viewlistQry = posPromotionHdr.getBrandPromotionDetails(plant,ID);
...
<script src="../jsp/js/EditBrandPromotion.js"></script>
<center>
	<h2>
...
<div class="container-fluid m-t-20">
	<div class="box">
	 ...
	 <ul class="breadcrumb backpageul">    
                ...
                <li><label>Edit Brand Promotion</label></li>                                   
            </ul>
        <!-- Thanzith Modified on 28.02.2022 --> 
		...
		<div class="container-fluid">
			<form class="form-horizontal" id="brandpromotionForm" name="cpoform" action="../brandpromotion/edit"  method="post"  enctype="multipart/form-data">
