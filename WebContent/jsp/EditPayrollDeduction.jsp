...
String title = "Edit Payroll Deduction";
...
HrDeductionHdr deductionhdr = hrDeductionHdrDAO.getdeductionhdrById(plant,Integer.valueOf(id));
ArrayList empmstlist = employeeDAO.getEmployeeListbyid(String.valueOf(deductionhdr.getEMPID()),plant);
Map empmst=(Map)empmstlist.get(0);

String empname = employeeDAO.getEmpnamebyid(plant, String.valueOf(deductionhdr.getEMPID()), "");
HrEmpType hrEmpType = hrEmpTypeDAO.getEmployeetypeById(plant, Integer.valueOf((String)empmst.get("EMPLOYEETYPEID")));

String emptype = "";
if(hrEmpType.getEMPLOYEETYPE() != null){
...
<div class="container-fluid m-t-20">
	...
	<!-- Muruganantham Modified on 16.02.2022 -->
            <ul class="breadcrumb backpageul">      	
                ...
                <li><label>Edit Payroll Deduction</label></li>                                   
            </ul>             
    <!-- Muruganantham Modified on 16.02.2022 -->
		<div class="box-header menu-drop">
              <h1 style="font-size: 20px;margin-bottom: 30px;" class="box-title">Edit Payroll Deduction</h1>
		...
		<div class="container-fluid">
			<form id="" class="form-vertical" name="form1" action="/track/PayrollServlet?Submit=EditDetection"  method="post" onsubmit="return validateDeduction()">
				<input type="hidden" name="plant" value="<%=plant%>">
				<input type="hidden" name="Deduction_numberOfDecimal" value=<%=numberOfDecimal%>>
				<input type="hidden" name="Deduction_empid" value="<%=deductionhdr.getEMPID()%>">
				...
				<div class="row">
					...
					<div class="col-lg-4 form-group">
						<select name="Deduction_month" onclick="validatemonthyear()" placeholder="Select Month" class="form-control">
						   <option <%if(deductionhdr.getMONTH().equalsIgnoreCase("1")){%> selected<%}%> value='1'>January</option>
						    <option <%if(deductionhdr.getMONTH().equalsIgnoreCase("2")){%> selected<%}%> value='2'>February</option>
						    <option <%if(deductionhdr.getMONTH().equalsIgnoreCase("3")){%> selected<%}%> value='3'>March</option>
						    <option <%if(deductionhdr.getMONTH().equalsIgnoreCase("4")){%> selected<%}%> value='4'>April</option>
						    <option <%if(deductionhdr.getMONTH().equalsIgnoreCase("5")){%> selected<%}%> value='5'>May</option>
						    <option <%if(deductionhdr.getMONTH().equalsIgnoreCase("6")){%> selected<%}%> value='6'>June</option>
						    <option <%if(deductionhdr.getMONTH().equalsIgnoreCase("7")){%> selected<%}%> value='7'>July</option>
						    <option <%if(deductionhdr.getMONTH().equalsIgnoreCase("8")){%> selected<%}%> value='8'>August</option>
						    <option <%if(deductionhdr.getMONTH().equalsIgnoreCase("9")){%> selected<%}%> value='9'>September</option>
						    <option <%if(deductionhdr.getMONTH().equalsIgnoreCase("10")){%> selected<%}%> value='10'>October</option>
						    <option <%if(deductionhdr.getMONTH().equalsIgnoreCase("11")){%> selected<%}%> value='11'>November</option>
						    <option <%if(deductionhdr.getMONTH().equalsIgnoreCase("12")){%> selected<%}%> value='12'>December</option>
   						</select> 
					</div>
				...
				<div class="row">
					...
					<div class="col-lg-4 form-group">
						<select class="form-control text-left Deduction_year"  value="<%=deductionhdr.getYEAR()%>" name="Deduction_year" placeholder="Select Year" onclick="validatemonthyear()">
				...
				<div class="row">
					...
					<div class="col-lg-4 form-group">
						<input type="text" class="ac-selected form-control typeahead" id="Deduction_name" name="Deduction_name" value="<%=deductionhdr.getDEDUCTION_NAME() %>" onclick="deductpopup(this)" placeholder="Select a deduction">
				...
				<div class="row">
					...
					<div class="col-lg-4 form-group">
						<input type="text" class="ac-selected form-control typeahead" id="Deduction_employee" value="<%=empname%>" name="Deduction_employee" placeholder="Select a employee" readonly>
				...
				<div class="row">
					...
					<div class="col-lg-4 form-group">
						<input name="Deduction_emptype" class="form-control text-left"  value="<%=emptype%>" type="text" readonly> 
					</div>
				</div>
				<div class="row">
					<div class="col-lg-3 form-group">
					...
					<div class="col-lg-4 form-group">
						<input class="form-control datepicker" name="Deduction_date" type="text" value="<%=deductionhdr.getDEDUCTION_DATE()%>" READONLY>
					</div>
				</div>
				<div class="row">
					<div class="col-lg-3 form-group">
					...
					<div class="col-lg-4 form-group">
						<input class="form-control" name="Deduction_amount" type="text" value="<%=StrUtils.addZeroes(deductionhdr.getDEDUCTION_AMOUNT(), numberOfDecimal)%>" onchange="validateamount(this)">
					</div>
				</div>
				...
				<div class="row">
					...
					<div class="col-lg-4 form-group">
						<input class="form-control" name="Deduction_dueamount" type="text" value="<%=StrUtils.addZeroes(deductionhdr.getDEDUCTION_DUE(), numberOfDecimal)%>" onchange="validateamount(this)">
					</div>
				</div>
				...
				<div class="row">
					...
					<div class="col-lg-4 form-group">
						<input type="hidden" name="Deduction_isgratuity" value="<%=deductionhdr.getISGRATUITY()%>"> 
						<%-- <input type="checkbox" id="isgra" name="Deduction_gratuity" onclick="setgratuity(this)" <%if(deductionhdr.getISGRATUITY()  == 1){ %> checked <%} %>> --%>
						<input type="checkbox" id="gratuity" name="Deduction_gratuity" onclick="setgratuity(this)">
					</div>
				</div>
				...
				<div class="row form-group">      
					<div class="col-sm-offset-3  col-sm-9 txn-buttons">
						...
						<button type="button" class="btn btn-danger" data-toggle="modal" data-target="#deletededuction">Delete</button>
					</div>
				</div>
			</form>
		</div>
	      ...
	      <div class="modal-body">
	        <div class="row">
			   ...
			   <div class="col-lg-10" style="padding-left: 2px">
			      <p> Deleted deduction information cannot be retrieved. Are you sure about deleting ?</p>
			      
			      <div class="alert-actions btn-toolbar">
			         <button class="btn btn-primary ember-view" id="cfmdelete" style="background:red;"><a href="/track/PayrollServlet?CMD=DELETE_DEDUCTION&hdrid=<%=id%>" style="color: white;">
			        	Yes 
			         </a></button>
...
function onClear()
{
	document.form1.Deduction_month.value="";
	document.form1.Deduction_year.value="";
	document.form1.Deduction_name.value="";
	$('input[name ="Deduction_amount"]').val("<%=zeroval%>");
	$('input[name ="Deduction_dueamount"]').val("<%=zeroval%>");
...
$(document).ready(function(){
	...
	var isg = "<%=deductionhdr.getISGRATUITY()%>";
	if(isg == "1"){
		$('#gratuity').prop('checked', true); 
	}
