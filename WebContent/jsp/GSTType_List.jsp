...
<html>
<head>
<title>VAT/GST/TAX Type List</title>
<meta charset="utf-8">
...
<h3 class="panel-title">VAT/GST/TAX TYPE LIST</h3> 
</div>
</div>
...
<thead style="background: #eaeafa">
    ...
    try
    {
    	...
    	_GstTypeUtil.setmLogger(mLogger);
   		...
   		List listQry= _GstTypeUtil.qryGstType(GSTTYPE ,plant," AND GSTTYPE <> 'POS' ");
...
<TR>
		<td class="main2" style="font-weight: bold" align="left">&nbsp;<a href="#"
			onClick="
      window.opener.form1.GSTTYPE.value='<%=sGstTypes %>';
      window.opener.form1.GSTTYPE_HIDDEN.value='<%=sGstTypes %>';
      window.opener.form1.GSTDESC.value='<%=sGstDesc%>';
      window.opener.form1.GSTPERCENTAGE.value='<%=sGstPercentage%>';
      window.opener.form1.REMARKS.value='<%=sRemarks%>';
     
      window.close();"><%=sGstTypes%>
		</a></td>
		<td align="left" class="main2">&nbsp;<%=sGstDesc%></td>
