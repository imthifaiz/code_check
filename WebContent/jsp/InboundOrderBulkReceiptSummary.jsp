...
String jobNum = "",custName = "",chkString ="",item_loc= "",EXPIREDATE = "",REF = "",fullReceive = "",allChecked = "",RECVDATE="",custcode="",email="";
...
<div class="container-fluid m-t-20">
	...
	<!-- Muruganantham Modified on 16.02.2022 -->
             <ul class="breadcrumb backpageul">      	
                  ...
                  <li>Goods Receipt By Purchase Order</li>                                    
             </ul>   
     <!-- Muruganantham Modified on 16.02.2022 --> 
...
<!--       <INPUT type="hidden" name="CLEARAGENTID" value="">  -->
	  ...
	  <TABLE BORDER="0" CELLSPACING="0" WIDTH="100%" class="table"  align="center">
      ...
      %>
					<TR bgcolor="<%=bgcolor%>">
						...
						<TD align="left" width="20%"><%=desc%></TD>
						...
						<input class="form-control" type="text" onkeypress="return isNumberKey(event,this,4)" name = "receivingQty_<%=polnno%>" id = "receivingQty_<%=polnno%>"  size = "6" maxlength = "10" value = <%=recvingQty%> >
						</TD>
						<td width="10%"><div class="input-group"><INPUT class="form-control" name="BATCH_<%=polnno%>" id="BATCH_<%=polnno%>" value = <%=batchNo%> type="TEXT" size="10"   MAXLENGTH=40>
    	   ...
    	   {%>
					<TR>
						<td colspan="9" align="center">Data's Not Found</TD>
					</TR>
					<%} }%>
		</tbody>
		</table>
