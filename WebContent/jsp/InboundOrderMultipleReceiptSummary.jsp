...
<form class="form-horizontal" name="form" method="post" action="/track/OrderReceivingServlet?">
 ...
 <h2><small><%=fieldDesc%></small></h2>
       ...
       <div class="col-sm-4">
  		...
  		<div class="col-sm-1 ">   
  		<button type="button" class="Submit btn btn-default" onClick="viewInboundOrders();"><b>View</b></button>
  		</div>
  		</div>  
 		</div>
        ...
        <div class="col-sm-4">
        <INPUT class="form-control" name="CUST_NAME" type="TEXT" value="<%=su.forHTMLTag(custName)%>" size="30" MAXLENGTH=80>
    	</div>
 		</div>
...
function viewInboundOrders(){
			document.form.action="/track/OrderReceivingServlet?action=ViewMultiple";
			//document.form.action.value ="View";
            document.form.submit();
		}
function submitForm(){
	document.form.action ="/track/OrderReceivingServlet?action=MultyReceive";
    document.form.submit();  
}
