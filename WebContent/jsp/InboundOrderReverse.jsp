...
<title>Inbound Order Reverse</title>
...
function validatePO(form)//form
{
   ...
   if(isNaN(document.form.REVERSEQTY.value)) {alert("Please enter valid REVERSEQTY.");document.form.REVERSEQTY.focus(); return false;}
...
<jsp:useBean id="du" class="com.track.util.DateUtils" />
  <%
       ...
       String  fieldDesc="";
       String   PLANT="",ORDERNO    = "",ORDERLNO="",CUSTNAME = "", ITEMNO   = "", UOM="",ITEMDESC  = "",
       LOC   = "" , BATCH  = "", REF   = "",
       ORDERQTY = "",RECEIVEQTY="", REVERSEDQTY="",REVERSEQTY="",BALANCEQTY="";
       ...
       RECEIVEQTY = strUtils.fString(request.getParameter("RECEIVEQTY"));
  ...
  <TABLE border="0" width="100%" cellspacing="0" cellpadding="0" align="center" bgcolor="#dddddd">
    <TR>
      <TH BGCOLOR="#000066" COLSPAN="11">
        <FONT color="#ffffff">Inbound Order Reverse</FONT>&nbsp;
      </TH>
  ...
  <TABLE border="0" CELLSPACING=0 WIDTH="100%" bgcolor="#dddddd">
    ...
    <TR>
     ...
     <TR>
         ...
         <TD><INPUT class="inactivegry" name="ITEMDESC" type = "TEXT" value="<%=ITEMDESC%>" size="50"  MAXLENGTH=80 readonly></TD>
    </TR>
     <TR>
         <TH WIDTH="35%" ALIGN="RIGHT" >*Loc&nbsp; : </TH>
         <TD><INPUT name="LOC"  type = "TEXT" value="<%=LOC%>" size="50"  MAXLENGTH=80 >
     ...
     <TR>
         ...
         <TD><INPUT name="BATCH" type = "TEXT" c value="<%=BATCH%>" size="50"        onkeypress="javascript:selectAll();"  MAXLENGTH=40 >
     ...
     <TR>
         <!--<TH WIDTH="35%" ALIGN="RIGHT" >Reversed Qty&nbsp;&nbsp;: </TH>-->
       ...
       <TR>
         ...
         <TD><INPUT name="REVERSEQTY" value="<%=REVERSEQTY%>"type = "TEXT"  size="50"  MAXLENGTH=80  ></TD>
    </TR>
    <TR>
         <TD COLSPAN = 2><BR>
    ...
    <TR>
         <TD COLSPAN = 2>
           &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
             ...
             <input type="Submit" value="Reverse" name="action" onClick="return validatePO(document.form)"/>&nbsp;&nbsp; 
