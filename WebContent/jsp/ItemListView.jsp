...
$.ajax({type: "POST",url: urlStr, data: { ITEM: "<%=sItem%>" ,ITEM_DESC:"<%=sItemDesc%>",COND:"AND ISACTIVE= 'Y' AND ISNULL(NONSTKFLAG,'')<>'Y'", ACTION: "PRODUCT_LIST",PLANT:"<%=plant%>"},dataType: "json", success: callback });
