...
<html>
<head>
<title>Kitting Child List</title>
<meta charset="utf-8">
...
<h3 class="panel-title">Kitting Child List</h3> 
</div>
</div>
...
ProductionBomUtil _ProductionBomUtil = new ProductionBomUtil();
 ...
 try{
		 ...
		 listQry = _ProductionBomUtil.getKitchilditemList(pitem,citem, plant, " ");
	 

  for (int i =0; i<listQry.size(); i++){
  Map map = (Map) listQry.get(i);
  sBGColor = ((i == 0) || (i % 2 == 0)) ? "#FFFFFF" : "#dddddd";
   String item         = strUtils.fString((String) map.get("CHILD_PRODUCT"));
