...
<title>Move To QC</title>
<link rel="stylesheet" href="css/style.css">
<SCRIPT LANGUAGE="JavaScript">

  var subWin = null;
  function popUpWin(URL) {
     subWin = window.open(URL, 'MoveTOQC', 'toolbar=0,scrollbars=yes,location=0,statusbar=0,menubar=0,dependant=1,resizable=1,width=700,height=400,left = 200,top = 184');
  }
...
function validatePO(form)//form
{
   ...
   var table = document.getElementById("MOVE_TO_QC");
   ...
   if(loc.value=="" || loc.value.length==0 )
    ...
    {  
	    ...
	    if(i==checkcnt)
	    {	   
	   document.form.action.value="MoveToQC";
...
<FORM name="form" method="post"
	action="/track/MoveToQCServlet?action=MoveToQC">
<br>
<CENTER>
<TABLE border="0" width="100%" cellspacing="0" cellpadding="0" align="center" bgcolor="#dddddd">
	<TR>
		<TH BGCOLOR="#000066" COLSPAN="11"><FONT color="#ffffff">Move To QC</FONT>&nbsp;</TH>
...
<TABLE border="0" CELLSPACING=0 WIDTH="100%" bgcolor="#dddddd">
	...
	<TR>
		...
		<table align="center" width="100%" border="0" id="MOVE_TO_QC">
		...
		<table align="center" width="85%" border="0">
			<tr>
				<td><INPUT type="button" value="ADD NEW ISSUING" onclick="addRow();" /> <INPUT type="button"
					...
					onclick="deleteRow('MOVE_TO_QC');" /> <INPUT type="hidden"
	...
	<TR>
		...
		<INPUT class="Submit" type="BUTTON" value="Cancel"
			...
			type="button" value="MoveToQC" name="SubmitButton"
...
function addRow() {
	...
	var locationCell = row.insertCell(0);
		...
		if(!sameLocaionUse) {
			locationCellText = locationCellText+ "<a href=\"#\" onClick=\"javascript:popUpWin('loc_list_QCTransfer.jsp?LOC='+form.LOC"+'_'+rowCount+".value+'&INDEX="+rowCount+"');\"><img src=\"images/populate.gif\" border=\"0\"></a>";
		}
