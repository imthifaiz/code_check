...
<title>Multiple Misc Order Issue</title>
<link rel="stylesheet" href="css/style.css">
<SCRIPT LANGUAGE="JavaScript">

  var subWin = null;
  function popUpWin(URL) {
     subWin = window.open(URL, 'OrderList', 'toolbar=0,scrollbars=yes,location=0,statusbar=0,menubar=0,dependant=1,resizable=1,width=700,height=400,left = 200,top = 184');
  }
...
function validatePO(form)//form
{
   ...
   var table = document.getElementById("MULTI_MISC_ISSUING");
   ...
   for(var i=0;i<rowCount;i++){
	   ...
	   var nonstkflg = document.getElementById("NONSTKFLG"+"_"+i);
   ...
   //else if(qty.value>availqty.value) {alert("Excied the available Qty.");qty.focus(); return false;}
   ...
   else  if(nonstkflg.value!="Y"){
	 
	   if(availqty.value=="" || availqty.value.length==0)
	 {
	 ...
	 if(issueqty>inavailqty) {alert("Entered Quantity exceeded the available Qty!");qty.focus(); return false;}
	 if(i==checkcnt)
	    {	   
	   document.form.action.value="MultipleMiscOrderIssue";
...
function onClear(){
  ...
  document.form.REFDET_0.value="";
  document.form.NONSTKFLG_0.value="";
...
<FORM name="form" method="post"
	action="/track/MiscOrderIssuingServlet?action=MultipleMiscOrderIssue">
<br>
<CENTER>
...
<TABLE border="0" CELLSPACING=0 WIDTH="100%" bgcolor="#dddddd">
	...
	<TR>
		<TD colspan="4" ><br>
		&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
		<left><b>Always use the same for the following :</b>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<input type="Checkbox" name="SERIAL_SELECTION" id="SERIAL_SELECTION" value="SERIAL_SELECTION" onClick="processSerialSelection();"></input> Serial Issuing
		&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
		...
		<table align="center" width="100%" border="0" id="MULTI_MISC_ISSUING">
			...
			size="15" MAXLENGTH=80 onkeypress="if((event.keyCode=='13') && ( document.form.ITEMNO_0.value.length > 0)){validateProduct(0);}">
				...
				<!--<a href="#" onClick="javascript:popUpWin('item_list_locationtransfer.jsp?FROM_LOC='+form.LOC_0.value+'&ITEMNO='+form.ITEMNO_0.value+'&INDEX=0');"><img src="images/populate.gif" border="0"/></a>-->
				</td>
				<td width="12%">
				<INPUT name="ITEMDESC_0"  type="TEXT" id="ITEMDESC_0" value="<%=StrUtils.forHTMLTag(ITEMDESC)%>" size="15" MAXLENGTH=100  >
				...
				<td width="12%"><INPUT name="BATCH_0" id="BATCH_0" type="TEXT" value="<%=BATCH%>" size="15" MAXLENGTH=40
					onkeypress="if((event.keyCode=='13') && ( document.form.BATCH_0.value.length > 0)){validateBatch(0);}">
			<a href="#" onClick="javascript:popUpWin('batch_list_locationtransfer.jsp?FROM_LOC='+form.LOC_0.value+'&ITEMNO='+form.ITEMNO_0.value+'&BATCH'+form.BATCH_0.value+'&INDEX=0');">
			...
			<INPUT type="hidden" name="AVAILABLEQTY_0" id="AVAILABLEQTY_0">
			<INPUT type="hidden" name="NONSTKFLG_0" id="NONSTKFLG_0">
			</td>
							</tr>
		...
		<table align="center" width="85%" border="0">
			<tr>
				<td><INPUT type="button" value="ADD NEW ISSUING" onclick="addRow();" /> <INPUT type="button"
					value="REMOVE LAST ADDED ISSUING"
					onclick="deleteRow('MULTI_MISC_ISSUING');" /> <INPUT type="hidden"
					name="DYNAMIC_ISSUING_SIZE">
...
<INPUT name="LOGINUSER" type="hidden" value="<%=sUserId %>" size="1"
	...
	<INPUT     name="AVAILQTY_0"  type ="hidden" id ="AVAILQTY_0" value="<%=AVAILQTY%>" size="10"   MAXLENGTH=80 >
...
function processSameProduct(){
	...
	var defaultValue = document.getElementById("ITEMNO_0").value;
        ...
        var nonstkValue = document.getElementById("NONSTKFLG_0").value;
	for(var index = 1; index<rowCount; index++) {
		var productID = document.getElementById("ITEMNO_"+index);
              ...
              var nonstlflg = document.getElementById("NONSTKFLG_"+index);
		if(document.form.ALWAYS_SAME_PRODUCT.checked){
			productID.value = defaultValue;
                        productDesc.value = descValue;
                        uom.value=uomValue;
                        nonstlflg.value=nonstkValue;
...
function addRow() {
	...
	var firstElementLocationValue = document.getElementById("LOC_0").value;
        ...
        var firstElementNonStkValue = document.getElementById("NONSTKFLG_0").value;
	...
	//itemCellText = itemCellText+ "<a href=\"#\" onClick=\"javascript:popUpWin('item_list_locationtransfer.jsp?FROM_LOC='+form.LOC"+'_'+rowCount+".value+'&ITEMNO='+form.ITEMNO"+'_'+rowCount+".value+'&INDEX="+rowCount+"');\"><img src=\"images/populate.gif\" border=\"0\"></a>";	
	...
	itemCellText = itemCellText + "	<INPUT name=\"NONSTKFLG_"+rowCount+"\" ";
    if(sameProductUse){
    	itemCellText = itemCellText+ "value=\""+firstElementNonStkValue+"\"  ";
	}
    itemCellText = itemCellText + " id=\"NONSTKFLG_"+rowCount+"\" type = \"hidden\"  >";
	...
	//itemdescCellText = itemdescCellText+ "<a href=\"#\" onClick=\"javascript:popUpWin('item_list_locationtransfer.jsp?FROM_LOC='+form.LOC"+'_'+rowCount+".value+'&ITEMNO='+form.ITEMNO"+'_'+rowCount+".value+'&INDEX="+rowCount+"');\"><img src=\"images/populate.gif\" border=\"0\"></a>";
	...
	itemdescCell.innerHTML = itemdescCellText;
 	...
 	var batchCellText = "<INPUT name=\"BATCH_"+rowCount+"\" id=\"BATCH_"+rowCount+"\"  type = \"TEXT\" size=\"15\"   onkeypress=\"if((event.keyCode=='13') && ( document.form.BATCH_"+rowCount+".value.length > 0)){validateBatch("+rowCount+");}\"  MAXLENGTH=\"40\">&nbsp;";
	batchCell.innerHTML = batchCellText;
	batchCell.innerHTML = batchCellText + "<a href=\"#\" onClick=\"javascript:popUpWin('batch_list_locationtransfer.jsp?FROM_LOC='+form.LOC"+'_'+rowCount+".value+'&ITEMNO='+form.ITEMNO"+'_'+rowCount+".value+'&BATCH='+form.BATCH"+'_'+rowCount+".value+'&INDEX="+rowCount+"');\"><img src=\"images/populate.gif\" border=\"0\"></a>";
	...
	var availQtyCell = row.insertCell(8);
	var availQtyCellText = "<INPUT name=\"AVAILQTY_"+rowCount+"\" id=\"AVAILQTY_"+rowCount+"\" type = \"HIDDEN\" >";
	availQtyCell.innerHTML = availQtyCellText;
...
/*function validateProduct(index) {
			...
			data : {
				...
				success : function(data) {
					...
					if (data.status == "100") {
						...
						document.getElementById("NONSTKFLG"+"_"+index).value=resultVal.isNonStk;
	...
	function validateProduct(index) {
		var productId = document.getElementById("ITEMNO"+"_"+index).value;
		var loc = document.getElementById("LOC"+"_"+index).value;
		if(productId=="" || productId.length==0 ) {
			alert("Enter Product ID!");
			document.getElementById("ITEMNO"+"_"+index).focus();
		}else{
				...
				data : {
					...
					success : function(data) {
						...
						if (data.status == "100") {
							...
							document.getElementById("NONSTKFLG"+"_"+index).value=resultVal.nonstockflag;
	...
	function validateQuantity(index) {
		...
		if (qty == "" || qty.length == 0) {
			...
			if (isNumericInput(qty) == false) {
				...
				document.getElementById("REFDET"+"_"+index).value = "";
