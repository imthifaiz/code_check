	...
	function onIssue(form){
    	...
    	}else
    	{
             ...
             for (i = 0; i < noofcheckbox; i++ )
              ...
              //document.form.Submit.value="Receiving";
...
<table border="1" width="100%" cellspacing="0" cellpadding="0"
	...
	<TR>
		<TH BGCOLOR="#000066" COLSPAN="11"><FONT color="#ffffff">Multiple Goods
			...
			<tr>
						...
						<TABLE BORDER="0" CELLSPACING=1 WIDTH="100%">
							<tr>
								...
								<TD><INPUT name="CUST_NAME" class="inactivegry"
									...
									type="hidden" name="CUST_CODE1" value="<%=custCode%>">
								</TD>
							</tr>
							<tr>
							...
							<tr>
								...
								<td><INPUT type="TEXT" size="20" class="inactivegry"
									...
									value="<%=toWareHouse%>" /> <INPUT type="Hidden" size="20"
									MAXLENGTH=20 name="CONTACT_NUM" value="<%=contactNum%>"></td>
							...
							<tr>
								...
								<td><INPUT type="TEXT" class="inactivegry" MAXLENGTH="20"
									readonly size="20" name="DELDATE" value="<%=deldate%>" /></td>

								<th WIDTH="20%" ALIGN="left" height="30">Unit No /
								Building:</th>
							...
							<tr>
								...
								<td><INPUT type="TEXT" size="20" class="inactivegry"
									MAXLENGTH="20" name="REMARK2" readonly value="<%=remarks%>" />
								</td>
							</tr>
						</TABLE>
						</CENTER>
				...
				<table width="100%" border="0" cellspacing="0" cellpadding="5"
					...
					<%
						...
						String towarehouse = "";
						ArrayList al = _TOUtil.listTODETForReceiving(plant, tono);
						if(al.size()==0)
					    {
					    	   AFLAG="";
					    }
						...
						if (al.size() > 0) {
							...
							for (int i = 0; i < al.size(); i++) {
								...
								ArrayList alLoc = _ToHdrDAO
										.getTransferOrderLocDetailsByWms(plant, tono);
								if (alLoc.size() > 0) {
								...
								chkString = tono + "," + tolnno + "," + item + "," + StrUtils.replaceCharacters2Send(desc)
										+ "," + qtyor + "," + qtyPick + "," + qtyrc + ","
										+ sUserId + "," + loc + "," + batch + ","
										+ custname + "," + fromwarehouse + ","
										+ towarehouse;
					%>
					<TR bgcolor="<%=bgcolor%>">
				...
				<INPUT type="Hidden" name="ENCRYPT_FLAG" value="1"> <INPUT
					type="Hidden" name="RFLAG" value="6">
				...
				<table border="0" width="100%" cellspacing="0" cellpadding="0">
					<tr>
						<td align="center"><input type="Button" value="Cancel" 
							...
							onClick="if(onIssue(document.form)) {submitForm();}" /><INPUT type="hidden"
							name="TRAVELER" value=""> <INPUT name="LOGIN_USER"
							type="hidden" value="<%=sUserId%>" size="1" MAXLENGTH=80></TD>
					</tr>
					<p>
					<p>
				</table>
...
function submitForm(){
	document.form.action="/track/TransferOrderServlet?Submit=MultiReceiving";
	//document.form.action.value ="View";
    document.form.submit();
}
