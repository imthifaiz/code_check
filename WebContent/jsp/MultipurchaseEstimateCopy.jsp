...
<%
	String title = "Multi Purchase Estimate Copy";
...
<script src="../jsp/js/MultipurchaseEstimateCopy.js"></script>
<center>
	<h2>
...
<div class="container-fluid m-t-20">
	...
	<!-- Muruganantham Modified on 16.02.2022 -->
            <ul class="breadcrumb backpageul" >      	
                ...
                <li><label>Multi Purchase Estimate Copy</label></li>                                   
            </ul>             
    <!-- Muruganantham Modified on 16.02.2022 -->
		...
		<div class="container-fluid">
			<form class="form-horizontal" id="purchaseOrderForm" name="cpoform" autocomplete="off" action="../purchaseestimate/copy"  method="post"  enctype="multipart/form-data">
				...
				<div class="form-group">
					...
					<div class="col-sm-4">
						<div class="input-group">
							<input type="text" class="form-control" id="POMULTIESTNO" name="POMULTIESTNO" onchange="checkorderno(this.value)" onkeypress="return blockSpecialCharOrderNo(event)" value="<%=poheader.getPOMULTIESTNO()%>" MAXLENGTH="50">
				...
				<div class="form-group">
					<div class="col-sm-12">
						...
						<label class="checkbox-inline">      
					      <INPUT Type=Checkbox  style="border:0;" name = "selectesp" id = "selectesp" value="selectesp" <%if(poheader.getSAMEASEXPDATE() == 1){%>checked <%}%> onclick="return checkAllExp(this.checked);">Apply 1st Line Expiry Date As All</label>
					      <label class="checkbox-inline">      
					      <INPUT Type=Checkbox  style="border:0;" name = "isProductAssignedSupplier" id = "isProductAssignedSupplier" value="isProductAssignedSupplier" <%if(poheader.getISPRODUCTASSIGNEDSUPPLIER() == 1){%>checked <%}%> onclick="return checkItemSupplier(this.checked);">Show Product Assigned Supplier</label>
					</div>
				</div>
