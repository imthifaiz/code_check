...
<script src="../jsp/js/NewPurchaseOrder.js"></script>
<center>
	<h2>
...
<div class="container-fluid m-t-20">
	<div class="box">
		...
		<div class="container-fluid">
			<form class="form-horizontal" id="purchaseOrderForm" name="cpoform" action="../purchaseorder/save"  method="post"  enctype="multipart/form-data">
				...
				<div class="form-group">
					...
					<div class="col-sm-4">
						<input type="text" class="form-control" id="INCOTERMS" name="INCOTERMS">
						<span class="select-icon" 
				...
				<div class="form-group">
					...
					<div class="col-sm-4 ac-box">
						<input type="text" class="ac-selected form-control typeahead" id="CURRENCY" name="CURRENCY" placeholder="Select a Currency" value="<%=currency%>">
				...
				<div class="form-group">
					...
					<div class="col-sm-4">
						<input type="text" class="form-control" id="Purchasetax" name="Purchasetax" placeholder="Select a Tax">
						<span class="select-icon" 
					...
					<table class="table table-bordered line-item-table po-table">
						...
						<tbody>
							<tr>
								...
								<td class="bill-item">
									<input type="text" name="item" class="form-control itemSearch" 
								...
								<td class="item-cost">
									<input type="text" name="unitprice" class="form-control text-right" value="<%=zeroval%>" onchange="calculateAmount(this)">
								</td>
								<td class="table-icon">
								...
								<div class="row">
									...
									<div class="col-lg-6 col-sm-6 col-6">
										<input class="form-control text-right ember-view" type="text"
											name="shippingcost" value="<%=zeroval%>"  onchange="calculateTotal()">
									</div>
								</div>
							</div>
