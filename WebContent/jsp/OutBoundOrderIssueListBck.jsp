    ...
    <TR BGCOLOR="#000066" >
      ...
      <TH align="left"><font color="white">Item</font></TH>
       <TH align="left"><font color="white">OrderQty</font></TH>
        <TH align="left"><font color="white">PickingQty</font></TH>
...
<%
   ...
   try{
    ...
    List listQry =  _DoDetDAO.getOutBoundOrderIssueDetailsByWMS(PLANT,ORDERNO);
    ...
    for(int i =0; i<listQry.size(); i++) {
     ...
     String sPickedqty=(String)m.get("qtypick");
      String sIssuedQty=(String)m.get("qtyis");
...
%>
    <TR bgcolor="<%=sBGColor%>">
      ...
      <a href="#" onClick="window.opener.form.ORDERNO.value='<%=sOrderno%>';
        ...
        window.opener.form.ITEMNO.value='<%=sItem%>';
        window.opener.form.ITEMDESC.value='<%=sDesc %>';
        window.opener.form.ORDERQTY.value='<%=sOrdqty %>';
        window.opener.form.PICKEDQTY.value='<%=sPickedqty %>';
        window.opener.form.ISSUEDQTY.value='<%=sIssuedQty %>';
        ...
        window.opener.form.LOC.value='<%=loc%>';
