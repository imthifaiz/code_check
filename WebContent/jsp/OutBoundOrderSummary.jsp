  ...
  <table border="1" width="100%" cellspacing="0" cellpadding="0" align="center" bgcolor="#dddddd">
      <TR>
        <TH BGCOLOR="#000066" COLSPAN="11">
          <FONT color="#ffffff">Picking By OutBound Order</FONT>&nbsp;
        </TH></table>
  <br>
      ...
      <td width="100%">&nbsp;
       ...
       <TABLE BORDER="1" CELLSPACING="0" WIDTH="100%" bgcolor="navy">
        <tr>
         ...
         <th width="7%"><font color="#ffffff"><%=IDBConstants.UOM_LABEL%> </font></th>
            ...
            <table border="0" width="100%" cellspacing="0" cellpadding="0">
              <tr>
                <td align="center">
                  ...
                  <input type="button" value="Picking" name="actionSubmit" onClick="if(onIssue(document.form)){submitForm();}"/>
...
function submitForm(){
	document.form.action="/track/OrderIssuingServlet?action=Picking";
    document.form.submit();
}
