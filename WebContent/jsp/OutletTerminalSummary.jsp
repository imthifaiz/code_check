...
<%
String title = "Outlet Terminals Summary";
%>
...
<script>
	...
	function popUpWin(URL) {
		subWin = window
				.open(URL,'GroupSummary','toolbar=0,scrollbars=yes,location=0,statusbar=0,menubar=0,dependant=1,resizable=1,width=800,height=400,left = 200,top = 184');
	}
</script>
...
<%
	...
	String fieldDesc = "";
	String PLANT = "", OUTLET_CODE = "",TERMINAL_CODE ="";
	String html = "";
	int Total = 0;
	String SumColor = "";
	boolean flag = false;
	...
	{
	displaySummaryEdit = ub.isCheckValAcc("outletterminaledit", PLANT,USERID);
	displaySummaryNew = ub.isCheckValAcc("outletterminalnew", PLANT,USERID);

	}
	if(systatus.equalsIgnoreCase("INVENTORY"))
	{
	displaySummaryEdit = ub.isCheckValinv("outletterminaledit", PLANT,USERID);
	displaySummaryNew = ub.isCheckValinv("outletterminalnew", PLANT,USERID);
	}
	...
	if (PGaction.equalsIgnoreCase("View")) {
		try {
			...
			locQryList = outletUtils.getOutletTerminalListStartsWithName(TERMINAL_CODE, PLANT);
...
<div class="container-fluid m-t-20">
	 ...
	 <ul class="breadcrumb backpageul">    
                ...
                <li><label>Outlet Terminals Summary</label></li>                                   
            </ul>
              ...
              <div class="box-title pull-right">
				...
				<%if(displaySummaryNew){ %>
					<button type="button" class="btn btn-default"
						onclick="window.location.href='../outletterminal/new'" 
...
<FORM class="form-horizontal" name="form" method="post" action="OutletTerminalSummary.jsp">
...
<!-- end -->
	...
	<div class="form-group">
  	...
  	<div class="form-group">
		<label class="control-label col-sm-2" for="TerminalName">Terminal Name</label>
		<div class="col-sm-4 ac-box" >
		<input type="hidden" name="TERMINAL_CODE" value="">
		<INPUT name="TERMINALNAME" id="TERMINALNAME" type="TEXT" value="<%=TERMINAL_CODE%>" size="20" MAXLENGTH=100 class="ac-selected form-control"> 
...
<script>
		...
		var tabletype;
		var OUTLETNAME,TERMINALNAME, groupRowColSpan = 6;
		...
		function getParameters(){
			return {
				...
				"PLANT":plant,
				"action":"GET_OUTLETTERMINAL_FOR_SUMMARY"
			}
		}
		function onGo(){
			    ...
			    if (tabletype){
			    	...
			    	tabletype = $('#table').DataTable({
						        	...
						        	if(typeof data.OUTLETLIST[0].OUTLET === 'undefined'){
						        		return [];
						        			...
						        			for(var dataIndex = 0; dataIndex < data.OUTLETLIST.length; dataIndex ++){
						        				var lineno = data.OUTLETLIST[dataIndex].TERMINAL;
						        				var sno=dataIndex+1;
						        				data.OUTLETLIST[dataIndex]['SNO'] = sno;
												<%if(displaySummaryEdit){ %>
						        				data.OUTLETLIST[dataIndex]['EDIT'] = '<a href="../outletterminal/edit?action=View&TERMINAL_CODE='+lineno+'"><i class="fa fa-pencil-square-o"></i></a>';
												<%}else{ %>
				        ...
				        "columns": [
				        	...
				        	{"data": 'TERMINAL_NAME', "orderable": true},
