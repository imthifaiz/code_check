...
<%
String title = "Payroll Payment Summary";
...
boolean displaySummaryNew=false,displaySummaryExport=false,displaySummaryEdit=false,displaySummaryDelete=false,displaySummaryPayroll=false,displaySummaryPdf=false;
if(systatus.equalsIgnoreCase("PAYROLL")){
	displaySummaryExport = ub.isCheckValPay("pexportPayrollPayment", plant,username);
	displaySummaryNew = ub.isCheckValPay("pnewPayrollPayment", plant,username);
	...
	displaySummaryPayroll = ub.isCheckValPay("pdetailPayrollPayment", plant,username);
	}
...
<div class="container-fluid m-t-20">
	 ...
	 <!-- Muruganantham Modified on 16.02.2022 -->
            <ul class="breadcrumb backpageul">      	
                ...
                <li><label>Payroll Payment Summary</label></li>                                   
            </ul>             
    <!-- Muruganantham Modified on 16.02.2022 -->
            <div class="box-header menu-drop">
              ...
              <button type="button" class="btn btn-default" onClick="window.location.href='../payroll/paymentprocess'" style="background-color: rgb(214, 72, 48);color: rgb(255, 255, 255);" >+ New</button>&nbsp;<% } %>              
              <h1
		...
		function getParameters(){
			return {
				"CURENCY":CURENCY,
				"Submit": "VIEW_PAYMENT_PAYMENT_SUMMARY",
				"PLANT":"<%=plant%>",
				"DECIMAL":DECIMAL
			}
		}  
				        ...
				        "dataSrc": function(data){
				        	if(typeof data.items[0].id === 'undefined'){
				        		return [];
				        			...
				        			data.items[dataIndex]['id'] = '<a href="../payroll/paymentdetail?TRANID=' +data.items[dataIndex]['id']+ '">'+data.items[dataIndex]['id']+'</a>';
