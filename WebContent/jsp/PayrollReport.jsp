...
ArrayList<String> payolllist = new ArrayList<String>();
payolllist.add("Payroll Detailed Report");
payolllist.add("Payslip");
 ...
 <div class="container-fluid m-t-20">
	...
	<!-- Muruganantham Modified on 16.02.2022 -->
            <ul class="breadcrumb backpageul">      	
                ...
                <li><label>Payroll Report</label></li>                                   
            </ul>             
    <!-- Muruganantham Modified on 16.02.2022 -->
    ...
    <div class="col-md-4">
    <h4>  <!-- <i class="fa fa-shopping-bag" aria-hidden="true"></i> --> Payroll </h4>
    <%java.util.Hashtable htMenuItems = (java.util.Hashtable)menuListWithSequence.get(57); //	Fifty Eight row
    java.util.Map htMenuItemDetail = (java.util.Map)htMenuItems.get(1);//	First column
          					...
          					for (int i = 0; i < payolllist.size(); i++) {
          						chkmenu12=false;
          						String ListmenuItemTitle=payolllist.get(i);          						
