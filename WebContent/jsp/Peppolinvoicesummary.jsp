...
<div class="container-fluid m-t-20">
	...
	<!-- Muruganantham Modified on 16.02.2022 -->
            <ul class="breadcrumb backpageul">      	
                ...
                <li><label>Peppol Invoice Summary</label></li>                                   
            </ul>             
    <!-- Muruganantham Modified on 16.02.2022 -->
					...
					<table id="tableemployeetype"
						...
						<thead>
							<tr>
								...
								<th style="font-size: smaller;">SEND INVOICE</th>
								<th style="font-size: smaller;">EVENTS</th>
		...
		function onGo(){
			   var urlStr = "/track/peppolapi/getinvoicesummary";
			   var groupColumn = 1;	
				    ...
				    tableemployeetype = $('#tableemployeetype').DataTable({
						...
						"ajax": {
					        ...
					        "dataSrc": function(data){
					        	...
					        	console.log(data.INVOICE[0].INVOICE);
					        	if(data.INVOICE.length>0){
						        	if(typeof data.INVOICE[0].INVOICE === 'undefined'){
						        		return [];
						        	}else {	
				        ...
				        "columns": [
			    			...
			    			{"data": 'SUB_TOTAL', "orderable": true},
			    			{"data": 'TAXAMOUNT', "orderable": true},
			    			{"data": 'TOTAL_AMOUNT', "orderable": true},
			    			{"data": 'SENDINVOICE', "orderable": true},
			    			{"data": 'IEVENTS', "orderable": true},
			    			],
						"orderFixed": [ ], 
						/*"dom": 'lBfrtip',*/
...
<script>
	...
	function sendinvoice(id){
		$.ajax( {
			type : "GET",
			url : "/track/peppolapi/sendinvoice?SID="+id,
			async : true,
			dataType : "json",
			contentType: false,
	        processData: false,
