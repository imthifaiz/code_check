...
<script src="../jsp/js/PoConvertToPurchase.js"></script>
<center>
	<h2>
	...
	<!-- Muruganantham Modified on 16.02.2022 -->
     ...
     <!-- Muruganantham Modified on 16.02.2022 --> 	
		<div class="box-header menu-drop">
			...
			<h1 style="font-size: 18px; cursor: pointer;" class="box-title pull-right" onclick="window.location.href='../purchaseorder/detail?pono=<%=poheader.getPONO()%>'">
				<i class="glyphicon glyphicon-remove"></i>
			</h1>
		</div>
		...
		<div class="container-fluid">
			<form class="form-horizontal" id="purchaseOrderForm" name="cpoform" autocomplete="off" action="../purchaseorder/convertToPurchase"  method="post"  enctype="multipart/form-data">
				...
				<input type = "hidden" name="PONOOLD" value="<%=pono%>">
...
<!-- 				</div> -->
				...
				<div class="form-group">
        			...
        			<div class="col-sm-4">
        				<INPUT class="form-control" type="TEXT" size="20" MAXLENGTH="20" name="JOB_NUM" value="<%=poheader.getPONO()%>">
       				</div>
				</div>
<!-- 				<div class="form-group"> -->
				...
				<div class="form-group">
					...
					<div class="col-sm-4">
						<input type="text" class="form-control" id="EMP_NAME"
							...
							<input type="hidden"
							name="ISEMPLOYEEVALIDATEPO"  value="<%=isEmployee%>"> 
							<span
							class="select-icon"
...
<jsp:include page="newProductDepTypeModal.jsp" flush="true"></jsp:include><!-- thanzith for add product department -->
			 ...
			 %></SELECT>
					...
					<div class="form-group">  
  					...
  					<div class="form-group">
       				...
       				<div class="col-sm-4">
       					<input type="text" class="form-control" id="sup_payment_terms"	name="sup_payment_terms" onchange="checksupplierpaymentterms(this.value)" placeholder="Select Payment Terms">
	      ...
	      <div class="input-group">   
	         ...
	         <!-- End -->
					...
					<div class="form-group">
      					<label class="control-label col-form-label col-sm-2" for="transmode">Transport Mode</label>
      						<div class="col-sm-4">           	
    							<input name="transportC" id="transportC" type="TEXT"  onchange="checkcustomertransport(this.value)" value="" placeholder="Select a transport" size="50" MAXLENGTH=50 class="form-control">
