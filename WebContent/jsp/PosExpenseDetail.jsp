	...
	<div class="box">
	 ...
	 <ul class="breadcrumb backpageul">    
                <li class="underline-on-hover"><a href="../home">Dashboard</a></li>	
                 <li><a href="../expenses/possummary"><span class="underline-on-hover">Expenses Summary</span></a></li> 
		...
		<div class="box-header menu-drop">
			...
			<%if(expjnledit.equals("1")){
				...
				<h1 style="font-size: 18px; cursor: pointer; vertical-align:middle;" class="box-title pull-right"
					onclick="window.location.href='../expenses/possummary'">
	  ...
	  <div class="modal-dialog modal-sm">	
		...
		<div class="modal-dialog modal-lg box-body">
			<form id="journalForm" class="form-horizontal" name="form1"  action="/track/JournalServlet?action=expjcreate" method="post" enctype="multipart/form-data">
				...
				<div class="modal-content">
					...
					<div class="modal-body">	
							...
							<input id="summary" name="summary" value="0" hidden>
								...
								<div class="row form-group">
									<label class="col-form-modal-label col-sm-2">Journal Date</label>
									<div class="col-sm-4">
										<input type="text" class="form-control datepicker" value="<%=expenselist.get("EXPENSES_DATE")%>" id="journal_date" name="journal_date">
									</div>
								</div>
								<%}%>
			...
			<tbody>
			  ...
			  <tr>
				<td class="journal-acc">
					<input type="text" name="journal_account_name" class="form-control journalaccountSearch" placeholder="Select Account" value="General expense">
				</td>
				<td  class="col-sm-6 journal-desc">
				...
				<td class="journal-credit">
					<input type="text" name="credit" onchange="journalcredit(this)" onkeypress="return isNumberKey(event,this,4)" class="form-control text-right" autocomplete="off" value="<%=Numbers.toMillionFormat(StrUtils.addZeroes((dTotalAmount/Double.parseDouble((String)expenselist.get("CURRENCYTOBASE"))), numberOfDecimal), Integer.valueOf(numberOfDecimal)) %>">
				</td>	
				  </tr>			
				<%}%>
