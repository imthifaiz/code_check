...
<TR>
		<td class="main2" style="font-weight: bold" align="left">&nbsp;<a href="#"
			onClick="window.opener.<%=formName%>.PRD_BRAND_ID.value='<%=prdbrandid%>';window.opener.<%=formName%>.PRD_BRAND_DESC.value='<%=desc%>'; setCheckedValue( window.opener.<%=formName%>.ACTIVE,'<%=isactive%>');window.close();"><%=prdbrandid%></a></td>
