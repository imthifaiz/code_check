...
<h3 class="panel-title">PRODUCT CLASS LIST</h3> 
</div>
</div>   
...
prdclsutil.setmLogger(mLogger);
  ...
  String item_id = strUtils.fString(request.getParameter("PRD_CLS_ID"));
 ...
 try{
  ...
  //sBGColor = ((i == 0) || (i % 2 == 0)) ? "#FFFFFF" : "#dddddd";
    String prdclsid         = strUtils.fString((String) map.get("prd_cls_id"));
    String desc             = strUtils.replaceCharacters2Send1(strUtils.fString((String) map.get("prd_cls_desc")));
...
%>
	...
	<TR>
		<td class="main2" style="font-weight: bold; align=left">&nbsp;<a href="#"
			onClick="window.opener.form1.PRD_CLS_ID.value='<%=prdclsid%>';window.opener.form1.PRD_CLS_DESC.value='<%=strUtils.insertEscp(desc)%>';window.opener.form1.PRD_CLS_ID1.value='<%=prdclsid%>';setCheckedValue( window.opener.form1.ACTIVE,'<%=isactive%>');window.close();"><%=prdclsid%></a></td>
