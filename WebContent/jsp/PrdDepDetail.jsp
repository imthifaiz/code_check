...
<%
String title = "Product Department Details";
%>
...
<%
	...
	sAddEnb = "enabled";
	String action = "";
	String sItemId = "", sPrdDepId = "", sItemDesc = "", isActive = "",catalogpath="";
	...
	sItemDesc = strUtils.replaceCharacters2Recv(strUtils.fString(request.getParameter("PRD_DEP_DESC")));
...
<div class="container-fluid m-t-20">
	 ...
	 <ul class="breadcrumb backpageul">    
                ...
                <li><label>Product Department Details</label></li>                                   
            </ul>
        <!-- Thanzith Modified on 23.02.2022 -->         
...
<form class="form-horizontal" name="form1" method="post">
    <div class="form-group">
      <label class="control-label col-sm-4" for="Product Department ID">Product Department ID</label>
      <div class="col-sm-4">
...
<div class="form-group">
      <label class="control-label col-sm-4" for="Product Department Description">Product Department Description</label>
      <div class="col-sm-4">          
