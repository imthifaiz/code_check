...
PrdTypeUtil prdutil = new PrdTypeUtil();
 ...
 try{
  List listQry = prdutil.getPrdTypeList(item_id,plant,"");
...
%>
   <TR>
		<td class="main2" style="font-weight: bold" align="left">&nbsp;<a href="#"
			onClick="window.opener.form1.PRD_TYPE_ID.value='<%=prdclsid%>';window.opener.form1.PRD_TYPE_DESC.value='<%=desc%>';window.opener.form1.PRD_TYPE_ID1.value='<%=prdclsid%>'; setCheckedValue( window.opener.form1.ACTIVE,'<%=isactive%>');window.close();"><%=prdclsid%></a></td>
