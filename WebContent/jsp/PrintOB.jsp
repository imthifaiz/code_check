...
<input type="hidden" name="STATUS_ID" value="">
  ...
  <div id="target" style="display:none;">
       ...
       <INPUT name="FROM_DATE" type = "TEXT" value="<%=FROM_DATE%>" id="FROM_DATE" size="30"  MAXLENGTH=20 class ="form-control datepicker" READONLY>
        ...
        <div class="col-sm-3">
        <INPUT class="form-control" name="DONO" id="DONO" type = "TEXT" value="<%=StrUtils.forHTMLTag(DONO)%>" style="width: 100%"  MAXLENGTH=100> 
       ...
       <div class="col-sm-3">
      	    <SELECT class="form-control" NAME ="PICKSTATUS" id="PICKSTATUS" style="width: 100%">
...
<!--       <button type="button" class="Submit btn btn-default" onClick="javascript:return onGo();"><b>View</b></button>&nbsp; -->
<!--   		<button type="button" class="Submit btn btn-default"  onClick="submitForm('Print Multiple DO');"><b>Print Sales Order</b></button>&nbsp; -->
...
//debugger;
   ...
   if(USER != null    && USER != "") { flag = true;}
    ...
    /* storeInLocalStorage('PrintOB_FROMDATE', FROM_DATE);
	storeInLocalStorage('PrintOB_TODATE', TO_DATE);
	storeInLocalStorage('PrintOB_CUSTOMER', $('#CUSTOMER').val());
	storeInLocalStorage('PrintOB_CUSTOMER_TYPE_ID', CUSTOMERTYPE);
	storeInLocalStorage('PrintOB_DONO', ORDERNO);
	storeInLocalStorage('PrintOB_JOBNO', JOBNO);
	storeInLocalStorage('PrintOB_ORDERTYPE',ORDERTYPE);
	storeInLocalStorage('PrintOB_PICKSTATUS', $('#PICKSTATUS').val());
	storeInLocalStorage('PrintOB_EMPNAME', EMPNO); */
...
function getTable(){
 ...
 $(document).ready(function(){
	 /* getLocalStorageValue('PrintOB_FROMDATE', $('#FROM_DATE').val(), 'FROM_DATE');
	 getLocalStorageValue('PrintOB_TODATE', '', 'TO_DATE');
	 getLocalStorageValue('PrintOB_CUSTOMER', '', 'CUSTOMER');
	 getLocalStorageValue('PrintOB_CUSTOMER_TYPE_ID', '', 'CUSTOMER_TYPE_ID');
	 getLocalStorageValue('PrintOB_DONO', '', 'DONO');
	 getLocalStorageValue('PrintOB_JOBNO', '', 'JOBNO');
	 getLocalStorageValue('PrintOB_ORDERTYPE', '', 'ORDERTYPE');
	 getLocalStorageValue('PrintOB_PICKSTATUS', '', 'PICKSTATUS');
	 getLocalStorageValue('PrintOB_EMPNAME', '', 'EMP_NAME'); */
 onGo();
    $('.Show').click(function() {
	    $('#target').show(500);
	    $('.ShowSingle').hide(0);
