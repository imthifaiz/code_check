...
String advancePayment = "", paymentMade = "", receivedAmount = "";
...
<div class="container-fluid m-t-20">
	...
	<!-- Muruganantham Modified on 16.02.2022 -->
            <ul class="breadcrumb backpageul">      	
                ...
                <li><a href="../payroll/claimsummary"><span class="underline-on-hover">Claim Summary</span> </a></li>                      
                <li><label>Process Claim</label></li>                                   
            </ul>             
    <!-- Muruganantham Modified on 16.02.2022 -->
		<div class="box-header menu-drop">
              <h1 style="font-size: 20px;" class="box-title"><%=title %></h1>
              <h1 style="font-size: 18px;cursor:pointer;" class="box-title pull-right" onclick="window.location.href='../payroll/claimsummary'">
		...
		<div class="container-fluid">
			...
			<form id="" class="form-vertical" name="form" action="/track/HrPayrollPaymentServlet?Submit=Save"  method="post" enctype="multipart/form-data"  onsubmit="return validatePayment()">
				...
				<input name="claimids" type="hidden" value="">
				<!-- <div class="row">
				...
				<div class="row">
					...
					<div class="col-lg-4 form-group">
						...
						<input id="" class="form-control" name="amount_paid_Curr" id="amount_paid_Curr" type="text" readonly value="<%=paymentMade%>" onchange="calculatebasecurrency(this)" required>
					</div>
					<div class="col-lg-4 form-group">
				...
				<div class="row">
					...
					<div class="col-lg-4 form-group">
						...
						<input id="payment_mode" name="payment_mode" class="form-control" type="text" required>
					...
					<div class="col-lg-4 form-group">
						...
						<input id="bankCharge" name="bank_charge" class="form-control text-left" value="<%=zeroval%>" type="text" readonly> 
					</div>
				</div>
						...
						<table class="table table-bordered line-item-table payment-table">
							...
							<tbody>
								<tr>
									...
									<td class="text-center">
										<input class="form-control text-left datepicker" type="text" name="cheque-date" placeholder="Enter Cheque Date" value="<%=curDate%>" readonly>
									</td>
									<td class="text-center">
										<input class="form-control text-right" type="text" name="cheque-amount" readonly value="<%=zeroval%>">
									</td>
								</tr>
							</tbody>
						</table>
