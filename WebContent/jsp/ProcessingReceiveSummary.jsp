...
<%
//String title = "Processing Receive Summary";
String title = "De-Kitting Summary";
...
<div class="container-fluid m-t-20">
	 ...
	 <ul class="breadcrumb backpageul">    
                ...
                <li><label>De-Kitting Summary</label></li>                                   
            </ul>
        <!-- Thanzith Modified on 28.02.2022 --> 
            <div class="box-header menu-drop">
              <h1 style="font-size: 20px;" class="box-title"><%=title %></h1>
              <div class="box-title pull-right">
              <button type="button" class="btn btn-default" onClick="window.location.href='../ProcessingReceive/new'" style="background-color: rgb(214, 72, 48);color: rgb(255, 255, 255);" >+ New</button>&nbsp;              
              </div>
              </h1>
		</div>
		...
		<div class="row"><div class="col-sm-2.5">		    	 
  		...
  		<div class="col-sm-4 ac-box">
				...
				<input type="text" class="ac-selected form-control" id="ORDERNO" name="ORDERNO" value="<%=StrUtils.forHTMLTag(ORDERNO)%>" placeholder="GINO">
  		...
  		<div class="col-sm-4 ac-box">  		
  		<input type="text" name="item" id="item" class="ac-selected form-control" placeholder="DE-KITTING PRODUCT" >
             ...
             <!-- <label for="searchType">Select Search Type:</label> -->
              ...
              <table id="tableInventorySummary" class="table table-bordred table-striped">                   
                   ...
                   <th style="font-size: smaller;">DATE</th>
                     ...
                     <th style="font-size: smaller;">DE-KITTING PRODUCT</th>
                     <th style="font-size: smaller;">LOCATION</th>
                     <th style="font-size: smaller;">BATCH</th>
                     <th style="font-size: smaller;">WASTAGE</th>
                     <th style="font-size: smaller;">DE-KITTING QUANTITY</th>
		...
		function getParameters(){
		  ...
		  function onGo(){
		   ...
		   if(TO_DATE != null    && TO_DATE != "") { flag = true;}		   
		    ...
		    var urlStr = "../ProcessingReceive/summary";
				        ...
				        "dataSrc": function(data){
				        	if(typeof data.items[0] === 'undefined'){
				        		...
				        		for(var dataIndex = 0; dataIndex < data.items.length; dataIndex ++){
				        			...
				        			data.items[dataIndex]['GRNO'] = '<a href="../ProcessingReceive/detail?GRNO=' +data.items[dataIndex]['GRNO']+'">'+data.items[dataIndex]['GINO']+'</a>';
 ...
 $('#ORDERNO').typeahead({
		...
		},
		{
		  display: 'GINO',  
		  source: function (query, process,asyncProcess) {
			var urlStr = "/track/ProcessingReceive/gino";
			$.ajax( {
			type : "GET",
			url : urlStr,
			async : true,
		  ...
		  empty: [
			...
			suggestion: function(data) {
				return '<div><p class="item-suggestion">'+data.GINO+'</p></div>';
			}
		  }
		}).on('typeahead:open',function(event,selection){
			var element = $(this).parent().parent().find('.select-icon').find('.glyphicon');
