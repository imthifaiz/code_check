...
<%
String title = "Product Return Summary";
...
if(systatus.equalsIgnoreCase("ACCOUNTING")) {
	displaySummaryNew = ub.isCheckValAcc("newproductreturn", plant,username);
	displaySummaryLink = ub.isCheckValAcc("summarylnkproductreturn", plant,username);
	displaySummaryExport = ub.isCheckValAcc("exportproductreturn", plant,username);
}
if(systatus.equalsIgnoreCase("INVENTORY")) {
	displaySummaryNew = ub.isCheckValinv("newproductreturn", plant,username);
	displaySummaryLink = ub.isCheckValinv("summarylnkproductreturn", plant,username);
	displaySummaryExport = ub.isCheckValinv("exportproductreturn", plant,username);
}
...
<div class="container-fluid m-t-20">
	 ...
	 <!-- Muruganantham Modified on 16.02.2022 -->
            <ul class="breadcrumb backpageul">      	
                ...
                <li><label>Product Return Summary</label></li>                                   
            </ul>             
    <!-- Muruganantham Modified on 16.02.2022 -->
            <div class="box-header menu-drop">
              ...
              <button type="button" class="btn btn-default" onClick="window.location.href='../productreturn/new'" style="background-color: rgb(214, 72, 48);color: rgb(255, 255, 255);" >+ New</button>&nbsp;              
              <%}%>
              </div>
              </h1>
		</div>
		...
		<input type="text" name="vendno" hidden>
...
<!-- 				<span class="select-icon" onclick="$(this).parent().find('input[name=\'CUSTOMER\']').focus()"><i class="glyphicon glyphicon-menu-down"></i></span> -->
  		...
  		<div class="col-sm-4 ac-box">  		
  		<input type="text" class="ac-selected form-control" id="ORDERNO" name="ORDERNO" value="<%=StrUtils.forHTMLTag(ORDERNO)%>" placeholder="RETURN NO">
		...
		<!-- <font face="Proxima Nova" > -->                
              <table id="tableInventorySummary" class="table table-bordred table-striped">                   
                   ...
                   <th style="font-size: smaller;">DATE</th>
                    <th style="font-size: smaller;">PRODUCT RETURN NO</th>
				        ...
				        "dataSrc": function(data){
				        	if(typeof data.items[0].bill === 'undefined'){
				        		...
				        		for(var dataIndex = 0; dataIndex < data.items.length; dataIndex ++){
				        			...
				        			data.items[dataIndex]['bill'] = '<a href="../productreturn/detail?&custno=' +data.items[dataIndex]['custno']+'&PRODUCT_HDR=' +data.items[dataIndex]['invoiceid']+'">'+data.items[dataIndex]['bill']+'</a>';
				        			<% }else{ %>
