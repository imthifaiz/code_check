...
<html>
<head>
<title>Production BOM List</title>
<meta charset="utf-8">
...
<h3 class="panel-title">PRODUCTION BOM LIST</h3> 
</div>
</div>
...
ProductionBomUtil _ProductionBomUtil = new ProductionBomUtil();
 ...
 try{
  ...
  sBGColor = ((i == 0) || (i % 2 == 0)) ? "#FFFFFF" : "#dddddd";
   String item         = strUtils.fString((String) map.get("PITEM"));
	...
	if(type.equalsIgnoreCase("PRODBOM")){%>
	 <TR>
		<td class="main2" style="font-weight: bold" align="left">&nbsp;<a href="#"
			onClick="window.opener.form.ITEM.value='<%=item%>';window.opener.form.DESC.value='<%=desc%>';window.opener.form.UOM.value='<%=uom%>'; window.close();"><%=item%></a></td>
...
<TR>
		<td class="main2" style="font-weight: bold" align="left">&nbsp;<a href="#"
		onClick="window.opener.form1.ITEM.value='<%=item%>';window.opener.form1.DESC.value='<%=desc%>';window.opener.form1.UOM.value='<%=uom%>'; window.opener.form1.OPR_SEQNUM.focus();window.close();"><%=item%></a></td>	
	    <td align="left" class="main2">&nbsp;<%=desc%></td>
		<td align="left" class="main2">&nbsp;<%=uom%></td>
		</TR>
