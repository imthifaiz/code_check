...
<%
	String title = "Edit Purchase Estimate Order";
...
<script src="../jsp/js/EditPurchaseEstimate.js"></script>
<center>
	<h2>
...
<div class="container-fluid m-t-20">
	...
	<!-- Muruganantham Modified on 16.02.2022 -->
            <ul class="breadcrumb backpageul" >      	
                ...
                <li><label>Edit Purchase Estimate Order</label></li>                                   
            </ul>             
    <!-- Muruganantham Modified on 16.02.2022 -->
		<div class="box-header menu-drop">
			...
			<div class=" pull-right">
				...
				&nbsp;
				<h1 style="font-size: 18px; cursor: pointer;" class="box-title pull-right" onclick="window.location.href='../purchaseorderestimate/detail?POESTNO=<%=POESTNO%>'">
		...
		<div class="container-fluid">
			<form class="form-horizontal" id="purchaseOrderForm" name="cpoform" autocomplete="off" action="../purchaseorderestimate/edit"  method="post"  enctype="multipart/form-data">
				...
				<div class="form-group">
					...
					<div class="col-sm-4">
						<div class="input-group">
							<input type="text" class="form-control" id="POESTNO" name="POESTNO" value="<%=poheader.getPOESTNO()%>" readonly>
			   		 	</div>
					</div>
				</div>
				<div class="form-group">
        			...
        			<div class="col-sm-4">
        				<INPUT class="form-control" type="TEXT" size="20" MAXLENGTH="20" name="JOB_NUM" value="<%=poheader.getJobNum()%>">
       				</div>
				</div>
				<div class="form-group">
...
<!-- 								</td> -->
				...
				<div class="row grey-bg">
					...
					<div class="col-sm-4">
						...
						<%if(PurchaseEstimateAttachList.size()>0){ %>
						<div id="billAttchNote">
							<small class="text-muted"><div class="attachclass"><a><%=PurchaseEstimateAttachList.size()%> files Attached</a>
									<div class="tooltiptext">

										<%for(int i =0; i<PurchaseEstimateAttachList.size(); i++) {
									  		Map attach=(Map)PurchaseEstimateAttachList.get(i); %>
...
<jsp:include page="../jsp/NewChartOfAccountpopup.jsp" flush="true" /> <!-- imti for add account --> 
