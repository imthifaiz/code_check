...
<%
String title = "Purchase Estimate Summary";
...
{
displaySummaryNew = ub.isCheckValAcc("newpurchaseorderestimate", plant,USERID);
displaySummaryLink = ub.isCheckValAcc("summarylnkpurchaseorderest", plant,USERID);
...
{
	displaySummaryNew = ub.isCheckValinv("newpurchaseorderestimate", plant,USERID);	
	displaySummaryLink = ub.isCheckValinv("summarylnkpurchaseorderest", plant,USERID);
...
<script src="../jsp/js/PurchaseEstimateSummary.js"></script>
<center>
	<h2>
...
<div class="container-fluid m-t-20">
	...
	<!-- Muruganantham Modified on 16.02.2022 -->
            <ul class="breadcrumb backpageul">      	
                ...
                <li><label>Purchase Estimate Summary</label></li>                                   
            </ul>             
    <!-- Muruganantham Modified on 16.02.2022 -->
		<div class="box-header menu-drop">
              <h1 style="font-size: 20px;" class="box-title"><%=title %></h1>
	              ...
	              <%if(displaySummaryNew){ %>
	              	...
	              	onClick="window.location.href='../purchaseorderestimate/new'" 
...
function onGo(){
   var flag = "false";
    ...
    var urlStr = "../purchaseorderestimate/summary";
		        ...
		        "dataSrc": function(data){
		        	if(typeof data.ORDERS[0] === 'undefined'){
		        		...
		        		for(var dataIndex = 0; dataIndex < data.ORDERS.length; dataIndex ++){
		        			...
		        			data.ORDERS[dataIndex]['POESTNO'] = '<a href="../purchaseorderestimate/detail?POESTNO='+data.ORDERS[dataIndex]['POESTNO']+'">'+data.ORDERS[dataIndex]['POESTNO']+'</a>';
		        			 } else{
	        			    	 data.ORDERS[dataIndex]['POESTNO'] =  data.ORDERS[dataIndex]['POESTNO'];
