...
<!-- DATE 14-06-2022 -->
<!-- DESC : Return Sales Reports Summary -->
...
<%
String title = "Return Sales Report";
%>
...
<div class="container-fluid m-t-20">
	 ...
	 <ul class="breadcrumb backpageul">    
                ...
                <li><label>Return Sales Report</label></li>                                   
            </ul>
...
<FORM class="form-horizontal" name="form" method="post" action="ReturnSalesReportsSummary.jsp">
...
<input type="hidden" name="srctype" value="Return">
...
<script>
		...
		function getParameters(){
			return {
				...
				"ACTION": "VIEW_POSRETURN_SUMMARY_WITH_PRICE","PLANT":"<%=PLANT%>",SRC:"POSRETURN",LOGIN_USER:"<%=USERID%>"
			}
		}
		function onGo(){
