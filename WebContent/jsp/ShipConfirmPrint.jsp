...
%>
<body onload="window.print();window.location.href='OutBoundsOrderIssue.jsp?action=View&plant=<%=plant%>&DONO=<%=DONO%>';">
                ...
                <CENTER>
                  ...
                  <TD>
                   ...
                   <tr>
                    ...
                    <th WIDTH="20%" ALIGN = "left" height="30">Address1/ Address2:</th>
                     <td height="30">
                   ...
                   <tr>
                    ...
                    <th WIDTH="20%" ALIGN="left">Address3/ Address4:</th>
                      <td>
