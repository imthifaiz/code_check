	...
	<div class="box">
            <div class="box-header menu-drop">
              ...
              <button type="button" class="btn btn-default"
						onClick="window.location.href='importSupplierDiscountExcelSheet.jsp'">
...
<INPUT type="hidden" name="listRecSize" value="<%=listRecSize%>">
  ...
  <div id="target" style="display:none"> 
       ...
       <div class="col-sm-3 ac-box">
    		...
    		<INPUT class="ac-selected form-control" name="CUSTOMER" type = "TEXT" value="<%=StrUtils.forHTMLTag(CUSTOMER)%>" size="30"  MAXLENGTH=50>
   		 	<span class="btn-danger input-group-addon"  onClick="javascript:popUpWin('supplierlist.jsp?CUSTOMER='+convertCharToString(form1.CUSTOMER.value));">
   		 <span class="glyphicon glyphicon-search" aria-hidden="true"></span></a></span>
  		</div>
  		</div>
  		<div class="form-inline">
  ...
  var tableData = [];
       ...
       <%
          ...
          rowData[rowData.length] = '<%=StrUtils.addZeroes(cost,numberOfDecimal)%>';
          rowData[rowData.length] = '<%=StrUtils.forHTMLTag((String)lineArr.get("DISCOUNT"))%>';
