...
<title>Pick/Receive By Transfer Order</title>
<link rel="stylesheet" href="css/style.css">
<SCRIPT LANGUAGE="JavaScript">
var subWin = null;
var isOpenOrder = false;
function popUpWin(URL) {
  subWin = window.open(URL, 'multiPickIssueReceive', 'toolbar=0,scrollbars=yes,location=0,statusbar=0,menubar=0,dependant=1,resizable=1,width=700,height=400,left = 200,top = 184');
}
</script>
<%
  ...
  <table border="1" width="100%" cellspacing="0" cellpadding="0" align="center" bgcolor="#dddddd">
      <TR>
        <TH BGCOLOR="#000066" COLSPAN="11">
          <FONT color="#ffffff">Multi Pick/Receive By Transfer Order</FONT>&nbsp;
        </TH></table>
  <br>
   ...
   <br>
      ...
      function onPickIssue()
      {
			...
			var ScannedQty = 0;
   	        ...
   	        if(ScannedQty == 0){
   			alert("No Scanned Qty To Pick/Receive.Scan the Product For Qty to Pick/Receive.");
   			return false;
   	        }
    	    ...
    	    // Call the method of JQuery Ajax provided
    	    $.ajax({type: "POST",url: urlStr, data: {TONO:orderNO,TRANSACTIONDATE:tranDate,ACTION: "PROCESS_MULTI_PICKRECEIVE",PLANT:"<%=PLANT%>"},dataType: "json", success: callback });
    	...
    	function callback(data){
    	        ...
    	        var issueHTML = '<br><br><TABLE WIDTH="20%"  border="0" cellspacing="1" cellpadding = 2 align = "center"> <TR><TD><INPUT  type="button" name="action" value="Reset Scan QTY" style="height: 25px; width: 100px" onClick="onResetScanqty();">'
    	        				...
    	        				+ 'value="Issue/Receive" style="height: 25px; width: 100px" onClick="onPickIssue();">'
    	...
    	function getTable(){
    	            return '<TABLE id="tabledata" WIDTH="90%"  border="0" cellspacing="1" cellpadding = 2 align = "center">'+
    	                    ...
    	                    '<TH><font color="#ffffff" align="left"><b>Picked/Received Qty</TH>'+
