	...
	function onIssue(form){
    	...
    	}else
    	{
             ...
             for (i = 0; i < noofcheckbox; i++ )
        	  ...
        	  document.form.Submit.value="Pick/Issue";
     ...
     <% 
       ...
       %>
        <TR bgcolor = "<%=bgcolor%>">
              ...
              <TD align="right" width="15%"><%=StrUtils.formatNum((String)m.get("qtyor"))%></TD>
              <TD align="right" width="14%"><%=StrUtils.formatNum((String)m.get("qtyPick"))%></TD>
              <TD align="right" width="10%"><%=StrUtils.formatNum((String)m.get("qtyrc"))%></TD>
...
function submitForm(){
	document.form.action="/track/TransferOrderServlet?Submit=Pick/Issue";
	//document.form.action.value ="View";
    document.form.submit();
}
