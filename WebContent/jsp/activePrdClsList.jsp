 ...
 <thead style="background: #eaeafa"> 
	...
	<TR>
		<td class="main2" style="font-weight: bold" align="left">&nbsp;<a href="#"
			onClick="window.opener.form1.PRD_CLS_ID.disabled = false;window.opener.form1.PRD_CLS_ID.value='<%=prdclsid%>';window.opener.form1.PRD_CLS_DESC.value='<%=strUtils.insertEscp(desc)%>';window.opener.form1.PRD_CLS_ID1.value='<%=prdclsid%>';window.close();"><%=prdclsid%></a></td>
