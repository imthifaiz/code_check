...
<%
    ...
    if (action.equalsIgnoreCase("Delete"))
    {
      ...
      if(n==1) result = "<font color=\"green\">Mobile Shopping Order Deleted Successfully</font><br><br><center>"+
                        "<input type=\"button\" value=\" OK \" onClick=\"window.location.href='../home'\">";
      else     result = "<font color=\"red\"> Error in Delete Mobile Shopping Order  -  <br><br><center>"+
      ...
      result = "Mobile Shopping Order<br><h3>"+result;
                ...
                <CENTER>
                 ...
                 <INPUT class="inactive" type = "hidden" size="40"  MAXLENGTH=20 name="REMARK1">
                  <INPUT class="inactive" type = "hidden" size="40"  MAXLENGTH=20 name="REMARK2">
                   ...
                   <TR>
                      <TH WIDTH="35%" ALIGN="RIGHT" >Quantity:&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                      <TH WIDTH="65%" ALIGN = "LEFT"><INPUT  type = "TEXT" size="20"  MAXLENGTH=20 name="QTY">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                     UOM:&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; <INPUT  type = "TEXT" size="20"  MAXLENGTH=20 name="UOM">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                     Unit price:&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                     <INPUT  type = "TEXT" size="10"  MAXLENGTH=20 name="UNITPRICE">
