...
<%
String title = "Create User Access Rights Group";
%>
...
<div class="container-fluid m-t-20">
	 ...
	 <ul class="breadcrumb backpageul">    
                ...
                <li><label>Create User Access Rights Group</label></li>                                   
            </ul>
        <!-- Thanzith Modified on 28.02.2022 -->  
 ...
 <div class="box-body">
<%--New page design end --%>
<form name="form" class="form-horizontal" method="POST" action="../jsp/userLevelSubmit.jsp" onSubmit="return validateLevel()">
    ...
    <TABLE class="table1" style="font-size:14px;width: 100%;">
             <TR>
	                ...
	                <TR>
	                  ...
	                  <TH WIDTH="20%" ALIGN = "LEFT">
	                  <label class="checkbox-inline"><INPUT Type=Checkbox  style="border:0;" name="UomLoc" value="assignuserlocation">    
	                  &nbsp; Assign User Location</label>
	                  
	                  <TH WIDTH="20%" ALIGN = "LEFT">
	                  <label class="checkbox-inline"><INPUT Type=Checkbox  style="border:0;" name="UomLoc" value="assigninvlocation">    
...
<div class="panel-body"> 
		<TABLE class="table1" style="font-size:14px;width: 100%;">
         ...
         <!--**************************************************  -->    
                   <TH WIDTH="20%" ALIGN = "LEFT">
                 <label class="checkbox-inline"><INPUT Type=Checkbox  style="border:0;" name="OrderAdmin" value="kittingSumm">
                  &nbsp; Bill Of Materials </label>
                  
                  
                  <TH WIDTH="20%" ALIGN = "LEFT">
                 <label class="checkbox-inline"><INPUT Type=Checkbox  style="border:0;" name="OrderAdmin" value="kittingNew">
                  &nbsp; Bill Of Materials New</label>
                  
                  <TH WIDTH="20%" ALIGN = "LEFT">
                 <label class="checkbox-inline"><INPUT Type=Checkbox  style="border:0;" name="OrderAdmin" value="kittingEdit">
                  ...
                  <TH WIDTH="20%" ALIGN = "LEFT">
                 <label class="checkbox-inline"><INPUT Type=Checkbox  style="border:0;" name="OrderAdmin" value="kittingExport">
	             ...
	             <TR>
	              ...
	              <TH WIDTH="20%" ALIGN = "LEFT">
                   ...
                   <label class="checkbox-inline"> <INPUT Type=Checkbox  style="border:0;" name="OrderConfiguration" value="goodsshiftclosereceiptprintout">
                    ...
                    <TH WIDTH="20%" ALIGN = "LEFT">
                   <label class="checkbox-inline"> <INPUT Type=Checkbox  style="border:0;" name="OrderConfiguration" value="editMinMaxEmailMsg">
                    &nbsp; Edit Inventory Min/Max Qty Email Alert </label>
                    
                    <TH WIDTH="20%" ALIGN = "LEFT">
                   <label class="checkbox-inline"> <INPUT Type=Checkbox  style="border:0;" name="OrderConfiguration" value="editInvexpiredateEmailMsg">
    	...
    	<TABLE class="table1" style="font-size:14px;width: 100%;">
                   ...
                   <label class="checkbox-inline"> <INPUT Type=Checkbox  style="border:0;" name="Purchaseestimate" value="summarypurchaseestimate">
                    ...
                    <TH WIDTH="20%" ALIGN = "LEFT">
	                 ...
	                 &nbsp; Summary &#45; Purchase Estimate Number Link</label>
                    ...
                    <TR>
                       ...
                       &nbsp; Stock Move</label>
                         ...
                         <%-- NAME: Thansith --%>
                          ...
                          <TH WIDTH="20%" ALIGN = "LEFT">
                       <label class="checkbox-inline"><INPUT Type=Checkbox  style="border:0;" name="InHouse" value="newProcessingReceive" >  
                       &nbsp; De-Kitting</label>
                       
                       <TH WIDTH="20%" ALIGN = "LEFT">
                       <label class="checkbox-inline"><INPUT Type=Checkbox  style="border:0;" name="InHouse" value="summarySemiFinished" >  
                       &nbsp; Kitting </label>
                       ...
                       <%--  END --%>
                            ...
                            <TH WIDTH="20%" ALIGN = "LEFT">
                        	<label class="checkbox-inline"><INPUT Type=Checkbox  style="border:0;" name="InHouse" value="manualstocktake"   >
                        	&nbsp; Stock Take</label> </TH>
                        	
                        	<TR>
                        	
                        	<TH WIDTH="20%" ALIGN = "LEFT">
                        	<label class="checkbox-inline"><INPUT Type=Checkbox  style="border:0;" name="InHouse" value="showavlqtyonstk"   >
                        	...
                        	<TH WIDTH="20%" ALIGN = "LEFT">
                         <label class="checkbox-inline"><INPUT Type=Checkbox  style="border:0;" name="InHouse" value="kitdekitwithbomnew">
                         &nbsp; Kitting De-Kitting New</label>
                        	...
                        	<TH WIDTH="20%" ALIGN = "LEFT">
                         <label class="checkbox-inline"><INPUT Type=Checkbox  style="border:0;" name="InHouse" value="kitdekitwithbomedit">
                        ...
                        <TH WIDTH="20%" ALIGN = "LEFT">
                        	<label class="checkbox-inline"><INPUT Type=Checkbox  style="border:0;" name="InHouse" value="kitdekitwithbomsummry"   >
                        	...
                        	<TH WIDTH="20%" ALIGN = "LEFT">
                      		 <label class="checkbox-inline"><INPUT Type=Checkbox  style="border:0;" name="InHouse" value="generateBarcode" >  
                       		&nbsp; Generate Barcode</label>
                        	
                            <TH WIDTH="20%" ALIGN = "LEFT">
                        	<label class="checkbox-inline"><INPUT Type=Checkbox  style="border:0;" name="InHouse" value="generateReceiptBarcode"   >
                        	&nbsp; Generate Receipt Barcode</label> </TH>
                        	
                       		<TH WIDTH="20%" ALIGN = "LEFT">
                            <label class="checkbox-inline"><INPUT Type=Checkbox  style="border:0;" name="InHouse" value="generateLocBarcode"  >
                            &nbsp;Generate Location Barcode</label>
                        	</TH>
                        	
                       		<TH WIDTH="20%" ALIGN = "LEFT">
                            <label class="checkbox-inline"><INPUT Type=Checkbox  style="border:0;" name="InHouse" value="genproductbarcode"  >
                        	...
                        	<TH WIDTH="20%" ALIGN = "LEFT">
                        	<label class="checkbox-inline"><INPUT Type=Checkbox  style="border:0;" name="InHouse" value="generateManualBarcode"   >
                        	&nbsp; Generate Manual Barcode </label></TH>
		...
		<TABLE >
                    <TR>
	                 ...
	                 <TR>
						...
						<TH WIDTH="20%" ALIGN = "LEFT">
	     				 <label class="checkbox-inline"> <INPUT Type=Checkbox  style="border:0;" name="PosReports" value="posrevenuereports">
