...
<div class="form-group">
      <label class="control-label col-sm-5" for="Current Price">Current Price:</label>
       <div class="col-sm-3">  
		 <INPUT class="form-control" name=CURRENTAMOUNT type = "TEXT" value="<%= CURRENTAMOUNT%>"   size="10"  MAXLENGTH="5" readonly >
		 </div>
	  </div>
   
<div class="form-group">
       <label class="control-label col-sm-5" for="Discount By Price">Discount By Price:</label>
       <label class="radio-inline" style="valign: center;">
...
<div class="form-group" style="display: none;">
      <label class="control-label col-sm-5" for="Emp First Name">Tax:</label>
	  <label class="radio-inline">
 			...
 			if(document.form.PERCENTAGEDISCOUNT.value.length > 0)
 	 		...
 	 		{	
 	 			if(document.form.AMOUNTDISCOUNT.value.length == 0)
 	 	 		...
 	 	 		var calAmount = parseFloat(amountdiscount).toFixedSpecial(<%=com.track.gates.DbBean.NOOFDECIMALPTSFORCURRENCY%>);
 	 	 		window.opener.form.RENTALPRICE.value =calAmount;
				window.opener.form.RENTALPRICERD.value =calAmount;
