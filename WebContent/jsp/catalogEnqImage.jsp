...
<%
	...
	productid = StrUtils.fString(request
			.getParameter(IDBConstants.PRODUCTID));
	...
	url = "http://" + servername+ ":"+port+"/track/jsp/mobileEnquiry.jsp?ID=" + plant + delim+ productid;
       // url = "http://" + servername+ ":8080/track/jsp/mobileEnquiry.jsp?ID=" + plant + delim+ productid;
...
<table width="100%" border="0" cellpadding="0" cellspacing="0"
	...
	<tr>
		...
		<td align="right" class="mobilelabel"><a
			href="instrtnsummry.jsp?PLANT=<%=plant%>&PAGENAME=enquiryimage&PRODUCTID=<%=productid%>"><font
...
<table align="center" cellpadding="0" cellspacing="0" width="100%">
	...
	<tr>
		<td align="center"  class="mobilelabel"><a
			href="pcMoreDetails.jsp?PLANT=<%=plant%>&CATALOGID=<%=productid%>&PAGENAME=enquiryimage"><font
	...
	%>
	<TR>
		<TD  align="center"><input type="button" name="Back"
