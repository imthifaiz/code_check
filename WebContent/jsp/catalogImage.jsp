...
String catalogPath="",price="",description1="",product1="",detailsPage="",description2="",description3="",uom="",strIndex="";
    int counter=0,nextCnt=0,prevCnt=0,iIndex=0;
            ...
            List catloglst=	_catlogutil.listCatalogs("distinct CATLOGID, PRODUCTID,PRICE,isnull(CATLOGPATH,'') CATLOGPATH ,DESCRIPTION1,DESCRIPTION2,DESCRIPTION3,ISNULL(DETAILLABEL,'') DETAILLABEL,ISACTIVE ",ht," AND PRODUCTID like '"+productid+"%' ");
	...
	String delim="AAABBACCB";
        url="http://"+servername+":"+port+"/track/jsp/mobileShopping.jsp?ID="+plant+"AAABBACCB"+productid+"AAABBACCB"+"Y";
 	//url="http://"+servername+":8080/track/jsp/mobileShopping.jsp?ID="+plant+"AAABBACCB"+productid;
...
<table width="100%" border="0" cellpadding="0" cellspacing="0" align="center">
   <tr>
         <td align="right" class="mobilelabel"><a href="instrtnsummry.jsp?PLANT=<%=plant%>&PAGENAME=shopimage&PRODUCTID=<%=productid%>" ><font size="5"  color="#669900"><b>INSTRUCTIONS</b></font></a></td>
   </tr>
...
<table align="center" cellpadding="0" cellspacing="0" width="100%" >
	...
	<tr><td  align="center"   class="mobilelabel" ><a  href="pcMoreDetails.jsp?PLANT=<%=plant%>&CATALOGID=<%=productid%>&PAGENAME=shopimage" ><font size="5"  ><b><%=detailsPage%></b></font></a></td>
...
<a href="#" style="border:0 none;cursor:default;text-decoration:none;">
...
<img src="/track/qrservlet?qrtext=<%=url%>" alt="QR Code" title="" /></a>
	...
	<TR>
		<TD  align="center"  >
		<input type="button" name="Close"  value="Close" class="mobileButtonB" onclick="window.close();">&nbsp;&nbsp;
		</TD>
	</TR>
