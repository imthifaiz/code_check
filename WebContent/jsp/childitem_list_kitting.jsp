...
<html>
<head>
<title>Kitting Child Product List</title>
...
<h3 class="panel-title">Kitting Child Product List</h3> 
</div>
</div>
...
<%
        ...
        String sBGColor = "";
         try{
	        ...
	        List listQry =   bomDAO.getKittingChildItemByWMS(PLANT,ITEM,PARENTBATCH,CHILDPRODUCT,FROM_DATE,TO_DATE);
...
<TR>
		<td class="main2" style="font-weight: bold" align="left">&nbsp;<a href="#"
			onClick="window.opener.form1.CHILDITEM.value='<%=sItem%>';
                     window.opener.form1.CDESC.value='<%=strUtils.insertEscp(sDesc)%>';
                     window.opener.form1.CDETDESC.value='<%=strUtils.insertEscp(sdetdesc)%>';
