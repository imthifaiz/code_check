...
<%
String title = "Close Outstanding Purchase Orders";
%>
...
function onForceClose(){
   ...
   var noofcheckbox=1;
    ...
    if(form1.chkdLot.length == undefined)
    {
            ...
            document.form1.action = "../purchaseorder/closeorder";
...
<div class="container-fluid m-t-20">
	 ...
	 <!-- Muruganantham Modified on 16.02.2022 -->
            <ol class="breadcrumb" style="background-color: rgb(255, 255, 255);">      	
                ...
                <li><label>Close Outstanding Purchase Order</label></li>                                   
            </ol>             
    <!-- Muruganantham Modified on 16.02.2022 --> 
 ...
 <div class="box-body">
  ...
  <form class="form-horizontal" name="form1" method="post"  action="../purchaseorder/closeorder">
...
$('#ORDERNO').typeahead({
	...
	},
	{
	  ...
	  source: function (query, process,asyncProcess) {
		...
		data : {
			PLANT : plant,
			Submit : "GET_ORDER_NO_FOR_FORCE_CLOSE",
