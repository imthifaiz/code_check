...
<%
String title = "Close Outstanding Rental Orders";
%>
...
function onForceClose(){
   ...
   var noofcheckbox=1;
    ...
    if(form1.chkdLot.length == undefined)
    {
            ...
            document.form1.action = "closeByOrderRental.jsp";
...
<div class="container-fluid m-t-20">
 ...
 <div class="box-body">
  ...
  <form class="form-horizontal" name="form1" method="post"  action="closeByOrderRental.jsp">
      ...
      <label class="control-label col-sm-2" for="Event Master">Order Number:</label>
        ...
        <INPUT  class="form-control" name="ORDERNO" type="TEXT" value="<%=ORDERNO%>"
			...
			<span class="input-group-addon" 
   		  onClick="javascript:popWin('list/orderList.jsp?ORDERNO='+form1.ORDERNO.value +'&MODULENAME='+form1.MODULENAME.value+'&STATUS='+form1.STATUS.value);"> 	
