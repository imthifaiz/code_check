...
<%
String title = "Close Outstanding Sales Orders";
%>
...
function onForceClose(){
   ...
   var noofcheckbox=1;
    ...
    if(form1.chkdLot.length == undefined)
    {
            ...
            document.form1.action = "../salesorder/closesalesorder";
...
<div class="container-fluid m-t-20">
	 ...
	 <!-- Muruganantham Modified on 16.02.2022 -->
            <ol class="breadcrumb backpageul">      	
                ...
                <li><label>Close Outstanding Sales Orders</label></li>                                   
            </ol>             
    <!-- Muruganantham Modified on 16.02.2022 -->
 ...
 <div class="box-body">
  ...
  <form class="form-horizontal" name="form1" method="post"  action="../salesorder/closesalesorder">
