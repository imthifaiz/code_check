...
{
displaySummaryEdit = ub.isCheckValAcc("editcontra", plant,USERID);
displayPrintPdf = ub.isCheckValAcc("printcontra", plant,USERID);
}
    ...
    <!-- Muruganantham Modified on 16.02.2022 -->
		<div class="box-header menu-drop">
			...
			<div class=" pull-right">
				...
				<%if(editcheck){ %>
					<button type="button" onclick="window.location.href='../banking/contraedit?ID=<%=journalid%>'" class="btn btn-default"
				...
				<h1 style="font-size: 18px; cursor: pointer; vertical-align:middle;" class="box-title pull-right"
					onclick="window.location.href='../banking/contrasummary'">
...
<%=fromAddress_Country%> <%=ZIP%>
			...
			<div class="col-xs-6" >		
      			<h1 style="font-size: 30px;text-align:right">Contra</h1>
					...
					<% for(JournalDetail journalDetail:journalDetailList)  {
			  		...
			  		%>
				  		<tr>
							...
							<td class="text-center" style="text-align:left"><%=journalDetail.getACCOUNT_NAME()%></td>
...
<script type="text/javascript">
		...
		<script>
			...
			function generatePdf(dataUrl){
				...
				doc.setFontSize(20);
				doc.setFontStyle("bold");
				doc.text('Contra', 170, 37,{align:'left'});
				doc.setFontSize(10);
