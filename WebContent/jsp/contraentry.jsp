...
<%
String title = "New Contra";
String plant = StrUtils.fString((String) session.getAttribute("PLANT"));
String curency = StrUtils.fString((String) session.getAttribute("BASE_CURRENCY"));
String username = StrUtils.fString((String) session.getAttribute("LOGIN_USER"));
String NOOFCONTRA=((String) session.getAttribute("NOOFCONTRA")); /* Resvi */
...
int noordvalid =journalDAO.Contracount(plant,FROM_DATE,TO_DATE);
if(!NOOFCONTRA.equalsIgnoreCase("Unlimited"))
{
int convl = Integer.valueOf(NOOFCONTRA);
if(noordvalid>=convl)
{
	OrdValidNumber=NOOFCONTRA;
}
}
//resvi ends

int journalcount=journalDAO.getmaxcount(plant);
int journalno=journalcount+1;
...
<div class="container-fluid m-t-20">
	 ...
	 <!-- Muruganantham Modified on 16.02.2022 -->
            <ul class="breadcrumb backpageul">      	
                <li><a href="../home"><span class="underline-on-hover">Dashboard</span> </a></li>    
                 <li><a href="../banking/contrasummary"><span class="underline-on-hover">Contra Summary</span> </a></li>                       
                <li><label>New Contra</label></li>                                   
            </ul>             
    <!-- Muruganantham Modified on 16.02.2022 -->
            <div class="box-header menu-drop">
              <h1 style="font-size: 20px;" class="box-title"><%=title %></h1>
              <h1 style="font-size: 18px;cursor:pointer;" class="box-title pull-right" onclick="window.location.href='../banking/contrasummary'">
	...
	<form id="journalForm" class="form-horizontal" name="form1"  action="/track/JournalServlet?action=create"  method="post" enctype="multipart/form-data">			
		...
		<div class="form-group">
			...
			<div class="col-sm-4">
				<input type="text" class="form-control" id="journalno" name="journalno" value="<%=journalno %>" readonly>
		    </div>  
		</div>
		<div class="form-group">	
			<div class="col-sm-2">
		...
		<div class="form-group">
			...
			<div class="col-sm-4">
				<textarea id="notes" name="notes" class="form-control" maxlength="1000" placeholder="Max 1000 characters"></textarea>
			</div>
		</div>
		...
		<div class="form-group">
			...
			<div class="col-sm-4">				
				<input type="text" class="form-control" id="currency" name="currency" onchange="checkcurrency(this.value)" value="<%=basecurrency%>">
			...
			<tbody>
			  <tr>
				...
				<td class="journal-debit">
					<input name="debit" type="text" onchange="journaldebit(this)" onkeypress="return isNumberKey(event,this,4)" class="form-control text-right" autocomplete="off">
				</td>
				<td class="journal-credit">
					<input type="text" name="credit" onchange="journalcredit(this)" onkeypress="return isNumberKey(event,this,4)" class="form-control text-right" autocomplete="off">
				</td>				
...
{
	var credit=$(node).val();
	credit = checkamount(credit,node);
	...
	$("#btnBillOpen").click(function(){
		...
		var ValidNumber   = document.form1.ValidNumber.value;
		   if(ValidNumber != "") {alert("You have reached the limit of "+ValidNumber+" contra's you can create"); return false; }
		//RESVI END
