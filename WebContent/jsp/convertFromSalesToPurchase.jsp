...
<%
	String title = "Convert To Purchase Order";
	...
	String collectionTime=_dateUtils.getTimeHHmm();
	...
	String STATEPREFIX ="";
	String COUNTRYLOC ="";
	if(doheader.getSALES_LOCATION().length()>0){
		ArrayList sprefix =  masterUtil.getSalesLocationByState(doheader.getSALES_LOCATION(), plant, "");
	...
	//List PurchaseAttachList= purchaseAttachDAO.getpurchaseAttachByPONO(plant, pono);
	 ...
	 /* String taxtreatment = Doheader.getTAXTREATMENT();
...
// 		currency = doheader.getCURRENCYID();
	 String CURRENCYUSEQT="0",DISPLAY="",DISPLAYID="";
	 CURRENCYUSEQT = StrUtils.addZeroes(doheader.getCURRENCYUSEQT(), numberOfDecimal);
	 List curQryList=new ArrayList();
	 curQryList = currencyDAO.getCurrencyDetails(doheader.getCURRENCYID(),plant);
	 ...
	 FinProjectDAO finProjectDAO = new FinProjectDAO();
		...
		String projectname = "";
		if(doheader.getPROJECTID() > 0){
			finProject = finProjectDAO.getFinProjectById(plant, doheader.getPROJECTID());
		...
		String empName = new EmployeeDAO().getEmpname(plant, doheader.getEMPNO(), "");
...
<script src="../jsp/js/SoConvertToPurchase.js"></script>
<center>
	<h2>
	...
	<!-- Thanzith Modified on 28.02.2022 -->
	 <ul class="breadcrumb backpageul">    
                <li><a href="../home"><span class="underline-on-hover">Dashboard</span></a></li>	
                 ...
                 <li><a href="../salesorder/detail?dono=<%=doheader.getDONO()%>"><span class="underline-on-hover">Sales Order Detail</span></a></li>	
                <li><label>Convert To Purchase Order</label></li>                                   
            </ul>
        <!-- Thanzith Modified on 28.02.2022 --> 
		<div class="box-header menu-drop">
			...
			<h1 style="font-size: 18px; cursor: pointer;" class="box-title pull-right" onclick="window.location.href='../salesorder/detail?dono=<%=doheader.getDONO()%>'">
				<i class="glyphicon glyphicon-remove"></i>
			</h1>
		</div>

		<div class="container-fluid">
			<form class="form-horizontal" id="purchaseOrderForm" name="cpoform" autocomplete="off" action="../purchaseorder/convertToPurchase"  method="post"  enctype="multipart/form-data">
				...
				<INPUT type="Hidden" name="COLLECTION_TIME" value="<%=doheader.getCollectionTime()%>"/>
				...
				<input type = "hidden" name="TELNO" value="<%=doheader.getContactNum()%>">
				<input type = "hidden" name="EMAIL" value="">
				<input type = "hidden" name="ADD1" value="<%=doheader.getAddress()%>">
				<input type = "hidden" name="ADD2" value="<%=doheader.getAddress2()%>">
				<input type = "hidden" name="ADD3" value="<%=doheader.getAddress3()%>">
				<input type = "hidden" name="REMARK2" value="<%=doheader.getRemark2()%>">
				...
				<input type = "hidden" name="STATUS_ID" value="<%=doheader.getSTATUS_ID()%>">
			
				<input type = "hidden" name="currency" value="<%=doheader.getCURRENCYID()%>">
				<input type = "hidden" name="orderstatus" value="<%=doheader.getORDER_STATUS()%>">
				<input type = "hidden" name="DONO" value="<%=doheader.getDONO()%>">
				<input type = "hidden" name="PERSON_INCHARGE" value="<%=doheader.getPersonInCharge()%>">
				<input type = "hidden" name="precost"  value="<%=prepurchasecost%>">
				<input type = "hidden" name="COUNTRYCODE"  value="<%=COUNTRYCODE%>">
				<input type = "hidden" name="shiptaxstatus" value="<%=doheader.getISSHIPPINGTAX()%>">
				<input type = "hidden" name="odiscounttaxstatus" value="<%=doheader.getISDISCOUNTTAX()%>">
				<input type = "hidden" name="ptaxpercentage" value="<%=gst%>">
				...
				<%} %>
				<input type = "hidden" name="PROJECTID" value="<%=doheader.getPROJECTID()%>">
				<input type = "hidden" name="TRANSPORTID" value="<%=doheader.getTRANSPORTID()%>">
				...
				<div class="form-group">
					...
					<div class="col-sm-4">
						<input type="text" class="form-control" id="payment_type" name="payment_type" onchange="checkpaymenttype(this.value)"  value="<%=doheader.getPAYMENTTYPE()%>">
					...
					<div class="col-sm-6 no-padding">
       				...
       				<div class="col-sm-6 ac-box">
       				<input type="text" class="form-control" id="payment_terms" name="payment_terms" onchange="checkpaymentterms(this.value)" value="<%=doheader.getPAYMENT_TERMS()%>" placeholder="Select Payment Terms">
...
<!-- 				</div> -->
				...
				<div class="form-group">
						...
						<div class="col-sm-6 ac-box">
							<INPUT class="form-control datepicker" type="TEXT" size="30" MAXLENGTH="10" name="ORDDATE" value="<%=collectionDate%>" <%-- value="<%=doheader.getCollectionDate()%>" --%>/>
						</div>
					    </div>
						</div>
				<div class="form-group">
        			...
        			<div class="col-sm-4">
        				<INPUT class="form-control" type="TEXT" size="20" MAXLENGTH="20" name="JOB_NUM" value="<%=doheader.getDONO()%>">
       				</div>
				</div>
<!-- 				<div class="form-group"> -->
<!-- 					<label class="control-label col-form-label col-sm-2" for="Reference No">Order Date:</label> -->
<!--         			<div class="col-sm-4"> -->
<%--         				<INPUT class="form-control datepicker" type="TEXT" size="30" MAXLENGTH="10" name="ORDDATE" value="<%=doheader.getCollectionDate()%>"/> --%>
<!--        				</div> -->
<!-- 				</div> -->
				<div class="form-group">
					<label class="control-label col-form-label col-sm-2" for="Delivery Date">Delivery Period/Date:</label>
        			<div class="col-sm-3">
      					<INPUT type = "TEXT" size="30"  MAXLENGTH="20" id="DELDATE" name="DELDATE" <%-- value="<%=doheader.getDELDATE()%>" --%> value="" class="form-control"/>
    				</div>
    				<div class="form-inline">
       				<label class="control-label col-sm-1">
       				<input type = "checkbox" id = "DATEFORMAT" name = "DATEFORMAT" <%-- <%if(doheader.getDELIVERYDATEFORMAT() == 1){%>checked<%}%> --%> onClick = "headerReadable();"/><font size="2.9"><b>&nbsp;By Date</b></font></label>
    				</div>
				</div>
				<div class="form-group">
					<label class="control-label col-form-label col-sm-2">Order Type:</label>
					<div class="col-sm-4">
							<input type="text" class="form-control" id="ORDERTYPE" name="ORDERTYPE" onchange="checkordertype(this.value)" vlaue="">
							<span class="select-icon"
				...
				<div class="form-group">
					...
					<div class="col-sm-4">
						<input type="text" class="form-control" onchange="checkincoterms(this.value)" value="<%=doheader.getINCOTERMS()%>" id="INCOTERMS" name="INCOTERMS">
						<span class="select-icon"
				...
				<div class="form-group">
					<label class="control-label col-form-label col-sm-2" for="Purchase Location">Purchase Location:</label>
        			<div class="col-sm-4">
			        	<input type="text" class="ac-selected form-control typeahead" id="PURCHASE_LOC" name="PURCHASE_LOC" value="<%=doheader.getSALES_LOCATION()%>" placeholder="Select a Purchase Location">
						<span class="select-icon" onclick="$(this).parent().find('input[name=\'PURCHASE_LOC\']').focus()"><i class="glyphicon glyphicon-menu-down"></i></span>
					...
					<div class="col-sm-12">
						...
						<div class="dropdown-noborder">
							<select class="ac-box dropdown-noborder form-control"
								...
								<option <%if(doheader.getITEM_RATES() == 0){%>selected<%}%> value="0">Tax Exclusive</option>
								<option <%if(doheader.getITEM_RATES() == 1){%>selected<%}%> value="1">Tax Inclusive</option>
							</select>
						</div>
					</div>
				</div>
							...
							<div class="total-label">
								<div class="row">
									<div class="col-lg-4 col-sm-4 col-4">
										...
										<%if(doheader.getISORDERDISCOUNTTAX() == 1){%><span id="odtax">(Tax Inclusive)</span><%}else{%><span id="odtax">(Tax Exclusive)</span><%} %>
									</div>
									<div class="col-lg-1 col-sm-1 col-1">
									<input type="checkbox" class="form-check-input isodisctax" <%if(doheader.getISORDERDISCOUNTTAX() == 1){%>checked<%}%> name="isodisctax" Onclick="isodisctaxing(this)">
									</div>
									<div class=" col-lg-6 col-sm-6 col-6">
										<div class="input-group my-group">
											<input class="form-control text-right" type="text" value="<%=StrUtils.addZeroes(doheader.getORDERDISCOUNT(), "3")%>"
											...
											<select class="discountPicker form-control"
												...
												<option <%if(doheader.getORDERDISCOUNTTYPE().equalsIgnoreCase(DISPLAYID)){%>checked<%}%> value="<%=DISPLAYID%>"><%=DISPLAYID%></option>
												<option <%if(doheader.getORDERDISCOUNTTYPE().equalsIgnoreCase("%")){%>checked<%}%> value="%">%</option>
											</select>
										</div>
									</div>
								</div>
							...
							<div class="badge-editable total-label">
								<div class="row">
									<div class="col-lg-4 col-sm-4 col-4">
										...
										<%if(doheader.getISSHIPPINGTAX() == 1){%><span id="shtax">(Tax Inclusive)</span><%}else{%><span id="shtax">(Tax Exclusive)</span><%} %>
									</div>
									<div class="col-lg-1 col-sm-1 col-1">
									<input type="checkbox" class="form-check-input isshiptax" <%if(doheader.getISSHIPPINGTAX() == 1){%>checked<%}%> name="isshiptax" Onclick="isshiptaxing(this)">
									</div>
									<div class="col-lg-6 col-sm-6 col-6">
										<input class="form-control text-right ember-view" type="text"
											name="shippingcost" value="<%=StrUtils.addZeroes(doheader.getSHIPPINGCOST(), numberOfDecimal)%>" onchange="calculateTotal()" onkeypress="return isNumberKey(event,this,4)">
									</div>
								</div>
							</div>
						...
						<div class="total-row">
							<div class="badge-editable total-label">
								<div class="row">
									...
									<div class="col-lg-6 col-sm-6 col-6">
										<input class="form-control text-right ember-view" type="text" value="<%=StrUtils.addZeroes(doheader.getADJUSTMENT(), numberOfDecimal) %>"
					...
					<div class="col-sm-6 notes-sec">
						...
						<div>
							<textarea rows="2" name="REMARK1" class="ember-text-area form-control ember-view"
								placeholder="Max 100 characters"  maxlength="100"><%=doheader.getRemark1() %></textarea>
						</div>

						<p>Remark2</p>
						<div>
							<textarea rows="2" name="REMARK3" class="ember-text-area form-control ember-view"
								placeholder="Max 100 characters"  maxlength="100"><%=doheader.getRemark3() %></textarea>
						</div>
					</div>
				</div>
				<div class="row">
...
<div id="shipaddr" class="modal fade" role="dialog">
	...
	function newshipddr(){
		...
		if($("select[name=SHIP_STATE]").val() == "Select State"){
			...
			addr += $("select[name=SHIP_STATE]").val();
		}
		if($("select[name=SHIP_COUNTRY_CODE]").val() == "Select Country"){
			
		}else{
			addr += ' '+$("select[name=SHIP_COUNTRY_CODE]").val();
		}
		addr += ' '+$("input[name=SHIP_ZIP]").val()+'</p>';
	         ...
	         <!-- End -->
					...
					<!-- 	                Author Name:Resviya ,Date:20/07/21 -->
					  ...
					  <label class="control-label col-form-label col-sm-2 required">Supplier
							Currency</label>
					 <div class="col-sm-4">
					  <INPUT class="form-control" name="SUP_CURRENCY"  id="SUP_CURRENCY" type="TEXT" onchange="checksuppliercurrency(this.value)"  value="<%=Supcurrency%>"  size="50" MAXLENGTH=100>
					 </div>
					 </div>
			...
			for(int i=0 ; i<ccList.size();i++)
			 ...
			 %></SELECT>
					...
					<div class="form-group">  
      				...
      				<div class="col-sm-4">
     		 			<input id="PAYTERMS" name="PAYTERMS" class="form-control" type="text" onchange="checksupplierpaymenttype(this.value)" value=""  MAXLENGTH=100 placeholder="Select Payment Types">
...
<!-- 				<OPTION style="display:none;">Select Bank</OPTION> -->
	<INPUT name="BANKNAME" type = "TEXT" value="" id="BANKNAME" class="form-control" onchange="checksupplierbank(this.value)" placeholder="BANKNAME">
						...
						<div class="col-sm-4">
							...
							<div class="input-group">
								<INPUT class="form-control" name="CUST_CODE_C" id="CUST_CODE_C" onkeypress="return blockSpecialChar(event)"
									type="TEXT" value="" onchange="checkitemcus(this.value)" size="50"
...
<!-- 	                Author Name:Resviya ,Date:20/07/21 -->
					  ...
					  <label class="control-label col-form-label col-sm-2 required">Customer
							Currency</label>
					 <div class="col-sm-4">
					  <INPUT class="form-control" name="CUS_CURRENCY"  id="CUS_CURRENCY" onchange="checkcustomercurrency(this.value)" type="TEXT" value="<%=currency%>"  size="50" MAXLENGTH=100>
					 </div>
					 </div>
...
<!-- 							<li class="nav-item"><a href="#home_cust" class="nav-link"
		...
		<div class="form-group">
			        ...
			        <label class="control-label col-form-label col-sm-2">Payment Type</label>
      				<div class="col-sm-4">
	       				<input id="CUST_PAYTERMS" name="CUST_PAYTERMS" class="form-control" type="text" onchange="checkcustomerpaymenttype(this.value)" value=""
	       				MAXLENGTH=100 placeholder="Select Payment Types">
...
$("#PAYTERMS").typeahead({
	...
	{	  
	  ...
	  empty: [
		...
		menuElement.after( '<div class="accountAddBtn footer"  data-toggle="modal" data-target="#paymentModeModal" onclick="document.cpoform.custModal.value=\'cust\'"><a href="#"> + New Payment Type</a></div>');
		menuElement.next().width(menuElement.width());
		menuElement.next().css({ "top": top,"padding":"3px 20px" });
		if($(this).parent().find(".tt-menu").css('display') != "block")
			menuElement.next().hide();	  
...
$("#CUST_PAYTERMS").typeahead({
	...
	{	  
	  ...
	  empty: [
		...
		menuElement.after( '<div class="accountAddBtn footer"  data-toggle="modal" data-target="#paymentModeModal" onclick="document.cpoform.custModal.value=\'shipcust\'"><a href="#"> + New Payment Type</a></div>');
		menuElement.next().width(menuElement.width());
		menuElement.next().css({ "top": top,"padding":"3px 20px" });
		if($(this).parent().find(".tt-menu").css('display') != "block")
			menuElement.next().hide();	  
