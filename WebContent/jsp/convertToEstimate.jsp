...
<%
	String title = "Convert To Estimate";
	...
	//Validate no.of Customers -- Azees 15.11.2020
			...
			String Cuscurrency=plantMstDAO.getBaseCurrency(plant);
...
<script src="../jsp/js/ConvertToEstimate.js"></script>
<center>
	<h2>
	...
	<!-- Thanzith Modified on 28.02.2022 -->
	 <ul class="breadcrumb backpageul">    
                <li><a href="../home"><span class="underline-on-hover">Dashboard</span></a></li>	
                 <li><a href="../salesestimate/salescounter?PGaction=view&CUSTOMER=<%=esthdr.getCustName()%>&ITEM=<%=rtitem%>"><span class="underline-on-hover">Sales Counter</span></a></li>
                <li><label>Convert To Estimate</label></li>                                   
            </ul>
        <!-- Thanzith Modified on 28.02.2022 --> 
		<div class="box-header menu-drop">
			<h1 style="font-size: 20px;" class="box-title"><%=title%></h1>
			<h1 style="font-size: 18px; cursor: pointer;" class="box-title pull-right" onclick="window.location.href='../salesestimate/salescounter?PGaction=view&CUSTOMER=<%=esthdr.getCustName()%>&ITEM=<%=rtitem%>'">
		...
		<div class="container-fluid">
			...
			action="../salesestimate/converttoestimate" enctype="multipart/form-data" onsubmit="return validateSalesOrder()">
...
<!-- 						<div class="input-group"> -->
							...
							placeholder="Select a customer" name="CUST_NAME" onchange="checkcustomer(this.value)" value="<%=esthdr.getCustName()%>" maxlength="100"> 
...
<!-- 			   		 	</div> -->
				...
				<div class="form-group shipCustomer-section" id="shipbilladd">
					<!-- <label class="control-label col-form-label col-sm-2">Shiping Address:</label> -->
...
<!-- 						<div class="input-group"> -->
								<input type="text" class="ac-selected  form-control typeahead" 
									id="project" placeholder="Select a project" onchange="checkproject(this.value)"
									name="project" value=""> 
...
<!-- 						</div> -->
				...
				<div class="form-group">
					...
					<div class="col-sm-4">
						<div class="input-group">
							<input type="text" class="form-control" id="ESTNO" name="ESTNO" onchange="checkorderno(this.value)" onkeypress="return blockSpecialCharOrderNo(event)">
				...
				<div class="form-group">
					...
					<div class="col-sm-4">
						<div class="input-group">
							<input type="text" class="form-control" id="JOB_NUM" name="JOB_NUM" value="" 
				...
				<div class="form-group">
					...
					<div class="col-sm-4">
						<input type="text" class="form-control" id="EMP_NAME" name="EMP_NAME" onchange="checkemployeess(this.value)" value="">
						<span class="select-icon" 
				...
				<div class="form-group">
        			<label class="control-label col-form-label col-sm-2" for="Expiry Date">Expiry Date:</label>
       					 <div class="col-sm-4">
       					<div class="input-group">          
       				<INPUT class="form-control datepicker" name="EXPIREDATE" type="TEXT" readonly="readonly" size="30" MAXLENGTH=50>
      			</div>
    		</div>
    	</div>
		...
		<%if(ispuloc){ %>
               ...
               <!--  Ends  -->
				...
				<div class="form-group">
					...
					<div class="col-sm-4">
						<input type="text" class="form-control" id="Salestax" name="Salestax" onchange="checktax(this.value)" placeholder="Select a Tax">
						<span class="select-icon" 
					...
					<table class="table table-bordered line-item-table so-table">
						...
						for(estDet estdet: estdetDetails){
							...
							double dQty ="".equals(qty) ? 0.0d :  Double.parseDouble(qty);
				  			...
				  			double dPrice = estdet.getUNITPRICE() * Double.valueOf(CURRENCYUSEQT);
						...
						%>
							<tr>
								...
								<td>
									<input type="text" name="item" class="form-control" onchange="checkitems(this.value,this)" readonly
								...
								<td>
									<input type="text" name="UOM" class="form-control" onchange="checkprduom(this.value,this)" readonly
									placeholder="Select UOM" value="<%=estdet.getUNITMO()%>">
								</td>
								<td>
									<input type="text" name="QTY" class="form-control text-right" readonly
						...
						<div class="total-row">
							<div class="badge-editable total-label">
								<div class="row">
									...
									<div class="col-lg-6 col-sm-6 col-6">
										<input class="form-control text-right ember-view" type="text" value=""
				...
				<div class="row">
					<div class="col-sm-12 txn-buttons">
						<button id="btnSalesDraft" type="button" class="btn btn-default">Save as Draft</button>
						<button id="btnSalesOpen" type="button" class="btn btn-success">Save as Open</button>
						<button type="button" class="btn btn-default" onclick="window.location.href='../salesestimate/summary'">
							Cancel
						</button>
					</div>
							...
							<INPUT name="RCBNO" type="TEXT" class="form-control" value=""
								...
								<div class="form-group">
									<label class="control-label col-form-label col-sm-2">Payment
										Type</label>
									<div class="col-sm-4">
												<input id="CUST_PAYTERMS" name="CUST_PAYTERMS" class="form-control" type="text" onchange="checkcustomerpaymenttype(this.value)" value="" MAXLENGTH=100 placeholder="Select Payment Types">
...
function checkorderno(orderno){	
	var urlStr = "../salesestimate/CheckOrderno";
	$.ajax( {
		type : "GET",
		url : urlStr,
		async : true,
		data : {
			...
			success : function(data) {
				if (data.status == "100") {
					...
					document.getElementById("ESTNO").focus();
...
$(document).ready(function(){
	 ...
	 $('[data-toggle="tooltip"]').tooltip(); 
	                ...
	                <!-- Author Name:Resviya ,Date:15/07/21 , Description: For Currency Label-->
	                var  curr = document.form1.CURRENCYID.value;		    
			   
			    var basecurrency = '<%=Cuscurrency%>';   
...
<%@include file="../jsp/newTransportModeModal.jsp"%> <!-- thansith for add transport -->
