...
String Urlred="../expenses/apsummary";
if(cmd.equalsIgnoreCase("Edit"))
{
	title = "Edit Expenses";
	Urlred="../expenses/apdetail?TRANID="+sTranId;
}
...
<div class="container-fluid m-t-20">
	...
	<form id="createExpensesForm" class="form-horizontal" name="form1"  action="/track/ExpensesServlet?Submit=APSave"  method="post" enctype="multipart/form-data" onsubmit="return validateExpenses()">			
	...
	<div class="form-group">
			...
			<div class="col-sm-4">
				<input type="text" class="form-control" value="" id="exbillno" name="exbillno" onchange="checkorderno(this.value)" >
			</div>
...
<!-- 				</div> -->
	...
	<INPUT type="hidden" name="cmd" value="<%=cmd%>" />
		...
		<div class="col-sm-6 no-padding">
					    ...
					    <div class="form-group">
					<label class="control-label col-form-label col-sm-2">Outlet:</label>
					<div class="col-sm-4">
						<input type="text" class="form-control" id="OUTLET_NAME" name="OUTLET_NAME"  placeholder="Select Outlet">
				...
				<div class="form-group">
					<label class="control-label col-form-label col-sm-2">Terminal:</label>
					<div class="col-sm-4">
						<input type="text" class="form-control" id="TERMINALNAME" name="TERMINALNAME" placeholder="Select Terminal">
						<span class="select-icon" 
							onclick="$(this).parent().find('input[name=\'Expensetax\']').focus()">
								<i class="glyphicon glyphicon-menu-down"></i>
						</span>
