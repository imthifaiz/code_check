...
<%
	String title = "Create Category Promotion";
...
<div class="container-fluid m-t-20">
	...
	<!-- Muruganantham Modified on 16.02.2022 -->
             <ul class="breadcrumb backpageul">      	
                  ...
                  <li><label>Create Category Promotion</label></li>                                   
             </ul>   
     <!-- Muruganantham Modified on 16.02.2022 --> 
		...
		<div class="container-fluid">
			<form class="form-horizontal" id="categorypromotionForm" name="cpoform" action="../categorypromotion/save"  method="post"  enctype="multipart/form-data">
...
<!-- 				<div class="form-group">
		    ...
		    <div style="overflow-x:auto;">
             ...
             <tfoot align="right" style="display: none;">
				...
				<div class="row">
					<div class="col-sm-6">
						<a class="add-line" style="text-decoration: none; cursor: pointer;" onclick="addRowCategory()">
							+ Add another line
						</a>
					</div>
				</div>
				...
				<div class="row">
					<div class="col-sm-12 txn-buttons">
						<div class="dropup">
							<button id="btnCategoryOpen" type="button" class="btn btn-success">Save</button>
...
<input type="text" id="PageName" style="display: none;" value="CategoryPromotion">
