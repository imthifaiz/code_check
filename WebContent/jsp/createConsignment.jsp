...
<script src="../jsp/js/Consignment.js"></script>
<center>
	<h2>
...
<div class="container-fluid m-t-20">
	...
	<!-- Muruganantham Modified on 16.02.2022 -->
            <ul class="breadcrumb backpageul">      	
                ...
                <li><label>Create Consignment Order</label></li>                                   
            </ul>             
    <!-- Muruganantham Modified on 16.02.2022 -->
		<div class="box-header menu-drop">
			<h1 style="font-size: 20px;" class="box-title"><%=title%></h1>
			<h1 style="font-size: 18px; cursor: pointer;" class="box-title pull-right" onclick="window.location.href='../consignment/summary'">
		...
		<div class="container-fluid">
			...
			<input type="hidden" name="CURRENCYUSEQTOLD" value="1">
				...
				<div class="form-group customer-section">
					...
					<div class="col-sm-6 ac-box">
						<div class="input-group">
							...
							<!-- <INPUT class="ac-selected  form-control typeahead" id="vendname" name="vendname" type="TEXT" size="30" MAXLENGTH=100>
				...
				<div class="form-group">
					...
					<div class="col-sm-4">
						<div class="input-group">
							<input type="text" class="form-control" id="TONO" name="TONO" onchange="checkorderno(this.value)" onkeypress="return blockSpecialCharOrderNo(event)">
				...
				<div class="form-group">
					...
					<div class="col-sm-4">
							<input type="text" class="form-control" id="FROMWAREHOUSE" name="FROMWAREHOUSE" onchange="checkfromloc(this.value)">
				...
				<div class="form-group">
					...
					<div class="col-sm-4">
							<input type="text" class="form-control" id="TOWAREHOUSE" name="TOWAREHOUSE" onchange="checktoloc(this.value)">
						...
						<tbody>
							<tr>
								...
								<td class="item-discount">
									...
									<select name="item_discounttype" class="discountPicker form-control" id="item_discounttype"
										onchange="calculateAmount(this)">
										<%-- <option value="<%=currency%>">SGD</option>
										<option value="%">%</option> --%>
									</select>
									</div>
									</div>
...
$(document).ready(function(){
	  ...
	  $('[data-toggle="tooltip"]').tooltip(); 
	    ...
	    var  curr = document.form1.CURRENCYID.value;		    
		    var basecurrency = '<%=currency%>';  <%--    resvi --%>
