...
<div class="container-fluid m-t-20">
    ...
    <!-- Muruganantham Modified on 16.02.2022 -->
	 <div class="box-header menu-drop">
              ...
              <h1 style="font-size: 18px;cursor:pointer;" class="box-title pull-right" onclick="window.location.href='../creditnote/summary'">
...
<input type="text" id="PageName" style="display: none;" value="">
	...
	<div class="form-group customer-section">
			...
			<div class="col-sm-6 ac-box">
				...
				<input type="text" class="ac-selected  form-control typeahead" id="CUSTOMER" placeholder="Select a customer" name="CUSTOMER" onchange="checkcustomer(this.value)" value="<%=CUSTOMER%>" onclick="removetaxtrestl()">
...
<!-- 				<span class="btn-danger input-group-addon" onclick="javascript:popUpWin('customer_list_issue_summary.jsp?TYPE=ACCTCUST&CUST_NAME='+form1.CUSTOMER.value);"><span class="glyphicon glyphicon-search" aria-hidden="true"></span></span>	 -->
        ...
        <%
		   ...
		   ArrayList ccList1 =  _MasterUtiln.getTaxTreatmentList("",plant,"");
			...
			<input type="text" name="soreturnstatus" value="" hidden>
		...
		<div class="form-group">
			<label class="control-label col-form-label col-sm-2">SO Return Number</label>
			
			<div class="col-sm-4">				
				<input type="text" class="form-control soreturn" id="soreturn" name="soreturn">
				<span class="select-icon" onclick="$(this).parent().find('input[name=\'soreturn\']').focus()"><i class="glyphicon glyphicon-menu-down"></i></span>
			</div>
		...
		<div class="form-group invoice-section">
			...
			<div class="col-sm-4 ac-box">
			<input type="text" class="ac-selected  form-control typeahead" id="invoice" name="invoice">
		...
		<div class="form-group">
			...
			<div class="col-sm-4">
				<input type="text" class="form-control datepicker" id="creditnote_date" name="creditnote_date" value="<%=curDate%>">
       				...
       				<div class="col-sm-6 ac-box">
       				<input type="text" class=" ac-selected form-control" id="payment_terms"	name="payment_terms" placeholder="Select Payment Terms" onchange="checkpaymentterms(this.value)">
		...
		<div class="form-group employee-section">
			...
			<div class="col-sm-4 ac-box">
				<input type="text" class="ac-selected form-control typeahead" id="EMP_NAME" name="EMP_NAME" onchange="checkemployeess(this.value)" placeholder="Select a Employee" value="<%=empname%>">
		...
		<%if(ispuloc){ %>
				...
				<%}%>
		        <div class="form-group">
					<label class="control-label col-form-label col-sm-2 required required">Currency</label>
					<div class="col-sm-4 ac-box">
		...
		<div class="row" style="margin:0px;">
			...
			<tbody>
			  <tr>
				...
				<td class="bill-acc">
					<input type="text" name="account_name" class="form-control accountSearch" placeholder="Select Account"  value="Local sales - retail">
				</td>			
				...
				<!-- <td class="item-tax">
				<input type="hidden" name="tax_type">
					<input name="tax" type="text" class="form-control taxSearch" placeholder="Select a Tax" readonly>
				</td> -->
			...
			<div class="total-section col-sm-6">
				...
				<div class="total-row"> 
					<div class="total-label">
						<div class="row">
							...
							<div class=" col-lg-6 col-sm-6 col-6">
								<div class="input-group my-group"> 
									<input class="form-control text-right" type="text" id="discountblock" name="discount" value="<%=zeroval %>" onchange="calculateTotal()" onkeypress="return isNumberKey(event,this,4)">
									<!-- <span class="input-group-addon">%</span>	-->
									<select class="discountPicker form-control" id="discount_type" name="discount_type" id="discount_type" onchange="calculateTotal()">
										<%-- <option value="<%=curency%>"><%=curency%></option>
										<option value="%">%</option> --%>										
									</select>							
								</div>
				...
				<div class="total-row">
					<div class="badge-editable total-label">
						<div class="row">
							<div class="col-lg-5 col-sm-5 col-5"> 
								<input class="form-control text-right ember-view" type="text" name="adjustment_name" value="Adjustment"> 
							</div> 
							<div class="col-lg-6 col-sm-6 col-6"> 
								<input class="form-control text-right ember-view" type="text" name="adjustment" value="<%=zeroval %>" onchange="calculateTotal()" onkeypress="return isNumberKey(event,this,4)"> 
							</div>  
						</div>
					</div> 
...
<jsp:include page="newProductDepTypeModal.jsp" flush="true"></jsp:include><!-- thansith Add for paymentmode -->
<jsp:include page="newPaymentModeModal.jsp" flush="true"></jsp:include> <!-- thansith for add transport -->
