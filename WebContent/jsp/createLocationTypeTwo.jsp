...
<%
String title = "Create Location Type Two";
%>
 ...
 function onGenID(){
		$.ajax({
			...
			success: function(data) {
				$("#LOC_TYPE_ID2").val(data.LOCTYPETWO);
			},
			error: function(data) {
...
<div class="container-fluid m-t-20">
	 ...
	 <ul class="breadcrumb backpageul">    
                ...
                <li><label>Create Location Type Two</label></li>                                   
            </ul>
        <!-- Thanzith Modified on 23.02.2022 -->     
    ...
    <div class="form-group">
      ...
      <div class="col-sm-4">
      	<div class="input-group">    
    		<input name="LOC_TYPE_ID2" id="LOC_TYPE_ID2" type="TEXT" value="<%=locationTypeID%>" onkeypress="return blockSpecialChar(event)"
 ...
 <div class="form-group">
      ...
      <div class="col-sm-4">          
        <INPUT  class="form-control" name="lOC_TYPE_DESC2" type="TEXT" value="<%=locationTypeDesc%>"
