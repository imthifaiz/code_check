...
<title>Create Mobile Enquiry Order Details</title>
...
<table border="1" width="100%" cellspacing="0" cellpadding="0" 
	...
	<TR>
		<TH BGCOLOR="#000066" COLSPAN="11"><font color="white">Create Mobile Enquiry Order Details </font>
</table>
	...
	<tr>
		...
		<TABLE BORDER="0" CELLSPACING=1 WIDTH="100%" READONLY>
			<tr>
				...
				<td>
				<P><INPUT type="TEXT" size="14" MAXLENGTH="14" name="DONO"
					value="<%=pono%>" /> <!-- <a href="#" onClick="javascript:popUpWin('do_list_do.jsp?DONO='+form.DONO.value);">
			...
			<tr>
				...
				<td><INPUT type="TEXT" size="25" class="inactiveGry"
                    ...
                    <INPUT type = "hidden" size="20"   MAXLENGTH=20 name="DISPLAY" value="<%=currencyid%>">
			<tr>
		...
		<ol>
			<li>Enter Mobile Enquiry Order No</li>
...
<table border="0" width="100%" cellspacing="0" cellpadding="0">
	<tr>
		<td align="center"><input type="Button" value="Cancel"
			...
			type="Submit" value="Add Products" name="Submit">
