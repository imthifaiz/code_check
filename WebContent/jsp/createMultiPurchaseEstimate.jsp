...
<%
	String title = "Multiple Purchase Estimate Order";
	...
	int noordvalid =multiPoEstHdrDAO.Ordercount(plant,FROM_DATE,TO_DATE);
	...
	String collectionTime=DateUtils.getTimeHHmm();
	 ...
	 SupplierChecked = StrUtils.fString(request.getParameter("SupplierChecked"));
...
<script src="../jsp/js/MultipurchaseEstimate.js"></script>
<center>
	<h2>
...
<div class="container-fluid m-t-20">
	...
	<!-- Muruganantham Modified on 16.02.2022 -->
            <ol class="breadcrumb backpageul">      	
                ...
                <li><label>Multiple Purchase Estimate Order</label></li>                                   
            </ol>             
    <!-- Muruganantham Modified on 16.02.2022 -->
		<div class="box-header menu-drop">
			<h1 style="font-size: 20px;" class="box-title"><%=title%></h1>
			<h1 style="font-size: 18px; cursor: pointer;" class="box-title pull-right" onclick="window.location.href='../purchaseestimate/summary'">
				<i class="glyphicon glyphicon-remove"></i>
			</h1>
		</div>

		<div class="container-fluid">
			<form class="form-horizontal" id="purchaseOrderForm" name="cpoform" autocomplete="off" action="../purchaseestimate/save"  method="post"  enctype="multipart/form-data">
				...
				<input type = "hidden" name="shiptaxstatus" value="1">
				...
				<div class="form-group">
					...
					<div class="col-sm-4">
						<div class="input-group">
							<input type="text" class="form-control" id="POMULTIESTNO" name="POMULTIESTNO" MAXLENGTH="50" onchange="checkorderno(this.value)" onkeypress="return blockSpecialCharOrderNo(event)">
				...
				<div class="form-group">
					...
					<%} %>
					<div class="col-sm-4">
						<input type="text" class="form-control" id="EMP_NAME" name="EMP_NAME" value="<%=empname%>" onchange="checkemployeess(this.value)" >
				...
				<div class="form-group">
					<div class="col-sm-12">
						...
						<div class="dropdown-noborder">
					      ...
					      <INPUT Type=Checkbox  style="border:0;" name = "selectesp" id = "selectesp" value="selectesp" <%if(allChecked.equalsIgnoreCase("true")){%>checked <%}%> onclick="return checkAllExp(this.checked);">Apply 1st Line Expiry Date As All</label>
					      <label class="checkbox-inline">      
					      <INPUT Type=Checkbox  style="border:0;" name = "isProductAssignedSupplier" id = "isProductAssignedSupplier" value="isProductAssignedSupplier" <%if(SupplierChecked.equalsIgnoreCase("true")){%>checked <%}%> onclick="return checkItemSupplier(this.checked);">Show Product Assigned Supplier</label>
					</div>
				</div>
				<div class="row" style="margin: 0px;">
					<table class="table table-bordered line-item-table po-table">
						<thead>
							<tr>
								<th colspan=2 style="width:14%">Product</th>
								<th  style="width:10%">Supplier </th>
								<th  colspan=2 style="width:10%">Currency</th>
								<th  style="width:8%">UOM</th>
								<th style="width:8%">Quantity</th>
								<th colspan=2  style="width:6%">Unit Cost</th>
								<!-- <th style="width:5%">Discount</th> -->
								<!-- <th class="bill-desc" style="width:10%">Tax</th> -->
								<th class="bill-desc" style="width:10%">Amount</th>
						...
						<tbody>
							<tr>
								<td class="item-img text-center" style="width:5%">
									...
									<input name="nTAXTREATMENT" value="" type="hidden">
								...
								<td class="bill-item">
									<input type="text" name="item" class="form-control itemSearch" onchange="checkitems(this.value,this)" style="width:87%" placeholder="Type or click to select an item.">
								...
								<td class ="bill-item">
								<INPUT class="form-control vendsearch"  name="vendname" id="vendname" onchange="checksupplier(this.value,this)" type="TEXT" style="width:90%"  placeholder="Supplier">
    		 				    </td>
								...
								<td class="table-icon" style="width:3%">
								...
								<input type="text" name="EXPIREDATE" id ="EXPIREDATE" class="form-control datepicker" READONLY>									
								</td>
								<td class="table-icon">
