...
<div class="container-fluid m-t-20">
    ...
    <!-- Muruganantham Modified on 16.02.2022 --> 
		<div class="box-header menu-drop">
              ...
              <h1 style="font-size: 18px;cursor:pointer;" class="box-title pull-right" onClick="window.location.href='../debit/summary'">
	...
	<form id="createBillForm" class="form-horizontal" name="form" autocomplete="off" action="/track/SupplierCreditServlet?Submit=Save"  method="post" enctype="multipart/form-data" onsubmit="return validateBill()">
	...
	<INPUT type="hidden" name="billhdrid" value="" />
		...
		<div class="form-group vendor-section">
			...
			<div class="col-sm-6 ac-box">
				<!-- <div class="input-group"> --> 
					<input type="text" class="ac-selected  form-control typeahead" id="vendname" placeholder="Select a supplier" name="vendname" onchange="checksupplier(this.value)" value="<%=vendName%>" onclick="removetaxtrestl()">
...
<SELECT class="form-control taxdropdown" data-toggle="dropdown" style="border: none;" onchange="OnChkTaxChange(this.value)" data-placement="right" id="nTAXTREATMENT" name="nTAXTREATMENT" value="" style="width: 100%">
		...
		<div class="form-group shipCustomer-section">
					...
					<div class="col-sm-6 ac-box">
								<input type="text" placeholder="Select a shipping address"  class="form-control typeahead" id="SHIPPINGCUSTOMER" name="SHIPPINGCUSTOMER" onchange="checkcustomer(this.value)" value=""> 
				...
				<div class="form-group shipCustomer-section">
					...
					<div class="col-sm-6 ac-box">
								<input type="text" class="form-control typeahead" 
									id="project" placeholder="Select a project" name="project" onchange="checkproject(this.value)" value="">
		...
		<div class="form-group">
			<label class="control-label col-form-label col-sm-2">PO Return Number</label>
			
			<div class="col-sm-4">				
				<input type="text" class="form-control poreturn" id="poreturn" name="poreturn">
				<span class="select-icon" onclick="$(this).parent().find('input[name=\'poreturn\']').focus()"><i class="glyphicon glyphicon-menu-down"></i></span>
			</div>
		...
		<div class="form-group">
			...
			<div class="col-sm-4">				
				<input type="text" class="form-control billno" id="billno" name="billno">
				<span class="select-icon" onclick="$(this).parent().find('input[name=\'billno\']').focus()"><i class="glyphicon glyphicon-menu-down"></i></span>
			</div>
		...
		<div class="form-group">
			...
			<div class="col-sm-4">				
				<input type="text" class="form-control grnno" id="grnno" name="grnno" readonly>
		...
		<div class="form-group">
			...
			<div class="col-sm-4">
				<div class="input-group">   
		        		<input class="form-control" name="creditnote" id="creditnote" type="text" onchange="checkorderno(this.value)" onkeypress="return blockSpecialCharOrderNo(event)"
		...
		<div class="form-group">
			...
			<div class="col-sm-4 ac-box">
				<input type="text" class="ac-selected form-control typeahead" id="SALES_LOC" name="SALES_LOC" placeholder="Select a Purchase Location" value="<%=plantstate%>" >
...
<!-- 				  <input type="hidden" name="lnno" value="1"> -->
				...
				<td class="bill-item-dbt">
					<input type="text" name="item" style="width:95%" class="form-control itemSearch" onchange="checkitems(this.value,this)" placeholder="Type or click to select an item." onchange="calculateAmount(this)">
				...
				<td class="bill-acc">
					<input type="text" name="account_name" class="form-control accountSearch" placeholder="Select Account" value="Inventory Asset">
				</td>
				...
				<div class="total-row"> 
					<div class="total-label">
						<div class="row">
							...
							<div class=" col-lg-6 col-sm-6 col-6">
								<div class="input-group my-group"> 
									<input class="form-control text-right" type="text" name="discount" id="discountblock" value="<%=zeroval %>" onchange="calculateTotal()" onkeypress="return isNumberKey(event,this,4)">
									<!-- <span class="input-group-addon">%</span>	-->
									<select class="discountPicker form-control discount_type" name="discount_type" id="discount_type" onchange="calculateTotal()">
										<%-- <option value="<%=curency%>"><%=curency%></option>
										<option value="%">%</option> --%>										
									</select>							
								</div>
				...
				<div class="total-row" Style="display: none;">
					<div class="badge-editable total-label">
						<div class="row">
							...
							<div class="col-lg-6 col-sm-6 col-6"> 
								<input class="form-control text-right ember-view" type="text" name="shippingcost" onkeypress="return isNumberKey(event,this,4)" value="<%=zeroval %>"> 
							</div>  
						</div>
					</div>
					<div class="total-amount" id="shipping" > <%=zeroval %></div>
				</div>				
				<div class="total-row">
					<div class="badge-editable total-label">
						<div class="row">
							<div class="col-lg-5 col-sm-5 col-5"> 
								<input type="text" class="form-control" name="adjustmentLabel" value="Adjustment">
							</div> 
							<div class="col-lg-6 col-sm-6 col-6"> 
								<input class="form-control text-right ember-view" type="text" value="<%=zeroval%>" name="adjustment" onchange="calculateTotal()" onkeypress="return isNumberKey(event,this,4)"> 
							</div>  
						</div>
					</div> 
...
<!-- 							<li class="nav-item"><a href="#home_cust" class="nav-link"
		...
		<div class="form-group">
			        ...
			        <label class="control-label col-form-label col-sm-2">Payment Mode</label>
      				<div class="col-sm-4">
	       				<input id="CUST_PAYTERMS" name="CUST_PAYTERMS" class="form-control" type="text" MAXLENGTH=100 onchange="checkcustomerpaymenttype(this.value)" value="" placeholder="Select Payment Mode">
...
else if(50<rcbn)
{
   ...
   /* document.form1.action  = "/track/CreateSupplierServlet?action=ADD&reurl=createSupplierCredit";
   document.form1.submit(); */
   
   var datasend = $('#formsupplierid').serialize();
   
   var urlStr = "/track/CreateSupplierServlet?action=JADD&reurl=createSupplierCredit";
	$.ajax( {
	type : "POST",
	url : urlStr,
	async : true,
	...
	success : function(data) {
		...
		if(document.form.custModal.value == "cust"){ /*  Author: Azees  Create date: June 26,2021  Description: Supplier Save Changes */
...
function onIDGen()
{
 /* document.form1.action  = "/track/CreateSupplierServlet?action=Auto-ID&reurl=createSupplierCredit";
   document.form1.submit(); */ 
