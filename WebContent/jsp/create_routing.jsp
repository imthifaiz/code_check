...
<title>Create Routing Master</title>
...
String res        = "",action     =   "",pitem="",operationseq="",loc="",remarks="",fieldDesc="";
...
remarks  = strUtils.fString(request.getParameter("REMARK"));
...
<FORM name="form1" method="post" action="/track/RoutingServlet?" >
  ...
  <table border="1" width="100%" cellspacing="0" cellpadding="0" align="center" bgcolor="#dddddd">
      <TR><TH BGCOLOR="#000066" COLSPAN="11"><font color="white">Create Routing Master</font>
  </table>
    ...
    <TR>
    	<td></td>
         <th  ALIGN="left">Remarks:</th>
				<td><INPUT name="REMARK" type="TEXT" id="REMARK" value="<%=remarks%>" size="20" MAXLENGTH=50
						onkeypress="if((event.keyCode=='13')) {onAdd();}">
...
function onAdd() {
	...
	var oprseqnum = document.form1.OPR_SEQNUM.value;
	//var locId = document.getElementById("LOC_0").value;
	var remarks = document.form1.REMARK.value;
    ...
    $.ajax({type: "POST",url: urlStr, data: {ITEM:product,OPRSEQNUM:oprseqnum,REMARKS:remarks,action: "ADD_ROUTING",PLANT:"<%=plant%>"},dataType: "json", success: callback });
   
    document.form1.OPR_SEQNUM.value = "";
    document.form1.OPR_SEQ_DESC.value = "";
    //document.form1.LOC_0.value = "";
