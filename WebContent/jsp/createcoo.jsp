...
<%
String title = "Create COO Master";
%>
...
<div class="container-fluid m-t-20">
	 ...
	 <ul class="breadcrumb backpageul">    
                ...
                <li><a href="../coo/edit"><span class="underline-on-hover">Edit COO</span></a></li>                       
                <li><label>Create COO Master</label></li>                                   
            </ul>
        <!-- Thanzith Modified on 23.02.2022 -->      
            <div class="box-header menu-drop">
              ...
              <h1 style="font-size: 18px; cursor: pointer;"
				...
				onclick="window.location.href='../coo/edit'">
...
<label class="control-label col-sm-2" for="COO">COO</label>
<INPUT type="hidden" name="RFLAG" value="1">
<div class="col-sm-4">
<input name="COO" id="COO" type="TEXT" value="<%=coo%>" onkeypress="return blockSpecialChar(event)"
...
<button type="button" class="btn btn-success" value="Add COO" onClick="onAdd()">Add To COO</button>&nbsp;&nbsp;
...
function onAdd() {
    ...
    $.ajax({type: "POST",url: urlStr, data: {COO:coo,action: "ADD_COO",PLANT:"<%=plant%>"},dataType: "json", success: callback });
    document.form.COO.value = "";
...
function onGo(index) {
    ...
    // Call the method of JQuery Ajax provided
    $.ajax({type: "POST",url: urlStr, data: {PLANT:"<%=plant%>",action: "VIEW_COO_DETAILS",PLANT:"<%=plant%>"},dataType: "json", success: callback });
...
function callback(data){
    ...
    document.getElementById('VIEW_RESULT_HERE').innerHTML = outPutdata;
     ...
     if(errorMsg=="COO Added Successfully")
  	{
  	document.form.action  = "../coo/edit?result=COO Added Successfully";
