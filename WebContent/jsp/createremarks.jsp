...
<%
String title = "Create Remarks Master";
%>
...
if(fieldDesc.equals("Remarks Added Successfully")){
	response.sendRedirect("../remarks/edit");
}
%>
<div class="container-fluid m-t-20">
	 ...
	 <ul class="breadcrumb backpageul">    
                ...
                <li><a href="../remarks/edit"><span class="underline-on-hover">Edit Remarks Details</span></a></li>                       
                <li><label>Create Remarks Master</label></li>                                   
            </ul>
        <!-- Thanzith Modified on 23.02.2022 -->     
            <div class="box-header menu-drop">
              ...
              <h1 style="font-size: 18px; cursor: pointer;"
				...
				onclick="window.location.href='../remarks/edit'">
...
<div class="col-sm-8">
<input name="REMARKS" id="REMARKS" type="TEXT" value="<%=remarks%>" placeholder="Max 200 Characters"
...
<button type="button" class="btn btn-success" value="Add To Remarks" onClick="onAdd()">Add To Remarks</button>&nbsp;&nbsp;
...
function onAdd() {
    ...
    $.ajax({type: "POST",url: urlStr, data: {REMARKS:remarks,action: "ADD_REMARKS",PLANT:"<%=plant%>"},dataType: "json", success: callback });
    document.form.REMARKS.value = "";
...
function onGo(index) {
    ...
    // Call the method of JQuery Ajax provided
    $.ajax({type: "POST",url: urlStr, data: {PLANT:"<%=plant%>",action: "VIEW_REMARKS_DETAILS",PLANT:"<%=plant%>"},dataType: "json", success: callback });
...
function callback(data){
    ...
    document.getElementById('VIEW_RESULT_HERE').innerHTML = outPutdata;
	 ...
	 if(errorMsg=="Remarks Added Successfully")
 	{
 	document.form.action  = "../remarks/edit?result=Remarks Added Successfully";
