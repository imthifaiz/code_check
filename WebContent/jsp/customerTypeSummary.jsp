...
<!-- END -->
<%
String title = "Customer Group Summary";
%>
...
var subWin = null;
  function popWin(URL) {
    subWin = window.open(URL, 'CustomerTypeSummary', 'toolbar=0,scrollbars=yes,location=0,statusbar=0,menubar=0,dependant=1,resizable=1,width=800,height=400,left = 200,top = 184');
  }
/*  function onGo(){
 ...
 function onView(){
	   document.form1.action  = "../jsp/customerTypeSummary.jsp?action=VIEW";
	   document.form1.submit();
	}
</script>
...
if(PGaction.equalsIgnoreCase("View")){
 try{
      ...
      if(strUtils.fString(PLANT).length() > 0)  ht.put("PLANT",PLANT);
			...
			if(fieldDesc.equalsIgnoreCase("Customer Group Deleted Successfully")){
				QryList =  _CustUtil.getCustTypeList(CUSTOMERTYPEID="",PLANT,"");
			}
			else{
         QryList =  _CustUtil.getCustTypeList(CUSTOMERTYPEID,PLANT,"");
			}
...
<div class="container-fluid m-t-20">
	 ...
	 <ul class="breadcrumb backpageul">    
                ...
                <li><label>Customer Group Summary</label></li>                                   
            </ul>
        <!-- Thanzith Modified on 23.02.2022 -->     
            <div class="box-header menu-drop">
              ...
              <button type="button" class="btn btn-default" onclick="window.location.href='../customertype/new'" style="background-color: rgb(214, 72, 48);color: rgb(255, 255, 255);" >+ New</button>&nbsp;
             <%} %>
              </div>
              <h1
...
<FORM class="form-horizontal" name="form1" method="post" action="customerTypeSummary.jsp">
...
<label class="control-label col-form-label col-sm-2" for="Customer Group Desc or ID">Customer Group Id/Desc</label>
<div class="col-sm-4" >
<div class="input-group">
<INPUT name="CUSTOMER_TYPE_ID"  id="CUSTOMER_TYPE_ID" type = "TEXT" value="<%=CUSTOMERTYPEID%>" size="20"  MAXLENGTH=100 class="form-control">
...
<!-- <span class="btn-danger input-group-addon" onClick="javascript:popWin('../jsp/CustomerTypeList.jsp?CUSTOMER_TYPE_ID='+form1.CUSTOMER_TYPE_ID.value);">
...
<!-- <table id="table" class="table table-bordered table-hover dataTable no-footer "
   role="grid" aria-describedby="tableInventorySummary_info" >  --> <!-- imtiziaf block -->
   
   <thead> <!-- imtiziaf additional line removed-->
          <tr>  
            <th >S/N</th>  
       ...
       %>
          ...
          <TR>
           ...
           <TD align="center">&nbsp;&nbsp; &nbsp;&nbsp;&nbsp;<%=strUtils.fString((String)lineArr.get("CUSTOMER_TYPE_ID"))%></TD>
    	     <TD align="center">&nbsp;&nbsp; &nbsp;&nbsp;&nbsp; <%=strUtils.fString((String)lineArr.get("CUSTOMER_TYPE_DESC"))%></TD>
              <TD align="center">&nbsp;&nbsp; &nbsp;&nbsp;&nbsp; <%=strUtils.fString((String)lineArr.get("ISACTIVE"))%></TD>
              <%if(displaySummaryEdit){ %>
              <TD align="center" class="textbold">&nbsp; <a href ="maintCustomerType.jsp?CUSTOMER_TYPE_ID=<%=(String)lineArr.get("CUSTOMER_TYPE_ID")%>&CUSTOMER_TYPE_DESC=<%=(String)lineArr.get("CUSTOMER_TYPE_DESC")%>&ACTIVE=<%=(String)lineArr.get("ISACTIVE")%>"%>
...
<script LANGUAGE="JavaScript">
		...
		var tabletype;
		var CUSTOMERTYPE, groupRowColSpan = 6;
		
		function getParameters(){
			return {
				"CUSTOMERTYPE":CUSTOMERTYPE,
				"PLANT":plant,
				"action":"GET_CUSTOMERTYPE_FOR_SUMMARY"
			}
		}
		function onGo(){
			    	...
			    	tabletype = $('#table').DataTable({
						...
						"ajax": {
					        ...
					        "dataSrc": function(data){
						        	...
						        	if(typeof data.CUSTOMERTYPELIST[0].CUSTOMER_TYPE_ID === 'undefined'){
						        		return [];
						        	}else {				        		
						        			for(var dataIndex = 0; dataIndex < data.CUSTOMERTYPELIST.length; dataIndex ++){
						        				var lineno = data.CUSTOMERTYPELIST[dataIndex].CUSTOMER_TYPE_ID;
						        				var sno=dataIndex+1;
						        				data.CUSTOMERTYPELIST[dataIndex]['SNO'] = sno;
												<%if(displaySummaryEdit){ %>
						        				data.CUSTOMERTYPELIST[dataIndex]['EDIT'] = '<a href="../customertype/edit?CUSTOMER_TYPE_ID=' +lineno+'&CUSTOMER_TYPE_DESC=' +data.CUSTOMERTYPELIST[dataIndex].CUSTOMER_TYPE_DESC+'&ACTIVE=' +data.CUSTOMERTYPELIST[dataIndex].ISACTIVE+'"><i class="fa fa-pencil-square-o"></i></a>';
												<%}else{ %>
				        ...
				        "columns": [
				        	...
				        	{"data": 'CUSTOMER_TYPE_ID', "orderable": true},
				        	{"data": 'CUSTOMER_TYPE_DESC', "orderable": true},
