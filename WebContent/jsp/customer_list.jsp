...
mLogger.setLoggerConstans(loggerDetailsHasMap);
    ...
    String sBGColor = "";
   try{
    ArrayList arrCust = custUtils.getCustomerListStartsWithName(sCustName,plant);
    for(int i =0; i<arrCust.size(); i++) {
        sBGColor = ((i == 0) || (i % 2 == 0)) ? "#FFFFFF" : "#dddddd";
        Map arrCustLine = (Map)arrCust.get(i);
        String sCustCode     = (String)arrCustLine.get("CUSTNO");
        String sCustName1     = strUtils.replaceCharacters2Send((String)arrCustLine.get("CNAME"));
        String sCustNameLast    = strUtils.removeQuotes((String)arrCustLine.get("LNAME"));
