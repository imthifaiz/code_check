...
function onNew(){
   ...
   document.form.action  = "customer_list_order.jsp?action=NEW";
...
function onAdd(){
   ...
   {
     alert(" Please Enter Payment Days Input In Number");
   ...
   document.form.action  = "customer_list_order.jsp?action=ADD";
   document.form.submit();
}

function onIDGen()
{
 document.form.action  = "customer_list_order.jsp?action=Auto-ID";
 document.form.submit(); 
}
...
String CREDITLIMIT="",ISCREDITLIMIT="";
...
if(action.equalsIgnoreCase("NEW")){
      ...
      sRcbno="";
      customertypeid="";
      CREDITLIMIT="";CREDITLIMITVALUE=0;ISCREDITLIMIT="";
      CUSTOMEREMAIL="";WEBSITE="";FACEBOOK="";TWITTER="";LINKEDIN="";SKYPE="";OPENINGBALANCE="";WORKPHONE="";
      sIBAN="";sBANKNAME="";sBANKROUTINGCODE="";sBRANCH="";CREDITLIMITVALUE=0;OPENINGBALANCEVALUE=0;
}
...
//2. >> Add
  ...
  if(!custUtil.isExistCustomer(sCustCode,plant) && !custUtil.isExistCustomerName(sCustName, plant)) // if the Customer exists already
    {
	  ISCREDITLIMIT = ((ISCREDITLIMIT != null) ? "1": "0").trim();
...
<div class="box-body">
  ...
  <div class="form-group">
      <label class="control-label col-sm-3 required" for="Create Customer ID">Customer ID:</label>
      <div class="col-sm-3">
      ...
      <label class="control-label col-sm-2 required" for="Customer Name">Customer Name:</label>
      <div class="col-sm-3">
                
        <INPUT  class="form-control" name="CUST_NAME1" type="TEXT" value="<%=sCustName%>" size="50"
    ...
    <div class="form-group">
     <label class="control-label col-sm-3" for="Tax Type">Customer Type:</label>
      <div class="col-sm-3">           	
  	 <div class="input-group">    
    		<input name="CUSTOMER_TYPE_ID" type="TEXT" value="<%=customertypeid%>" size="50"
    ...
    <div class="form-inline">
      <label class="control-label col-sm-2" for="Telephone No">Customer Phone:</label>
      <div class="col-sm-3">
    ...
    <div class="form-group">
      <label class="control-label col-sm-3" for="Fax">Customer Fax:</label>
      <div class="col-sm-3">
       ...
       <div class="form-inline">
      <label class="control-label col-sm-2" for="Customer Email">Customer Email:</label>
      <div class="col-sm-3"> 
   ...
   <div class="bs-example">
     ...
     <div class="form-group">
      ...
      <div class="col-sm-3">  
      <INPUT name="CREDITLIMIT" type="TEXT" value="<%=new java.math.BigDecimal(CREDITLIMIT).toPlainString()%>" style="width:100%" size="50" MAXLENGTH=50  class="form-control" onkeypress="return isNumberKey(event,this,4)">
       <label class="checkbox-inline">      
     <input type = "checkbox" name = "ISCREDITLIMIT" value = "ISCREDITLIMIT" <%if(ISCREDITLIMIT.equals("Y")) {%>checked <%}%> />Apply Credit Limit</label>
      </div>            
      </div>
      </div>
      ...
      <div class="form-group">
      <label class="control-label col-sm-3" for="Facebook">Facebook Id</label>       
      <div class="col-sm-3">
      <INPUT name="FACEBOOK" type="TEXT" value="<%=FACEBOOK%>" size="50" MAXLENGTH=50 class="form-control">        
       
      </div>
   <div class="form-inline">
   <label class="control-label col-sm-2" for="Twitter Id">Twitter Id:</label>    
	<div class="col-sm-3">
	<INPUT name="TWITTER" type="TEXT" class="form-control" value="<%=TWITTER%>" style="width:100%" size="50" MAXLENGTH="100" >        
      </div>
   </div>
   </div>
   
   <div class="form-group">
   <label class="control-label col-sm-3" for="LinkedIn Id">LinkedIn Id:</label>       
      <div class="col-sm-3">
      <INPUT name="LINKEDIN" type="TEXT" class="form-control"	value="<%=LINKEDIN%>" size="50" style="width:100%" MAXLENGTH="30">
      </div>
      <div class="form-inline">
      <label class="control-label col-sm-2" for="Skype Id">Skype Id:</label>
      <div class="col-sm-3">             
       <INPUT name="SKYPE" type="TEXT" class="form-control" value="<%=SKYPE%>" style="width:100%" size="50" MAXLENGTH="100" >
      </div>
      </div>
      </div>
   ...
   <div class="form-inline">
    ...
    <label class="control-label col-sm-3" for="Postal Code">Postal Code:</label>
      ...
      <div class="form-group">
      <div class="col-sm-3">
      <a href="#" id="Show" style="font-size: 15px; color: #0059b3; text-decoration:none;">Show Create Customer</a>
      <a href="#" id="Hide" style="font-size: 15px; color: #0059b3; text-decoration:none; display:none;">Hide Create Customer</a>
      </div>
       	  </div>
...
<%
	...
	if(sCustName.equals("CASH"))
    	sCustName="";
    session=request.getSession();
    plant = (String)session.getAttribute("PLANT");
    String sBGColor = "",sCustomerStatusDesc="",sCustomerTypeDesc="";
    String autoSuggestion = strUtils.fString(request.getParameter("AUTO_SUGG"));
   try{
    ...
    for(int i =0; i<arrCust.size(); i++) {
        ...
        sCustCode     = (String)arrCustLine.get(0);
        ...
        sContactName     = strUtils.replaceCharacters2Send((String)arrCustLine.get(3));
        sTelNo     = strUtils.removeQuotes((String)arrCustLine.get(4));
        sEmail     = strUtils.removeQuotes((String)arrCustLine.get(5));
        ...
        sCountry    = strUtils.replaceCharacters2Send((String)arrCustLine.get(10));
        sRemarks     = strUtils.replaceCharacters2Send((String)arrCustLine.get(11));
        sZip     = strUtils.removeQuotes((String)arrCustLine.get(12));
	    String sCustomerStatusId     = strUtils.removeQuotes((String)arrCustLine.get(14));
        String sCustomerTypeId     = strUtils.removeQuotes((String)arrCustLine.get(15));
        String paymenttype=strUtils.removeQuotes((String)arrCustLine.get(16));
        sTAXTREATMENT=strUtils.removeQuotes((String)arrCustLine.get(17));
           
		if(sCustomerStatusId == null || sCustomerStatusId.equals("")||sCustomerStatusId.equals("NOCUSTOMERSTATUS"))
		...
		{
			sCustomerStatusDesc = customerBeanDAO.getCustomerStatusDesc(plant,sCustomerStatusId);
		}
		
		if(sCustomerTypeId == null || sCustomerTypeId.equals("")|| sCustomerTypeId.equals("NOCUSTOMERTYPE"))
		{
			sCustomerTypeDesc="";
		}
		else
		{
			sCustomerTypeDesc = customerBeanDAO.getCustomerTypeDesc(plant,sCustomerTypeId);
		}
		System.out.println("sCustomerStatusDesc"+sCustomerStatusDesc);
		System.out.println("sCustomerTypeDesc"+sCustomerTypeDesc);
		if(autoSuggestion.equalsIgnoreCase("") ){
%>
...
<TR>
		<td class="main2" style="font-weight: bold" align="left">&nbsp;<a href="#"
			onClick="window.opener.form.CUST_CODE.disabled = true;
                     ...
                     window.opener.form.CUSTOMERSTATUSDESC.value='<%=sCustomerStatusDesc%>';
                     window.opener.form.CUSTOMERTYPEDESC.value='<%=sCustomerTypeDesc%>';   
			...
			%>
		   	<TR>
				<td class="main2" style="font-weight: bold" align="left">&nbsp;
					<a href="#" onClick="window.opener.form1.CUST_CODE.value='<%=sCustCode%>';
					window.opener.form1.CUSTOMER.value='<%=strUtils.insertEscp(sCustName1)%>';
