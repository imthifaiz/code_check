...
<%
String title = "Edit Your Company Profile";
%>
...
// 	 document.form1.ACTUALEXPIRYDATE.value= ""; 
// 	 document.form1.NOOFCATALOGS.value= ""; 
// 	 document.form1.NOOFSIGNATURES.value= ""; 
//      document.form1.BaseCurrency.value= ""; 
//      document.form1.NOOFSUPPLIER.value= ""; 
//      document.form1.NOOFCUSTOMER.value= ""; 
//      document.form1.NOOFEMPLOYEE.value= ""; 
//      document.form1.NOOFINVENTORY.value= ""; 
// 	 document.form1.NOOFLOCATION.value= ""; 
// 	 document.form1.NOOFORDER.value= ""; 
// 	 document.form1.NOOFPAYMENT.value= ""; 
// 	 document.form1.NOOFJOURNAL.value= ""; 
// 	 document.form1.NOOFCONTRA.value= ""; 



	 document.form1.PLNTDESC.value= ""; 
	 document.form1.PEPPOL_UKEY.value= ""; 
	 document.form1.companyregnumber.value= ""; 
	 document.form1.decimal_precision.value= ""; 
	 document.form1.CompanyIndustry.value= ""; 
	 document.form1.RCBNO.value= ""; 
	 document.form1.ADD1.value= ""; 
	 document.form1.DESGINATION.value= ""; 
	 document.form1.HPNO.value= ""; 
	 document.form1.EMAIL.value= ""; 
	 document.form1.ADD2.value= ""; 
	 document.form1.ADD3.value= ""; 
	 document.form1.ADD4.value= ""; 
	 ...
	 document.form1.PEPPOL_ID.value= ""; 
	 ...
	 document.form1.SHOW_POS_SUMMARY.checked = false;
	 document.form1.ISAUTO_CONVERT_ESTPO.checked = false;
	 document.form1.ISPRODUCTMAXQTY.checked = false;//thanzith
	 document.form1.ISAUTO_CONVERT_RECEIPTBILL.checked = false;//Thanzith
	 document.form1.SETCURRENTDATE_GOODSRECEIPT.checked = false;//Thanzith
	 document.form1.SETCURRENTDATE_PICKANDISSUE.checked = false;//Thanzith
	 document.form1.ISPRICE_UPDATEONLY_IN_OWNOUTLET.checked = false;//Thanzith
	 document.form1.SHOWITEM_AVGCOST.checked = false;//Thanzith
	 document.form1.ISPEPPOL.checked = false;//Thanzith
	 document.form1.ISAUTO_MINMAX_MULTIESTPO.checked = false;//Thanzith
	 document.form1.ISAUTO_CONVERT_SOINVOICE.checked = false;//RESVI
	 document.form1.ENABLE_RESERVEQTY.checked = false;//Thanzith
	 document.form1.ISSALESTOPURCHASE.checked = false;//Thanzith
	 document.form1.ISAUTO_CONVERT_ISSUETOINVOICE.checked = false;//Thanzith
	 document.form1.ISEMPLOYEEVALIDATEPO.checked = false;//alafath
	 document.form1.ISEMPLOYEEVALIDATESO.checked = false;//alafath
...
function seal_delete(){
    ...
    data:  formData,//{key:val}
        ...
        success: function (data) {
        	...
        	var result =JSON.parse(data).result;
        	$('#msg').html(result.message); 
        	  $('#item_img_seal').attr('src',"../jsp/dist/img/NO_IMG.png");
        	  $('#productSeal').val('');
...
function sign_delete(){
    ...
    data:  formData,//{key:val}
        ...
        success: function (data) {
        	...
        	var result =JSON.parse(data).result;
        	$('#msg').html(result.message); 
        	  $('#item_img_sign').attr('src',"../jsp/dist/img/NO_IMG.png");
        	  $('#productSign').val('');
...
function onAdd(){
  ...
  if(COUNTRY_CODE != "SG") {
   if(rcbn>0){if("15"!=rcbn){alert(" Please Enter your 15 digit numeric "+TAXBYLABEL+" No.");document.form1.RCBNO.focus();return false;}}
  }
 ...
 document.form1.action  = "../company/editcompany";
 document.form1.submit();
 }
 </script>
...
<%
	...
	EDIT_REGION=strUtils.fString(request.getParameter("EDIT_REGION"));
...
//    ISPEPPOL=StrUtils.fString(request.getParameter("ISPEPPOL"));
    ...
    ISPEPPOL = (request.getParameter("ISPEPPOL") != null) ? "1": "0";
...
System.out.println("Existing company"+plntcode);
	     if(existingplnt.equalsIgnoreCase(Plant))
	     {
	       ...
	       updateQyery.append(",REGION='" +EDIT_REGION+ "'");
	       ...
	       updateQyery.append(",ISPEPPOL= '"+ (String)ISPEPPOL+ "'");
	    ...
	    List viewlistQry = plantmstutil.getPlantMstDetails(Plant);
            for (int i = 0; i < viewlistQry.size(); i++) {
                Map map = (Map) viewlistQry.get(i);
                        ...
                        ISSHOWPOSPRICEBYOUTLET=StrUtils.fString((String)map.get("ISSHOWPOSPRICEBYOUTLET"));
            ...
            String appPath = DbBean.COMPANY_ORDER_APP_BACKGROUND_PATH + "/" + APPPATH;
...
<div class="container-fluid m-t-20">
	 ...
	 <!-- Thanzith Modified on 23.02.2022 -->
            <ul class="breadcrumb backpageul">      	
                ...
                <li><label>Edit Your Company Profile</label></li>                                   
            </ul>             
    <!-- Thanzith Modified on 23.02.2022 -->
 ...
 <form class="form-horizontal" name="form1" id="form1" method="post" autocomplete="off" action="../company/editcompany">
 <div class="col-sm-6">
<div class="row">
   ...
   <div class="form-group">
    ...
    <div class="form-group">
      ...
      <div class="col-sm-6">
      <div class="input-group">
      	  	 <input class="form-control" name="STARTDATE" type = "TEXT" value="<%=STARTDATE%>" size="50"  MAXLENGTH=20 readonly>
  		</div>
      </div>
    </div>
    ...
    <div class="form-group">
      ...
      <div class="col-sm-6">
      <div class="input-group">
      	  	 <input class="form-control" name="EXPIRYDATE" class="inactiveGry" type = "TEXT" value="<%=EXPIRYDATE%>"  size="50"  MAXLENGTH=20 readonly>
  		</div>
      </div>
    </div>
    ...
    <div class="form-group">
      ...
      <div class="col-sm-6">
      <div class="input-group">
      	  	 <input class="form-control" name="ACTUALEXPIRYDATE" type = "TEXT"  value="<%=ACTUALEXPIRYDATE%>" size="30"    MAXLENGTH=20  readonly>
  		</div>
      </div>
    </div>
    ...
    <div class="form-group">
      <label class="control-label col-form-label col-sm-6" for="Base Currency">Base Currency</label>
      <div class="col-sm-6">
      <div class="input-group">
      <input class="form-control" name="BaseCurrency" type = "TEXT" value="<%=currencyCode%>" size="30"  MAXLENGTH=30 readonly>
  		</div>
      </div>
    </div>
    ...
    <div class="form-group">
      <label class="control-label col-form-label col-sm-6" for="Number Of Catalogs">Number Of Supplier</label>
      <div class="col-sm-6">
      <div class="input-group">
      	  	 <input class="form-control" name="NOOFSUPPLIER" type = "TEXT" value="<%=NOOFSUPPLIER%>" size="30"  MAXLENGTH=30  readonly>
  		</div>
      </div>
    </div>

    <div class="form-group">
      <label class="control-label col-form-label col-sm-6" for="Number Of Catalogs">Number Of Customer</label>
      <div class="col-sm-6">
      <div class="input-group">
      	  	 <input class="form-control" name="NOOFCUSTOMER" type = "TEXT" value="<%=NOOFCUSTOMER%>" size="30"  MAXLENGTH=30  readonly>
  		</div>
      </div>
    </div>

    <div class="form-group">
      <label class="control-label col-form-label col-sm-6" for="Number Of Catalogs">Number Of Employee</label>
      <div class="col-sm-6">
      <div class="input-group">
      	  	 <input class="form-control" name="NOOFEMPLOYEE" type = "TEXT" value="<%=NOOFEMPLOYEE%>" size="30"  MAXLENGTH=30  readonly>
  		</div>
      </div>
    </div>

    <div class="form-group">
      <label class="control-label col-form-label col-sm-6" for="Number Of Catalogs">Number Of Inventory</label>
      <div class="col-sm-6">
      <div class="input-group">
      	  	 <input class="form-control" name="NOOFINVENTORY" type = "TEXT" value="<%=NOOFINVENTORY%>" size="30"  MAXLENGTH=30  readonly>
  		</div>
      </div>
    </div>
     <!-- imti start -->
	     <div class="form-group">
	      <label class="control-label col-form-label col-sm-6" for="Number Of Location">Number of Location</label>
	      <div class="col-sm-6" >
	      <div class="input-group">
	       <input class="form-control" name="NOOFLOCATION" type = "TEXT" value="<%=NOOFLOCATION%>"  size="30"  MAXLENGTH=30  readonly>
	  		</div>
	      </div>
	    </div>

	     <div class="form-group">
	      <label class="control-label col-form-label col-sm-6" for="Number Of Catalogs">Number of Order</label>
	      <div class="col-sm-6">
	      <div class="input-group">
	       <input class="form-control" name="NOOFORDER" type = "TEXT" value="<%=NOOFORDER%>" size="30"  MAXLENGTH=30  readonly>
	  		</div>
	      </div>
	    </div>
<!-- imti end -->
...
<!-- Resvi start Number of Expenses/Bill/Invoice Quot./Invoices 24/6/21 -->
  ...
  <div class="form-group">
	       <label class="control-label col-form-label col-sm-6" for="Number Of Expense">Number of Expenses/Bill/Invoice Quot./Invoices</label>
	      <div class="col-sm-6">
	         <div class="input-group">   
	      	  	  <input class="form-control" name="NOOFEXPBILLINV" type = "TEXT" value="<%=NOOFEXPBILLINV%>" size="30"  MAXLENGTH=30  readonly>
	  		  </div>
	      </div>
	      </div>
...
<!-- Resvi start -->
       ...
       <div class="form-group">
	      <label class="control-label col-form-label col-sm-6" for="Number Of Catalogs">Number of Payment</label>
	        <div class="col-sm-6">
	        <div class="input-group">
	       <input class="form-control" name="NOOFPAYMENT" type = "TEXT" value="<%=NOOFPAYMENT%>" size="30"  MAXLENGTH=30  readonly>
	  		</div>
	        </div>
	    </div>

        <div class="form-group">
	      <label class="control-label col-form-label col-sm-6" for="Number Of Catalogs">Number of Journal</label>
	        <div class="col-sm-6">
	        <div class="input-group">
	       <input class="form-control" name="NOOFJOURNAL" type = "TEXT" value="<%=NOOFJOURNAL%>" size="30"  MAXLENGTH=30  readonly>
	  		</div>
	        </div>
	    </div>

	    <div class="form-group">
	       <label class="control-label col-form-label col-sm-6" for="Number Of Catalogs">Number of Contra</label>
	        <div class="col-sm-6">
	       <div class="input-group">
	      <input class="form-control" name="NOOFCONTRA" type = "TEXT" value="<%=NOOFCONTRA%>" size="30"  MAXLENGTH=30  readonly>
	  		</div>
	       </div>
	    </div>
...
<!-- 	    Resvi End -->
    ...
    <div class="form-group">
      	<label class="control-label col-form-label col-sm-6" for="Purchase System">Purchase System</label>
      	<div class="col-sm-6" style="padding-top: 7px;"><%if (Integer.parseInt(ENABLEINVENTORY) == 1){%>Order Management<input type="hidden" value="i" name="ENABLE_INVENTORY" id="ENABLE_INVENTORY" /><%}%>
       						 <%if (Integer.parseInt(ENABLEACCOUNTING) == 1){%>,Accounting<input type="hidden" value="a" name="ENABLE_ACCOUNTING" id="ENABLE_ACCOUNTING" /><%}%>
       						 <%if (Integer.parseInt(ENABLEPAYROLL) == 1){%>,Payroll<input type="hidden" value="p" name="ENABLE_PAYROLL" id="ENABLE_PAYROLL" /><%}%> 
       						  <%if (Integer.parseInt(ENABLEPOS) == 1){%>,POS<input type="hidden" value="o" name="ENABLE_POS" id="ENABLE_POS" /><%}%>      						 
      	</div>
    	</div>
...
<%--     	<div class="form-group">
      	<label class="control-label col-form-label col-sm-6" for="Access System">Access System</label>
       	<div class="col-sm-6" style="padding-top: 7px;">
       						 <%if (Integer.parseInt(OWNERAPP) == 1){%>Owner App<input type="hidden" value="o" name="OWNER_APP" id="OWNER_APP" /><%}%>
       						 <%if (Integer.parseInt(MANAGERAPP) == 1){%>,Manager App<input type="hidden" value="m" name="MANAGER_APP" id="MANAGER_APP" /><%}%>
       						 <%if (Integer.parseInt(STOREAPP) == 1){%>,Store App<input type="hidden" value="m" name="STORE_APP" id="STORE_APP" /><%}%>
       						 <%if (Integer.parseInt(RIDEAPP) == 1){%>,Ride App<input type="hidden" value="r" name="RIDE_APP" id="RIDE_APP" /><%}%>
      	</div>
    	</div> --%>
		...
		<div class="row">
			<div class="col-sm-8">
				...
				<font style="font-size:20px;" id="msg"><%=logores%></font>
					...
					<img id="item_img_seal" name="CATALOGPATH"
					class="img-thumbnail img-responsive col-sm-3"
					src="<%=(new File(sealPath).exists()) ?  "/track/ReadFileServlet/?fileLocation="+sealPath:"images/trackNscan/nouser.png"%>"
					style="width: 70%; padding: 3px;">

				</div>

				<div class="form-group">
					<label>Upload Your Company Seal:</label> <INPUT class="form-control btn-sm"  name="seal"  type="File" size="20" id ="productSeal" MAXLENGTH=100>
					</div>
					 <div class="form-group">
					<b><INPUT class=" btn btn-sm btn-default" type="BUTTON" value="Remove Image" onClick="seal_delete();"></b>
					<b><INPUT class=" btn btn-sm btn-default" type="BUTTON" value="Upload & Save Image" onClick="seal_edit();"></b>
				</div>

				<div class="col-sm-8">
				<font style="font-size:20px;" id="msg"><%=logores%></font>

					<img id="item_img_sign" name="CATALOGPATH"
					class="img-thumbnail img-responsive col-sm-3"
					src="<%=(new File(signPath).exists()) ?  "/track/ReadFileServlet/?fileLocation="+signPath:"images/trackNscan/nouser.png"%>"
					style="width: 70%; padding: 3px;">

				</div>

				<div class="form-group">
					<label>Upload Your Company Signature:</label> <INPUT class="form-control btn-sm"  name="dsignature"  type="File" size="20" id ="productSign" MAXLENGTH=100>
					</div>
					 <div class="form-group">
					<b><INPUT class=" btn btn-sm btn-default" type="BUTTON" value="Remove Image" onClick="sign_delete();"></b>
					<b><INPUT class=" btn btn-sm btn-default" type="BUTTON" value="Upload & Save Image" onClick="sign_edit();"></b>
				</div>
			</div>
		</div> --%>
		...
		<div class="row" style="height:588px">
			...
			<!-- imthi -->
				...
				<div class="col-sm-5" style="border: 1px dashed #ddd;border-radius: 4px;padding: 10px;">
						...
						<%-- <%if(!(new File(appPath).exists())){%> hidden <%} %>> --%>  <!-- old --> 
						<%-- <%if(SEALNAME.equalsIgnoreCase("")){%> hidden <%} %>> --%>  <!-- new -->
						...
						<%-- <%if((new File(appPath).exists())){%> hidden <%} %>> --%>
  ...
  <%} else {%>
    ...
    <label class="radio-inline">
      ...
      <div class="col-sm-4">
       <SELECT class="form-control" data-toggle="dropdown" data-placement="right" onchange="OnRegion(this.value)" id="REGION" name="REGION" value="<%=REGION%>" style="width: 100%">
			...
			ArrayList ccList =  _MasterUtil.getRegionList("");
    ...
    <div class="form-group">
       ...
       <fieldset>
       		...
       		<input type="checkbox" name="shopify" <%= "1".equals(shopify) ? "checked='checked'" : "" %> disabled="disabled"/> Shopify
       	</fieldset>
       	</div>
       	<div class="col-sm-12 col=md-4 col-lg-4">
       	<fieldset>
       		<legend>eCommerce</legend>
       		<input type="checkbox" name="lazada" <%= "1".equals(lazada) ? "checked='checked'" : "" %> disabled="disabled"/> Lazada
       	<br><input type="checkbox" name="shopee" <%= "1".equals(shopee) ? "checked='checked'" : "" %> disabled="disabled"/> Shopee
       	<br><input type="checkbox" name="amazon" <%= "1".equals(amazon) ? "checked='checked'" : "" %> disabled="disabled"/> Amazon
       	</fieldset>
       	</div>
       	<div class="col-sm-12 col=md-4 col-lg-4">
       	<fieldset>
       		<legend>Peppol</legend>
       		<input type="checkbox" name="ISPEPPOL" <%= "1".equals(ISPEPPOL) ? "checked='checked'" : "" %>/> Peppol
       		<br><INPUT name="PEPPOL_ID" id="PEPPOL_ID" type="TEXT" value="<%=PEPPOL_ID%>"	size="50" MAXLENGTH=50 class="form-control" placeholder="Peppol ID" disabled="disabled">
       		<br><input name="PEPPOL_UKEY" id="PEPPOL_UKEY" type="TEXT" value="<%=PEPPOL_UKEY%>" size="200" maxlength="200" class="form-control" style="display: none;" placeholder="Peppol UKEY" disabled="disabled">
       	</fieldset>
       	</div>
       </div>
        ...
        <div class="panel-body">
        	 ...
        	 <TR>
              ...
              <input type="checkbox" disabled value="o" name="OWNER_APP" id="OWNER_APP" <%if(OWNERAPP.equals("1")){%> checked <%}%>/>Owner App&nbsp;&nbsp; 
              </label>
              
        	  <TH WIDTH="20%" ALIGN = "LEFT">
              <label class="checkbox-inline"> 
       		  <input type="checkbox" disabled value="m" name="CUSTOMER_APP" id="CUSTOMER_APP" <%if(CUSTOMERAPP.equals("1")){%> checked <%}%>/> Customer App&nbsp;&nbsp;
              </label>
              
        	  <TH WIDTH="20%" ALIGN = "LEFT">
              <label class="checkbox-inline"> 
       		  <input type="checkbox" disabled value="m" name="MANAGER_APP" id="MANAGER_APP" <%if(MANAGERAPP.equals("1")){%> checked <%}%>/> Manager App&nbsp;&nbsp;
              </label>
              
        	  <TH WIDTH="20%" ALIGN = "LEFT">
              <label class="checkbox-inline"> 
    		  <input type="checkbox" disabled value="s" name="STORE_APP" id="STORE_APP" <%if(STOREAPP.equals("1")){%> checked <%}%>/> Store App&nbsp;&nbsp;
              </label>
              
        	  <TH WIDTH="20%" ALIGN = "LEFT">
              <label class="checkbox-inline"> 
       		  <input type="checkbox" disabled value="r" name="RIDE_APP" id="RIDE_APP" <%if(RIDEAPP.equals("1")){%> checked <%}%>/> Delivery App
              </label>
              </TABLE>
        </div>
        </div>
      ...
      <div class="col-sm-4">
      <div class="input-group">
      <input class="form-control" name="CompanyIndustry" type="TEXT" value="<%=COMP_INDUSTRY%>"  readonly>    
      	  	 <%-- <select class="form-control" data-toggle="dropdown" data-placement="right" name="CompanyIndustry" disabled>
...
<%--   <TH WIDTH="20%" ALIGN = "LEFT">
  	<div class="row">
	<div class="col-sm-12" style="padding-bottom: 3.5%;text-align: left; display:none">
	<label class ="checkbox-inline">
...
<TR>
 --%>
  ...
  <%} %> --%>
      		...
      		<div class="col-sm-12" style="padding-bottom: 2%;text-align: left;">
  ...
  <table class="table1" style="font-size:14px;width: 100%;">
    <TR>
		...
		<TH WIDTH="20%" ALIGN = "LEFT">
			...
			<%if(ISPRICE_UPDATEONLY_IN_OWNOUTLET.equals("1")) {%>checked <%}%> disabled="disabled"/>Update List Price only on own Outlet </label>
		</div>
	</div>
	</TH>
