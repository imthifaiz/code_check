...
function onNew(){
   ...
   document.form.action  = "../jsp/customer_view.jsp?action=NEW";
...
// 	   }
 ...
 return false;
   ...
   if(form.COUNTRY_CODE.selectedIndex==0)
	{
	 alert("Please Select Country from Contact And Address Details");
...
function onUpdate(){
   ...
   document.form.action  = "../jsp/customer_view.jsp?action=UPDATE";
   document.form.submit();
}
function onDelete(){
   ...
   var CUST_CODE   = document.form.CUST_CODE.value;
   if(CUST_CODE == "" || CUST_CODE == null) {alert("Please Enter Customer ID");  return false; }
   confirm("Are you sure to delete Customer permanently ");
   document.form.action  = "../jsp/customer_view.jsp?action=DELETE";
   document.form.submit();
}
function onView(){
   var CUST_CODE   = document.form.CUST_CODE.value;
...
return false;
   ...
   document.form.action  = "../jsp/customer_view.jsp?action=VIEW";
   document.form.submit();
}
function onIDGen()
{
	$.ajax({
		...
		error: function(data) {
			alert('Unable to generate Customer ID. Please try again later.');
		},
		complete: function(){
			hideLoader();
		}
...
/*  document.form.action  = "customer_view.jsp?action=Auto-ID";
 document.form.submit();  */
}
...
String sContactName ="", sDesgination="",sTelNo="",sHpNo="",sFax="",sDob="",sNational="",sEmail="",sRemarks="",sPayTerms="",sPayMentTerms="",sPayInDays="",customertypeid="",customertype_id="",desc="",customerstatusid="",statusdesc="",sRcbno="";
...
String sIBAN="",sBANKNAME="",sBANKROUTINGCODE="",CURRENCY="",transport="",sBRANCH="",sSAVE_RED,PEPPOL="",PEPPOL_ID="";
...
shipState = strUtils.InsertQuotes(strUtils.fString(request.getParameter("SHIP_STATE")));
...
// shipCountry = strUtils.fString(request.getParameter("SHIP_COUNTRY_CODE"));
shipCountry = strUtils.InsertQuotes(strUtils.fString(request.getParameter("SHIP_COUNTRY")));
...
if(action.equalsIgnoreCase("NEW")){
      ...
      CUSTOMEREMAIL="";WEBSITE="";FACEBOOK="";TWITTER="";LINKEDIN="";SKYPE="";OPENINGBALANCE="";WORKPHONE="";PEPPOL="";PEPPOL_ID="";
	  ...
	  OPENINGBALANCE = StrUtils.addZeroes(OPENINGBALANCEVALUE, numberOfDecimal);
		...
		if(sCustCode!="C0001")
          ...
          if(custInserted&&inserted) {
        	  sSAVE_RED="Customer Added Successfully";
   ...
   if(custUtil.isExistCustomer(sCustCode,plant))
    {
          ...
          htUpdate.put("payment_terms", sPayMentTerms);
...
//4. >> Delete
    ...
    if(custUtil.isExistCustomer(sCustCode,plant))
    {
          ...
          if(custDeleted) {
                    ...
                    CURRENCY="";
                    sZip       = "";
                    sCons      = "Y";sDesgination="";sTelNo="";sHpNo="";sFax="";sDob="";sNational="";sEmail="";sRemarks="";sPayTerms="";sPayMentTerms="";sPayInDays="";
                    sContactName="";customertypeid="";CREDITLIMIT="";CUST_ADDONCOST="";
                    shipContactName="";shipDesgination="";shipWORKPHONE="";shipHpNo="";shipEmail="";shipCountry="";shipAddr1="";shipAddr2="";shipAddr3="";shipAddr4="";shipState="";shipZip="";
                    CUSTOMEREMAIL="";WEBSITE="";FACEBOOK="";TWITTER="";LINKEDIN="";SKYPE="";OPENINGBALANCE="";WORKPHONE="";PEPPOL="";PEPPOL_ID="";
...
<div class="container-fluid m-t-20">
	 ...
	 <ul class="breadcrumb backpageul">    
                ...
                <li><label>Create Customer</label></li>                                   
            </ul>
        <!-- Thanzith Modified on 23.02.2022 -->     
 ...
 <div class="box-body">
   ...
   <CENTER class="success-msg"><strong><%=res%></strong></CENTER>

  <form class="form-horizontal" id="customerform" name="form" method="post" action="../customer/Save" autocomplete="off" enctype="multipart/form-data">
	...
	<div class="form-group">
      ...
      <div class="col-sm-4">
      	...
      	<div class="input-group">   
      	  	<INPUT class="form-control" name="CUST_CODE" id="CUST_CODE" type="TEXT" value="<%=sCustCode%>" onkeypress="return blockSpecialChar(event)" onchange="checkitem(this.value)" size="50" MAXLENGTH=50 width="50"<%=sCustEnb%>>
        ...
        <input type="hidden" name="CURRENCYID" value="<%=DISPLAYID%>">
  	    ...
  	    <input type = "hidden" name="CUSTOMER_TYPE_ID" value="<%=customertype_id%>">
      </div>
...
<div class="col-sm-6" style="right: 15px;">  
      ...
      <input type="radio" name="SHOWSALESBYPURCHASECOST" <%if(SHOWSALESBYPURCHASECOST.equalsIgnoreCase("2")) {%>checked <%}%> value="2">Show Sales Price by Purchase Cost
		...
		<%} %>
	     ...
	     <% if(!COMP_INDUSTRY.equals("Education")){%>
    <div class="form-group">
      <label class="control-label col-form-label col-sm-2">Customer Group</label>
      <div class="col-sm-4">           	
			...
			size="50" MAXLENGTH=50 class="form-control">
   		 	<span class="select-icon"  onclick="$(this).parent().find('input[name=\'CUSTOMER_TYPE_DESC\']').focus()" > 	
    ...
    <div class="form-group">
      <label class="control-label col-form-label col-sm-2">Customer Phone</label>
      <div class="col-sm-4">
    ...
    <div class="form-group">
      <label class="control-label col-form-label col-sm-2">Customer Fax</label>
      <div class="col-sm-4">
    ...
    <div class="form-group">
      	<label class="control-label col-form-label col-sm-2">Customer Email</label>
      	<div class="col-sm-4">  
...
<!--         </li> -->
    ...
    <div class="form-group">
      ...
      <% if(!COMP_INDUSTRY.equals("Education")){%>
        ...
        <div class="form-inline">
        <label class="checkbox-inline" style="margin-top: 10px;font-size: 16px;">         
    ...
    <%} %>
      ...
      <% if(!COMP_INDUSTRY.equals("Education")){%>
        <div class="form-group">
         <label class="control-label col-form-label col-sm-2">Contact Name</label>
      <div class="col-sm-4">
    ...
    <div class="form-group">
      ...
      <%} %>
      	...
      	<% if(!COMP_INDUSTRY.equals("Education")){%>
    	<div class="form-group">
      	<label class="control-label col-form-label col-sm-2">Work Phone</label>
      	<div class="col-sm-4">  
        <INPUT name="WORKPHONE" id="WORKPHONE" type="TEXT" value="<%=WORKPHONE%>" onkeypress="return validateInput(event)"	size="50" MAXLENGTH=30 class="form-control">
      	...
      	<div class="col-sm-4">  
        <INPUT name="SHIP_WORKPHONE" id="SHIP_WORKPHONE" type="TEXT" value="<%=shipWORKPHONE%>" onkeypress="return validateInput(event)"	size="50" MAXLENGTH=30 class="form-control">
      	</div>
    	</div>
      	<%} %>
    ...
    <%} %>
        ...
        <div class="form-group" style="display: none;">
      	<label class="control-label col-form-label col-sm-2">Opening Balance</label>
      	<div class="col-sm-4">  
  ...
  <% if(COMP_INDUSTRY.equals("Education")){%>
  <div class="form-group" style="display:none;">
      <label class="control-label col-form-label col-sm-2">Credit Limit</label>
      <div class="col-sm-4">  
      <INPUT name="CREDITLIMIT" id="CREDITLIMIT"  type="TEXT" value="<%=new java.math.BigDecimal(CREDITLIMIT).toPlainString()%>" size="50" MAXLENGTH=50  class="form-control" onkeypress="return isNumberKey(event,this,4)">
      </div>
      <div class="form-inline">
      <div class="col-sm-2">
      </div>
  ...
  <div class="form-group">
   ...
   <div class="form-group">
    ...
    <%} %>
      ...
      <div class="form-group">
      <label class="control-label col-form-label col-sm-2">Add on Cost</label>
      <div class="col-sm-4">  
      ...
      <div class="form-inline">
		<div class="col-sm-6" style="right: 15px;">  
      	<input type="radio" name="ADDONCOSTTYPE" onchange="addoncosttype('BYCOST')" value="0" id="byCost">By Cost &nbsp;&nbsp;
      	<input type="radio" name="ADDONCOSTTYPE" onchange="addoncosttype('BYPERCENTAGE')" value="1" id="byPercentage">By Percentage &nbsp;&nbsp;
      	</div>
	</div>
    </div>
  
  <div class="form-group">
      	<label class="control-label col-form-label col-sm-2">Facebook Id</label>
      	<div class="col-sm-4">  
...
<input type="hidden" name="Basecurrency" id="Basecurrency" style="display: none;" value=<%=curency%>>
 ...
 $(document).ready(function(){
	 ...
	 /* Bank Name Auto Suggestion */
		...
		{
		document.form.action  = "../customer/summary?PGaction=View&result=Customer Added Successfully";
		document.form.submit();
		}
...
function shippingAddress(){
	...
	if (document.getElementById("SameAsContactAddress").checked == true) {
		...
		$("select[name ='SHIP_COUNTRY_CODE']").val(country_code);
    ...
    function add_attachments(){
        ...
        $.ajax({
           ...
           // 	window.location.reload();
            	//document.form.action  = "../jsp/customer_view.jsp?action=ADD";
            	  // document.form.submit();
