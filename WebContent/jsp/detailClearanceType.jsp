...
<%
String title = "Detail Clearance Type";
%>
...
return (false);
    ...
    if(chkmsg){
   document.form1.action  = "../jsp/detailClearanceType.jsp?action=UPDATE";
...
function onDelete() {
	...
	if (chkmsg) {
		document.form1.action = "../jsp/detailClearanceType.jsp?action=DELETE";
		document.form1.submit();
	} else {
		return false;
	}
	...
	if (action.equalsIgnoreCase("Clear")) {
		...
		{	
			res = "<font class = " + IDBConstants.FAILED_COLOR
					+ " >Cannot Delete as Clearance are tagged to Clearance Type</font>";
...
<div class="container-fluid m-t-20">
	 ...
	 <ul class="breadcrumb backpageul">    
                ...
                <li><label>Detail Clearance Type</label></li>                                   
            </ul>
 ...
 <div class="form-group">
  ...
  <div class="col-sm-4">
    <label class="radio-inline">
      <input readonly type="radio" name="ACTIVE" value="0"<%if (sType.equalsIgnoreCase("0")) {%> checked <%}%>>Import
    </label>
    <label class="radio-inline">
      <input readonly type="radio" name="ACTIVE" value="1"<%if (sType.equalsIgnoreCase("1")) {%> checked <%}%>>Export
    </label>
     </div>
</div>
  </form>
