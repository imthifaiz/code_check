...
<%
String title = "Location Type Three Details";
%>
...
sLocId  = strUtils.fString(request.getParameter("LOC_TYPE_ID3"));
sLocDesc  = strUtils.replaceCharacters2Recv(strUtils.fString(request.getParameter("lOC_TYPE_DESC3")));
...
<div class="container-fluid m-t-20">
	 ...
	 <ul class="breadcrumb backpageul">    
                ...
                <li><label>Location Type Three Details</label></li>                                   
            </ul>
        <!-- Thanzith Modified on 23.02.2022 -->     
...
<form class="form-horizontal" name="form1" method="post">
    <div class="form-group">
      ...
      <div class="col-sm-4">
      		<input name="LOC_TYPE_ID3" id="LOC_TYPE_ID3" type="TEXT" value="<%=sLocId%>"
...
<div class="form-group">
      ...
      <div class="col-sm-4">          
        <INPUT  class="form-control" name="lOC_TYPE_DESC3" id="lOC_TYPE_DESC3" type="TEXT" value="<%=sLocDesc%>"
