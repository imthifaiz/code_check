...
String fieldDesc="", bill ="", shipRef="", refNum="", billDate = "", dueDate = "",ORDERTYPE="",empName="", empno="",payTerms = "",orderdiscount="",orderdiscounttype="",isshiptaxable ="0",
	...
	ptaxisshow="0",taxid="0",gst="0",aorderdiscount="0",projectid="",projectname="",transportmode="",shippingid="",shippingcust="";
String billtype="";
...
// 	transportmode = (String)billHdr.get("TRANSPORTID");
	...
	billtype = (String)billHdr.get("BILL_TYPE");
...
<script src="../jsp/js/EditBill.js"></script>
<center>
...
<div class="container-fluid m-t-20">
	...
	<form id="updateBillForm" class="form-horizontal" name="form" autocomplete="off" action="/track/BillingServlet?Submit=Update"  method="post" enctype="multipart/form-data" onsubmit="return validateBill()">
	...
	<%} %>
		...
		<div class="form-group vendor-section">
			...
			<div class="col-sm-6 ac-box">
				...
				<input type="text" class="ac-selected  form-control" name="vendname" id="vendname" value="<%=vendName%>" readonly>	
				</div>
		...
		<div class="form-group" id="ponoenv">
			...
			<div class="col-sm-4">				
				<input type="text" class="form-control" id="pono" class="pono" name="pono" value="<%=pono%>" readonly>
			</div>
		</div>
		<div class="form-group">
			<label class="control-label col-form-label col-sm-2">GRNO</label>
			<div class="col-sm-4">				
				<input type="text" class="form-control" id="grno" name="grno" value="<%=grno%>" readonly>
			</div>
		</div>
		<div class="form-group">
			<label class="control-label col-form-label col-sm-2">Shipment Reference</label>
			<div class="col-sm-4">				
				<input type="text" class="form-control" name="shipRef" value="<%=shipRef%>" readonly>
			</div>
		</div>
		...
		<div class="form-group">
			...
			<div class="col-sm-4">				
				<input type="text" class="form-control" id="refNum" name="refNum" value="<%=refNum%>" maxlength="50">
			</div>
		</div>
		<div class="form-group">
			<label class="control-label col-form-label col-sm-2 required">Bill Date</label>
			<div class="col-sm-4">
				<input type="text" class="form-control datepicker" id="bill_date" name="bill_date" value="<%=billDate%>" READONLY>
			</div>
		</div>
		<div class="form-group">
			...
			<%}else{ %>
				<input type="text" class="form-control datepicker" value="<%=dueDate%>" id="due_date" name="due_date" READONLY>
			<%} %>
		...
		<%-- <div class="form-group">
				...
				<div class="form-group">
        			...
        			<div class="col-sm-4">
			        	<input type="text" class="ac-selected form-control typeahead" id="SALES_LOC" name="SALES_LOC" value="" placeholder="Select a Purchase Location" disabled>
						<span class="select-icon" onclick="$(this).parent().find('input[name=\'SALES_LOC\']').focus()"><i class="glyphicon glyphicon-menu-down"></i></span>
		...
		<div class="form-group">
					...
					<div class="col-sm-4 ac-box">
						<input type="text" class="ac-selected form-control typeahead" id="CURRENCY" name="CURRENCY" placeholder="Select a Currency"  onchange="checkcurrency(this.value)" value="<%=DISPLAY%>" disabled>
...
<!-- 			</td>				 -->
		...
		<div class="row">
			...
			<div class="total-section col-sm-6">
						...
						<div class=" col-lg-6 col-sm-6 col-6">
							<div class="input-group my-group">
										<%if(orderdiscounttype.equalsIgnoreCase("%")) {%>
											...
											<select class="discountPicker form-control" name="oddiscount_type" readonly>
												<option value="%">%</option>
											</select>
										<%}else{ %>
				...
				<%}else if(billtype.equalsIgnoreCase("INVENTORY")){ %>
					<div class="expense-section-inv">
							<div class="expense-details-inv">
							</div>
							<div class="accountAddBtn footer addexphide-inv" style="margin-top: -35px;"  id="addexpenseinvmodel"><a href="#">+ Add Additional Expenses</a></div>
							<br><br>
					</div>
				<%}else{ %>
				<%} %>
...
<%-- 	<%@include file="newSupplierModal.jsp" %> --%>
	...
	<INPUT type="hidden" id="expencetax"
			name="expencetax" value=<%=gstexp%>>
<%-- 	<%@include file="newProductModal.jsp" %> --%>
<%-- <%@include file="NewChartOfAccountAdd.jsp"%> --%>


	<%-- <%@include file="newProductModalPurchase.jsp" %> <!-- imti for add product -->
...
<%-- <jsp:include page="newEmployeeModal.jsp" ></jsp:include>
	...
	<%@include file="NewAdditionalExpenses.jsp"%> --%>
	...
	<jsp:include page="NewAdditionalExpenses.jsp" flush="true"></jsp:include>
	<jsp:include page="NewAddExpForInventory.jsp" flush="true"></jsp:include>
	      ...
	      <div class="modal-footer">
	      			<div class="dropup">
								...
								<button class="btn btn-success dropdown-toggle" type="button"
									data-toggle="dropdown">Save<span class="caret"></span>
								</button>
								<ul class="dropdown-menu">
									<li><a id="btnBillOpen" href="#">Save</a></li>
									<li><a id="btnBillOpenEmail" href="#">Save and Send Email</a></li>
	      ...
	      <div class="input-group">   
	         ...
	         <!-- End -->
					...
					<div class="form-group">
						...
						<div class="col-sm-4">
							<div class="input-group">
								<input name="SUPPLIER_TYPE_ID" type="TEXT" value="" size="50"
...
else if(50<rcbn)
{
   ...
   document.form1.submit(); */
	...
	success : function(data) {
		...
		$('select[name ="CURRENCY_ID"]').val(data.supplier[0].sCURRENCY_ID);
		$('select[name ="CURRENCYUSEQT"]').val(data.supplier[0].CURRENCYUSEQT);
...
$(document).ready(function(){
	...
	if(billtype == "INVENTORY"){
		getShipingReference();
		$("input[name ='billhdridinv']").val("<%=billHdrId%>");
		getExpenseDetailForInventoryBill("SN00001");
	}
