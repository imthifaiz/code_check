...
<script src="../jsp/js/editConsignment.js"></script>
<center>
	<h2>
...
<div class="container-fluid m-t-20">
	...
	<!-- Muruganantham Modified on 16.02.2022 -->
            <ul class="breadcrumb backpageul">      	
                ...
                <li><a href="../consignment/detail?tono=<%=toHdr.getTONO()%>"><span class="underline-on-hover">Consignment Order Detail</span> </a></li>                     
    ...
    <!-- Muruganantham Modified on 16.02.2022 -->
		<div class="box-header menu-drop">
			...
			<div class=" pull-right">
				&nbsp;
				<h1 style="font-size: 18px; cursor: pointer;" class="box-title pull-right" onclick="window.location.href='../consignment/detail?tono=<%=toHdr.getTONO()%>'">
		...
		<div class="container-fluid">
			...
			action="../consignment/new" enctype="multipart/form-data" onsubmit="return validateConsignmentOrder()">
					...
					<%-- <div class="col-sm-6 ac-box">
						<div class="input-group">
								<input type="text" class="ac-selected  form-control typeahead" 
									...
									name="SHIPPINGCUSTOMER" value="<%=toHdr.getSHIPPINGCUSTOMER()%>"> 
			...
			<div class="form-group shipCustomer-section" id="shipbilladd">
					...
					<div class="col-sm-4">
						<div class="input-group">
							<input type="text" class="form-control datepicker" id="DELDATE" 
								...
								name="DELDATE" value="<%=toHdr.getDELDATE()%>" readonly>
						</div>
					</div>
						...
						<div class="col-sm-6">
							<div class="input-group">
								<input type="text" class="form-control" id="COLLECTION_TIME" 
									name="COLLECTION_TIME" value="<%=toHdr.getCollectionTime()%>" readonly>
				   		 	</div>
						</div>
					</div>					
				</div>
					...
					<div class="col-sm-4">
						...
						<%
							for(int i=0 ; i<salesLocations.size();i++){
						        ...
						        <%=toHdr.getSALES_LOCATION().equalsIgnoreCase(STATE_PREFIX) ? "selected" : "" %>><%=STATE %> </option>				          
	        			<%} %>
	        			</SELECT>
					</div>
				</div> --%>
				...
				<%-- <div class="form-group">
					...
					<div class="col-sm-4">
						<input type="text" class="form-control" id="CURRENCYUSEQT" name="CURRENCYUSEQT" placeholder="Enter Equivalent Currency" value="<%=toHdr.getCURRENCYUSEQT()%>">
					</div>
				</div>
				 --%>
				<div class="form-group">
					...
					<div class="col-sm-4">
						<div class="input-group">
							<input type="text" class="form-control" id="GST" name="GST" onchange="changetaxforgst()" onkeypress="return isNumberKey(event,this,4)"  value="<%=toHdr.getCONSIGNMENT_GST()%>">
...
<%-- 									<input type="hidden" name="itemprice" value="<%=pcsprice%>"> --%>
								...
								<td class="item-qty">
									<input type="text" name="QTY" class="form-control text-right" 
									 data-rl="<%=m.get("stkqty")%>" data-msq="<%=m.get("maxstkqty")%>" data-soh="<%=m.get("stockonhand")%>"
									  ...
									  data-pq="<%=todet.getQtyPick().doubleValue()%>" 
								...
								<%-- <td class="item-tax">
									...
									value="<%=todet.getTAX_TYPE()%>" placeholder="Select a Tax" readonly>
								...
								<td class="table-icon" style="position:relative;">
									<%if(todet.getLNSTAT().equals("O") || todet.getLNSTAT().equals("C")) {%>
				...
				<div class="row">
					<div class="col-sm-12 txn-buttons">
						<%if(toHdr.getORDER_STATUS().equalsIgnoreCase("Draft")){%>
								<div class="dropup">
					    ...
					    <span class="caret"></span></button>
					    <ul class="dropdown-menu">
					      <li><a id="btnSales" href="#">Save</a></li>
...
// 		form1.TONO.focus();
// 	}else{
// 		window.location.href = "../jsp/invoicePayment.jsp?type=ADVANCE&TONO="+tono+"&CUST_CODE="+form1.CUST_CODE1.value+"&CUST_NAME="+form1.CUST_NAME.value;		
// 	}
// 	}
