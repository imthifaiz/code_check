...
<script src="../jsp/js/editEstimateOrderProduct.js"></script>
<center>
	<h2>
...
<div class="container-fluid m-t-20">
	<div class="box">
		<div class="box-header menu-drop">
			...
			<h1 style="font-size: 18px; cursor: pointer;" class="box-title pull-right" onclick="window.location.href='../salesestimate/detailPro?estno=<%=esthdr.getESTNO()%>'">
		...
		<div class="container-fluid">
			...
			<input type="hidden" name="CURRENCYUSEQTOLD" value="<%=esthdr.getCURRENCYUSEQT()%>">
				...
				<INPUT type="hidden" name="curency"  value="<%=esthdr.getCURRENCYID()%>">
				...
				<div class="form-group">
					...
					<div class="col-sm-4">
						<div class="input-group">
							<input type="text" class="form-control" id="GST" name="GST" onchange="changetaxforgst()"  value="<%=esthdr.getOUTBOUND_GST()%>">
