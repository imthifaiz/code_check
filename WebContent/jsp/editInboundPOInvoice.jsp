...
<%
String title = "Edit Purchase Order Printout (With Cost)";
%>
...
//         RESVI ENDS
	...
	function onAdd(){
     	    document.form1.action  =  "/track/SettingsServlet?Submit=EDIT_PO_RCPT_INVOICE_HDR";
...
<%
	...
	printwithbrand="",PreparedBy="",AuthSignature="",printRoundoffTotalwithDecimal="",printWithDeliveryDate="",prdDeliveryDate="",printWithPrdDeliveryDate="",
	...
	POUtil posUtil = new POUtil();
         Map m= posUtil.getPOReceiptInvoiceHdrDetails(plant);
...
<div class="container-fluid m-t-20">
	 ...
	 <ul class="breadcrumb backpageul">    
                ...
                <li><label>Edit Purchase Order Printout (With Cost)</label></li>                                   
            </ul>
        <!-- Thanzith Modified on 23.02.2022 -->     
