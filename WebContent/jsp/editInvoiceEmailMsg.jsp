...
<%
String title = "Edit Invoice Email Message";
%>
...
/*                
		...
		*/
		...
		document.form1.action = "<%=rootURI%>/email_config/invoice";
...
<%
		...
		try{
                ...
                if (!isUpdated) {
                        ...
                        res = "<font class = " + IConstants.SUCCESS_COLOR+ ">Email Configuration for Invoice edited successfully</font>";
                }
	...
	try{
         Map m= mailUtil.getEmailMsgDetails(plant,IConstants.INVOICE);
...
<div class="container-fluid m-t-20">
	 ...
	 <ul class="breadcrumb backpageul">    
                ...
                <li>Edit Invoice Email Message</li>                                   
            </ul>
        <!-- Thanzith Modified on 23.02.2022 -->  
