...
<%
String title = "Edit Location Type Two";
%>
...
function onNew(){
	...
	document.form1.lOC_TYPE_DESC2.value = "";
}

function onUpdate(){

	 var LOC_TYPE_ID2   = document.form1.LOC_TYPE_ID2.value;
	 var lOC_TYPE_DESC2 = document.form1.lOC_TYPE_DESC2.value;
	 if(LOC_TYPE_ID2 == "" || LOC_TYPE_ID2 == null) {alert("Please Enter Location Type ID");document.form1.LOC_TYPE_ID2.focus(); return false; }
	 if(lOC_TYPE_DESC2 == "" || lOC_TYPE_DESC2 == null) {alert("Please Enter Location Type Description");document.form1.lOC_TYPE_DESC2.focus(); return false; }
	...
	// Loop from zero to the one minus the number of radio button selections
	 ...
	 return (false);
	     ...
	     if(chkmsg){
		    ...
		    $.ajax({
		        type: 'POST',
		        url: "../locationtypetwo/edit",
			    data:  formData,
			    contentType: false,
			    processData: false,
		        success: function (data) {
		        	if(data.ERROR_CODE == 100)
		        		window.location.href="../locationtypetwo/summary?msg="+data.MESSAGE;
		        	else
		        		alert(data.MESSAGE);
		        },
		        error: function (data) {
...
function onDelete() {
	var LOC_TYPE_ID2   = document.form1.LOC_TYPE_ID2.value;
	if (LOC_TYPE_ID2 == "" || LOC_TYPE_ID2 == null) {
	...
	if (chkmsg) {
		$.ajax({
			type: 'POST',
	        url: "../locationtypetwo/delete?LOC_TYPE_ID2="+LOC_TYPE_ID2,
		    contentType: false,
		    processData: false,
    		success : function(data) {
    			if(data.STATUS == "NOT OK"){
    				...
    				window.location.href="../locationtypetwo/summary?msg=Location Type Two deleted successfully";
    			}
    		}
    	});	
	} else {
...
<%
	...
	sLocTypeId  = strUtils.fString(request.getParameter("LOC_TYPE_ID2"));
	sLocTypeDesc  = strUtils.fString(request.getParameter("lOC_TYPE_DESC2"));
...
<div class="container-fluid m-t-20">
	 ...
	 <ul class="breadcrumb backpageul">    
                ...
                <li><label>Edit Location Type Two</label></li>                                   
            </ul>
        <!-- Thanzith Modified on 23.02.2022 -->      
 ...
 <div class="box-body">
  ...
  <form class="form-horizontal" id="form1" name="form1" method="post" 
			action="../locationtypetwo/new" enctype="multipart/form-data">
    <div class="form-group">
      <label class="control-label col-form-label col-sm-4 required" for="Location Type ID">Location Type ID</label>
      <div class="col-sm-4">
      	<div class="input-group">    
    		<input name="LOC_TYPE_ID2" id="LOC_TYPE_ID2" type="TEXT" value="<%=sLocTypeId%>"
			size="50" MAXLENGTH=50 class="form-control" readonly>
   		 	<!-- <span class="input-group-addon"  
   		 onClick="javascript:popWin('../jsp/LocTypeTwoList.jsp?LOC_TYPE_ID2='+form1.LOC_TYPE_ID2.value);">
    ...
    <div class="form-group">
      ...
      <div class="col-sm-4">          
        <INPUT  class="form-control" name="lOC_TYPE_DESC2" id="lOC_TYPE_DESC2" type="TEXT" value="<%=sLocTypeDesc%>"
