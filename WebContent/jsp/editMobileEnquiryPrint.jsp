...
<title>Edit Mobile Enquiry Order Printout</title>
...
<%
	...
	DOUtil doUtil = new DOUtil();
         ...
         Map m= doUtil.getDOReceiptHdrDetails(plant,"Mobile Enquiry");
...
<TABLE border="0" width="100%" cellspacing="0" cellpadding="0"
	...
	<TR>
		<TH BGCOLOR="#000066" COLSPAN="11"><font color="white">Edit Mobile Enquiry Order Printout</font></TH>
	</TR>
</TABLE>
<B>
<CENTER><%=res%>
