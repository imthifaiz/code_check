...
<%
String title = "Edit PaySlip Email Configuration";
%>
...
<SCRIPT LANGUAGE="JavaScript">
	...
	function onAdd(){
		...
		document.form1.action = "<%=rootURI%>/email_config/payslip";
...
<%
		...
		try{
                ...
                if (!isUpdated) {
                        ...
                        res = "<font class = " + IConstants.SUCCESS_COLOR+ ">Email Configuration for Payslip edited successfully</font>";
                }
	...
	try{
         Map m= mailUtil.getEmailMsgDetails(plant,IConstants.PAYSLIP);
...
<div class="container-fluid m-t-20">
	 ...
	 <ul class="breadcrumb backpageul">    
                ...
                <li>Edit Payslip Email Configuration</li>                                   
            </ul>
        <!-- Thanzith Modified on 23.02.2022 -->  
 ...
 <div class="box-body">
  ...
  <form class="form-horizontal" name="form1" method="post" action="editInboundOrderEmailMsg.jsp">
   ...
   <div class="form-group">
      ...
      <div class="col-sm-2">         
       <input type="radio" name="send_attachment" value="payslip" /> Payslip<br/>
