...
<%
String title = "Edit Goods Issue Printout";
%>
...
<!-- <title>Edit Goods Issue Printout</title> -->
...
<SCRIPT LANGUAGE="JavaScript">
	...
	function onClear()
	{
		...
		document.form1.UnitPrice.value="";
	...
	function onAdd(){
   		/*document.form1.action  = "/track/GstTypeServlet?action=EDIT_POS_ISSUE_HDR";
   	 	var formData = $('form#editposReceiptForm').serialize();
		$.ajax({
	    type: 'post',
	    url: "/track/GstTypeServlet?action=EDIT_POS_ISSUE_HDR", 
	    dataType:'html',
	    data:  formData,
...
<%
	...
	String HEADER = "", GREET1 = "", GREET2 = "",FOOT1="",FOOT2="";
        String Product = "",PaymentMode="",SalesRep="",SerialNo="",ReceiptNo = "",Description="",UnitPrice="",Qty="",UOM="",Discount="",Total="",Subtotal="",Tax="",TotalAmt="",PaymentPaid="",
	...
	if (action.equalsIgnoreCase("Clear")) {
		action = "";
                HEADER = "";
                Product = "";PaymentMode="";SalesRep="";SerialNo="";ReceiptNo = "";Description="";UnitPrice="";Qty="";UOM="";Discount="";Total="";Subtotal="";Tax="";TotalAmt="";PaymentPaid="";ChangeRemaining="";
		GREET1 = "";
		GREET2 = "";
		FOOT1 = "";
		FOOT2 = "";
...
<div class="container-fluid m-t-20">
	 ...
	 <ul class="breadcrumb backpageul">    
                ...
                <li><label>Edit Goods Issue Printout</label></li>                                   
            </ul>
        <!-- Thanzith Modified on 23.02.2022 -->  
 ...
 <div class="box-body">
		...
		<FORM class="form-horizontal" name="form1" id="editposReceiptForm" method="post">
		...
		<%if(PrintWRcpt.equals("1")) {%>checked <%}%>>Print Receipt during completion of Check Out</lable>
      	</div>
  		</div>
  		</div>
  		
  		<div class="form-group">
      	<label class="control-label col-form-label col-sm-2" for="Serial">Serial No</label>
      	<div class="col-sm-3">
  		...
  		<div class="form-group">
      	<label class="control-label col-form-label col-sm-2" for="Receipt">Receipt No</label>
      	<div class="col-sm-3">
  		...
  		<!-- Unit Price -->
  		<INPUT class="form-control" name="UnitPrice" type="hidden" value="<%=UnitPrice%>"	size="50" MAXLENGTH=15>		
		...
		<div class="form-group">
  		...
  		<INPUT class="form-control" name="FOOT1" type="hidden" value=""	size="50" MAXLENGTH=100 <%=FOOT1%>>
