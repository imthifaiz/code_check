...
<%
String title = "Edit Stock Move Printout";
%>
...
<!-- <title>Edit Stock Move Printout</title> -->
...
<SCRIPT LANGUAGE="JavaScript">
	...
	function onAdd(){
   		/*document.form1.action  = "/track/GstTypeServlet?action=EDIT_POS_MOVE_HDR";
   	 	var formData = $('form#editposMoveForm').serialize();
		$.ajax({
	    type: 'post',
	    url: "/track/GstTypeServlet?action=EDIT_POS_MOVE_HDR", 
	    dataType:'html',
	    data:  formData,
...
<div class="container-fluid m-t-20">
	 ...
	 <ul class="breadcrumb backpageul">    
                ...
                <li><label>Edit Stock Move Printout</label></li>                                   
            </ul>
        <!-- Thanzith Modified on 23.02.2022 -->  
 ...
 <CENTER><strong><font style="font-size:40px;"><%=res%></font></strong></CENTER>
		...
		<FORM class="form-horizontal" name="form1" id="editposMoveForm" method="post">
		...
		<%if(PrintWRcpt.equals("1")) {%>checked <%}%>>Print Receipt during completion of Move</lable>
      	</div>
  		</div>
  		</div>
      	...
      	<textarea rows="1" class="form-control" name="Description" type="TEXT" value=""	
					size="50" MAXLENGTH=15><%=Description%></textarea>
  		</div>
  		</div>
  		<!-- Unit Cost -->
