...
<%
	...
	boolean displayCustomerpop=false,displayPaymentTypepop=false,displaydelete=false;
	if(systatus.equalsIgnoreCase("ACCOUNTING"))
	{
		...
		displaydelete = ub.isCheckValAcc("deleteproject", plant,USERID);
	...
	if(systatus.equalsIgnoreCase("INVENTORY"))
	{
		...
		displaydelete = ub.isCheckValinv("deleteproject", plant,USERID);
	}
...
<div class="container-fluid m-t-20">
	...
	<!-- Muruganantham Modified on 16.02.2022 -->
            <ul class="breadcrumb backpageul" >      	
                ...
                <li><label>Edit Project</label></li>                                   
            </ul>             
    <!-- Muruganantham Modified on 16.02.2022 -->
				...
				<div class="form-group customer-section">
					...
					<div class="col-sm-6 ac-box">
						<input type="text" class="ac-selected  form-control typeahead" id="CUSTOMER" 
							 name="CUST_NAME" onchange="checkcustomer(this.value)" value="<%=CustName%>"   MAXLENGTH="50">
...
<!-- 						</div> -->
				...
				<div class="form-group">
					...
					<div class="col-sm-4">
						<div class="input-group">
							<input type="text" class="form-control" id="PRNO" name="PRNO" value="<%=finProject.getPROJECT()%>"  MAXLENGTH="50" readonly >
			   		 	</div>
					</div>
				</div>
				...
				<div class="form-group">
					...
					<div class="col-sm-4">
						<div class="input-group">
							<input type="text" class="form-control" id="PR_NAME" name="PR_NAME" value="<%=finProject.getPROJECT_NAME() %>" 
					...
					<div class="col-sm-4">
						<div class="input-group">
							<input type="text" class="form-control datepicker" id="DELDATE" 
								...
								name="DELDATE" value="<%=finProject.getPROJECT_DATE()%>" readonly>
						</div>
					</div>
				...
				<div class="form-group">
					...
					<div class="input-group">
							<input type="text" class="form-control datepicker" id=EXPIRYDATE 
								name="EXPIRYDATE" value="<%=finProject.getEXPIRY_DATE()%>" readonly>
						</div>
						<%-- <div class="input-group">
				...
				<div class="form-group">
					...
					<div class="col-sm-4">
						<div class="input-group">
							<input type="text" class="form-control" id="PRESTCOST" name="PRESTCOST" onkeypress="return isNumberKey(event,this,4)" onchange="changetaxforgst()"  value="<%=finProject.getESTIMATE_COST()%>">
					...
					<label class="control-label col-form-label col-sm-2"></label>
			 		<div class="col-sm-4">
			      	...
			      	<input type="radio" name="MANDAYHOUR" type = "radio"  value="0"  id="manday" <%if (mandayhour1 == 0) {%> checked <%}%>>Man-day</label>
			    	<label class="radio-inline">
			      	<input type="radio" name="MANDAYHOUR" type = "radio" value="1"  id = "hour" <%if (mandayhour1 == 1) {%> checked <%}%>>Hour</label>
			     	</div>
				</div>
				<div class="form-group">
					...
					<div class="col-sm-4">
						<div class="input-group">
							<input type="text" class="form-control" id="DAYHOUR" name="DAYHOUR" onkeypress="return isNumberKey(event,this,4)" value="<%=dayhour%>">
			   		 	</div>
					</div>
				</div>
				<hr />
					...
					<div class="col-sm-6 notes-sec">
						...
						<div>
							<textarea rows="2" name="Notes" class="ember-text-area form-control ember-view" 
								placeholder="Max 1000 characters"  maxlength="1000"><%=finProject.getNOTE()%></textarea>
						</div>
					</div>
				</div>
				<div class="row">
