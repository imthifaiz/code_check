...
<%
String title = "Edit Purchase Estimate Order Printout";
%>
...
<script type="text/javascript">
	...
	function onClear()
	{
        ...
        document.form1.CompanySig.value="";
 		document.form1.printDisReport.checked = false;
        ...
        document.form1.printWithExpiryDate.checked = false;
	...
	function onAdd(){
     	    document.form1.action  =  "/track/EstimateServlet?Submit=EDIT_PURCHASE_ESTIMATE";
	...
	function headerReadable(){
		...
		document.getElementById('InboundOrderHeader').getAttributeNode('class').value="inactivegry";
		}
		else{
			document.form1.InboundOrderHeader.readOnly = false;
			document.getElementById('InboundOrderHeader').getAttributeNode('class').value="";
		}
	}
	</script>
...
<%
	...
	printDetailDesc="",printSupTerms="",printSupRemarks="",printwithproject="",printwithtransportmode="",printWithUENNO="",printWithSupplierUENNO="",	Description = "", OrderQty  = "",Uom="",rcbno="",supplierrcbno="",UenNo="",SupUenNO="",grno="", 
	Rate = "",TaxAmount="",Amt="",SubTotal="",    TotalTax="",Total="",Adjustment="",ProductRatesAre="",
	Footer1="",Footer2="",Footer3="",Footer4="",Footer5="",Footer6="",Footer7="",Footer8="",Footer9="",
	remark1="",remark2="",deliverydate="",shipto="",project="",TransportMode="",showPreviousPurchaseCost="",
	CompanyDate="",CompanyName="",CompanyStamp="",CompanySig="",printDisReport="",totalafterdiscount="",grndate="",
	Discount="",NetRate="",Orientation="",orderdiscount="",shippingcost="",Roundoff="", incoterm="", Footer="",printwithproductremarks="",
	printwithbrand="",PreparedBy="",AuthSignature="",printRoundoffTotalwithDecimal="",printWithDeliveryDate="",prdDeliveryDate="",printWithPrdDeliveryDate="",ExpiryDate="",printWithExpiryDate="",
	calculateTaxwithShippingCost="",printwithcompanysig="",printwithcompanyseal="",BillNo="",employee="",printWithemployee="",BillDate="";
	int FOOTER_SIZE=0;
		
	StrUtils strUtils = new StrUtils();
    res =  strUtils.fString(request.getParameter("result"));
	POUtil posUtil = new POUtil();
         Map m= posUtil.getPurchaseEstimateHdrDetails(plant);
		 ...
		 printDisReport=(String)m.get("PRINTWITHDISCOUNT");
	     ...
	     printWithExpiryDate = (String) m.get("PRINTWITHEXPIREDATE");
...
<div class="container-fluid m-t-20">
	 ...
	 <ul class="breadcrumb backpageul">    
                ...
                <li><label>Edit Purchase Estimate Order Printout</label></li>                                   
            </ul>
        <!-- Thanzith Modified on 23.02.2022 --> 
...
<div class="form-group">
      ...
      <div class="col-sm-4">          
        <INPUT class="form-control" name="InboundOrderHeader" type="TEXT" value="<%=OrderHeader%>" <%if(DisplayByOrderType.equals("1")) {%>readonly class = inactivegry<%} else{%> class = "" <%}%>
 ...
 <label class="control-label col-form-label col-sm-2" for="Order Date">Order Date</label>      
    ...
    <div class="form-group">
      ...
      <div class="col-sm-4">          
        <INPUT class="form-control" name="BILLNO" type="TEXT" value="<%=BillNo%>"
			placeholder="Max 30 Characters" size="50" MAXLENGTH=30>
      </div>	  
    </div>
     ...
     <div class="form-group">
      ...
      <div class="col-sm-4">          
        <INPUT class="form-control" name="BILLDATE" type="TEXT" value="<%=BillDate%>"
			placeholder="Max 30 Characters" size="50" MAXLENGTH=30>
      </div>      
    </div>
 ...
 <div class="form-group">
   ...
   <div class="tab-pane active" id="other">
    ...
    <div class="form-inline">
      ...
      <div class="form-group">
      <label class="control-label col-form-label col-sm-2" for="ExpiryDate">Expire Date</label>
      <div class="col-sm-4">          
        <INPUT class="form-control" name="ExpiryDate" type="TEXT" value="<%=ExpiryDate%>"
			placeholder="Max 30 Characters" size="50" MAXLENGTH=30>
      </div>
      <div class="form-inline">
      	<div class="col-sm-4">
      		<label class="checkbox-inline">      
        		<input type = "checkbox" id = "printWithExpiryDate" name = "printWithExpiryDate" value = "printWithExpiryDate" 
				<%if(printWithExpiryDate.equals("1")) {%>checked <%}%> />Print Expiry Date</label>
      	</div>
      </div>
    </div>
     ...
     <div class="form-group">
      ...
      <div class="form-group">
      <label class="control-label col-form-label col-sm-2" for="Payment Type">Payment Type</label>
      <div class="col-sm-4">          
    ...
    <div class="form-group">
      ...
      <div class="col-sm-4" style="display: none;">
      <label class="checkbox-inline">      
        <input type = "checkbox" id = "printDisReport" name = "printDisReport" value = "printDisReport" 
			<%if(printDisReport.equals("1")) {%>checked <%}%> />Print with Discount and Unit Cost</label>
      </div>
      <div class="col-sm-4">
      <label class="checkbox-inline">      
    ...
    <div class="form-group">
      <label class="control-label col-form-label col-sm-2" for="Net Amount">Tax Amount</label>
      <div class="col-sm-4">          
    ...
    <div class="form-group" style="display: none;">
      <label class="control-label col-form-label col-sm-2" for="Total After Discount ">Total After Discount</label>
      <div class="col-sm-4">          
      ...
      <div class="form-group" style="display: none;">
      <label class="control-label col-form-label col-sm-2" for="Total Tax">Total Tax</label>
      <div class="col-sm-4">          
    ...
    <div class="form-group">
      <label class="control-label col-form-label col-sm-2" for="Roundoff">Roundoff</label>
      <div class="col-sm-4">          
        <INPUT class="form-control" name="Roundoff" type="TEXT" value="<%=Roundoff%>" placeholder="Max 30 Characters" size="50" MAXLENGTH=30>
      </div>
      <div class="col-sm-4">
      <label class="checkbox-inline">      
