...
<title>Estimate Outbound list</title>
...
<h3 class="panel-title">Estimate Outbound list</h3> 
</div>
</div>
...
<table id="myTable" class="table">
 <thead style="background: #eaeafa"> 
   ...
   try{
     ...
     ArrayList listQry = _DOUtil.getDoHdrDetails("dono,estno",ht,extCond);
    ...
    <TR>
		<td class="main2" style="font-weight: bold" align="left">&nbsp;<a href="#"
			onClick="window.opener.form.EST_DONO.value='<%=dono%>';
                     window.close();"><%=dono%></a></td>
		<td align="left" class="main2">&nbsp;<%=estno%></td>
	</TR>
