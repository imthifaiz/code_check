...
// 					"lengthMenu": [[100, 500, 1000, 2500], [100, 500, 1000, "All"]],
				        ...
				        "dataSrc": function(data){
				        	if(typeof data.items[0].expensesaccount === 'undefined'){
				        		return [];
				        			...
				        			data.items[dataIndex]['id'] = '<a href="../expenses/detail?TRANID=' +data.items[dataIndex]['id']+ '">'+data.items[dataIndex]['id']+'</a>';
				        			<% }else { %>
			    ...
			    $("#tableExpensesSummary_filter.dataTables_filter").append($("#searchType")); $.fn.dataTable.ext.search.push(function (settings, data, dataIndex) {
