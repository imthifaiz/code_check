...
<script language="javascript">
	function onDownloadOutboundTemplate(){
      	...
      	frmRoot.action = "/track/BillingServlet?Submit=BillImportTemplate" ;
      	frmRoot.submit();
      	return true;
    }    
	...
	{
  var frmRoot=document.form1;
  frmRoot.action = "/track/BillingServlet?Submit=confirmCountSheet" ;
  frmRoot.submit();
  return true;
}
 ...
 var frmRoot=document.form1;
    ...
    /*   if(frmRoot.isDataPresent.value=="true"){
      ...
      if(con) {
          ...
          frmRoot.action = "/track/BillingServlet?Submit=importCountSheet" + "&ImportFile=" + file +"&SheetName=" + sheet;
          frmRoot.submit();
          return true;
   }else
   {
...
// 	document.form1.action  = "importBill.jsp";
    ...
    <!-- Muruganantham Modified on 16.02.2022 -->
            <div class="box-header menu-drop">
              ...
              <h1 style="font-size: 18px; cursor: pointer;"
				...
				onclick="window.location.href='../bill/summary'"> <!-- resvi -->
				<i class="glyphicon glyphicon-remove"></i>
			</h1>
		</div>
 <div class="box-body">
 <form class="form-horizontal" name="form1" method="post" enctype="multipart/form-data" action="/BillingServlet">
 <input type="hidden"  name="isDataPresent" value="true" ></input>
    <input type="hidden" value="" name="download"></input>
     ...
     <div class="form-group" style="margin-bottom: 3%;">
     	<div class="col-sm-3">  
     		<button type="button" class="btn btn-success" style="margin-left: 14%;" onclick="javascript:return onDownloadOutboundTemplate();">Download Bill Template</button>
     	</div> 
     </div>
<!--      ENDS -->
    <br>
 ...
 <div class="form-inline">
  ...
  <thead>
	 <tr>
         ...
         <th style="font-size: smaller;"><font align="left">BILL</font></th> 
		 <th style="font-size: smaller;"><font align="left">LNNO</font></th>
     	 <th style="font-size: smaller;"><font align="left">RefNo</font></th>
	 	 <th style="font-size: smaller;"><font align="left">Bill Date</font></th>
	 	 <th style="font-size: smaller;"><font align="left">Bill tax</font></th>
	 	 <th style="font-size: smaller;"><font align="left">Supplier Code</font></th> 
	 	 ...
	 	 <th style="font-size: smaller;"><font align="left">UOM</font></th> 
	  	 <th style="font-size: smaller;"><font align="left">Unit Cost</font></th>
     ...
     <tbody>
       ...
       %>
             ...
             <TD align="left"><%=(String)lineArr.get("BILL")%></TD>
             <TD align="left"><%=(String)lineArr.get("LNNO")%></TD>
             <TD align="left"><%="null".equalsIgnoreCase((String)lineArr.get("REFERENCE")) ? "" :  (String)lineArr.get("REFERENCE")%></TD>
             <TD align="left"><%=(String)lineArr.get("BILLDATE")%></TD>
             <TD align="left"><%=(String)lineArr.get("TAX")%></TD>
             <TD align="left"><%=(String)lineArr.get("SUPPLIERCODE")%></TD>
