...
<script language="JavaScript" type="text/javascript" src="../jsp/js/general.js"></script>
    ...
    function onDownloadContactTemplate()
    {
      var frmRoot=document.form1;
      frmRoot.action = "/track/ImportItemServlet?action=downloadContactTemplate" ;
      frmRoot.submit();
      return true;
    }    
...
{
  var frmRoot=document.form1;
  frmRoot.action = "/track/ImportItemServlet?action=confirmContactCountSheet" ;
  frmRoot.submit();
  return true;
}
 ...
 var frmRoot=document.form1;
  ...
  else if(frmRoot.SheetName.value=="" || frmRoot.SheetName.value.length==0)
	{
      ...
      if(con) {
          ...
          frmRoot.action = "/track/ImportItemServlet?action=importContactCountSheet" + "&ImportFile=" + file +"&SheetName=" + sheet ;
          frmRoot.submit();
          return true;
   }else
   {
...
%>
 ...
 <input type="hidden"  name="isDataPresent" value="true" ></input>
    ...
    <div class="form-group" style="margin-bottom: 3%;">
     	<div class="col-sm-3">  
     		<button type="button" class="btn btn-success" style="margin-left: 14%;" onclick="javascript:return onDownloadContactTemplate();">Download Contact Template</button>
     	</div> 
     </div>
    <br>
  ...
  <TABLE class="table table-bordred table-striped" WIDTH="80%"  border="0" cellspacing="1" cellpadding = 2 align = "center">
   <thead>
	    <tr>
              ...
              <th style="font-size: smaller;" width="10%"><font align="left">Company Name</font></th> 
              <th style="font-size: smaller;" width="10%"><font align="left">Country</font></th> 
              <th style="font-size: smaller;" width="10%"><font align="left">Industry</font></th> 
              <th style="font-size: smaller;" width="10%"><font align="left">Contact Person</font></th> 
              <th style="font-size: smaller;" width="10%"><font align="left">Contact Number</font></th> 
              <th style="font-size: smaller;" width="10%"><font align="left">Email</font></th> 
              <th style="font-size: smaller;" width="10%"><font align="left">Sales Consultant</font></th> 
              <th style="font-size: smaller;" width="10%"><font align="left">LifeCycle Stage</font></th> 
              <th style="font-size: smaller;" width="10%"><font align="left">Lead Status</font></th> 
     	 </tr>
     	  </thead>
	      <tbody>
       <%
       ...
       %>
           <TR>
             ...
             <TD align="left" width="10%"><%=(String)lineArr.get("COMPANY")%></TD>
             <TD align="left" width="10%"><%=(String)lineArr.get("COUNTRY")%></TD>
             <TD align="left" width="10%"><%=(String)lineArr.get("INDUSTRY")%></TD>
             <TD align="left" width="10%"><%=(String)lineArr.get("CONTACT_PERSON")%></TD>
             <TD align="left" width="10%"><%=(String)lineArr.get("CONTACT_NO")%></TD>
             <TD align="left" width="10%"><%=(String)lineArr.get("EMAIL")%></TD>
             <TD align="left" width="10%"><%=(String)lineArr.get("SALES_CONS")%></TD>
             <TD align="left" width="10%"><%=(String)lineArr.get("LIFECYCLE")%></TD>
             <TD align="left" width="10%"><%=(String)lineArr.get("LEAD_STATUS")%></TD>
           </TR> 
       <%}%>
