...
<%
String title = "Import Customer Discount Sales Order";
%>
...
{
  var frmRoot=document.form1;
  frmRoot.action = "/track/ImportServlet?action=confirmCustomerDiscountCountSheet" ;
  frmRoot.submit();
  return true;
}
 ...
 var frmRoot=document.form1;
  ...
  else if(frmRoot.SheetName.value=="" || frmRoot.SheetName.value.length==0)
	{
      ...
      if(con) {
          ...
          frmRoot.action = "/track/ImportServlet?action=importCustomerDiscountCountSheet" + "&ImportFile=" + file +"&SheetName=" + sheet;
          frmRoot.submit();
          return true;
   }else
   {
...
if(action.equalsIgnoreCase("new")){
   ...
   session.removeAttribute("IMP_CUSTOMERDISCOUNTRESULT");
   session.removeAttribute("CUSTOMERDISCOUNTRESULT");
   ImportFile="";
   SheetName="";
   action="";
 ...
 fieldDesc=StrUtils.fString((String)session.getAttribute("CUSTOMERDISCOUNTRESULT"));
 session.removeAttribute("CUSTOMERDISCOUNTRESULT");
 if(null == session.getAttribute("IMP_CUSTOMERDISCOUNTRESULT"))
    {
      alRes = new ArrayList();
      buttonStat= "disabled";
   } else{
    
      alRes = (ArrayList)session.getAttribute("IMP_CUSTOMERDISCOUNTRESULT");
      if(alRes.size()==0)
      buttonStat= "disabled";
  }
...
%>
  <div class="container-fluid m-t-20">
	 ...
	 <!-- Thanzith Modified on 16.02.2022 -->
            <ol class="breadcrumb backpageul" >      	
                ...
                <li><a href="../customer/discount"><span class="underline-on-hover">Customer Discount Summary</span> </a></li>               
                <li>Import Customer Discount Sales Order</li>                                   
            </ol>             
    <!-- Thanzith Modified on 16.02.2022 -->
            <div class="box-header menu-drop">
              ...
              <h1 style="font-size: 18px; cursor: pointer;"
				...
				onclick="window.location.href='../customer/discount'" >
 ...
 <input type="hidden"  name="isDataPresent" value="true" ></input>
    ...
    <div class="form-group" style="margin-bottom: 3%;">
     	<div class="col-sm-3">  
     		<button type="button" class="btn btn-success" style="margin-left: 14%;" onclick="javascript:return onDownloadCustomerDiscountTemplate();">Download Customer Discount Template</button>
     	</div> 
     </div>
    <br>
 ...
 <div class="form-inline">
   ...
   <div class="form-group">        
      	<div class="col-sm-12" align="center">
       	<button type="button" class="Submit btn btn-default" onclick="window.location.href='../customer/importdiscount'">Clear</button>&nbsp;
  ...
  <TABLE class="table table-bordred table-striped" WIDTH="80%"  border="0" cellspacing="1" cellpadding = 2 align = "center">
   <thead>
	    <tr>
         ...
         <th style="font-size: smaller;" width="13%"><font align="left">Customer Type ID</font></th> 
         <th style="font-size: smaller;" width="13%"><font align="left">By Price</font></th>
	 ...
	 <tbody>
       ...
       %>
            <TR>
              ...
              <TD align="left" width="12%"><%=(String)lineArr.get(IConstants.CUSTOMERTYPEID)%></TD>
              <TD align="left" width="12%"><%=(String)lineArr.get(IConstants.BYPRICE)%></TD>
              <TD align="left" width="12%"><%=(String)lineArr.get(IConstants.BYPERCENTAGE)%></TD>
             </TR> 
       <%}%>
    </tbody>
    </TABLE>
