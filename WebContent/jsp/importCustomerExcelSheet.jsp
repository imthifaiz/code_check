...
<%
String title = "Import Customer Master";
%>
...
{
  var frmRoot=document.form1;
  frmRoot.action = "/track/ImportServlet?action=confirmCustomerCountSheet" ;
  frmRoot.submit();
  return true;
}
 ...
 var frmRoot=document.form1;
  ...
  else if(frmRoot.SheetName.value=="" || frmRoot.SheetName.value.length==0)
	{
      ...
      if(con) {
          ...
          var trunkateData ="";
          frmRoot.action = "/track/ImportServlet?action=importCustomerCountSheet" + "&ImportFile=" + file +"&SheetName=" + sheet ;
          frmRoot.submit();
          return true;
   }else
   {
...
if(action.equalsIgnoreCase("new")){
   ...
   session.removeAttribute("IMP_CUSTRESULT");
   session.removeAttribute("CUSTRESULT");
   ImportFile="";
   SheetName="";
   action="";
 ...
 fieldDesc=StrUtils.fString((String)session.getAttribute("CUSTRESULT"));
 session.removeAttribute("CUSTRESULT");

 if(null == session.getAttribute("IMP_CUSTRESULT"))
    {
      alRes = new ArrayList();
      buttonStat= "disabled";
   } else{
    
      alRes = (ArrayList)session.getAttribute("IMP_CUSTRESULT");
...
%>
  <div class="container-fluid m-t-20">
	 ...
	 <ul class="breadcrumb backpageul">    
                ...
                <li><label>Import Customer Master</label></li>                                   
            </ul>
        <!-- Thanzith Modified on 28.02.2022 --> 
 ...
 <input type="hidden"  name="isDataPresent" value="true" ></input>
    ...
    <div class="form-group" style="margin-bottom: 3%;">
     	<div class="col-sm-3">  
     		<button type="button" class="btn btn-success" style="margin-left: 14%;" onclick="javascript:return onDownloadCustTemplate();">Download Customer Template</button>
     	</div> 
     </div>
    <br>
 ...
 <div class="form-inline">
  ...
  <div class="form-group">        
      	<div class="col-sm-12" align="center">
       	<button type="button" class="Submit btn btn-default" onclick="window.location.href='../customer/import'">Clear</button>&nbsp;
  ...
  <TABLE class="table table-bordred table-striped" WIDTH="80%"  border="0" cellspacing="1" cellpadding = 2 align = "center">
   <thead>
        ...
        <th style="font-size: smaller;"><font align="left">Customer ID</font></th>
        <th style="font-size: smaller;"><font align="left">Customer Name</font></th>
        <th style="font-size: smaller;"><font align="left">Customer Currency</font></th>
       	<th style="font-size: smaller;"><font align="left">Customer Type</font></th>       	 
        <th style="font-size: smaller;"><font align="left">Customer Phone</font></th>
        <th style="font-size: smaller;"><font align="left">Customer Fax</font></th>
        <th style="font-size: smaller;"><font align="left">Customer Email</font></th>
...
<!--         <th style="font-size: smaller;"><font align="left">Opening Balance</font></th> -->
        <th style="font-size: smaller;"><font align="left">Credit Limit</font></th>
        <th style="font-size: smaller;"><font align="left">Credit Limit By</font></th>
      ...
      <%
       ...
       %>
              <TR>
                ...
                <TD align="left"><%=StrUtils.fString((String)lineArr.get("CUSTNO"))%></TD>
                ...
                <TD align="left" ><%=StrUtils.fString((String)lineArr.get("CUSTOMER_TYPE_ID"))%></TD>                
...
<%--                 <TD align="left" ><%=StrUtils.fString((String)lineArr.get("OPENINGBALANCE"))%></TD> --%>
                 <TD align="right" ><%=StrUtils.fString((String)lineArr.get("CREDITLIMIT"))%></TD>
                <TD align="left" ><%=StrUtils.fString((String)lineArr.get("CREDIT_LIMIT_BY"))%></TD>
