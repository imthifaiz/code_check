...
<%
String title = "Import Employee Leave Apply";
%>
...
<script language="JavaScript" type="text/javascript" src="js/general.js"></script>
    ...
    function onLeaveApplyTemplate()
    {
      var frmRoot=document.form1;
      frmRoot.action = "/track/ImportServlet?action=downloadEmployeeLeaveApplyTemplate" ;
      frmRoot.submit();
      return true;
    }
...
{
  var frmRoot=document.form1;
  frmRoot.action = "/track/ImportServlet?action=confirmEmployeeLeaveApplyCountSheet" ;
  frmRoot.submit();
  return true;
}
 ...
 var frmRoot=document.form1;
  ...
  else if(frmRoot.SheetName.value=="" || frmRoot.SheetName.value.length==0)
	{
      ...
      if(con) {
          ...
          var trunkateData ="";
          frmRoot.action = "/track/ImportServlet?action=importEmployeeLeaveApplyCountSheet" + "&ImportFile=" + file +"&SheetName=" + sheet ;
          frmRoot.submit();
          return true;
   }else
   {
...
function onClear()
{
	document.form1.action  = "importEmployeeLeaveApply.jsp";
...
%>
	 ...
	 <div class="box"> 
            <div class="box-header menu-drop">
              ...
              <h1 style="font-size: 18px; cursor: pointer;"
				...
				onclick="window.location.href='ApplyLeave.jsp'">
 ...
 <input type="hidden"  name="isDataPresent" value="true" ></input>
    ...
    <div class="form-group" style="margin-bottom: 3%;">
     	<div class="col-sm-3"> 
     			<button type="button" class="btn btn-success" style="margin-left: 14%;" onclick="javascript:return onLeaveApplyTemplate();">Download Leave Apply Template</button>
     	</div> 
     </div>
    <br>
 ...
 <div class="form-inline">
  ...
  <TABLE class="table table-bordred table-striped" WIDTH="80%"  border="0" cellspacing="1" cellpadding = 2 align = "center">
   <thead>
        ...
        <th style="font-size: smaller;"><font align="left">LEAVE TYPE</font></th>  
        <th style="font-size: smaller;"><font align="left">LEAVE DURATION</font></th>      
        <th style="font-size: smaller;"><font align="left">NUMBER OF DAYS</font></th>
        <th style="font-size: smaller;"><font align="left">FROM DATE</font></th>
        <th style="font-size: smaller;"><font align="left">FROM DATE PART OF THE DAYS</font></th>
        <th style="font-size: smaller;"><font align="left">TO DATE</font></th>
        <th style="font-size: smaller;"><font align="left">TO DATE PART OF THE DAYS</font></th>
      ...
      <%
       ...
       %>
              <TR>
                ...
                <TD align="left"><%=StrUtils.fString((String)lineArr.get("EMPCODE"))%></TD>
                <TD align="left" ><%=StrUtils.fString((String)lineArr.get("EMPNAME"))%></TD>
                <TD align="left" ><%=StrUtils.fString((String)lineArr.get("LEAVETYPE"))%></TD>   
                 <TD align="left" ><%=StrUtils.fString((String)lineArr.get("LEAVEDURATION"))%></TD>                
                <TD align="left" ><%=StrUtils.fString((String)lineArr.get("NUMBEROFDAYS"))%></TD>
                <TD align="left" ><%=StrUtils.fString((String)lineArr.get("FROMDATE"))%></TD>
                <TD align="left" ><%=StrUtils.fString((String)lineArr.get("FDAYSTATUS"))%></TD>
                <TD align="left" ><%=StrUtils.fString((String)lineArr.get("TODATE"))%></TD>
                <TD align="left" ><%=StrUtils.fString((String)lineArr.get("TDAYSTATUS"))%></TD>
