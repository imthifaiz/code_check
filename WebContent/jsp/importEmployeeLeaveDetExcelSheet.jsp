...
<%
String title = "Import Employee Leave Details";
%>
...
function onConfirm()
{
  ...
  frmRoot.action = "/track/ImportServlet?action=confirmEmployeeLeaveDetCountSheet" ;
  frmRoot.submit();
  return true;
}

function onDownloadEmployeelvtTemplate()
{
  var frmRoot=document.form1;
  frmRoot.action = "/track/ImportServlet?action=downloadEmployeeLeaveDetTemplate" ;
  frmRoot.submit();
  return true;
}
 ...
 var frmRoot=document.form1;
  ...
  else if(frmRoot.SheetName.value=="" || frmRoot.SheetName.value.length==0)
	{
      ...
      if(con) {
          ...
          var trunkateData ="";
          frmRoot.action = "/track/ImportServlet?action=importEmployeeLeaveDetCountSheet" + "&ImportFile=" + file +"&SheetName=" + sheet ;
          frmRoot.submit();
          return true;
   }else
   {
...
/* function onClear()
{
	document.form1.action  = "importEmployeeLeaveDetExcelSheet.jsp";
  ...
  <div class="container-fluid m-t-20">
	 ...
	 <!-- Muruganantham Modified on 16.02.2022 -->
            <ul class="breadcrumb backpageul">      	
                ...
                <li><label>Import Employee Leave Details</label></li>                                   
            </ul>             
    <!-- Muruganantham Modified on 16.02.2022 --> 
 ...
 <input type="hidden"  name="isDataPresent" value="true" ></input>
    <input type="hidden" value="" name="download"></input>
     <div class="form-group" style="margin-bottom: 3%;">
     	<div class="col-sm-3">  
     		<button type="button" class="btn btn-success" style="margin-left: 14%;" onclick="javascript:return onDownloadEmployeelvtTemplate();">Download Employee Leave Details Template</button>
     	</div> 
     </div>
 ...
 <div class="form-inline">
      ...
      <div class="form-group">        
      	<div class="col-sm-12" align="center">
       	<button type="button" class="Submit btn btn-default" onclick="window.location.href='../payroll/importempleave'">Clear</button>&nbsp;
  ...
  <TABLE class="table table-bordred table-striped" WIDTH="80%"  border="0" cellspacing="1" cellpadding = 2 align = "center">
   <thead>
        ...
        <th style="font-size: smaller;"><font align="left">TOTAL ENTITLEMENT</font></th>        
        <th style="font-size: smaller;"><font align="left">LEAVE YEAR</font></th>
        <th style="font-size: smaller;"><font align="left">NOTES</font></th>
         </tr>
         </thead>
         <tbody>
      <%
       ...
       %>
              <TR>
                ...
                <TD align="left" ><%=StrUtils.fString((String)lineArr.get("LEAVETYPE"))%></TD>  
                 <TD align="left" ><%=StrUtils.fString((String)lineArr.get("TDAYS"))%></TD>                
                <TD align="left" ><%=StrUtils.fString((String)lineArr.get("LYEAR"))%></TD>
                <TD align="left" ><%=StrUtils.fString((String)lineArr.get("NOTES"))%></TD>
           </TR> 
       <%}%>
    </tbody>
    </TABLE>
