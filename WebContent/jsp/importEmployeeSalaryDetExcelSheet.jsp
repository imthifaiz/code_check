...
<%
String title = "Import Employee Salary Details";
%>
...
function onConfirm()
{
  ...
  frmRoot.action = "/track/ImportServlet?action=confirmEmployeeSalaryDetCountSheet" ;
  frmRoot.submit();
  return true;
}

function onDownloadEmployeeSalaryTemplate()
{
  var frmRoot=document.form1;
  frmRoot.action = "/track/ImportServlet?action=downloadEmployeeSalaryDetTemplate" ;
  frmRoot.submit();
  return true;
}
 ...
 var frmRoot=document.form1;
  ...
  else if(frmRoot.SheetName.value=="" || frmRoot.SheetName.value.length==0)
	{
      ...
      if(con) {
          ...
          var trunkateData ="";
          frmRoot.action = "/track/ImportServlet?action=importEmployeeSalaryDetCountSheet" + "&ImportFile=" + file +"&SheetName=" + sheet ;
          frmRoot.submit();
          return true;
   }else
   {
...
/* function onClear()
{
	document.form1.action  = "importEmployeeSalaryDetExcelSheet.jsp";
  ...
  <div class="container-fluid m-t-20">
	 ...
	 <!-- Muruganantham Modified on 16.02.2022 -->
            <ul class="breadcrumb backpageul">      	
                ...
                <li><label>Import Employee Salary Details</label></li>                                   
            </ul>             
    <!-- Muruganantham Modified on 16.02.2022 --> 
 ...
 <input type="hidden"  name="isDataPresent" value="true" ></input>
    <input type="hidden" value="" name="download"></input>
     <div class="form-group" style="margin-bottom: 3%;">
     	<div class="col-sm-3">  
     		<button type="button" class="btn btn-success" style="margin-left: 14%;" onclick="javascript:return onDownloadEmployeeSalaryTemplate();">Download Employee Salary Details Template</button>
     	</div> 
     </div>
 ...
 <div class="form-inline">
      ...
      <div class="form-group">        
      	<div class="col-sm-12" align="center">
       	<button type="button" class="Submit btn btn-default" onclick="window.location.href='../payroll/importempsalary'"> Clear</button>&nbsp;
  ...
  <TABLE class="table table-bordred table-striped" WIDTH="80%"  border="0" cellspacing="1" cellpadding = 2 align = "center">
   <thead>
        ...
        <th style="font-size: smaller;"><font align="left">SALARY</font></th>
         </tr>
         </thead>
         <tbody>
      <%
       ...
       %>
              <TR>
                ...
                <TD align="left" ><%=StrUtils.fString((String)lineArr.get("SALARYTYPE"))%></TD>  
                 <TD align="left" ><%=StrUtils.fString((String)lineArr.get("SALARY"))%></TD>
           </TR> 
       <%}%>
    </tbody>
    </TABLE>
