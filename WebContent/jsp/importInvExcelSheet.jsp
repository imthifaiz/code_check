...
<%
String title = "Import Inventory Master";
%>
...
function onConfirm()
{
  ...
  frmRoot.action = "/track/ImportInvServlet?action=confirmCountSheet" ;
  frmRoot.submit();
  return true;
}
 ...
 var frmRoot=document.form1;
    ...
    /*   if(frmRoot.isDataPresent.value=="true"){
      ...
      if(con) {
          ...
          frmRoot.action = "/track/ImportInvServlet?action=importCountSheet" + "&ImportFile=" + file +"&SheetName=" + sheet;
          frmRoot.submit();
          return true;
   }else
   {
...
%>
  <div class="container-fluid m-t-20">
	 ...
	 <ul class="breadcrumb backpageul">    
                ...
                <li><label>Import Inventory Master</label></li>                                   
            </ul>
        <!-- Thanzith Modified on 23.02.2022 -->     
<!-- 	 RESVI -->
 ...
 <!-- <table border="0" width="80%" cellspacing="0" cellpadding="0" align="center"      bgcolor="#dddddd">
   ...
   <div class="form-group">        
      	<div class="col-sm-12" align="center">
       	<button type="button" class="Submit btn btn-default" onclick="window.location.href='../import/inventoryexcel'"> Clear</button>&nbsp;
  ...
  <TABLE class="table table-bordred table-striped" WIDTH="80%"  border="0" cellspacing="1" cellpadding = 2 align = "center">
   <thead >
	    <tr>
           ...
           <th style="font-size: smaller;" width="5%"><font align="left">QTY</font></th>
	 ...
	 <tbody>
       ...
       %>
           <TR>
             ...
             <TD align="left" width="13%"><%=(String)lineArr.get(IConstants.IN_UNITMO)%></TD>
       ...
       <TR bgcolor = "">
             ...
             <TD align="left" width="13%"><%=(String)linemap.get(IConstants.IN_UNITMO)%></TD>
