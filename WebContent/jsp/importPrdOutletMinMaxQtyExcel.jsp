...
<%
String title = "Import Outlet Min/Max Quantity";
%>
...
<script language="JavaScript" type="text/javascript" src="../jsp/js/general.js"></script>
    ...
    function onDownloadOutletMinMaxTemplate()
    {
      var frmRoot=document.form1;
      frmRoot.action = "/track/ImportItemServlet?action=downloadOutletMinMaxTemplate" ;
      frmRoot.submit();
      return true;
    }    
...
{
  var frmRoot=document.form1;
  frmRoot.action = "/track/ImportItemServlet?action=confirmOutletMinMaxCountSheet" ;
  frmRoot.submit();
  return true;
}
 ...
 var frmRoot=document.form1;
  ...
  else if(frmRoot.SheetName.value=="" || frmRoot.SheetName.value.length==0)
	{
      ...
      if(con) {
          ...
          frmRoot.action = "/track/ImportItemServlet?action=importOutletMinMaxCountSheet" + "&ImportFile=" + file +"&SheetName=" + sheet ;
          frmRoot.submit();
          return true;
   }else
   {
...
%>
  <div class="container-fluid m-t-20">
	 ...
	 <!-- Thanzith Modified on 16.02.2022 -->
            <ol class="breadcrumb backpageul" >      	
                ...
                <li>Import Outlet Min/Max Quantity</li>                                   
            </ol>             
    <!-- Thanzith Modified on 16.02.2022 -->
 ...
 <input type="hidden"  name="isDataPresent" value="true" ></input>
    ...
    <div class="form-group" style="margin-bottom: 3%;">
     	<div class="col-sm-3">  
     		<button type="button" class="btn btn-success" style="margin-left: 14%;" onclick="javascript:return onDownloadOutletMinMaxTemplate();">Download Min/Max Quantity Template</button>
     	</div> 
     </div>
    <br>
  ...
  <TABLE class="table table-bordred table-striped" WIDTH="80%"  border="0" cellspacing="1" cellpadding = 2 align = "center">
   <thead>
	    <tr>
              ...
              <th style="font-size: smaller;" width="10%"><font align="left">Outlet</font></th> 
	          <th style="font-size: smaller;" width="10%"><font align="left">Min Qty</font></th>
	          <th style="font-size: smaller;" width="10%"><font align="left">Max Qty</font></th>
     	 </tr>
     	  </thead>
	      <tbody>
       <%
       ...
       %>
           <TR>
             ...
             <TD align="left" width="10%"><%=(String)lineArr.get(IConstants.OUTLET)%></TD>
             <TD align="left" width="12%"><%=(String)lineArr.get(IConstants.STKQTY)%></TD>
             <TD align="left" width="12%"><%=(String)lineArr.get(IConstants.MAXSTKQTY)%></TD>
           </TR> 
       <%}%>
