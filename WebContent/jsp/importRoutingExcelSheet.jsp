...
function onConfirm()
{
  ...
  frmRoot.action = "/track/WorkOrderImportServlet?action=confirmRoutingCountSheet" ;
  frmRoot.submit();
  return true;
}
 ...
 var frmRoot=document.form1;
    ...
    /*   if(frmRoot.isDataPresent.value=="true"){
      ...
      if(con) {
          ...
          frmRoot.action = "/track/WorkOrderImportServlet?action=importRoutingCountSheet" + "&ImportFile=" + file +"&SheetName=" + sheet;
          frmRoot.submit();
          return true;
   }else
   {
...
if(action.equalsIgnoreCase("new")){
   ...
   session.removeAttribute("IMP_ROUTINGRESULT");
   session.removeAttribute("ROUTINGRESULT");
   ImportFile="";
   SheetName="";
   action="";
 ...
 fieldDesc=StrUtils.fString((String)session.getAttribute("ROUTINGRESULT"));

 if(null == session.getAttribute("IMP_ROUTINGRESULT"))
    {
      alRes = new ArrayList();
      buttonStat= "disabled";
   } else{
    
      alRes = (ArrayList)session.getAttribute("IMP_ROUTINGRESULT");
      if(alRes.size()==0)
      buttonStat= "disabled";
  }
...
%>
    ...
    <table border="0" width="100%" cellspacing="0" cellpadding="0"
      ...
      <tr>
        <th bgcolor="#000066" colspan="11">
          <font color="#ffffff">Import Routing Data </font>
        </th>
      </tr>
    </table>
  ...
  <TABLE WIDTH="90%"  border="0" cellspacing="1" cellpadding = 2 align = "center">
	 ...
	 <td width="5%"><font color="#ffffff" align="left"><center><STRONG>Remarks</STRONG></center></font></td>
	  </tr>
       <%
