...
<%
String title = "Import Shopee Sales Order";
%>
...
function onConfirm()
{
  ...
  frmRoot.action = "/track/OrderImportServlet?action=confirmCountSheetShopee" ;
  frmRoot.submit();
  return true;
}
 ...
 var frmRoot=document.form1;
  ...
  else if(frmRoot.SheetName.value=="" || frmRoot.SheetName.value.length==0)
	{
      ...
      if(con) {
          ...
          frmRoot.action = "/track/OrderImportServlet?action=importCountSheetShopee" + "&ImportFile=" + file +"&SheetName=" + sheet;
          frmRoot.submit();
          return true;
   }else
   {
...
function onClear()
{
	document.form1.action  = "importShopifySalesOrder.jsp";
...
if(action.equalsIgnoreCase("new")){
   ...
   session.removeAttribute("IMP_OUTBOUNDRESULT_SHOPEE");
   session.removeAttribute("OUTBOUNDRESULT_SHOPEE");
   ImportFile="";
   SheetName="";
   action="";
 ...
 fieldDesc=StrUtils.fString((String)session.getAttribute("OUTBOUNDRESULT_SHOPEE"));

 if(null == session.getAttribute("IMP_OUTBOUNDRESULT_SHOPEE"))
    {
      alRes = new ArrayList();
      buttonStat= "disabled";
   } else{
    
      alRes = (ArrayList)session.getAttribute("IMP_OUTBOUNDRESULT_SHOPEE");
      if(alRes.size()==0)
      buttonStat= "disabled";
  }
...
%>
	...
	<!-- Muruganantham Modified on 16.02.2022 -->
            <ol class="breadcrumb backpageul">      	
                ...
                <li><label>Import Shopee Sales Order</label></li>                                   
            </ol>             
    <!-- Muruganantham Modified on 16.02.2022 -->
            <div class="box-header menu-drop">
              ...
              <h1 style="font-size: 18px; cursor: pointer;"
				...
				onClick="window.location.href='../salesorder/summary'" > 
...
<div class="form-group">
 ...
 <div class="form-inline">
      ...
      <!-- <input name="SheetName" type="text" value="<%=SheetName%>" size="20" maxlength="20"></input> -->         
        <INPUT class="form-control" name="SheetName" type="text" value="orders" size="20" maxlength="20">
          </div>
          <div class="col-sm-1">
