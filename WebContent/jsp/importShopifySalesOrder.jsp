...
<%
String title = "Import Shopify Sales Order";
%>
...
function onConfirm()
{
  ...
  frmRoot.action = "/track/OrderImportServlet?action=confirmCountSheetShopify" ;
  frmRoot.submit();
  return true;
}
 ...
 var frmRoot=document.form1;
    ...
    /*   if(frmRoot.isDataPresent.value=="true"){
      ...
      if(con) {
          ...
          frmRoot.action = "/track/OrderImportServlet?action=importCountSheetShopify" + "&ImportFile=" + file +"&SheetName=" + sheet;
          frmRoot.submit();
          return true;
   }else
   {
...
if(action.equalsIgnoreCase("new")){
   ...
   session.removeAttribute("IMP_OUTBOUNDRESULT_SHPIFY");
   session.removeAttribute("OUTBOUNDRESULT_SHPIFY");
   ImportFile="";
   SheetName="";
   action="";
 ...
 fieldDesc=StrUtils.fString((String)session.getAttribute("OUTBOUNDRESULT_SHPIFY"));

 if(null == session.getAttribute("IMP_OUTBOUNDRESULT_SHPIFY"))
    {
      alRes = new ArrayList();
      buttonStat= "disabled";
   } else{
    
      alRes = (ArrayList)session.getAttribute("IMP_OUTBOUNDRESULT_SHPIFY");
      if(alRes.size()==0)
      buttonStat= "disabled";
  }
...
%>
	...
	<!-- Muruganantham Modified on 16.02.2022 -->
            <ol class="breadcrumb backpageul">      	
                ...
                <li><label>Import Shopify Sales Order</label></li>                                   
            </ol>             
    <!-- Muruganantham Modified on 16.02.2022 -->
...
<div class="form-group">
 ...
 <div class="form-inline">
      ...
      <!-- <input name="SheetName" type="text" value="<%=SheetName%>" size="20" maxlength="20"></input> -->         
        <INPUT class="form-control" name="SheetName" type="text" value="in" size="20" maxlength="20">
          </div>
          <div class="col-sm-1">
