...
<%
String title = "Import Consignment Order Customer Master";
%>
...
{
  var frmRoot=document.form1;
  frmRoot.action = "/track/ImportServlet?action=confirmTransferAssigneeCountSheet" ;
  frmRoot.submit();
  return true;
}
 ...
 var frmRoot=document.form1;
  ...
  else if(frmRoot.SheetName.value=="" || frmRoot.SheetName.value.length==0)
	{
      ...
      if(con) {
          ...
          var trunkateData ="";
          frmRoot.action = "/track/ImportServlet?action=importTransferAssigneeCountSheet" + "&ImportFile=" + file +"&SheetName=" + sheet ;
          frmRoot.submit();
          return true;
   }else
   {
...
function onClear()
{
	document.form1.action  = "importTransferAssigneeExcelSheet.jsp";
...
if(action.equalsIgnoreCase("new")){
   ...
   session.removeAttribute("IMP_TRANSFERASSIGNEERESULT");
   session.removeAttribute("TRANSFERASSIGNEERESULT");
   ImportFile="";
   SheetName="";
   action="";
 ...
 fieldDesc=StrUtils.fString((String)session.getAttribute("TRANSFERASSIGNEERESULT"));

 if(null == session.getAttribute("IMP_TRANSFERASSIGNEERESULT"))
    {
      alRes = new ArrayList();
      buttonStat= "disabled";
   } else{
    
      alRes = (ArrayList)session.getAttribute("IMP_TRANSFERASSIGNEERESULT");
...
%>
	 ...
	 <div class="box"> 
            <div class="box-header menu-drop">
              ...
              <h1 style="font-size: 18px; cursor: pointer;"
				...
				onclick="window.location.href='toassigneeSummary.jsp'">
 ...
 <input type="hidden"  name="isDataPresent" value="true" ></input>
    ...
    <div class="form-group" style="margin-bottom: 3%;">
     	<div class="col-sm-3">  
     		<button type="button" class="btn btn-success" style="margin-left: 14%;" onclick="javascript:return onDownloadTransferAssigneeTemplate();">Download Consignment Order Customer Template</button>
     	</div> 
     </div>
    <br>
      ...
      <%
       ...
       %>
              <TR>
                ...
                <TD align="left"><%=StrUtils.fString((String)lineArr.get("ASSIGNENO"))%></TD>
                <TD align="left" ><%=StrUtils.fString((String)lineArr.get("ASSIGNENAME"))%></TD>
