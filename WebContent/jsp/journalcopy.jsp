...
<%
String title = "Copy Manual Journals";
	 ...
	 <div class="box"> 
	  <!-- Muruganantham Modified on 16.02.2022 -->
            <ul class="breadcrumb backpageul">      	
                ...
                <li><a href="../banking/journaldetail?ID=<%=journalid%>"><span class="underline-on-hover">Manual Journals Detail</span> </a></li>                     
                <li><label>Copy Manual Journals</label></li>                                   
            </ul>             
    <!-- Muruganantham Modified on 16.02.2022 -->
            <div class="box-header menu-drop">
              <h1 style="font-size: 20px;" class="box-title"><%=title %></h1>
              <h1 style="font-size: 18px;cursor:pointer;" class="box-title pull-right" onclick="window.location.href='../banking/journaldetail?ID=<%=journalid%>'">
