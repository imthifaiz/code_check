...
<%
String title = "New Manual Journals";
String plant = StrUtils.fString((String) session.getAttribute("PLANT"));
String curency = StrUtils.fString((String) session.getAttribute("BASE_CURRENCY"));
String username = StrUtils.fString((String) session.getAttribute("LOGIN_USER"));
String NOOFJOURNAL=((String) session.getAttribute("NOOFJOURNAL")); /* Resvi */
...
int noordvalid =journalDAO.Journalcount(plant,FROM_DATE,TO_DATE);
if(!NOOFJOURNAL.equalsIgnoreCase("Unlimited"))
{
	int convl = Integer.valueOf(NOOFJOURNAL);
	if(noordvalid>=convl)
	{
		OrdValidNumber=NOOFJOURNAL;
	}
}
//	resvi ends
...
<div class="container-fluid m-t-20">
	 ...
	 <!-- Muruganantham Modified on 16.02.2022 -->
            <ul class="breadcrumb backpageul">      	
                ...
                <li><label>New Manual Journals</label></li>                                   
            </ul>             
    <!-- Muruganantham Modified on 16.02.2022 -->
            <div class="box-header menu-drop">
              <h1 style="font-size: 20px;" class="box-title"><%=title %></h1>
              <h1 style="font-size: 18px;cursor:pointer;" class="box-title pull-right" onclick="window.location.href='../banking/journalsummary'">
	...
	<form id="journalForm" class="form-horizontal" name="form1"  action="/track/JournalServlet?action=create"  method="post" enctype="multipart/form-data">			
		...
		<input type="text" name="tran_type" value="JOURNAL" hidden>
		...
		<div class="form-group">
			...
			<div class="col-sm-2">
			<label class="control-label col-form-label required">Journal#</label>
			</div>
			<div class="col-sm-4">
