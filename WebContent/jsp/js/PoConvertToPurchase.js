...
$(document).ready(function(){
	...
	var pono = document.cpoform.PONOOLD.value;
...
//	getSupplierDetails();
	...
	$("#btnSalesOpenEmail").click(function(){
		...
		if(isValid){
			...
			$.ajax({
				type : "POST",
				url : "../purchaseorder/convertToPurchase",
				data : data,
				dataType : "json",
				contentType: false,
				processData: false,
...
//			}else{
//				$('#shipadd').empty();
//				var addr = '<div><h5 style="font-weight: bold;">Shipping Address   <a><span data-toggle="modal" data-target="#shipaddr" onclick="getshipaddr();">Change</span></a></h5>';
...
function loadPOTable(orders){
	...
	$.each(orders, function( key, data) {
			...
			body += '<input type="text" name="item" class="form-control itemSearch" value="'+data.ITEM+'" style="width:87%" placeholder="Type or click to select an item.">';
			body += '<button type="button" style="position: absolute;margin-left: -18px;z-index: 2;vertical-align: middle;font-size: 20px;opacity: 0.5;" onclick="changeitem(this)"><i class="glyphicon glyphicon-menu-down" style="font-size: 8px;"></i></button>';
