...
function removeSuggestionToTable(){
	...
	$(".ProductClass").typeahead('destroy');
...
function addRowCategory(){
	...
	body += '</td>';
	body += '<td class="bill-item">';
	body += '<input type="text" name="item_category" class="form-control ProductClass" onchange="checkprdcat(this.value,this)" style="width:87%" placeholder="Type or click to select an Category.">';
	body += '<button type="button" style="position: absolute;margin-left: -18px;z-index: 2;vertical-align: middle;font-size: 20px;opacity: 0.5;" onclick="changeitem(this)"><i class="glyphicon glyphicon-menu-down" style="font-size: 8px;"></i></button>';
	body += '</td>';	
	...
	body += '<td class="BV" style="position:relative;">';
	body += '<span class="glyphicon glyphicon-remove-circle bill-action" aria-hidden="true" style="left: 475px;"></span>';
	body += '<input type="text" name="promotionvalue" onkeypress="return isNumberKey(event,this,4)" class="form-control" value="0.000" >';
	body += '</td>';
	body += '<td class="Bill" style="position:relative;">';
	body += '<input type="text" name="LIMIT_USAGE" onkeypress="return isNumberKey(event,this,4)" class="form-control" value="0.000" >';
	body += '</td>';
	body += '</tr>';
	$(".po-table tbody").append(body);
	removeSuggestionToTable();
...
function addRowBrand(){
	...
	body += '</td>';
	body += '<td class="bill-item">';
	body += '<input type="text" name="item_brand" class="form-control ProductBrand" onchange="checkprdcat(this.value,this)" style="width:87%" placeholder="Type or click to select an Category.">';
	body += '<button type="button" style="position: absolute;margin-left: -18px;z-index: 2;vertical-align: middle;font-size: 20px;opacity: 0.5;" onclick="changeitem(this)"><i class="glyphicon glyphicon-menu-down" style="font-size: 8px;"></i></button>';
	body += '</td>';	
	body += '<td class="item-qty text-right"><input type="text" name="qty" class="form-control text-right" data-rl="0.000" data-msq="0.000" data-soh="0.000" data-eq="0.000" data-aq="0.000" value="1.000" onkeypress="return isNumberKey(event,this,4)">';
	body += '</td>';	
			...
			data : {
				...
				success : function(data) {
					if (data.status == "99") {
						...
						$(obj).typeahead('val', '');
						$(obj).parent().find('input[name="item_category"]').focus();
						return false;	
					} 
					else 
						return true;
