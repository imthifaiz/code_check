			...
			$(".itemSearch").on('keydown', function(event) {
			    if (event.key === 'Enter') {
			        ...
			        $.ajax({
			            ...
			            url: "../ItemMstServlet",
			            data: {
			               ACTION : "GET_PRODUCT_LIST_AUTOcamer_SUGGESTION",
				           /*CUSTNO : $("input[name=CUST_CODE]").val(),*/
			                ITEM: item
			            },
			            dataType: "json",
...
function setCurrencyid(CURRENCYID,CURRENCYUSEQT){
	...
	document.getElementById('lbltotal').innerHTML = "Total ("+CURRENCYID+")"; //  Author: Azees  Create date: July 31,2021  Description:  Total of Local Currency
...
function calculateTotal(){
	...
	if(ptaxstatus == "0"){
	 ...
	 var CURRENCYUSEQT = $('input[name ="CURRENCYUSEQT"]').val();//Author: Azees  Create date: July 19,2021  Description:  Total of Local Currency
