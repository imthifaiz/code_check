var rootURI;
var tableposlivesales;
var interval = null;
$(document).ready(function() {
	rootURI = location.href.toString();
	rootURI = rootURI.substring(0, rootURI.indexOf("/home"));
	...
	$('a[data-toggle="tab"]').on('shown.bs.tab', function(e) {
		...
		if (target == "#accountMgtDashboard") {
		...
		}else if(target == "#posDashboard"){
			poslivesales();
			interval = setInterval(function () {
				console.log("tiler strated");
				var dt = new Date();
				var time = dt.getHours() + ":" + dt.getMinutes() + ":" + dt.getSeconds();
				console.log(time);
				tableposlivesales.ajax.url("/track/DashboardServlet").load();
				console.log("tiler ended");
				}, 180000);
				
			$("#possalesreload").change(function () {
				var stimer = $('#possalesreload').find(":selected").val();
			...
			$("#possalesrefresh").click(function () {
							tableposlivesales.ajax.url("/track/DashboardServlet").load();
			});
		}
		
		if(target != "#posDashboard"){
			clearInterval(interval);
		}
	});
	...
	calendar2 = new FullCalendar.Calendar(calendarE2, {
	  ...
	  eventLimit: true, // allow "more" link when too many events
	  events: {
		  url: rootURI + '/DashboardServlet?ACTION=EXPIRED_PURCHASE_ORDER',
		  failure: function() {
			document.getElementById('script-warning').style.display = 'block'
		  }
	  },
	...
	calendar3 = new FullCalendar.Calendar(calendarE3, {
		...
		eventLimit: true, // allow "more" link when too many events
		events: {
			url: rootURI + '/DashboardServlet?ACTION=PENDING_SALES_ESTIMATE',
			failure: function() {
				document.getElementById('script-warning').style.display = 'block'
			}
		},
	...
	calendar4 = new FullCalendar.Calendar(calendarE4, {
		...
		eventLimit: true, // allow "more" link when too many events
		events: {
			url: rootURI + '/DashboardServlet?ACTION=SALES_ORDER_DELIVERY_DATE',
			failure: function() {
				document.getElementById('script-warning').style.display = 'block'
			}
		},
	...
	window.totalAccPayChart.canvas.style.height = "260px"
	...
	window.totalAccRecvChart.canvas.style.height = "300px"
	...
	/*---------------------payment made----------------------------	*/
	var ctxpaymadepi = document.getElementById('canvaspaymadepi').getContext('2d');
	window.totalPaymentMadeForMgtChart = new Chart(ctxpaymadepi, {
		type: 'pie',
		data: totalPaymentMadeForMgtChartConfig,
		options: {
			responsive: true,
			maintainAspectRatio: false,
			legend: {
	...
	window.totalPaymentMadeForMgtChart.canvas.style.height = "230px"

	var ctxpaymadebarmgt = document.getElementById('canvasPayMadeMgtBar').getContext('2d');
	window.totalPaymentMadeForMgtChartbar = new Chart(ctxpaymadebarmgt, {
		type: 'bar',
		data: totalPaymentMadeForMgtChartbarConfig,
		options: {
			responsive: true,
			legend: {
				display: false
	...
	var ctxpayReceiptpi = document.getElementById('canvaspayReceiptpi').getContext('2d');
	window.totalPaymentReceiptForMgtChart = new Chart(ctxpayReceiptpi, {
		type: 'pie',
		data: totalPaymentReceiptForMgtChartConfig,
		options: {
			responsive: true,
			maintainAspectRatio: false,
			legend: {
	...
	window.totalPaymentReceiptForMgtChart.canvas.style.height = "230px"

	var ctxpayReceiptbarmgt = document.getElementById('canvasPayReceiptMgtBar').getContext('2d');
	window.totalPaymentReceiptForMgtChartbar = new Chart(ctxpayReceiptbarmgt, {
		type: 'bar',
		data: totalPaymentReceiptForMgtChartbarConfig,
		options: {
			responsive: true,
			legend: {
				display: false
	...
	var ctxpaymadepiAcc = document.getElementById('canvaspaymadepiAcc').getContext('2d');
	window.totalPaymentMadeChart = new Chart(ctxpaymadepiAcc, {
		type: 'pie',
		data: totalPaymentMadeChartConfig,
		options: {
			responsive: true,
			maintainAspectRatio: false,
			legend: {
	...
	window.totalPaymentMadeChart.canvas.style.height = "230px"

	var ctxpaymadebar = document.getElementById('canvasPayMadeBar').getContext('2d');
	window.totalPaymentMadeChartbar = new Chart(ctxpaymadebar, {
		type: 'bar',
		data: totalPaymentMadeChartbarConfig,
		options: {
			responsive: true,
			legend: {
				display: false
	...
	var ctxpayReceiptpiAcc = document.getElementById('canvaspayReceiptpiAcc').getContext('2d');
	window.totalPaymentReceiptChart = new Chart(ctxpayReceiptpiAcc, {
		type: 'pie',
		data: totalPaymentReceiptChartConfig,
		options: {
			responsive: true,
			maintainAspectRatio: false,
			legend: {
	...
	window.totalPaymentReceiptChart.canvas.style.height = "230px"

	var ctxpayReceiptbar = document.getElementById('canvasPayReceiptBar').getContext('2d');
	window.totalPaymentReceiptChartbar = new Chart(ctxpayReceiptbar, {
		type: 'bar',
		data: totalPaymentReceiptChartbarConfig,
		options: {
			responsive: true,
			legend: {
				display: false
	...
	window.totalAccPayForMgtChart.canvas.style.height = "260px"
	...
	window.totalAccRecvForMgtChart.canvas.style.height = "300px"
	...
	$.ajax({
		...
		$('#total_purchase_by_bill').countTo({ from: 0, to: $('#total_purchase_by_bill').html(), 
			onComplete: function(value){
				$('#total_purchase_by_bill').html(getNumberInMillionFormat(value));
			}
		});
	});
}
...
function getTotalSalesByInvoice(period) {
	...
	$.ajax({
		...
		$('#total_sales_by_invoice').countTo({ from: 0, to: $('#total_sales_by_invoice').html(), 
			onComplete: function(value){
				$('#total_sales_by_invoice').html(getNumberInMillionFormat(value));
			}
		});
	});
}
...
function setTotalIncomeCharData(data) {
	...
	$("#totalIncome").text(getNumberInMillionFormat(data.TOTAL_AMOUNT));
	window.totalIncomeChart.update();
}
...
function setTotalExpenseCharData(data) {
	...
	$("#totalExpense").text(getNumberInMillionFormat(data.TOTAL_AMOUNT));
	window.totalExpenseChart.update();
}
			...
			"ajax": {
				...
				"dataSrc": function(data) {
					if (typeof data.payments[0].PAYMENT_DATE === 'undefined') {
						...
						for (var dataIndex = 0; dataIndex < data.payments.length; dataIndex++) {
							data.payments[dataIndex]['CHEQUE_AMOUNT'] = getNumberInMillionFormat(data.payments[dataIndex]['CHEQUE_AMOUNT']);
						}
...
function setAccountpayableCharData(data) {
	...
	$("#totalAccPay").text(getNumberInMillionFormat(data.totalOutstanding));
	window.totalAccPayChart.update();
}
...
function setAccountReceivableCharData(data) {
	...
	$("#totalAccRecv").text(getNumberInMillionFormat(data.totalOutstanding));
	window.totalAccRecvChart.update();
}
			...
			"ajax": {
				...
				"dataSrc": function(data) {
					...
					if ((data.reportContent[0] === '') || (typeof data.reportContent[0] === 'undefined')) {
						...
						for (var dataIndex = 0; dataIndex < data.reportContent.length; dataIndex++) {
							data.reportContent[dataIndex]['amountdue'] = getNumberInMillionFormat(data.reportContent[dataIndex]['amountdue']);
							data.reportContent[dataIndex]['notDue'] = getNumberInMillionFormat(data.reportContent[dataIndex]['notDue']);
							data.reportContent[dataIndex]['v30daysdue'] = getNumberInMillionFormat(data.reportContent[dataIndex]['v30daysdue']);
							data.reportContent[dataIndex]['v60daysdue'] = getNumberInMillionFormat(data.reportContent[dataIndex]['v60daysdue']);
							data.reportContent[dataIndex]['v90daysdue'] = getNumberInMillionFormat(data.reportContent[dataIndex]['v90daysdue']);
							data.reportContent[dataIndex]['v90plusdaysdue'] = getNumberInMillionFormat(data.reportContent[dataIndex]['v90plusdaysdue']);
						}
...
function setTotalPurchaseSummaryByBillForMgtCharData(data) {
	...
	for (var index = 0; index < purSumryByBillForMgtChartConfig.datasets.length; ++index) {
		purSumryByBillForMgtChartConfig.datasets[index].data = total_cost;//getNumberInMillionFormat(total_cost);
	}
	$("#totalPurchaseByBillSumryForMgt").text(data.currency+getNumberInMillionFormat(data.totalAmountWithoutCurrency));
...
function setTotalSalesSummaryByInvoiceForMgtCharData(data) {
	...
	$("#totalSalesByInvoiceSumryForMgt").text(getNumberInMillionFormat(data.TOTAL_AMOUNT));
...
function setTotalIncomeForMgtCharData(data) {
	...
	$("#totalIncomeForMgt").text(getNumberInMillionFormat(data.TOTAL_AMOUNT));
	window.totalIncomeForMgtChart.update();
}
...
function setTotalExpenseForMgtCharData(data) {
	...
	$("#totalExpenseForMgt").text(getNumberInMillionFormat(data.TOTAL_AMOUNT));
	window.totalExpenseForMgtChart.update();
}
...
function getTotalPaymentMadeForMgt(period) {
	...
	$.ajax({
		...
		"dataType": "json",
		success: function(data) {
			if (typeof data.payment[0] === 'undefined' || typeof data.payment[0].ACCOUNTDETAILTYPE === 'undefined') {
...
function setTotalPaymentMadeForMgtCharData(data) {
	...
	$("#totalPaymentMadeMgt").text(getNumberInMillionFormat(data.TOTAL_AMOUNT));
	window.totalPaymentMadeForMgtChart.update();
}
...
function setTotalPaymentReceiptForMgtCharData(data) {
	...
	$("#totalPaymentReceiptMgt").text(getNumberInMillionFormat(data.TOTAL_AMOUNT));
	window.totalPaymentReceiptForMgtChart.update();
}
...
function setTotalPaymentMadeCharData(data) {
	...
	$("#totalPaymentMade").text(getNumberInMillionFormat(data.TOTAL_AMOUNT));
	window.totalPaymentMadeChart.update();
}
...
function setTotalPaymentReceiptCharData(data) {
	...
	$("#totalPaymentReceipt").text(getNumberInMillionFormat(data.TOTAL_AMOUNT));
	window.totalPaymentReceiptChart.update();
}
...
function setAccountpayableForMgtCharData(data) {
	...
	$("#totalAccPayForMgt").text(getNumberInMillionFormat(data.totalOutstanding));
	window.totalAccPayForMgtChart.update();
}
...
function setAccountReceivableForMgtCharData(data) {
	...
	$("#totalAccRecvForMgt").text(getNumberInMillionFormat(data.totalOutstanding));
	window.totalAccRecvForMgtChart.update();
}
...
function getCashInHand(period) {
	...
	$.ajax({
		...
		$('#totalCashInHand').countTo({ from: 0, to: $('#totalCashInHand').html(), 
			onComplete: function(value){
				$('#totalCashInHand').html(getNumberInMillionFormat(value));
			}
		});
	});
}
...
function getTotalCashAtBank(period) {
	...
	$.ajax({
		...
		$('#totalCashAtBank').countTo({ from: 0, to: $('#totalCashAtBank').html(), 
			onComplete: function(value){
				$('#totalCashAtBank').html(getNumberInMillionFormat(value));
			}
		});
	});
}
...
function getNetProfit(period) {
	...
	$.ajax({
		...
		$('#netProfit').countTo({ from: 0, to: $('#netProfit').html(), 
			onComplete: function(value){
				$('#netProfit').html(getNumberInMillionFormat(value));
			}
		});
	});
}
...
function getGrossProfit(period) {
	...
	$.ajax({
		...
		$('#grossProfit').countTo({ from: 0, to: $('#grossProfit').html(), 
			onComplete: function(value){
				$('#grossProfit').html(getNumberInMillionFormat(value));
			}
		});
	});
}
				...
				"dataSrc": function(data) {
					if (data.items.length == 0) {
						...
						for(var dataIndex = 0; dataIndex < data.items.length; dataIndex ++){
							data.items[dataIndex]['DEBITS'] = getNumberInMillionFormat(data.items[dataIndex]['DEBITS']);
						}
						$("#totalpurchaseSummaryForMgt").text(data.currency+getNumberInMillionFormat(data.totalWithoutCurrency));
						return data.items;
					}
				}
			},
			...
			"ajax": {
				...
				"dataSrc": function(data) {
					if (data.items.length == 0) {
						...
						for(var dataIndex = 0; dataIndex < data.items.length; dataIndex ++){
							data.items[dataIndex]['CREDITS'] = getNumberInMillionFormat(data.items[dataIndex]['CREDITS']);
						}
						$("#totalSalesSummaryForMgt").text(data.currency + getNumberInMillionFormat(data.totalWithoutCurrency));
						return data.items;
					}
				}
			},
			...
			"ajax": {
				...
				"dataSrc": function(data) {
					if (data.INCOME.length == 0) {
						...
						for(var dataIndex = 0; dataIndex < data.INCOME.length; dataIndex ++){
							data.INCOME[dataIndex]['TOTAL_AMOUNT'] = getNumberInMillionFormat(data.INCOME[dataIndex]['TOTAL_AMOUNT']);
						}
						$("#totalincomeSummaryForMgt").text(data.currency + getNumberInMillionFormat(data.totalWithoutCurrency));
						return data.INCOME;
					}
				}
			},
			...
			"ajax": {
				...
				"dataSrc": function(data) {
					if (data.EXPENSE.length == 0) {
						...
						for(var dataIndex = 0; dataIndex < data.EXPENSE.length; dataIndex ++){
							data.EXPENSE[dataIndex]['TOTAL_AMOUNT'] = getNumberInMillionFormat(data.EXPENSE[dataIndex]['TOTAL_AMOUNT']);
						}
						$("#totalexpenseSummaryForMgt").text(data.currency + getNumberInMillionFormat(data.totalWithoutCurrency));
						return data.EXPENSE;
					}
				}
			},
				...
				"dataSrc": function(data) {
					if (data.PAYMENT.length == 0) {
						...
						for (var dataIndex = 0; dataIndex < data.PAYMENT.length; dataIndex++) {
							...
							data.PAYMENT[dataIndex]['TOTAL_AMOUNT'] = getNumberInMillionFormat(data.PAYMENT[dataIndex]['TOTAL_AMOUNT']);
						}
						$("#PaymentIssuedSummaryForMgt").text(data.currency+getNumberInMillionFormat(data.totalWithoutCurrency));
						return data.PAYMENT;
					}
				}
			},
			...
			"ajax": {
				...
				"dataSrc": function(data) {
					if (data.PAYMENT.length == 0) {
						...
						$("#PaymentReceiptSummaryForMgt").text(data.currency+getNumberInMillionFormat(data.totalWithoutCurrency));
						return data.PAYMENT;
					}
				}
			},
			...
			"ajax": {
				...
				"dataSrc": function(data) {
					if (data.items.length == 0) {
						...
						$("#totalpurchaseSummary").text(data.currency+getNumberInMillionFormat(data.totalWithoutCurrency));
						return data.items;
					}
				}
			},
			...
			"ajax": {
				...
				"dataSrc": function(data) {
					if (data.items.length == 0) {
						...
						$("#totalSalesSummary").text(data.currency+getNumberInMillionFormat(data.totalWithoutCurrency));
						return data.items;
					}
				}
			},
			...
			"ajax": {
				...
				"dataSrc": function(data) {
					if (data.INCOME.length == 0) {
						...
						$("#totalincomeSummary").text(data.currency+getNumberInMillionFormat(data.totalWithoutCurrency));
						return data.INCOME;
					}
				}
			},
			...
			"ajax": {
				...
				"dataSrc": function(data) {
					if (data.EXPENSE.length == 0) {
						...
						$("#totalexpenseSummary").text(data.currency+getNumberInMillionFormat(data.totalWithoutCurrency));
						return data.EXPENSE;
					}
				}
			},
			...
			"ajax": {
				...
				"dataSrc": function(data) {
					if (data.PAYMENT.length == 0) {
						...
						$("#PaymentIssuedSummary").text(data.currency+getNumberInMillionFormat(data.totalWithoutCurrency));
						return data.PAYMENT;
					}
				}
			},
			...
			"ajax": {
				...
				"dataSrc": function(data) {
					if (data.PAYMENT.length == 0) {
						...
						$("#PaymentReceiptSummary").text(data.currency+getNumberInMillionFormat(data.totalWithoutCurrency));
						return data.PAYMENT;
					}
				}
			},
...
function loadCustomerAgeingTotal(data) {
	...
	for (i = 0; i < data.length; i++) {
		notDue += parseFloat(data[i].notDue.replace(/,/g, ''));
		v30daysdue += parseFloat(data[i].v30daysdue.replace(/,/g, ''));
		v60daysdue += parseFloat(data[i].v60daysdue.replace(/,/g, ''));
		v90daysdue += parseFloat(data[i].v90daysdue.replace(/,/g, ''));
		v90plusdaysdue += parseFloat(data[i].v90plusdaysdue.replace(/,/g, ''));
	}
	var tbody = "<tr>";
	tbody += "<td>" + getNumberInMillionFormat(parseFloat(parseFloat(notDue) + parseFloat(v30daysdue) + parseFloat(v60daysdue)
		+ parseFloat(v90daysdue) + parseFloat(v90plusdaysdue)).toFixed(document.form.numberOfDecimal.value)) + "</td>";
	tbody += "<td>" + getNumberInMillionFormat(parseFloat(notDue).toFixed(document.form.numberOfDecimal.value)) + "</td>";
	tbody += "<td>" + getNumberInMillionFormat(parseFloat(v30daysdue).toFixed(document.form.numberOfDecimal.value)) + "</td>";
	tbody += "<td>" + getNumberInMillionFormat(parseFloat(v60daysdue).toFixed(document.form.numberOfDecimal.value)) + "</td>";
	tbody += "<td>" + getNumberInMillionFormat(parseFloat(v90daysdue).toFixed(document.form.numberOfDecimal.value)) + "</td>";
	tbody += "<td>" + getNumberInMillionFormat(parseFloat(v90plusdaysdue).toFixed(document.form.numberOfDecimal.value)) + "</td>";
			...
			"ajax": {
				...
				"dataSrc": function(data) {
					...
					if ((data.reportContent[0] === '') || (typeof data.reportContent[0] === 'undefined')) {
						...
						for (var dataIndex = 0; dataIndex < data.reportContent.length; dataIndex++) {
							data.reportContent[dataIndex]['total_due'] = getNumberInMillionFormat(data.reportContent[dataIndex]['total_due']);
							data.reportContent[dataIndex]['over_due'] = getNumberInMillionFormat(data.reportContent[dataIndex]['over_due']);
						}
						return data.reportContent;
					}
				}
...
function getPeriod(keyPrefix, period, selectControlId) {
	period = getLocalStorageValue("home_" + keyPrefix + "Period", period, selectControlId);
	$('#' + selectControlId).siblings('.select-selected').html(period);
	return period;
}

function storePeriod(keyPrefix, period) {
	storeInLocalStorage("home_" + keyPrefix + "Period", period);
}

function getParameters(){
			return {
				"ACTION":"GET_POS_SALES_DASHBOARD"
			}
		}

function poslivesales(){
				var urlStr = "/track/DashboardServlet";
			    if (tableposlivesales){
			    	tableposlivesales.ajax.url( urlStr ).load();
			    	
			    }else{
				    tableposlivesales = $('#tableposlivesales').DataTable({
						"processing": true,
						 //"responsive" : true,
						 "responsive": {
					            details: {
						...
						"lengthMenu": [[500,600,700], [500,600,700]],
						"ajax": {
							"type": "GET",
							"url": urlStr,
							"data": function(d){
					        ...
					        if(data.SEARCH_DATA.length>0){
								for(var dataIndex = 0; dataIndex < data.SEARCH_DATA.length; dataIndex ++){
									if(data.SEARCH_DATA[dataIndex]['ISOUTLET']=='1'){
				        				//data.SEARCH_DATA[dataIndex]['TERMINALNAME'] = '<span style="color:white;background:blue;">'+data.SEARCH_DATA[dataIndex]['TERMINAL']+'</span>';
				        				data.SEARCH_DATA[dataIndex]['TERMINALNAME'] = '<span style="color:white;">'+data.SEARCH_DATA[dataIndex]['TERMINAL']+'</span>';
				        			}else{
					        			data.SEARCH_DATA[dataIndex]['TERMINALNAME'] = data.SEARCH_DATA[dataIndex]['TERMINALNAME']+'-'+data.SEARCH_DATA[dataIndex]['OUTLETNAME'];
					        		}
					        		
					        		if(data.SEARCH_DATA[dataIndex]['ISOUTLET']=='1'){	
					        			data.SEARCH_DATA[dataIndex]['TOTALPRICE'] = '<span style="color:white;background:#2baab1;">'+parseFloat(data.SEARCH_DATA[dataIndex]['TOTALPRICE']).toFixed(document.form.numberOfDecimal.value)+'</span>';
										data.SEARCH_DATA[dataIndex]['TOTALCOST'] = '<span style="color:white;background:#2baab1;">'+parseFloat(data.SEARCH_DATA[dataIndex]['TOTALCOST']).toFixed(document.form.numberOfDecimal.value)+'</span>';
									}else{	
					        			data.SEARCH_DATA[dataIndex]['TOTALPRICE'] = parseFloat(data.SEARCH_DATA[dataIndex]['TOTALPRICE']).toFixed(document.form.numberOfDecimal.value);
										data.SEARCH_DATA[dataIndex]['TOTALCOST'] = parseFloat(data.SEARCH_DATA[dataIndex]['TOTALCOST']).toFixed(document.form.numberOfDecimal.value);
					        		}
					        		
					        		if(data.SEARCH_DATA[dataIndex]['ISOUTLET']=='1'){	
					        			data.SEARCH_DATA[dataIndex]['intime'] = '';
										data.SEARCH_DATA[dataIndex]['outtime'] = '';
										data.SEARCH_DATA[dataIndex]['intimediff'] = '';
										data.SEARCH_DATA[dataIndex]['outtimediff'] = '';
									}else{	
					        			if(data.SEARCH_DATA[dataIndex]['intimestatus']=='red'){
											data.SEARCH_DATA[dataIndex]['intimediff'] = '<span style="color:white;background:red;">'+data.SEARCH_DATA[dataIndex]['intimediff']+'</span>';
										}else if(data.SEARCH_DATA[dataIndex]['intimestatus']=='green'){
											data.SEARCH_DATA[dataIndex]['intimediff'] = '<span style="color:white;background:green;">'+data.SEARCH_DATA[dataIndex]['intimediff']+'</span>';
										}else{
											data.SEARCH_DATA[dataIndex]['intimediff'] = '-';
										}
										
										if(data.SEARCH_DATA[dataIndex]['outtimestatus']=='red'){
											data.SEARCH_DATA[dataIndex]['outtimediff'] = '<span style="color:white;background:red;">'+data.SEARCH_DATA[dataIndex]['outtimediff']+'</span>';
										}else if(data.SEARCH_DATA[dataIndex]['outtimestatus']=='green'){
											data.SEARCH_DATA[dataIndex]['outtimediff'] = '<span style="color:white;background:green;">'+data.SEARCH_DATA[dataIndex]['outtimediff']+'</span>';
										}else{
											data.SEARCH_DATA[dataIndex]['outtimediff'] = '-';
										}		
					        		}
				        ...
				        "columns": [
				        	{"data": 'TERMINALNAME', "orderable": false},
			    			{"data": 'TOTALPRICE', "orderable": false},
			    			/*{"data": 'TOTALCOST', "orderable": false},*/
			    			{"data": 'intime', "orderable": false},
			    			{"data": 'intimediff', "orderable": false},
			    			{"data": 'outtime', "orderable": false},
			    			{"data": 'outtimediff', "orderable": false}
			    			],
			    		"columnDefs": [{"className": "t-right", "targets": [1]},
				        ...
				        "createdRow": function( row, data, dataIndex){
			               if( data.ISOUTLET=='1'){
								$(row).css("background-color", "#2baab1");
							}
			            },
