...
//			menuElement.after( '<div class="PRD_DEPT_IDAddBtn footer"  data-toggle="modal" data-target="#prddepModal"> <a href="#"> + Add Product Department</a></div>');
	...
	/*Search Product Type Id Auto Suggestion */
	$('.ProductType').typeahead({
		...
		},
		{
		  ...
		  empty: [
			...
			/*menuElement.after( "<div class=\"ARTISTAddBtn footer\" ><a href=\"#\"  onClick=\"javascript:popUpWin('list/typelist_save.jsp?sArtist='"+form.ARTIST.value+");return false;\"> + Add Product Type</a></div>");*/
			menuElement.next().width(menuElement.width());
			menuElement.next().css({ "top": top,"padding":"3px 20px" });
			if($(this).parent().find(".tt-menu").css('display') != "block")
				menuElement.next().hide();
