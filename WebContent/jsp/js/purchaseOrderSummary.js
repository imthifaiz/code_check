$(document).ready(function(){
	/*getLocalStorageValue('purchaseorderSummary_ORDERNO', '', 'ORDERNO');
	getLocalStorageValue('purchaseorderSummary_ORDERTYPE', '', 'ORDERTYPE');
	getLocalStorageValue('purchaseorderSummary_CUSTOMER', '', 'CUSTOMER');
	getLocalStorageValue('purchaseorderSummary_REFERENCE', '', 'Reference');
	getLocalStorageValue('purchaseorderSummary_STATUS', '', 'status');
	getLocalStorageValue('purchaseorderSummary_FROMDATE', $('#fromdate').val(), 'fromdate');
	getLocalStorageValue('purchaseorderSummary_TODATE', '', 'todate');*/
// onGo();
 $('.Show').click(function() {
	    $('#target').show(500);
	    $('.ShowSingle').hide(0);
