...
<thead style="background: #eaeafa">
	...
	<%
		...
		String prd_Cls_Id = strUtils.fString(request
				.getParameter("PRD_CLS_ID"));

		String sBGColor = "";

		try {
			List listQry = prdclsutil.getPrdTypeList(prd_Cls_Id, plant,
					" AND ISACTIVE ='Y' ");
			...
			for (int i = 0; i < listQry.size(); i++) {
				...
				String desc = (String) map.get("prd_cls_desc");
	%>
	<TR>
		<td class="main2" style="font-weight: bold; align=left">&nbsp;<a href="#"
			onClick="window.opener.form.PRD_CLS_ID.disabled = false;window.opener.form.PRD_CLS_ID.value='<%=prdclsid%>';window.close();"><%=prdclsid%></a></td>
