...
<SCRIPT LANGUAGE="JavaScript">
	...
	function onNew(){
	   ...
	   document.form.action  = "item_list_po.jsp?action=NEW&PRD_CLS_ID="+prdcls;
	...
	function onAdd(){
	 var ITEM   = document.form.ITEM2.value;/*  */
	 var DESC = document.form.DESC1.value;
	 var uom = document.form.UOM.value;
	 ...
	 if(ITEM == "" || ITEM == null)
	{
	 ...
	 {
		alert("Please key in Description");
		document.form.DESC1.focus(); return false;
	 }
	else if(uom=="" || uom == null)
	{
		alert("Please key in UOM");
	...
	document.form.DYNAMIC_SUPPLIERDISCOUNT_SIZE.value = document
			...
			document.form.action = "item_list_po.jsp?action=ADD";
			document.form.submit();
		}
	...
	function onViewMapItem() {
		...
		document.form.action = "item_list_po.jsp?action=VIEWMAPITEM";
		document.form.submit();
	}
...
<%
	...
	sItemDesc      = StrUtils.fString(request.getParameter("DESC1"));
	      ...
	      else
	      {
	      ...
	      } catch(Exception e)
	         {
	    	  mLogger.exception(true,
						"ERROR IN JSP PAGE - item_list_po.jsp ", e);
	         }
...
<div class="box-body">
  ...
  <div class="form-group">
    	...
    	<div class="form-inline">
      	...
      	<div class="col-sm-3">
    	<INPUT class="form-control" name="DESC1" type="TEXT" value="<%=sItemDesc%>" style="width:100%" MAXLENGTH=100>
    	</div>
    	</div>
        </div>
    	...
    	<INPUT class="form-control" name="UOM" type="TEXT" value="<%=uom%>" size="31" MAXLENGTH=100 readonly>
   		<span class="input-group-addon"  onClick="javascript:popUpWin('uomlist_save.jsp?UOM='+form.UOM.value);">
    	...
    	<INPUT class="form-control" name="PRD_CLS_ID" type="TEXT" value="<%=prdclsid%>" size="20" MAXLENGTH=100 readonly>
   		<span class="input-group-addon"  onClick="javascript:popUpWin('classlist_save.jsp?prdclsid='+form.PRD_CLS_ID.value);">
    	...
    	<INPUT class="form-control" name="ARTIST" type="TEXT" value="<%=sArtist%>" size="31" MAXLENGTH=100 readonly>
   		<span class="input-group-addon"  onClick="javascript:popUpWin('typelist_save.jsp?sArtist='+form.ARTIST.value);">
    	...
    	<INPUT class="form-control" name="PRD_BRAND" type="TEXT" value="<%=prdBrand%>" size="20" MAXLENGTH=100 readonly>
   		<span class="input-group-addon"  onClick="javascript:popUpWin('brandlist_save.jsp?prdBrand='+form.PRD_BRAND.value);">
		...
		<span class="input-group-addon"  onClick="javascript:popUpWin('hscodelist_save.jsp?hscode='+form.HSCODE.value);">
		...
		<span class="input-group-addon" onClick="javascript:popUpWin('coolist_save.jsp?coo='+form.COO.value);">
...
function onPrint(){
   var ITEM   = document.form.ITEM2.value;
   var ITEMDESC = document.form.DESC1.value;
...
String sPitem= strUtils.fString(request.getParameter("PITEM"));
String sPtype= strUtils.fString(request.getParameter("PTYPE"));
...
if(sPtype.equals("KITBOMSUMMARY")){
...
%>
<% if(type.equalsIgnoreCase("CHILDITEM") && sPtype.equalsIgnoreCase("KITBOMSUMMARY")){ %>

<TR>
		<td class="main2" style="font-weight: bold" align="left">&nbsp;<a href="#"
			onClick=" window.opener.form.CITEM.value='<%=item%>';window.opener.form.EITEM.value='<%=eitem%>';
      	             ;window.opener.form.EDESC.value='<%=edesc%>';window.opener.form.EDETDESC.value='<%=edetdesc%>';window.opener.ValidateChildProduct();
...
<%} else if(type.equalsIgnoreCase("CHILDITEM") && sPtype.equalsIgnoreCase("CREATEKITBOM")){%>

<TR>
		<td class="main2" style="font-weight: bold" align="left">&nbsp;<a href="#"
			onClick=" window.opener.form.CITEM.value='<%=item%>';
      	              window.opener.ValidateChildProduct();
       		          window.close();"><%=item%></a></td>
		<td align="left" class="main2">&nbsp;<%=itemdesc%></td>
		<td align="left" class="main2">&nbsp;<%=uom%></td>
...
<%} else if(type.equalsIgnoreCase("EQUIVALENTITEM") ){%>

<TR>
		<td class="main2" style="font-weight: bold" align="left">&nbsp;<a href="#"
			onClick=" window.opener.form.EITEM.value='<%=item%>';
      	              window.opener.ValidateEquivalentProduct();
       		          window.close();"><%=item%></a></td>
		<td align="left" class="main2">&nbsp;<%=itemdesc%></td>
		<td align="left" class="main2">&nbsp;<%=uom%></td>
...
<%}else if(type.equalsIgnoreCase("CHILDITEM") ){%>
...
<br>
  <div class="text-center">       
        <button type="button" class="Submit btn btn-default" onClick="onClose();"><b>Close</b></button>&nbsp;&nbsp;
	     </div>   
</div>
</form>
</body>
