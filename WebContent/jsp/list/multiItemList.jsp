...
var indexed      = <%=index%>; 
window.opener.form.ITEM_<%=index%>.value=item;
...
$.ajax({type: "POST",url: urlStr, data: { ITEM: "<%=sItem%>" ,COND:" AND ISNULL(NONSTKFLAG,'N')='N' ", ACTION: "PRODUCT_LIST",PLANT:"<%=plant%>"},dataType: "json", success: callback });
