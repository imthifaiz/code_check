...
String sLoc = strUtils.fString(request.getParameter("LOC"));
...
window.opener.validateProduct(indexed);
window.close();
}
</script>
...
$.ajax({type: "POST",url: urlStr, data: { ITEM: "<%=sItem%>" ,ITEM_DESC:"<%=sItemDesc%>",LOC:"<%=sLoc%>", ACTION: "INV_PRODUCT_LIST",PLANT:"<%=plant%>"},dataType: "json", success: callback });
