...
mLogger.setLoggerConstans(loggerDetailsHasMap);
    ...
    String sDisplay = strUtils.fString(request.getParameter("DISPLAY"));
    String sBGColor = "";
    try
    {
    	...
    	_CurrencyUtil.setmLogger(mLogger);
    	 ...
    	 arrCust = _CurrencyUtil.getCurDetailsByDisplay(sDisplay,plant);
...
<TR>
		<td class="main2" style="font-weight: bold" align="left">&nbsp;<a href="#"
			onClick="window.opener.form.CURRENCY_ID.value='<%=currencyid%>';
                     window.opener.form.DESC.value='<%=description%>';
                     window.opener.form.DISPLAY.value='<%=display%>';
