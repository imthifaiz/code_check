...
<tbody>
    ...
    String moduleType = StrUtils.fString(request.getParameter("MODULENAME"));
    ...
    try{
     ...
     ArrayList listQry = orderUtil.getOrderHdrDetails(plant,moduleType,orderNo,status);
  ...
  <TR>
		<td class="main2" style="font-weight: bold" align="left">&nbsp;<a href="#"
			onClick="window.opener.form1.ORDERNO.value='<%=orderNo%>';
                     window.close();"><%=orderNo%></a></td>
		<td align="left" class="main2">&nbsp;<%=StrUtils.replaceCharacters2Recv(custName)%></td>
		<td align="left" class="main2">&nbsp;<%=status1%></td>
	</TR>
