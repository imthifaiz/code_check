...
<%
String title = "Rental and Sevice Customer Details";
%>
...
ArrayList arrCust = custUtil.getLoanAssigneeDetails(sCustCode,plant);
 ...
 <div class="box-body">
  ...
  <form class="form-horizontal" name="form" method="post">
    <div class="form-group">
      <label class="control-label col-sm-4"  for="Create Loan Assignee ID">Customer ID:</label>
      <div class="col-sm-4">
  ...
  <div class="col-sm-offset-4 col-sm-8">
   ...
   <div class="form-group">        
      ...
      <button type="button" class="Submit btn btn-default" onClick="window.location.href='loanAssigneeSummary.jsp'"><b>Back</b></button>&nbsp;&nbsp;
