...
<%
String title = "Location Type Two Summary";
%>
...
{
displaySummaryLink = ub.isCheckValAcc("summarylnkloctypetwo", PLANT,USERID);
displaySummaryEdit = ub.isCheckValAcc("editloctypetwo", PLANT,USERID);
displaySummaryNew = ub.isCheckValAcc("newloctypetwo", PLANT,USERID);

}
if(systatus.equalsIgnoreCase("INVENTORY"))
{
displaySummaryLink = ub.isCheckValinv("summarylnkloctypetwo", PLANT,USERID);
displaySummaryEdit = ub.isCheckValinv("editloctypetwo", PLANT,USERID);
displaySummaryNew = ub.isCheckValinv("newloctypetwo", PLANT,USERID);
}
...
<div class="container-fluid m-t-20">
	 ...
	 <ul class="breadcrumb backpageul">    
                ...
                <li><label>Location Type Two Summary</label></li>                                   
            </ul>
        <!-- Thanzith Modified on 23.02.2022 -->     
            <div class="box-header menu-drop">
              ...
              <button type="button" class="btn btn-default"	onClick="window.location.href='../locationtypetwo/new'"  style="background-color: rgb(214, 72, 48);color: rgb(255, 255, 255);" >+ New</button>&nbsp;
               <%}%>
              </div>
		</div>
...
<input type="hidden" name="lOC_TYPE_DESC2" value="">
<!-- imti -->
...
<INPUT name="LOC_TYPE_ID2"  id="LOC_TYPE_ID2"  type = "TEXT" value="<%=LOCID%>" size="20"  MAXLENGTH=100 class="form-control">
<!--  <span class="btn-danger input-group-addon" onClick="javascript:popWin('../jsp/LocTypeTwoList.jsp?LOC_TYPE_ID2='+form1.LOC_TYPE_ID2.value);">
...
<script LANGUAGE="JavaScript">
		...
		function onGo(){
			LOCATIONTYPE=document.form1.LOC_TYPE_ID2.value;
		       var urlStr = "../locationtypetwo/summary";
			    	...
			    	tabletype = $('#table').DataTable({
						...
						"ajax": {
					        ...
					        "dataSrc": function(data){
						        	...
						        	if(typeof data.CUSTOMERTYPELIST[0].LOC_TYPE_ID2 === 'undefined'){
						        		return [];
						        	}else {				        		
						        			for(var dataIndex = 0; dataIndex < data.CUSTOMERTYPELIST.length; dataIndex ++){
						        				var lineno = data.CUSTOMERTYPELIST[dataIndex].LOC_TYPE_ID2;
						        				var sno=dataIndex+1;
						        				data.CUSTOMERTYPELIST[dataIndex]['SNO'] = sno;
												<%if(displaySummaryEdit){ %>
						        				data.CUSTOMERTYPELIST[dataIndex]['EDIT'] = '<a href ="../locationtypetwo/edit?action=View&LOC_TYPE_ID2='+lineno+'&lOC_TYPE_DESC2=' +data.CUSTOMERTYPELIST[dataIndex].LOC_TYPE_DESC2+'&ACTIVE=' +data.CUSTOMERTYPELIST[dataIndex].IsActive+'"><i class="fa fa-pencil-square-o"></i></a>';
												<%}else{ %>
												...
												data.CUSTOMERTYPELIST[dataIndex]['LOC_TYPE_ID2'] = '<a href ="../locationtypetwo/detail?action=View&LOC_TYPE_ID2='+lineno+'&lOC_TYPE_DESC2=' +data.CUSTOMERTYPELIST[dataIndex].LOC_TYPE_DESC2+'&ISACTIVE=' +data.CUSTOMERTYPELIST[dataIndex].IsActive+'">'+data.CUSTOMERTYPELIST[dataIndex].LOC_TYPE_ID2+'</a>';
												<% } %>
						        			}
				        ...
				        "columns": [
				        	...
				        	{"data": 'LOC_TYPE_DESC2', "orderable": true},
