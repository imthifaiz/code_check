...
<head>
  ...
  <!-- iCheck -->
 <!--  <link rel="stylesheet" href="jsp/dist/css/blue.css"> -->
...
<%
 ...
 <div class="" style="text-align:center">
  ...
  <!-- /.login-logo -->
    ...
    <form action="signin" method="post" class="fo-login" name="loginForm">
...
<!-- Bootstrap 3.3.7 -->
<script src="jsp/dist/js/bootstrap.min.js"></script>
<script src="jsp/dist/js/index.js"></script>
<script type="text/javascript">
<%if (!isWarnExist){%>
