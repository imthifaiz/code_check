...
<title>Edit Mobile Enquiry  Email Message</title>
	...
	if(emailTo == "" || emailTo == null) {alert("Please Enter To Email Address"); return false; }
        ...
        if (atpos<1 || dotpos<atpos+2 || dotpos+2>=emailTo.length)
         ...
         document.form1.cmd.value = "UPDATE_EMAIL_MSG"
     	 document.form1.action  =  "mEnquiryMailMsg.jsp";
...
<%
	...
	action = strUtils.fString(request.getParameter("cmd"));
		...
		try{
                ...
                ht.put(IDBConstants.MODULE_TYPE,"MOBILE ENQUIRY");
                ...
                if (!isUpdated) {
                        ...
                        res = "<font class = " + IConstants.SUCCESS_COLOR+ ">Email Message for Mobile Enquiry  edited successfully</font>";
                }
	...
	try{
         Map m= mailUtil.getEmailMsgDetails(plant,"MOBILE ENQUIRY");
...
<FORM name="form1" method="post" action="mEnquiryMailMsg.jsp"><br>
<CENTER>
<INPUT type="hidden" name="cmd" value=""/>
<TABLE border="0" width="100%" cellspacing="0" cellpadding="0"
	align="center" bgcolor="#dddddd">
	<TR>
		<TH BGCOLOR="#000066" COLSPAN="11"><font color="white">Edit Mobile Enquiry  Email Message</font></TH>
	</TR>
</TABLE>
<B>
<CENTER><%=res%>
...
<INPUT name="OrderType" type="hidden" value="MOBILE ENQUIRY" >
 ...
 <TR>
   ...
   <TR>
	...
	<TR>
        ...
        <TR>
		<TH WIDTH="35%" ALIGN="RIGHT">Enquiry Number: </TH>
