...
<title>Edit Mobile Order Email Message</title>
	...
	if(emailTo == "" || emailTo == null) {alert("Please Enter To Email Address"); return false; }
        ...
        if (atpos<1 || dotpos<atpos+2 || dotpos+2>=emailTo.length)
         ...
         document.form1.cmd.value = "UPDATE_EMAIL_MSG"
     	 document.form1.action  =  "mOrderMailMsg.jsp";
...
<%
	...
	action = strUtils.fString(request.getParameter("cmd"));
		...
		try{
                ...
                ht.put(IDBConstants.MODULE_TYPE,"MOBILE ORDER");
                ...
                if (!isUpdated) {
                        ...
                        res = "<font class = " + IConstants.SUCCESS_COLOR+ ">Email Message for Mobile Order edited successfully</font>";
                }
	...
	try{
         Map m= mailUtil.getEmailMsgDetails(plant,"MOBILE ORDER");
...
<FORM name="form1" method="post" action="mOrderMailMsg.jsp"><br>
<CENTER>
<INPUT type="hidden" name="cmd" value=""/>
<TABLE border="0" width="100%" cellspacing="0" cellpadding="0"
	align="center" bgcolor="#dddddd">
	<TR>
		<TH BGCOLOR="#000066" COLSPAN="11"><font color="white">Edit Mobile Order Email Message</font></TH>
	</TR>
</TABLE>
<B>
<CENTER><%=res%>
 ...
 <TR>
   ...
   <TR>
	...
	<TR>
        ...
        <TR>
		<TH WIDTH="35%" ALIGN="RIGHT">Order Number: </TH>
