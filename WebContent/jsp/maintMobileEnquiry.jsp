   ...
   if (form.DONO.value.length < 1)
    ...
    if (form.DISPLAY.value.length < 1)
    {
     ...
     if (form.DELDATE.value.length > 1){
      ...
      var mes=confirm("Do you want to update the Mobile Enquiry !");
      if(mes==true)
      {
...
<title>Maint Mobile Enquiry</title>
...
<FORM name="form" method="post" action="/track/deleveryorderservlet?" onSubmit="return validatePO(document.form)">
  ...
  <table border="1" width="100%" cellspacing="0" cellpadding="0" align="center" bgcolor="#dddddd">
      <TR><TH BGCOLOR="#000066" COLSPAN="11"><font color="white">Maint Mobile Enquiry </font></table>
  <br>
  <%
  String statusValue = su.fString(request.getParameter("statusValue"));
  if(statusValue.equals("100")) {
	  out.println("<div><b><font color='green'><center>Mobile Enquiry Order "+pono+" has sucessfully Deleted!</center></font></b></div>");
  }
  if(statusValue.equals("99")) {
	  out.println("<div><b><font color='red'><center>Mobile Enquiry Order "+pono+"  does not exist</center></font></b></div>");
  }
  if(statusValue.equals("98")) {
	  out.println("<div'><b><font color='red'><center>Mobile Enquiry Order "+pono+" is in use. Cannot Deleted!</center></font></b></div>");
  }
  if(statusValue.equals("97")) {
	  out.println("<div'><b><font color='red'><center>Unable to remove Mobile Enquiry Order "+pono+". Some Error Occured!</center></font></b></div>");
  }
  %>
  <table border="1" width="100%" cellspacing="0" cellpadding="0" align="center" bgcolor="#dddddd">
    <tr>
          ...
          <table border="0" width="100%">
                   ...
                   <tr>
                     ...
                     <td>
                       <P>
                         ...
                         <a href="#" onClick="javascript:popUpWin('do_list_do.jsp?ORDERTYPE=MOBILE ENQUIRY&DONO='+form.DONO.value);">
			...
			<tr>
				...
				<td><INPUT type="TEXT" size="20" MAXLENGTH="20"
					name="ORDERTYPE" value="MOBILE ENQUIRY" class="inactiveGry" readonly />
				...
				<td><INPUT type="TEXT" size="25" class="inactiveGry"
                    ...
                    <input type="hidden" name="DESC">
                     <td height="30"><INPUT type = "hidden" size="20"   MAXLENGTH=20 name="DISPLAY" value="<%=currencyid%>" class="inactiveGry" readonly >
                     </td>
              ...
              <tr>
                <td align="center">
                 ...
                 <!-- <input type="Submit" value="Print Mobile Order" name="Submit"/>
                   &nbsp;-->
                  <input type="Submit" value="Print Mobile Enquiry" name="Submit"/>
                  </td>
