...
function onDelete(form)
{
	  if (form.DONO.value.length < 1)
	    ...
	    return false;
		     ...
		     var mes=confirm("Do you want to Delete the Mobile Enquiry !");
		      if(mes==true)
		      {
   ...
   if (form.DONO.value.length < 1)
    ...
    if (form.DISPLAY.value.length < 1)
    {
     ...
     if (form.DELDATE.value.length > 1){
      ...
      var mes=confirm("Do you want to update the Mobile Registration !");
      if(mes==true)
      {
...
<title>Maintain Mobile Registration</title>
...
<FORM name="form" method="post" action="/track/deleveryorderservlet?" onSubmit="return validatePO(document.form)">
  ...
  <table border="1" width="100%" cellspacing="0" cellpadding="0" align="center" bgcolor="#dddddd">
      <TR><TH BGCOLOR="#000066" COLSPAN="11"><font color="white">Maintain Mobile Registration </font></table>
  <br>
  <%
  String statusValue = su.fString(request.getParameter("statusValue"));
  if(statusValue.equals("100")) {
	  out.println("<div><b><font color='green'><center>Mobile Registration Order "+pono+" has sucessfully Deleted!</center></font></b></div>");
  }
  if(statusValue.equals("99")) {
	  out.println("<div><b><font color='red'><center>Mobile Registration Order "+pono+"  does not exist</center></font></b></div>");
  }
  if(statusValue.equals("98")) {
	  out.println("<div'><b><font color='red'><center>Mobile Registration Order "+pono+" is in use. Cannot be Deleted!</center></font></b></div>");
  }
  if(statusValue.equals("97")) {
	  out.println("<div'><b><font color='red'><center>Unable to remove Mobile Registration Order "+pono+". Some Error Occured!</center></font></b></div>");
  }
  %>
  <table border="1" width="100%" cellspacing="0" cellpadding="0" align="center" bgcolor="#dddddd">
    <tr>
          ...
          <table border="0" width="100%">
                   ...
                   <tr>
                     ...
                     <td>
                       <P>
                         ...
                         <a href="#" onClick="javascript:popUpWin('do_list_do.jsp?ORDERTYPE=MOBILE REGISTRATION&DONO='+form.DONO.value);">
			...
			<tr>
				...
				<td><INPUT type="TEXT" size="20" MAXLENGTH="20"
					name="ORDERTYPE" value="MOBILE REGISTRATION" class="inactiveGry" readonly />
    ...
    <table width="100%" border="0" cellspacing="0" cellpadding="5" bgcolor="#eeeeee">
      <%=fieldDesc%>
        ...
        <INPUT type="Hidden" name="RFLAG" value="10">
         ...
         <INPUT type = "hidden" size="20"   MAXLENGTH=20 name="DISPLAY" value="<%=currencyid%>" class="inactiveGry" readonly ">
              ...
              <tr>
                ...
                <!--   <input type="Submit" value="Add Products" name="Submit">
                  ...
                  <input type="Submit" value="Print Mobile Order" name="Submit"/>
                   &nbsp;-->
                  <input type="Submit" value="Print Mobile Registration" name="Submit"/>
                  </td>
