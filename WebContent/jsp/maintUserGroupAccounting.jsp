                 ...
                 <tr>
                    ...
                    <label class="checkbox-inline"><INPUT Type=Checkbox  style="border:0;background=#dddddd" name="UserAdmin" value="outletterminalnew" <%=disabled%> <%=checkOption("outletterminalnew")%>>
                     &nbsp; New Outlet Terminal</label>
                      ...
                      <th WIDTH="20%" ALIGN = "LEFT">
                    <label class="checkbox-inline"><INPUT Type=Checkbox  style="border:0;background=#dddddd" name="UserAdmin" value="outletterminaledit" <%=disabled%> <%=checkOption("outletoutletterminaleditedit")%>>
...
<div class="panel-body">
		<table class="table1" style="font-size:14px;width: 100%;">
        	 <tr>
               ...
               <%--      <th WIDTH="20%" ALIGN = "LEFT">
                 <label class="checkbox-inline"><INPUT Type=Checkbox  style="border:0;" name="OrderAdminHS" value="packingMasterSummary" <%=disabled%> <%=checkOption("packingMasterSummary")%>>
                  &nbsp; Packing List </label>

                  <tr>

                  <th WIDTH="20%" ALIGN = "LEFT">
                 <label class="checkbox-inline"><INPUT Type=Checkbox  style="border:0;" name="OrderAdminHS" value="newpackingMaster" <%=disabled%> <%=checkOption("newpackingMaster")%>>
                  &nbsp; New Packing List </label>

                  <th WIDTH="20%" ALIGN = "LEFT">
                 <label class="checkbox-inline"><INPUT Type=Checkbox  style="border:0;" name="OrderAdminHS" value="removepackingMaster" <%=disabled%> <%=checkOption("removepackingMaster")%>>
                  &nbsp; Remove Packing List </label>
                  
                  
                  <th WIDTH="20%" ALIGN = "LEFT">
                 <label class="checkbox-inline"><INPUT Type=Checkbox  style="border:0;" name="OrderAdminHS" value="transport_mode" <%=disabled%> <%=checkOption("transport_mode")%>>
                  &nbsp;  Transport Mode </label>
                  
                  <th WIDTH="20%" ALIGN = "LEFT">
                 <label class="checkbox-inline"><INPUT Type=Checkbox  style="border:0;" name="OrderAdminHS" value="newtransportmode" <%=disabled%> <%=checkOption("newtransportmode")%>>
                  &nbsp; New Transport Mode</label>
                  
                  <TR>
                  
                  <th WIDTH="20%" ALIGN = "LEFT">
                 <label class="checkbox-inline"><INPUT Type=Checkbox  style="border:0;" name="OrderAdminHS" value="removetransportmode" <%=disabled%> <%=checkOption("removetransportmode")%>>
	             ...
	             <TH WIDTH="20%" ALIGN = "LEFT">
	              ...
	              <th WIDTH="20%" ALIGN = "LEFT">
                   ...
                   <label class="checkbox-inline"> <INPUT Type=Checkbox  style="border:0;" name="OrderConfiguration" value="goodsshiftclosereceiptprintout" <%=disabled%> <%=checkOption("goodsshiftclosereceiptprintout")%>>
					...
					<%} %>			
										<%-- <th WIDTH="20%" ALIGN = "LEFT">
                   <label class="checkbox-inline"> <INPUT Type=Checkbox  style="border:0;" name="OrderConfiguration" value="editBillMailMsg" <%=disabled%> <%=checkOption("editBillMailMsg")%>>
                    &nbsp; Edit Bill Email Message </label> 
									</tr> --%>
...
<div class="panel-body">
             ...
             <tr>
              ...
              <th WIDTH="20%" ALIGN = "LEFT">
                   <label class="checkbox-inline"> <INPUT Type=Checkbox  style="border:0;" name="Project" value="summaryproject" <%=disabled%> <%=checkOption("summarypurchaseorder")%>>
                    &nbsp; Project</label>
...
<div class="panel-body">
		<table class="table1" style="font-size:14px;width: 100%;">
        	...
        	<th WIDTH="20%" ALIGN = "LEFT">
             <label class="checkbox-inline" style="display: <%=region.equals("ASIA PACIFIC") ? "none" : "block"%>;">  <INPUT Type=Checkbox  style="border:0;" name="AccountingAdmin" value="taxreturnpayments_acc" <%=disabled%> <%=checkOption("taxreturnpayments_acc")%> >
             &nbsp; Tax Payments </label>

            <th WIDTH="20%" ALIGN = "LEFT">
	         <label class="checkbox-inline" style="display: <%=region.equals("ASIA PACIFIC") ? "none" : "block"%>;"> <INPUT Type=Checkbox  style="border:0;" name="AccountingAdmin" value="taxAdjustmentSummary_acc" <%=disabled%> <%=checkOption("taxAdjustmentSummary_acc")%> >
    ...
    <div class="panel-body">
		<table >
               ...
               <tr>
                         ...
                         <th WIDTH="20%" ALIGN = "LEFT">
	                        	<label class="checkbox-inline"><INPUT Type=Checkbox  style="border:0;" name="statementofcashflows" value="expenseDetails" <%=disabled%> <%=checkOption("statementofcashflows")%> >
