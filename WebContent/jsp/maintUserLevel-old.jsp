...
function onUpdate()
{
	...
	if(chk){
	document.levelform.action="userLevelSubmit.jsp?Action=Update";
...
<div class="col-sm-4">
 ...
 <SELECT class="form-control" style="width: 100%" data-toggle="dropdown" data-placement="right" id="LEVEL_NAME" NAME="LEVEL_NAME" <%=disabledInView%> >
  ...
  <div class=form-inline>
   ...
   <!-- <button type="button" class="Submit btn btn-default" onClick="{backNavigation('settings.jsp','UA');}"><b>Back</b></button>&nbsp;&nbsp; -->
    ...
    <%
    	...
    	if (level_name == null){
    		response.sendRedirect("maintUserLevel.jsp?LEVEL_NAME");
    		return;
    	}
  ...
  <form class="form-horizontal" method="POST" name="levelform" action="userLevelSubmit.jsp">
