...
if (document.levelform.UserAdmin)
{
    ...
    if (document.levelform.expenses)
    {
        if (document.levelform.expenses.disabled == false)
        	document.levelform.expenses.checked = isChk;
        for (i = 0; i < document.levelform.expenses.length; i++)
        {
                if (document.levelform.expenses[i].disabled == false)
            	document.levelform.expenses[i].checked = isChk;
        }
    }
    
    if (document.levelform.GoodsReceipt)
    {
        if (document.levelform.GoodsReceipt.disabled == false)
        	document.levelform.GoodsReceipt.checked = isChk;
        for (i = 0; i < document.levelform.GoodsReceipt.length; i++)
        {
                if (document.levelform.GoodsReceipt[i].disabled == false)
            	document.levelform.GoodsReceipt[i].checked = isChk;
        }
    }
    
    if (document.levelform.bill)
    {
        if (document.levelform.bill.disabled == false)
        	document.levelform.bill.checked = isChk;
        for (i = 0; i < document.levelform.bill.length; i++)
        {
                if (document.levelform.bill[i].disabled == false)
            	document.levelform.bill[i].checked = isChk;
        }
    }
    ...
    if (document.levelform.SupplierCreditNotes)
    {
        if (document.levelform.SupplierCreditNotes.disabled == false)
        	document.levelform.SupplierCreditNotes.checked = isChk;
        for (i = 0; i < document.levelform.SupplierCreditNotes.length; i++)
        {
                if (document.levelform.SupplierCreditNotes[i].disabled == false)
            	document.levelform.SupplierCreditNotes[i].checked = isChk;
        }
    }
   ...
   if (document.levelform.InHouse)
    ...
    if (document.levelform.GoodsIssued)
    {
        if (document.levelform.GoodsIssued.disabled == false)
        	document.levelform.GoodsIssued.checked = isChk;
        for (i = 0; i < document.levelform.GoodsIssued.length; i++)
        {
                if (document.levelform.GoodsIssued[i].disabled == false)
            	document.levelform.GoodsIssued[i].checked = isChk;
        }
    }

    if (document.levelform.Invoice)
    {
        if (document.levelform.Invoice.disabled == false)
        	document.levelform.Invoice.checked = isChk;
        for (i = 0; i < document.levelform.Invoice.length; i++)
        {
                if (document.levelform.Invoice[i].disabled == false)
            	document.levelform.Invoice[i].checked = isChk;
        }
    }
    ...
    if (document.levelform.CreditNotes)
    {
        if (document.levelform.CreditNotes.disabled == false)
        	document.levelform.CreditNotes.checked = isChk;
        for (i = 0; i < document.levelform.CreditNotes.length; i++)
        {
                if (document.levelform.CreditNotes[i].disabled == false)
            	document.levelform.CreditNotes[i].checked = isChk;
        }
    }
   ...
   if (document.levelform.AccountingMaster)
    ...
    if (document.levelform.chartOfAccounts)
    {
        if (document.levelform.chartOfAccounts.disabled == false)
        	document.levelform.chartOfAccounts.checked = isChk;
        for (i = 0; i < document.levelform.chartOfAccounts.length; i++)
        {
                if (document.levelform.chartOfAccounts[i].disabled == false)
            	document.levelform.chartOfAccounts[i].checked = isChk;
        }
    }

    if (document.levelform.apSummary)
    {
        if (document.levelform.apSummary.disabled == false)
        	document.levelform.apSummary.checked = isChk;
        for (i = 0; i < document.levelform.apSummary.length; i++)
        {
                if (document.levelform.apSummary[i].disabled == false)
            	document.levelform.apSummary[i].checked = isChk;
        }
    }
    
    if (document.levelform.PaymentMade)
    {
        if (document.levelform.PaymentMade.disabled == false)
        	document.levelform.PaymentMade.checked = isChk;
        for (i = 0; i < document.levelform.PaymentMade.length; i++)
        {
                if (document.levelform.PaymentMade[i].disabled == false)
            	document.levelform.PaymentMade[i].checked = isChk;
        }
    }
    
    if (document.levelform.PDCPaymentMade)
    {
        if (document.levelform.PDCPaymentMade.disabled == false)
        	document.levelform.PDCPaymentMade.checked = isChk;
        for (i = 0; i < document.levelform.PDCPaymentMade.length; i++)
        {
                if (document.levelform.PDCPaymentMade[i].disabled == false)
            	document.levelform.PDCPaymentMade[i].checked = isChk;
        }
    }
    
    if (document.levelform.PaymentReceived)
    {
        if (document.levelform.PaymentReceived.disabled == false)
        	document.levelform.PaymentReceived.checked = isChk;
        for (i = 0; i < document.levelform.PaymentReceived.length; i++)
        {
                if (document.levelform.PaymentReceived[i].disabled == false)
            	document.levelform.PaymentReceived[i].checked = isChk;
        }
    }
    
    if (document.levelform.PDCPaymentReceived)
    {
        if (document.levelform.PDCPaymentReceived.disabled == false)
        	document.levelform.PDCPaymentReceived.checked = isChk;
        for (i = 0; i < document.levelform.PDCPaymentReceived.length; i++)
        {
                if (document.levelform.PDCPaymentReceived[i].disabled == false)
            	document.levelform.PDCPaymentReceived[i].checked = isChk;
        }
    }
    
    if (document.levelform.JournalEntry)
    {
        if (document.levelform.JournalEntry.disabled == false)
        	document.levelform.JournalEntry.checked = isChk;
        for (i = 0; i < document.levelform.JournalEntry.length; i++)
        {
                if (document.levelform.JournalEntry[i].disabled == false)
            	document.levelform.JournalEntry[i].checked = isChk;
        }
    }
    
    if (document.levelform.ContraEntry)
    {
        if (document.levelform.ContraEntry.disabled == false)
        	document.levelform.ContraEntry.checked = isChk;
        for (i = 0; i < document.levelform.ContraEntry.length; i++)
        {
                if (document.levelform.ContraEntry[i].disabled == false)
            	document.levelform.ContraEntry[i].checked = isChk;
        }
    }
	 ...
	 <div class="box"> 
	  <!-- Thanzith Modified on 23.02.2022 -->
            <ul class="breadcrumb backpageul">    
                ...
                <li><label>Edit Accounting User Access Rights</label></li>                                   
            </ul>             
    <!-- Thanzith Modified on 23.02.2022 -->
...
function onUpdate()
{
	...
	if(chk){
	document.levelform.action="../jsp/userLevelAccountingSubmit.jsp?Action=Update";
...
<form name="form" class="form-horizontal" method="POST" action="../useraccess/edit">
<br>
<%=delParam%>
...
<div class="col-sm-4">
 ...
 <SELECT class="form-control" style="width: 100%" data-toggle="dropdown" data-placement="right" id="LEVEL_NAME" NAME="LEVEL_NAME" <%=disabledInView%> >
  ...
  <div class=form-inline>
   ...
   <!-- <button type="button" class="Submit btn btn-default" onClick="{backNavigation('settings.jsp','UA');}"><b>Back</b></button>&nbsp;&nbsp; -->
    ...
    <%
    	...
    	if (level_name == null){
    		response.sendRedirect("../useraccess/edit?LEVEL_NAME");
    		return;
    	}
  ...
  <form class="form-horizontal" method="POST" name="levelform" action="../jsp/userLevelAccountingSubmit.jsp">
   <INPUT type="Hidden" name="LEVEL_NAME" value="<%=level_name%>">
    ...
    <TABLE class="table1" style="font-size:14px;width: 100%;">
                 <TR>
                    ...
                    <% if(COMP_INDUSTRY.equals("Retail")) { %> 
                    <TH WIDTH="20%" ALIGN = "LEFT">
                     <label class="checkbox-inline"><INPUT Type=Checkbox  style="border:0;background=#dddddd" name="UserAdmin" value="outletsummary" <%=disabled%> <%=checkOption("outletsummary")%>>
                      &nbsp; Outlet Summary</label>
                      
                      <TH WIDTH="20%" ALIGN = "LEFT">
                     <label class="checkbox-inline"><INPUT Type=Checkbox  style="border:0;background=#dddddd" name="UserAdmin" value="outletnew" <%=disabled%> <%=checkOption("outletnew")%>>
                      &nbsp; New Outlet</label>
                      
                      <TH WIDTH="20%" ALIGN = "LEFT">
                     <label class="checkbox-inline"><INPUT Type=Checkbox  style="border:0;background=#dddddd" name="UserAdmin" value="outletedit" <%=disabled%> <%=checkOption("outletedit")%>>
                      &nbsp; Edit Outlet</label>
                      
                      <TR>
                        
                        <TH WIDTH="20%" ALIGN = "LEFT">
                     <label class="checkbox-inline"><INPUT Type=Checkbox  style="border:0;background=#dddddd" name="UserAdmin" value="outletterminalummary" <%=disabled%> <%=checkOption("outletterminalummary")%>>
                      &nbsp; Outlet Terminal Summary</label>
                      
                      <TH WIDTH="20%" ALIGN = "LEFT">
                     <label class="checkbox-inline"><INPUT Type=Checkbox  style="border:0;background=#dddddd" name="UserAdmin" value="outletterminalnew" <%=disabled%> <%=checkOption("outletterminalnew")%>>
                      &nbsp; New Outlet Terminal</label>
                      
                      <TH WIDTH="20%" ALIGN = "LEFT">
                     <label class="checkbox-inline"><INPUT Type=Checkbox  style="border:0;background=#dddddd" name="UserAdmin" value="outletterminaledit" <%=disabled%> <%=checkOption("outletterminaledit")%>>
                     ...
                     <TH WIDTH="20%" ALIGN = "LEFT">
                     <label class="checkbox-inline"><INPUT Type=Checkbox  style="border:0;background=#dddddd" name="UserAdmin" value="contactsmry" <%=disabled%> <%=checkOption("contactsmry")%>>
                      &nbsp; Contacts</label>
                     ...
                     <TH WIDTH="20%" ALIGN = "LEFT">
                     <label class="checkbox-inline"><INPUT Type=Checkbox  style="border:0;background=#dddddd" name="UserAdmin" value="contactnew" <%=disabled%> <%=checkOption("contactnew")%>>
                      &nbsp; New Contacts</label>
                     
                     <TH WIDTH="20%" ALIGN = "LEFT">
                     <label class="checkbox-inline"><INPUT Type=Checkbox  style="border:0;background=#dddddd" name="UserAdmin" value="contactedit" <%=disabled%> <%=checkOption("contactedit")%>>
                      &nbsp; Edit Contacts</label>
    ...
    <TABLE>
             <TR>
	                ...
	                <TR>
	                  ...
	                  &nbsp; Summary &#45; Location Two Link</label> 
	                ...
	                <TR>
	                  ...
	                  &nbsp; Summary &#45; Location Three Link</label> 
...
<div class="panel-body"> 
    	<TABLE class="table1" style="font-size:14px;width: 100%;">
	             ...
	             <TH WIDTH="20%" ALIGN = "LEFT">
                    <label class="checkbox-inline"><INPUT Type=Checkbox  style="border:0;" name="OrderConfiguration" value="purchaseestimateconfig"  <%=disabled%> <%=checkOption("purchaseestimateconfig")%>>
	              ...
	              <TH WIDTH="20%" ALIGN = "LEFT">
                   ...
                   <label class="checkbox-inline"> <INPUT Type=Checkbox  style="border:0;" name="OrderConfiguration" value="editBillPrintout" <%=disabled%> <%=checkOption("editBillPrintout")%>>
                    ...
                    <th WIDTH="23%" ALIGN = "LEFT">
                    <label class="checkbox-inline"><INPUT Type=Checkbox  style="border:0;" name="OrderConfiguration" value="email_config_bill"  <%=disabled%> <%=checkOption("email_config_bill")%>>
                   ...
                   <TH WIDTH="20%" ALIGN = "LEFT">
                    ...
                    <th WIDTH="23%" ALIGN = "LEFT">
                    <label class="checkbox-inline"><INPUT Type=Checkbox  style="border:0;" name="OrderConfiguration" value="email_config_invoice"  <%=disabled%> <%=checkOption("email_config_invoice")%>>
                    &nbsp; Edit Invoice Email Message</label>
                     
                    <TR>
                    
                    <th WIDTH="23%" ALIGN = "LEFT">
                    <label class="checkbox-inline"><INPUT Type=Checkbox  style="border:0;" name="OrderConfiguration" value="email_config_delivery"  <%=disabled%> <%=checkOption("email_config_delivery")%>>
...
<div class="panel-body">
       <TABLE class="table1" style="font-size:14px;width: 100%;">
                    ...
                    <TH WIDTH="20%" ALIGN = "LEFT">
	                 <label class="checkbox-inline"><INPUT Type=Checkbox  style="border:0;" name="expenses" value="expensesSummary"   <%=disabled%> <%=checkOption("expensesSummary")%> >     
	                 &nbsp; Expenses</label>
	                 
	                <TH WIDTH="20%" ALIGN = "LEFT">
                     <label class="checkbox-inline"><INPUT Type=Checkbox  style="border:0;" name="expenses" value="newexpenses" <%=disabled%> <%=checkOption("newexpenses")%>>
                     &nbsp; New</label> 
	                
	                <TH WIDTH="20%" ALIGN = "LEFT">
	                 <label class="checkbox-inline"><INPUT Type=Checkbox  style="border:0;" name="expenses" value="summarylnkexpenses"  <%=disabled%> <%=checkOption("summarylnkexpenses")%> >     
	                 &nbsp; Summary &#45; Expenses Number Link</label>
	                 
	                 <TH WIDTH="20%" ALIGN = "LEFT">
                     <label class="checkbox-inline"><INPUT Type=Checkbox  style="border:0;" name="expenses" value="exportexpense" <%=disabled%> <%=checkOption("exportexpense")%>>
                     &nbsp; Export</label> 
                     
                    <TR> 
                    
                     <TH WIDTH="20%" ALIGN = "LEFT">
                     <label class="checkbox-inline"><INPUT Type=Checkbox  style="border:0;" name="expenses" value="editexpenses" <%=disabled%> <%=checkOption("editexpenses")%>>
                     &nbsp; Edit</label>
	                
	                <TH WIDTH="20%" ALIGN = "LEFT">
                     <label class="checkbox-inline"><INPUT Type=Checkbox  style="border:0;" name="expenses" value="printexpenses" <%=disabled%> <%=checkOption("printexpenses")%>>
                     &nbsp; PDF/Print</label>
                     
                     <TH WIDTH="20%" ALIGN = "LEFT">
                     <label class="checkbox-inline"><INPUT Type=Checkbox  style="border:0;" name="expenses" value="convertexpenses" <%=disabled%> <%=checkOption("convertexpenses")%>>
                     &nbsp; Convert to Invoice</label>
                     
                    <TH WIDTH="20%" ALIGN = "LEFT">
                     <label class="checkbox-inline"><INPUT Type=Checkbox  style="border:0;" name="expenses" value="moreexpenses" <%=disabled%> <%=checkOption("moreexpenses")%>>
                     &nbsp; More</label>  
		</TABLE>
    </div>
 </div>
...
<div class="panel-body">
       <TABLE class="table1" style="font-size:14px;width: 100%;">
                    ...
                    <TH WIDTH="20%" ALIGN = "LEFT">
	                 <label class="checkbox-inline"><INPUT Type=Checkbox  style="border:0;" name="GoodsReceipt" value="grnSummary"  <%=disabled%> <%=checkOption("grnSummary")%> >     
	                 &nbsp; Goods Receipt</label>
	                
	                <TH WIDTH="20%" ALIGN = "LEFT">
	                 <label class="checkbox-inline"><INPUT Type=Checkbox  style="border:0;" name="GoodsReceipt" value="summarylnkgrn"  <%=disabled%> <%=checkOption("summarylnkgrn")%> >     
	                 &nbsp; Summary &#45; Order Number Link</label>
	                 
	                 <TH WIDTH="20%" ALIGN = "LEFT">
	                 <label class="checkbox-inline"><INPUT Type=Checkbox  style="border:0;" name="GoodsReceipt" value="exportgrn"  <%=disabled%> <%=checkOption("exportgrn")%> >     
	                 &nbsp; Export</label>
	                
	                <TH WIDTH="20%" ALIGN = "LEFT">
                     <label class="checkbox-inline"><INPUT Type=Checkbox  style="border:0;" name="GoodsReceipt" value="printgrn" <%=disabled%> <%=checkOption("printgrn")%>>
                     &nbsp; PDF/Print</label>
                     
                     <TR>
                     
                     <TH WIDTH="20%" ALIGN = "LEFT">
                     <label class="checkbox-inline"><INPUT Type=Checkbox  style="border:0;" name="GoodsReceipt" value="convertgrn" <%=disabled%> <%=checkOption("convertgrn")%>>
...
<div class="panel-body">
       <TABLE class="table1" style="font-size:14px;width: 100%;">
                    ...
                    <TH WIDTH="20%" ALIGN = "LEFT">
	                 <label class="checkbox-inline"><INPUT Type=Checkbox  style="border:0;" name="bill" value="billSummary"   <%=disabled%> <%=checkOption("billSummary")%> >     
	                 &nbsp; Bill</label>
	                 
	                <TH WIDTH="20%" ALIGN = "LEFT">
                     <label class="checkbox-inline"><INPUT Type=Checkbox  style="border:0;" name="bill" value="newbill" <%=disabled%> <%=checkOption("newbill")%>>
                     &nbsp; New</label>
                     
                    <TH WIDTH="20%" ALIGN = "LEFT">
	                 <label class="checkbox-inline"><INPUT Type=Checkbox  style="border:0;" name="bill" value="summarylnkbill" <%=disabled%> <%=checkOption("summarylnkbill")%> >
	                 &nbsp; Summary &#45; Bill Number Link</label>
	             
	                 <TH WIDTH="20%" ALIGN = "LEFT">
                     <label class="checkbox-inline"><INPUT Type=Checkbox  style="border:0;" name="bill" value="exportbill" <%=disabled%> <%=checkOption("exportbill")%>>
                     &nbsp; Export</label>
	                ...
	                <TR>
	                  ...
	                  <TH WIDTH="20%" ALIGN = "LEFT">
                     <label class="checkbox-inline"><INPUT Type=Checkbox  style="border:0;" name="bill" value="editbill" <%=disabled%> <%=checkOption("editbill")%>>
                     &nbsp; Edit</label>
                        
                    <TH WIDTH="20%" ALIGN = "LEFT">
                     <label class="checkbox-inline"><INPUT Type=Checkbox  style="border:0;" name="bill" value="printbill" <%=disabled%> <%=checkOption("printbill")%>>
                     &nbsp; PDF/Print</label>
                     
                     <TH WIDTH="20%" ALIGN = "LEFT">
                     <label class="checkbox-inline"><INPUT Type=Checkbox  style="border:0;" name="bill" value="applycreditsbill" <%=disabled%> <%=checkOption("applycreditsbill")%>>
                     &nbsp; Apply Credits</label>
                     
                     <TH WIDTH="20%" ALIGN = "LEFT">
                     <label class="checkbox-inline"><INPUT Type=Checkbox  style="border:0;" name="bill" value="recordpaymentbill" <%=disabled%> <%=checkOption("recordpaymentbill")%>>
                     &nbsp; Record Payment</label> 
                      
                     <TR>
                      
                    <TH WIDTH="20%" ALIGN = "LEFT">
                     <label class="checkbox-inline"><INPUT Type=Checkbox  style="border:0;" name="bill" value="morebill" <%=disabled%> <%=checkOption("morebill")%>>
                     &nbsp; More</label> 
...
<div class="panel-body">
       <TABLE class="table1" style="font-size:14px;width: 100%;">
	                ...
	                <TH WIDTH="20%" ALIGN = "LEFT">
	                 <label class="checkbox-inline"><INPUT Type=Checkbox  style="border:0;" name="PurchaseReturn" value="summarylnkpurchasereturn" <%=disabled%> <%=checkOption("summarylnksalesreturn")%> >
...
<div class="panel-body">
       <TABLE class="table1" style="font-size:14px;width: 100%;">
                    ...
                    <TH WIDTH="20%" ALIGN = "LEFT">
	                 <label class="checkbox-inline"><INPUT Type=Checkbox  style="border:0;" name="SupplierCreditNotes" value="supplierCreditNote"   <%=disabled%> <%=checkOption("supplierCreditNote")%> >     
	                 &nbsp; Debit Note</label>
	                 
	                <TH WIDTH="20%" ALIGN = "LEFT">
	                 <label class="checkbox-inline"><INPUT Type=Checkbox  style="border:0;" name="SupplierCreditNotes" value="newSupplierCreditNote"  <%=disabled%> <%=checkOption("newSupplierCreditNote")%> >     
	                 &nbsp; New</label>
	                 
	                <TH WIDTH="20%" ALIGN = "LEFT">
	                 <label class="checkbox-inline"><INPUT Type=Checkbox  style="border:0;" name="SupplierCreditNotes" value="summarylnkSupplierCreditNote" <%=disabled%> <%=checkOption("summarylnkSupplierCreditNote")%> >
	                 &nbsp; Summary &#45; Debit Number Link</label>
	                 
	                 <TH WIDTH="20%" ALIGN = "LEFT">
	                 <label class="checkbox-inline"><INPUT Type=Checkbox  style="border:0;" name="SupplierCreditNotes" value="exportSupplierCreditNote"  <%=disabled%> <%=checkOption("exportSupplierCreditNote")%> >     
	                 &nbsp; Export</label>
                    ...
                    <TR> 
                     ...
                     <TH WIDTH="20%" ALIGN = "LEFT">
                     <label class="checkbox-inline"><INPUT Type=Checkbox  style="border:0;" name="SupplierCreditNotes" value="editSupplierCreditNote" <%=disabled%> <%=checkOption("editSupplierCreditNote")%>>
                     &nbsp; Edit</label>
                     
                        
                    <TH WIDTH="20%" ALIGN = "LEFT">
                     <label class="checkbox-inline"><INPUT Type=Checkbox  style="border:0;" name="SupplierCreditNotes" value="printSupplierCreditNote" <%=disabled%> <%=checkOption("printSupplierCreditNote")%>>
                     &nbsp; PDF/Print</label>
                     
                    <TH WIDTH="20%" ALIGN = "LEFT">
                     <label class="checkbox-inline"><INPUT Type=Checkbox  style="border:0;" name="SupplierCreditNotes" value="moreSupplierCreditNote" <%=disabled%> <%=checkOption("moreSupplierCreditNote")%>>
                     &nbsp; More</label>   
       </TABLE>
    </div>
 </div>
...
<div class="panel-body"> 
		<TABLE class="table1" style="font-size:14px;width: 100%;">
        	 ...
        	 <TH WIDTH="20%" ALIGN = "LEFT">
	                 <label class="checkbox-inline"><INPUT Type=Checkbox  style="border:0;" name="GoodsIssued" value="ginotoinvoiceSummary"  <%=disabled%> <%=checkOption("ginotoinvoiceSummary")%> >     
	                 &nbsp;  Goods Issued</label>
	                
	                <TH WIDTH="20%" ALIGN = "LEFT">
	                 <label class="checkbox-inline"><INPUT Type=Checkbox  style="border:0;" name="GoodsIssued" value="summarylnkginotoinvoice"  <%=disabled%> <%=checkOption("summarylnkginotoinvoice")%> >     
	                 &nbsp; Summary &#45; Order Number Link</label>
	                
	                 <TH WIDTH="20%" ALIGN = "LEFT">
	                 <label class="checkbox-inline"><INPUT Type=Checkbox  style="border:0;" name="GoodsIssued" value="exportlnkginotoinvoice"  <%=disabled%> <%=checkOption("exportlnkginotoinvoice")%> >     
	                 &nbsp; Export</label>
	                 
	                <TH WIDTH="20%" ALIGN = "LEFT">
                     <label class="checkbox-inline"><INPUT Type=Checkbox  style="border:0;" name="GoodsIssued" value="printginotoinvoice" <%=disabled%> <%=checkOption("printginotoinvoice")%>>
                     &nbsp; PDF/Print</label>
                                          
                     <TR>
                     
                     <TH WIDTH="20%" ALIGN = "LEFT">
                     <label class="checkbox-inline"><INPUT Type=Checkbox  style="border:0;" name="GoodsIssued" value="convertginotoinvoice" <%=disabled%> <%=checkOption("convertginotoinvoice")%>>
                     &nbsp; Convert to Invoice</label> 
...
<div class="panel-body"> 
		<TABLE class="table1" style="font-size:14px;width: 100%;">
        	 ...
        	 <TH WIDTH="20%" ALIGN = "LEFT">
	                 <label class="checkbox-inline"><INPUT Type=Checkbox  style="border:0;" name="Invoice" value="invoiceSummary"  <%=disabled%> <%=checkOption("invoiceSummary")%> >     
	                 &nbsp; Invoice</label>
	                 
	                <TH WIDTH="20%" ALIGN = "LEFT">
                     <label class="checkbox-inline"><INPUT Type=Checkbox  style="border:0;" name="Invoice" value="newinvoice" <%=disabled%> <%=checkOption("newinvoice")%>>
                     &nbsp; New</label>
                     
                    <%-- <TH WIDTH="20%" ALIGN = "LEFT">
	                 <label class="checkbox-inline"><INPUT Type=Checkbox  style="border:0;" name="Invoice" value="invoiceByOpen" <%=disabled%> <%=checkOption("invoiceByOpen")%>>     
	                 &nbsp;  Invoice By Open</label>
	                        
	                <TH WIDTH="20%" ALIGN = "LEFT">
	                 <label class="checkbox-inline"><INPUT Type=Checkbox  style="border:0;" name="Invoice" value="invoiceByDraft" <%=disabled%> <%=checkOption("invoiceByDraft")%>>     
	                 &nbsp; Invoice By Draft</label> --%>
                     
                    <TH WIDTH="20%" ALIGN = "LEFT">
	                 <label class="checkbox-inline"><INPUT Type=Checkbox  style="border:0;" name="Invoice" value="summarylnkinvoice" <%=disabled%> <%=checkOption("summarylnkinvoice")%> >
	                 &nbsp; Summary &#45; Invoice Number Link</label>
	                 
	                   
	                <TH WIDTH="20%" ALIGN = "LEFT">
                     <label class="checkbox-inline"><INPUT Type=Checkbox  style="border:0;" name="Invoice" value="exportinvoice" <%=disabled%> <%=checkOption("exportinvoice")%>>
                     &nbsp; Export</label>
	                        
	                <TR>
                     
                    <TH WIDTH="20%" ALIGN = "LEFT">
                     <label class="checkbox-inline"><INPUT Type=Checkbox  style="border:0;" name="Invoice" value="editinvoice" <%=disabled%> <%=checkOption("editinvoice")%>>
                     &nbsp; Edit</label>
                        
                    <TH WIDTH="20%" ALIGN = "LEFT">
                     <label class="checkbox-inline"><INPUT Type=Checkbox  style="border:0;" name="Invoice" value="printwtinvoice" <%=disabled%> <%=checkOption("printwtinvoice")%>>
                     &nbsp; PDF/Print</label>
                     
                       <TH WIDTH="20%" ALIGN = "LEFT">
                     <label class="checkbox-inline"><INPUT Type=Checkbox  style="border:0;" name="Invoice" value="applycreditsinvoice" <%=disabled%> <%=checkOption("applycreditsinvoice")%>>
                     &nbsp; Apply Credits</label>
                        
                     
                     <TH WIDTH="20%" ALIGN = "LEFT">
                     <label class="checkbox-inline"><INPUT Type=Checkbox  style="border:0;" name="Invoice" value="recordpaymentinvoice" <%=disabled%> <%=checkOption("recordpaymentinvoice")%>>
                     &nbsp; Record Payment</label>
	                        
	                <TR> 
                       
                    <TH WIDTH="20%" ALIGN = "LEFT">
                     <label class="checkbox-inline"><INPUT Type=Checkbox  style="border:0;" name="Invoice" value="moreinvoice" <%=disabled%> <%=checkOption("moreinvoice")%>>
                     &nbsp; More</label>
...
<div class="panel-body"> 
		<TABLE class="table1" style="font-size:14px;width: 100%;">
        	 ...
        	 <TH WIDTH="20%" ALIGN = "LEFT">
	                 <label class="checkbox-inline"><INPUT Type=Checkbox  style="border:0;" name="CreditNotes" value="customerCreditNote"  <%=disabled%> <%=checkOption("customerCreditNote")%> >     
	                 &nbsp; Credit Note</label>
	                 
	                <TH WIDTH="20%" ALIGN = "LEFT">
	                 <label class="checkbox-inline"><INPUT Type=Checkbox  style="border:0;" name="CreditNotes" value="newCreditNote"  <%=disabled%> <%=checkOption("newsalesreturn")%> >     
	                 &nbsp; New</label>
	                 
	                <TH WIDTH="20%" ALIGN = "LEFT">
	                 <label class="checkbox-inline"><INPUT Type=Checkbox  style="border:0;" name="CreditNotes" value="summarylnkCreditNote" <%=disabled%> <%=checkOption("summarylnksalesreturn")%> >
	                 &nbsp; Summary &#45; Credit Number Link</label>
	                 
	                 <TH WIDTH="20%" ALIGN = "LEFT">
	                 <label class="checkbox-inline"><INPUT Type=Checkbox  style="border:0;" name="CreditNotes" value="exportCreditNote"  <%=disabled%> <%=checkOption("exportCreditNote")%> >     
	                 &nbsp; Export</label>
                    ...
                    <TR> 
                     ...
                     <TH WIDTH="20%" ALIGN = "LEFT">
                     <label class="checkbox-inline"><INPUT Type=Checkbox  style="border:0;" name="CreditNotes" value="editCreditNote" <%=disabled%> <%=checkOption("editCreditNote")%>>
                     &nbsp; Edit</label>   
                        
                    <TH WIDTH="20%" ALIGN = "LEFT">
                     <label class="checkbox-inline"><INPUT Type=Checkbox  style="border:0;" name="CreditNotes" value="printCreditNote" <%=disabled%> <%=checkOption("printCreditNote")%>>
                     &nbsp; PDF/Print</label>
                     
                    <TH WIDTH="20%" ALIGN = "LEFT">
                     <label class="checkbox-inline"><INPUT Type=Checkbox  style="border:0;" name="CreditNotes" value="moreCreditNote" <%=disabled%> <%=checkOption("moreCreditNote")%>>
                     &nbsp; More</label>
        	 ...
        	 <TR>
		                   ...
		                   <TH WIDTH="20%" ALIGN = "LEFT">
                        	...
                        	<TR>
                             ...
                             <TH WIDTH="20%" ALIGN = "LEFT">
                        	<label class="checkbox-inline"><INPUT Type=Checkbox  style="border:0;" name="SalesReports" value="salesoderdelivery" <%=disabled%> <%=checkOption("salesoderdelivery")%> >
                           ...
                           <TH WIDTH="20%" ALIGN = "LEFT">
	                        ...
	                        <TH WIDTH="20%" ALIGN = "LEFT">
	                        	<label class="checkbox-inline"><INPUT Type=Checkbox  style="border:0;" name="SalesReports" value="salessummarycustomer"  <%=disabled%> <%=checkOption("salessummarycustomer")%> >
...
<div class="panel-body"> 
		<TABLE class="table1" style="font-size:14px;width: 100%;">
        	 ...
        	 <TH WIDTH="20%" ALIGN = "LEFT">
              <label class="checkbox-inline"><INPUT Type=Checkbox  style="border:0;" name="chartOfAccounts" value="chartOfAccounts" <%=disabled%> <%=checkOption("chartOfAccounts")%>>
              &nbsp; Chart of Accounts</label>
              
             <TH WIDTH="20%" ALIGN = "LEFT">
	          <label class="checkbox-inline"><INPUT Type=Checkbox  style="border:0;" name="chartOfAccounts" value="newchartOfAccounts"  <%=disabled%> <%=checkOption("newchartOfAccounts")%> >     
	          &nbsp; New</label>
	          
	         <TH WIDTH="20%" ALIGN = "LEFT">
	          <label class="checkbox-inline"><INPUT Type=Checkbox  style="border:0;" name="chartOfAccounts" value="editchartOfAccounts"  <%=disabled%> <%=checkOption("editchartOfAccounts")%> >     
	          &nbsp; Edit</label>
	          
	         <TH WIDTH="20%" ALIGN = "LEFT">
	          <label class="checkbox-inline"><INPUT Type=Checkbox  style="border:0;" name="chartOfAccounts" value="printchartOfAccounts"  <%=disabled%> <%=checkOption("printchartOfAccounts")%> >     
	          &nbsp; PDF/Print</label>
	          
	          <TR>
	          
	         <TH WIDTH="20%" ALIGN = "LEFT">
	          <label class="checkbox-inline"><INPUT Type=Checkbox  style="border:0;" name="chartOfAccounts" value="deletechartOfAccounts"  <%=disabled%> <%=checkOption("deletechartOfAccounts")%> >     
	          &nbsp; Delete</label>  
...
<div class="panel-body"> 
		<TABLE class="table1" style="font-size:14px;width: 100%;">
        	 ...
        	 <TH WIDTH="20%" ALIGN = "LEFT">
              <label class="checkbox-inline"><INPUT Type=Checkbox  style="border:0;" name="apSummary" value="apsummary" <%=disabled%> <%=checkOption("apsummary")%> >
              &nbsp; AP Document</label>
              
             <TH WIDTH="20%" ALIGN = "LEFT">
	          <label class="checkbox-inline"><INPUT Type=Checkbox  style="border:0;" name="apSummary" value="possummary" <%=disabled%> <%=checkOption("possummary")%> >     
	          &nbsp; POS Expenses</label>
...
<div class="panel-body"> 
		<TABLE class="table1" style="font-size:14px;width: 100%;">
			 ...
			 <TH WIDTH="20%" ALIGN = "LEFT">
	          <label class="checkbox-inline">  <INPUT Type=Checkbox  style="border:0;" name="PaymentMade" value="billPaymentSummary"  <%=disabled%> <%=checkOption("billPaymentSummary")%> >
	          &nbsp; Payment</label>
	          
	         <TH WIDTH="20%" ALIGN = "LEFT">
	          <label class="checkbox-inline"><INPUT Type=Checkbox  style="border:0;" name="PaymentMade" value="newPaymentMade"  <%=disabled%> <%=checkOption("newPaymentMade")%> >     
	          &nbsp; New</label>
	          
	         <TH WIDTH="20%" ALIGN = "LEFT">
	          <label class="checkbox-inline"><INPUT Type=Checkbox  style="border:0;" name="PaymentMade" value="summarylnkPaymentMade" <%=disabled%> <%=checkOption("summarylnkPaymentMade")%> >
	          &nbsp; Summary &#45; Payment Number Link</label> 
	          
	           <TH WIDTH="20%" ALIGN = "LEFT">
	          <label class="checkbox-inline"><INPUT Type=Checkbox  style="border:0;" name="PaymentMade" value="exportPaymentMade"  <%=disabled%> <%=checkOption("exportPaymentMade")%> >     
	          &nbsp; Export</label>
	          ...
	          <TH WIDTH="20%" ALIGN = "LEFT">
	          <label class="checkbox-inline"><INPUT Type=Checkbox  style="border:0;" name="PaymentMade" value="editPaymentMade"  <%=disabled%> <%=checkOption("editPaymentMade")%> >     
	          &nbsp; Edit</label>
	          
	         <TH WIDTH="20%" ALIGN = "LEFT">
	          <label class="checkbox-inline"><INPUT Type=Checkbox  style="border:0;" name="PaymentMade" value="printPaymentMade"  <%=disabled%> <%=checkOption("printPaymentMade")%> >     
	          &nbsp; PDF/Print</label>
	          
	         <TH WIDTH="20%" ALIGN = "LEFT">
	          <label class="checkbox-inline"><INPUT Type=Checkbox  style="border:0;" name="PaymentMade" value="deletePaymentMade"  <%=disabled%> <%=checkOption("deletePaymentMade")%> >     
	          &nbsp; Delete</label>
	         
	         <TH WIDTH="20%" ALIGN = "LEFT">
              <label class="checkbox-inline"><INPUT Type=Checkbox  style="border:0;" name="PaymentMade" value="morePaymentMade" <%=disabled%> <%=checkOption("morePaymentMade")%>>
              &nbsp; More</label>  
...
<div class="panel-body"> 
		<TABLE class="table1" style="font-size:14px;width: 100%;">
        	 ...
        	 <TH WIDTH="20%" ALIGN = "LEFT">
	          <label class="checkbox-inline"> <INPUT Type=Checkbox  style="border:0;" name="PDCPaymentMade" value="pdcpaymentSummary"   <%=disabled%> <%=checkOption("pdcpaymentSummary")%> >
	          &nbsp; PDC Issued</label>
	          
	         <TH WIDTH="20%" ALIGN = "LEFT">
	          <label class="checkbox-inline"><INPUT Type=Checkbox  style="border:0;" name="PDCPaymentMade" value="newPDCPaymentMade"  <%=disabled%> <%=checkOption("newPaymentMade")%> >     
	          &nbsp; Process Payment</label>
	          
	          <TH WIDTH="20%" ALIGN = "LEFT">
	          <label class="checkbox-inline"><INPUT Type=Checkbox  style="border:0;" name="PDCPaymentMade" value="exportPDCPaymentMade"  <%=disabled%> <%=checkOption("exportPDCPaymentMade")%> >     
	          &nbsp; Export</label>  
	          
	         <TH WIDTH="20%" ALIGN = "LEFT">
	          <label class="checkbox-inline"><INPUT Type=Checkbox  style="border:0;" name="PDCPaymentMade" value="editPDCPaymentMade"  <%=disabled%> <%=checkOption("editPaymentMade")%> >     
	          &nbsp; Edit</label>  
        </TABLE>
  </div>
</div>	 	 
...
<div class="panel-body"> 
		<TABLE class="table1" style="font-size:14px;width: 100%;">
			 ...
			 <TH WIDTH="20%" ALIGN = "LEFT">
	          <label class="checkbox-inline"><INPUT Type=Checkbox  style="border:0;" name="PaymentReceived" value="invoicePaymentSummary"  <%=disabled%> <%=checkOption("invoicePaymentSummary")%> >
	          &nbsp; Receipt</label>
	          
	         <TH WIDTH="20%" ALIGN = "LEFT">
	          <label class="checkbox-inline"><INPUT Type=Checkbox  style="border:0;" name="PaymentReceived" value="newPaymentReceived"  <%=disabled%> <%=checkOption("newPaymentReceived")%> >     
	          &nbsp; New</label>
	          
	         <TH WIDTH="20%" ALIGN = "LEFT">
	          <label class="checkbox-inline"><INPUT Type=Checkbox  style="border:0;" name="PaymentReceived" value="summarylnkPaymentReceived" <%=disabled%> <%=checkOption("summarylnkPaymentReceived")%> >
	          &nbsp; Summary &#45; Receipt Number Link</label>
	          
	           <TH WIDTH="20%" ALIGN = "LEFT">
	          <label class="checkbox-inline"><INPUT Type=Checkbox  style="border:0;" name="PaymentReceived" value="editPaymentReceived"  <%=disabled%> <%=checkOption("editPaymentReceived")%> >     
	          &nbsp; Edit</label> 
	          
	          <TR>
	          
	         <TH WIDTH="20%" ALIGN = "LEFT">
	          <label class="checkbox-inline"><INPUT Type=Checkbox  style="border:0;" name="PaymentReceived" value="printPaymentReceived"  <%=disabled%> <%=checkOption("printPaymentReceived")%> >     
	          &nbsp; PDF/Print</label>
	          
	         <TH WIDTH="20%" ALIGN = "LEFT">
	          <label class="checkbox-inline"><INPUT Type=Checkbox  style="border:0;" name="PaymentReceived" value="deletePaymentReceived"  <%=disabled%> <%=checkOption("deletePaymentReceived")%> >     
	          &nbsp; Delete</label>
	         
	         <TH WIDTH="20%" ALIGN = "LEFT">
              <label class="checkbox-inline"><INPUT Type=Checkbox  style="border:0;" name="PaymentReceived" value="morePaymentReceived" <%=disabled%> <%=checkOption("morePaymentReceived")%>>
              &nbsp; More</label>  
...
<div class="panel-body"> 
		<TABLE class="table1" style="font-size:14px;width: 100%;">
        	 ...
        	 <TH WIDTH="20%" ALIGN = "LEFT">
	          <label class="checkbox-inline"><INPUT Type=Checkbox  style="border:0;" name="PDCPaymentReceived" value="pdcpaymentReceiveSummary"  <%=disabled%> <%=checkOption("pdcpaymentReceiveSummary")%> >
	          &nbsp; PDC Received</label>
	          
	         <TH WIDTH="20%" ALIGN = "LEFT">
	          <label class="checkbox-inline"><INPUT Type=Checkbox  style="border:0;" name="PDCPaymentReceived" value="newPDCPaymentReceived"  <%=disabled%> <%=checkOption("newPDCPaymentReceived")%> >     
	          &nbsp; Process Payment</label>
	          
	          <TH WIDTH="20%" ALIGN = "LEFT">
	          <label class="checkbox-inline"><INPUT Type=Checkbox  style="border:0;" name="PDCPaymentReceived" value="exportPDCPaymentReceived"  <%=disabled%> <%=checkOption("exportPDCPaymentReceived")%> >     
	          &nbsp; Export</label>
	          
	         <TH WIDTH="20%" ALIGN = "LEFT">
	          <label class="checkbox-inline"><INPUT Type=Checkbox  style="border:0;" name="PDCPaymentReceived" value="editPDCPaymentReceived"  <%=disabled%> <%=checkOption("editPDCPaymentReceived")%> >     
	          &nbsp; Edit</label>
...
<div class="panel-body"> 
		<TABLE class="table1" style="font-size:14px;width: 100%;">
        	 ...
        	 <TH WIDTH="20%" ALIGN = "LEFT">
              <label class="checkbox-inline"> <INPUT Type=Checkbox  style="border:0;" name="JournalEntry" value="journalsummary" <%=disabled%> <%=checkOption("journalsummary")%>>
              &nbsp; Manual Journals</label>
             
             <TH WIDTH="20%" ALIGN = "LEFT">
              <label class="checkbox-inline"> <INPUT Type=Checkbox  style="border:0;" name="JournalEntry" value="newjournal" <%=disabled%> <%=checkOption("newjournal")%>>
              &nbsp; New</label>
              
             <TH WIDTH="20%" ALIGN = "LEFT">
	          <label class="checkbox-inline"><INPUT Type=Checkbox  style="border:0;" name="JournalEntry" value="summarylnkjournal" <%=disabled%> <%=checkOption("summarylnkjournal")%> >
	          &nbsp; Summary &#45; Journal Number Link</label> 
	          
	         <TH WIDTH="20%" ALIGN = "LEFT">
	          <label class="checkbox-inline"><INPUT Type=Checkbox  style="border:0;" name="JournalEntry" value="editjournal"  <%=disabled%> <%=checkOption("editjournal")%> >     
	          &nbsp; Edit</label>
	          
	          <TR>
	          
	         <TH WIDTH="20%" ALIGN = "LEFT">
	          <label class="checkbox-inline"><INPUT Type=Checkbox  style="border:0;" name="JournalEntry" value="printjournal"  <%=disabled%> <%=checkOption("printjournal")%> >     
	          &nbsp; PDF/Print</label>  
...
<div class="panel-body"> 
		<TABLE class="table1" style="font-size:14px;width: 100%;">
        	 ...
        	 <TH WIDTH="20%" ALIGN = "LEFT">
              <label class="checkbox-inline"> <INPUT Type=Checkbox  style="border:0;" name="ContraEntry" value="contrasummary" <%=disabled%> <%=checkOption("contrasummary")%>>
              &nbsp; Contra</label>
             
             <TH WIDTH="20%" ALIGN = "LEFT">
              <label class="checkbox-inline"> <INPUT Type=Checkbox  style="border:0;" name="ContraEntry" value="newcontra" <%=disabled%> <%=checkOption("newcontra")%>>
              &nbsp; New</label>
              
             <TH WIDTH="20%" ALIGN = "LEFT">
	          <label class="checkbox-inline"><INPUT Type=Checkbox  style="border:0;" name="ContraEntry" value="summarylnkcontra" <%=disabled%> <%=checkOption("summarylnkcontra")%> >
	          &nbsp; Summary &#45; Contra Number Link</label> 
	          
	         <TH WIDTH="20%" ALIGN = "LEFT">
	          <label class="checkbox-inline"><INPUT Type=Checkbox  style="border:0;" name="ContraEntry" value="editcontra"  <%=disabled%> <%=checkOption("editcontra")%> >     
	          &nbsp; Edit</label>
	          
	          <TR>
	          
	         <TH WIDTH="20%" ALIGN = "LEFT">
	          <label class="checkbox-inline"><INPUT Type=Checkbox  style="border:0;" name="ContraEntry" value="printcontra"  <%=disabled%> <%=checkOption("printcontra")%> >     
	          &nbsp; PDF/Print</label>  
...
<div class="panel-body"> 
		<TABLE class="table1" style="font-size:14px;width: 100%;">
            ...
            <TH WIDTH="20%" ALIGN = "LEFT">
              <label class="checkbox-inline"> <INPUT Type=Checkbox  style="border:0;" name="AccountingAdmin" value="taxreturnsummary_acc" <%=disabled%> <%=checkOption("taxreturnsummary_acc")%>>
              &nbsp; Tax Return  </label>            
            ...
            <TH WIDTH="20%" ALIGN = "LEFT" style="display: <%=region.equals("ASIA PACIFIC") ? "none" : "block"%>;">
                  ...
                  <TR>
	         <TH WIDTH="20%" ALIGN = "LEFT">
              <label class="checkbox-inline"> <INPUT Type=Checkbox  style="border:0;" name="AccountingAdmin" value="taxReports" <%=disabled%> <%=checkOption("taxReports")%>>
              &nbsp; Tax Reports   </label>   
              
              <TH WIDTH="20%" ALIGN = "LEFT">
              <label class="checkbox-inline"> <INPUT Type=Checkbox  style="border:0;" name="AccountingAdmin" value="taxFilingSummary" <%=disabled%> <%=checkOption("taxFilingSummary")%>>
              &nbsp;  Tax Filing Summary  </label>   
              
              <TH WIDTH="20%" ALIGN = "LEFT">
              <label class="checkbox-inline"> <INPUT Type=Checkbox  style="border:0;" name="AccountingAdmin" value="taxFilingDetailedSummary" <%=disabled%> <%=checkOption("taxFilingDetailedSummary")%>>
              &nbsp;Tax Filing Detailed Summary   </label>   
              
              <TH WIDTH="20%" ALIGN = "LEFT">
              <label class="checkbox-inline"> <INPUT Type=Checkbox  style="border:0;" name="AccountingAdmin" value="taxLiabilityReport" <%=disabled%> <%=checkOption("taxLiabilityReport")%>>
    ...
    <div class="panel-body">
		<TABLE >
                    <TR>
                         ...
                         <TH WIDTH="20%" ALIGN = "LEFT">
	                        	<label class="checkbox-inline"><INPUT Type=Checkbox  style="border:0;" name="AccountingReports" value="parentbalance" <%=disabled%> <%=checkOption("parentbalance")%> >
                         ...
                         <TH WIDTH="20%" ALIGN = "LEFT">
	                        	<label class="checkbox-inline"><INPUT Type=Checkbox  style="border:0;" name="AccountingReports" value="parentprofitloss" <%=disabled%> <%=checkOption("parentprofitloss")%> >
              ...
              <TR>  
                         ...
                         <TH WIDTH="20%" ALIGN = "LEFT">
	                        	<label class="checkbox-inline"><INPUT Type=Checkbox  style="border:0;" name="AccountingReports" value="statementofcashflows" <%=disabled%> <%=checkOption("statementofcashflows")%> >
	        ...
	        <TR>
                         ...
                         <TH WIDTH="20%" ALIGN = "LEFT">
	                        <label class="checkbox-inline"><INPUT Type=Checkbox  style="border:0;" name="AccountingReports" value="bankreconcilationsummary" <%=disabled%> <%=checkOption("bankreconcilationsummary")%> >      
	           ...
	           <TR>
	                     ...
	                     <TH WIDTH="20%" ALIGN = "LEFT">
	                    		<label class="checkbox-inline">    <INPUT Type=Checkbox  style="border:0;" name="AccountingReports" value="parentjournalreport" <%=disabled%> <%=checkOption("parentjournalreport")%> >      
	             ...
	             <TR>
	                     ...
	                     <TH WIDTH="20%" ALIGN = "LEFT">
	                    		<label class="checkbox-inline">    <INPUT Type=Checkbox  style="border:0;" name="AccountingReports" value="parenttrialbalance" <%=disabled%> <%=checkOption("parenttrialbalance")%> >      
	                        	&nbsp;  Consolidated Trail Balance</label>
	                     </TH>
	                        
	                     <TH WIDTH="20%" ALIGN = "LEFT">
	                    		<label class="checkbox-inline">    <INPUT Type=Checkbox  style="border:0;" name="AccountingReports" value="projectprofitloss" <%=disabled%> <%=checkOption("projectprofitloss")%> >      
	                        	&nbsp;  Project Profit and Loss</label>
	                     </TH>
	                        
	                     <TH WIDTH="20%" ALIGN = "LEFT">
	                    		<label class="checkbox-inline">    <INPUT Type=Checkbox  style="border:0;" name="AccountingReports" value="projecttrialbalance" <%=disabled%> <%=checkOption("projecttrialbalance")%> >      
	                        	&nbsp;  Project Trial Balance</label>
	                     </TH>
	                        
	                     <TH WIDTH="20%" ALIGN = "LEFT">
	                    		<label class="checkbox-inline">    <INPUT Type=Checkbox  style="border:0;" name="AccountingReports" value="consolprojecttrialbalance" <%=disabled%> <%=checkOption("consolprojecttrialbalance")%> >      
