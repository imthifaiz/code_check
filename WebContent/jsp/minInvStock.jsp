...
function ExportReport()
{
  ...
  document.form1.action="InventoryExcel.jsp";
...
if(PGaction.equalsIgnoreCase("View")){
 try{
	 ITEM = itemMstUtil.isValidAlternateItemInItemmst( PLANT, ITEM);
      ...
      invQryListSumTotal = invUtil.getInvListSumTotalByItem(htSumTotal,PLANT,ITEM);
	 ...
	 cntRec=true;
	 //response.sendRedirect("view_inv_list.jsp");
 }
}

%>
<%@ include file="body.jsp"%>
<FORM name="form1" method="post" action="minInvStock.jsp">
...
<input type="hidden" name="PRD_TYPE_ID1" value="">
  ...
  <TABLE border="0" width="70%" cellspacing="0" cellpadding="0" align="center" bgcolor="#dddddd">
   ...
   <TR>
          ...
          <a href="#" onClick="javascript:popUpWin('loc_list_inventory.jsp');">
        ...
        <TR>
          ...
          <TD width="15%"><INPUT name="PRD_CLS_ID" type = "TEXT" value="<%=PRD_CLS_ID%>" size="15"  MAXLENGTH=20>
           <a href="#" onClick="javascript:popUpWin('activePrdClsList.jsp?ITEM_ID='+form1.PRD_CLS_ID.value);">
           <img src="images/populate.gif" border="0"/>
          </a>
          </TD>
         ...
         <TH ALIGN="left" width="15%"> &nbsp;&nbsp;Product Description:  </TH>
          <TD width="13%"><INPUT name="PRD_DESCRIP" type = "TEXT" value="<%=PRD_DESCRIP%>" size="15"  MAXLENGTH=20>
  ...
  <TABLE WIDTH="80%"  border="0" cellspacing="1" cellpadding = 2 align = "center">
    <TR BGCOLOR="#000066">
       ...
       //       invQryList = invUtil.getInvListSummary(ht,PLANT,(String)lineArrSum.get("ITEM"),LOC,BATCH,PRD_CLS_ID1,PRD_DESCRIP);
               ...
               // String bgcolor = ((iCnt == 0) || (iCnt % 2 == 0)) ? "#FFFFFF"  : "#dddddd";
                rowColor = ((j == 0) || (j % 2 == 0)) ? "#FFFFFF"  : "#dddddd";
                 ...
                 trDate    = trDate.substring(8,10)+"-"+ trDate.substring(5,7)+"-"+trDate.substring(0,4);
                   Total=Total+Integer.parseInt(((String)lineArr.get("QTY").toString()));
                 int invItemQty=Integer.parseInt(((String)lineArr.get("ITEMQTY").toString()));
                  stkqty=Integer.parseInt(((String)lineArr.get("STKQTY").toString()));
                 ...
                 qty=Integer.parseInt(((String)lineArr.get("QTY").toString()));
                 stkqty=Integer.parseInt(((String)lineArr.get("STKQTY").toString()));
          %>
          <% if(stkqty  > invItemQty){%>
          <TR bgcolor = "<%=rowColor%>">
           <!-- <TD align="center"><%=j%></TD>-->
              ...
              <TD align= "center"><%=(String)lineArr.get("STKQTY") %></TD>
              <TD align= "center" ><%=(String)lineArr.get("QTY") %></TD>
         <%}%>   
       <%} if(flag==true) {%>
         </TR>
           <%
