...
<h3 class="panel-title">Reason Code List</h3> 
</div>
</div>
...
%>
<%if(FORM.equalsIgnoreCase("form1")){ %>
<TR>
		<td class="main2" style="font-weight: bold" align="left">&nbsp;<a href="#"
			onClick=" window.opener.form1.REASONCODE.value='<%=sItem%>';
...
<TR>
		<td class="main2" style="font-weight: bold" align="left">&nbsp;<a href="#"
			onClick=" window.opener.form.REASONCODE.value='<%=sItem%>';
                      window.close();"><%=sItem%></a></td>
		<td align="left" class="main2">&nbsp;<%=strUtils.replaceCharacters2Recv(sDesc)%></td>
	</TR>
...
<TR>
		<td class="main2" style="font-weight: bold" align="left">&nbsp;<a href="#"
			onClick=" window.opener.form.REASONCODE_<%=index%>.value='<%=sItem%>';
                      window.close();"><%=sItem%></a></td>
		<td align="left" class="main2">&nbsp;<%=strUtils.replaceCharacters2Recv(sDesc)%></td>
	</TR>
