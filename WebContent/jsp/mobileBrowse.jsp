...
<script>
	function onNext() {
		...
		document.form.action = "mobileBrowse.jsp?ID=" + plant + delim
...
String catalogPath="",price="",description1="",product1="",description2="",detailsPage="",description3="",uom="",strIndex="";
...
String isProductStart = StrUtils.fString(request.getParameter("START"));
String firstPrdScanned ="";
...
DecimalFormat decformat = new DecimalFormat("#,##0.00");
  ...
  if(isProductStart.equalsIgnoreCase("Y")){
      isProductStart= productid;
      session.setAttribute("PRODUCT_QR_SCANNED",isProductStart);
  }
...
<form name="form" method="post"><input type="hidden"
	...
	name="PRODUCTID1" value="<%=product1%>" /> <input type="hidden"
	name="PLANT" value="<%=plant%>" /> <input type="hidden" name="INDEX"
	value="<%=iIndex%>" /> <input type="hidden" name="COUNTER"
	value="<%=counter%>" /> <input type="hidden" name="PAGENAME"
	value="mobileventreg" />
...
<!-- Removed logo Image -->
	<tr>
		...
		<td align="right" class="mobilelabel"><a
			href="instrtnsummry.jsp?PLANT=<%=plant%>&PAGENAME=mobileenquiry"><font
			size="12" color="#669900"><b>INSTRUCTIONS</b></font></a></td>
	</tr>
...
<table cellpadding="0" cellspacing="0" width="100%">
	<tr>
		...
		<td align="center"><img
			...
			name="<%=productid%>" width="90%" id="<%=productid%>" /></td>
		<td>
...
<table align="center" cellpadding="0" cellspacing="0" width="100%">
	...
	<tr>
		<td></td>
		<td align="center" class="mobilelabel">&nbsp;<font size="8"><b>Price:&nbsp;S$<%=decformat.format(dprice)%>/<%=uom%>
		</b> </font></td>
		<td></td>
	</tr>
	<% }%>
	...
	<tr>
		...
		<td align="center" class="mobilelabel"><a
			href="mobileDetails.jsp?PLANT=<%=plant%>&CATALOGID=<%=productid%>&PAGENAME=mobileenquiry"><font
			size="8"><b><%=detailsPage%></b></font></a></td>
