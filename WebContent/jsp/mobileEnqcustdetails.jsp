...
<title>Enquiry Customer Details</title>
</head>
<form  class="form" name="mobileenquirydetails" method="post"  action="">
	<table>
	<!-- Removed Logo Image -->
 <tr>
      <td width="left"></td>
	...
	<TR height="45px"><td>&nbsp;</td></TR>
	 <TR align="center">
	  ...
	  <TD colspan="2" align="center"> 
	   ...
	   <INPUT type="button"  value="Submit" 	onClick="if(validate(document.mobileenquirydetails)) {submitForm();}"  class="mobileButton1" />
...
{
  var frmRoot=document.mobileenquirydetails;
...
function CheckMobileNumber() {
	var mobile = document.mobileenquirydetails.MOBILE.value;	
			...
			data : {
				...
				success : function(data) {
					...
					if (data.status == "99") {
						...
						document.mobileenquirydetails.MOBILE.focus();
						return false;
					}
					if (data.status == "100") {
...
function submitForm(){
	...
	if(isExist=='N'){
	document.mobileenquirydetails.action="mobileEnquiryConfirm.jsp";
	
    document.mobileenquirydetails.submit();}
	else
	{
		return false;
	}
...
function EmailAvailability() {
	var email = document.mobileenquirydetails.EMAIL.value;
	var reg = /^([A-Za-z0-9_\-\.])+\@([A-Za-z0-9_\-\.])+\.([A-Za-z]{2,4})$/;
	
	if(document.mobileenquirydetails.EMAIL.value=="" ||document.mobileenquirydetails.EMAIL.value.length==0 )
	{
		alert("Please enter email!");
		document.mobileenquirydetails.EMAIL.focus();
		return false;
	}	
