...
<title>Mobile Enquiry Cart</title>
</head>
...
<script>
	...
	function onAddCart() {		
		...
		document.form.action = "/track/MobileEnquiryServlet?Submit=ENQUIRE&PLANT="
	...
	function onNext() {
		...
		if(parseInt(index)>parseInt(counter))
			index=counter;
		document.form.action ="mobileEnquiry.jsp?ID=" + plant+delim+productid+delim+index;
		document.form.submit();
	}
	function onPrevious(){
		var plant = document.form.PLANT.value;
		...
		document.form.action = "mobileEnquiry.jsp?ID=" + plant+delim+productid+delim+previndex;
		document.form.submit();
	...
	function onFirst() {
		...
		var delim = "AAABBACCB";
		var productid = document.form.PRODUCTID1.value;						
		document.form.action = "mobileEnquiry.jsp?ID=" + plant + delim
...
<form name="form" method="post">
	...
	<input type="hidden" name="PAGENAME" value="mobileenquiry" />
...
<table align="center" cellpadding="0" cellspacing="0" width="100%">
	...
	<tr>
      <td ></td>
      <td align="center" class="mobilelabel"><a  href="mobileDetails.jsp?PLANT=<%=plant%>&CATALOGID=<%=productid%>&PAGENAME=mobileenquiry" ><font size="8"  ><b><%=detailsPage%></b></font></a></td>
...
>
	...
	&nbsp;
			...
			<table>
<tr>
<td align="right" width="40%"><INPUT
			class="mobileEnqBtn" type="BUTTON" value="Enquiry"
			onClick="onAddCart();"
></td>&nbsp;&nbsp;
&nbsp;&nbsp;&nbsp;			<td align="center"  valign="bottom"  width="60%">			
			<INPUT
			class="mobileEnqBtn" type="BUTTON" value="Member Enquiry" onClick="onMemEnq();" >&nbsp;&nbsp;&nbsp;
			</td>
			</tr>				
			</table>
</form>
