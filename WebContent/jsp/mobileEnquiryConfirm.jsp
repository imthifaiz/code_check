...
<form  class="form" name="mobiledetailconfirm" method="post"  action="">
	<br>
...
function submitForm(){
	...
	document.mobiledetailconfirm.action="/track/MobileEnquiryServlet?Submit=CREATE_ENQUIRY";
	
    document.mobiledetailconfirm.submit();
}
</script>
</html>
