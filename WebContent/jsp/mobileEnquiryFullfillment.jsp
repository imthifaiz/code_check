...
<title>Mobile Enquiry Order Full Fillment</title>
...
function onIssue(form){
 ...
 var pono=document.form.DONO.value;
   ...
   if(pono==null||pono=="")
	{
	alert("Please select Outbound Order");	
	return false;
	}  
...
function onConfirm(buttonVal)
{
  ...
  var flag    = "false";
   ...
   document.form.action="/track/OrderIssuingServlet?action=MobileEnquiryConfirmStatus&Status="+buttonVal;
   ...
   if(action.equalsIgnoreCase("View")){
      ...
      fieldDesc=(String)request.getSession().getAttribute("RESULT");
       ...
       if(m.size()>0){
             ...
             remark1=StrUtils.fString((String)m.get("remark1"));
             remark2=StrUtils.fString((String)m.get("remarks"));
             foundRec=true;
     }
      else 
      {
        fieldDesc="Details not found for Mobile Enquiry order:"+ pono;  
      }
    }
  ...
  <table border="1" width="100%" cellspacing="0" cellpadding="0" align="center" bgcolor="#dddddd">
      <TR>
        <TH BGCOLOR="#000066" COLSPAN="11">
          <FONT color="#ffffff">Mobile Enquiry Order Full Fillment</FONT>&nbsp;
        </TH></table>
  <br>
 ...
 <table  border="0" cellspacing="1" cellpadding="2"  bgcolor="">
  ...
  <table border="1" width="100%" cellspacing="0" cellpadding="0" align="center" bgcolor="#dddddd">
                ...
                <CENTER>
                  <TABLE BORDER="0" CELLSPACING=1 WIDTH="100%">
                   <tr>
                     ...
                     <td>
                       <P>
                         <INPUT type="TEXT" size="20" MAXLENGTH="20" name="DONO" value="<%=pono%>" onkeypress="if((event.keyCode=='13') && ( document.form.DONO.value.length > 0)){loadOutboundOrderDetails();}"/>
                         <a href="#" onClick="javascript:popUpWin('do_list_for_singlepickissue.jsp?ORDERTYPE=MOBILE ENQUIRY&DONO='+form.DONO.value);">
    ...
    <table width="100%" border="0" cellspacing="0" cellpadding="5" bgcolor="#eeeeee">
     ...
     if(foundRec){
        al = _DOUtil.listOutGoingPickingDODET(plant,pono);
        foundRec=false;
     }
       ...
       if(al.size()>0)
       {
    	AFLAG="DATA";
          ...
          chkString  =dono+","+dolnno+","+item+","+su.replaceCharacters2Send(desc)+","+qtyor+","+qtyPick+","+qtyis+","+sUserId+","+loc+","+batch+","+strUtils.replaceCharacters2Send(strUtils.fString(custname));
            ...
            <table border="0" width="100%" cellspacing="0" cellpadding="0">
              <tr>
                <td align="center">
                  ...
                  <input type="button" value="Revert To New" onClick="onConfirm('New');" >
                   <input type="button" value="Open" onClick="onConfirm('Open');" >
                   <input type="button" value="Close" onClick="onConfirm('Close');" >
                  <INPUT type="hidden" name="TRAVELER" value="">
                  <INPUT     name="LOGIN_USER"  type ="hidden" value="<%=sUserId %>" size="1"   MAXLENGTH=80 >
                  <br> Note : Change the status to Open,Close,Revert to New</TD>
              </tr>
              <p>
              <p>
            </table>
...
function viewOutboundOrders(){
	document.form.action="/track/OrderIssuingServlet?action=MobileEnquiry&ORDERTYPE=MOBILE ENQUIRY";
        document.form.submit();
}
