...
<form  class="form" name="frmdeliveryaddr" method="post"  action="">
 ...
 <TABLE    border="0" width="80%"  cellspacing="0" cellpadding="0" align="center" bgcolor="#ffffff">    
	...
	<TR height="15px"><td colspan="2">&nbsp;</td></TR>
	<TR align="center">	
	    <TD align="right"  class="mobilelabel"  width="40%" ><font size=7 >Postal Code <font color=red size =7 >*</font>&nbsp;:</font></td>
		<TD align="left" >
		&nbsp;&nbsp;&nbsp;&nbsp;
...
<script>
function submitForm(){
	        document.frmdeliveryaddr.action  ="mobileEventRegConfirm.jsp";
