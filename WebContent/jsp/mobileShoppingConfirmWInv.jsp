...
<SCRIPT LANGUAGE="JavaScript">
	...
	function popUpWin(URL) {
 		subWin = window.open(URL, 'OutBoundsOrderIssue', 'toolbar=0,scrollbars=yes,location=0,statusbar=0,menubar=0,dependant=1,resizable=1,width=500,height=200,left = 200,top = 184');
	}
...
function onDelete(form)
{
    ...
    return false;
     ...
     var mes=confirm("Do you want to delete the Outbound order !");
      if(mes==true)
      {
      return true;
      }
                ...
                <CENTER>
                  <TABLE BORDER="0" CELLSPACING=1 WIDTH="100%">
                   <tr>
                     ...
                     <td>
                       <P>
                         <INPUT type="TEXT" size="20" MAXLENGTH="20" readonly name="DONO" value="<%=DONO%>" />
        ...
        <div align="center"><center>
          <br>
            <table border="0" width="100%" cellspacing="0" cellpadding="0">
              <tr align="center">
                <td >
                  <input type="Button" value="Cancel" onClick="window.location.href='mobileShoppingFullfillment.jsp?action=View&DONO='+form.DONO.value+'&PLANT='+form.PLANT.value "/>&nbsp; 
...
function submitForm(){
	document.form.action="/track/OrderIssuingServlet?action=Confirm_Issue_For_MobileShop";
