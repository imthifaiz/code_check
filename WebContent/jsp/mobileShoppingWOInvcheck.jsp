        ...
        <div align="center"><center>
          <br>
            <table border="0" width="100%" cellspacing="0" cellpadding="0">
              <tr align="center">
                <td >
                  <input type="Button" value="Cancel" onClick="window.location.href='mobileShopWOInv.jsp?action=View&DONO='+form.DONO.value "/>&nbsp; 
...
function submitForm(){
	document.form.action="/track/OrderIssuingServlet?action=Confirm_Issue_For_MobileShopWOInvcheck";
