<div id="productModal" class="modal fade" role="dialog">
	...
	<form name="productForm" id="productForm" method="post" enctype="multipart/form-data">
      ...
      <div class="col-sm-4">         
      <div class="input-group">       
			<INPUT class="form-control" name="LOC_ID" type="TEXT" value="" size="20" MAXLENGTH=100 id="LOC_ID" placeholder="Select Location">
...
<!--     	<label class="radio-inline"><INPUT Type=Checkbox  name ="ISCOMPRO" style="border:0;" value="0" id="ISCOMPRO" onclick="iscombpro();">Is Finished Product</label>				 -->
     ...
     <div class="row form-group comproprice">
      ...
      <div class="col-sm-1">
		...
		<TD align="center"><div class="input-group"><span class="glyphicon glyphicon-remove-circle emptype-action" aria-hidden="true" onclick="deleteRowSales('customerDiscount');return false;"></span><INPUT class="form-control customerSearch" name="CUSTOMER_TYPE_ID" id="CUSTOMER_TYPE_ID_0" placeholder="Select Customer Type" type = "TEXT" value="" size="20"  MAXLENGTH=50
			...
			$.ajax( {
		        ...
		        success : function(data) {
					if (data.STATUS == "FAIL") {		                               
						...
						if(page=="Invoice")
							productCallbackwithallInvoice(data);
...
function addRowSales(tableID) {
	...
	var itemCell = row.insertCell(1);
	var itemCellText =  "<div class=\"input-group\"><INPUT class=\"form-control\" name=\"CUSTOMER_TYPE_ID\" ";
