...
<%
String title = "Sales Order Summary Details By Outlets";
%>
...
<div class="container-fluid m-t-20">
    ...
    <!-- Muruganantham Modified on 16.02.2022 -->
            <ul class="breadcrumb backpageul">      	
                ...
                <li><label>Sales Order Summary Details By Outlets</label></li>                                   
            </ul>             
    <!-- Muruganantham Modified on 16.02.2022 -->
...
<div class="box-body">
<FORM class="form-horizontal" name="form1" method="post" action="../salesorder/summarydetailsoutlets" >
