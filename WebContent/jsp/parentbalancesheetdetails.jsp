...
<div class="container-fluid m-t-20">
	...
	<div class="box">
		...
		<div class="box-header menu-drop">
			 <h1 style="font-size: 18px;cursor:pointer;" class="box-title pull-right" onclick="window.location.href='../businessoverview/parentbalance'">
			...
			<div class="row">
				...
				<div class="col-sm-4" style="text-align:center">
					...
					<div style="font-size:18px"><%=trialBalanceDetails.get(0).getACCOUNT()%></div>
