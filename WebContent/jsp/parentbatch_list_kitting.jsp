...
<html>
<head>
<title>Kitting Parent Batch List</title>
...
<h3 class="panel-title">Kitting Parent Batch List</h3> 
</div>
</div>
...
<%
        ...
        String sBGColor = "";
         try{
	        ...
	        List listQry =   bomDAO.getKittingParentBatchByWMS(PLANT,ITEM,FROM_DATE,TO_DATE,PARENTBATCH);
...
<TR>
		<td class="main2" style="font-weight: bold" align="left">&nbsp;<a href="#"
			onClick=" window.opener.form.BATCH_0.value='<%=sBatch%>';
                      window.opener.form.PARENTQTY.value='<%=sqty%>';
...
<TR>
		<td class="main2" style="font-weight: bold" align="left">&nbsp;<a href="#"
			onClick=" window.opener.form1.PARENTBATCH.value='<%=sBatch%>';
                      window.close();"><%=sBatch%></a></td>
		<td align="left" class="main2">&nbsp;<%=sqty%></td>
	</TR>
<%
