...
<%
	...
	String RefNo   = "", Terms  = "", TermsDetails   = "",pagename="",SoNo ="",pageDetails="",scanid="",index="",Item ="";
	...
	sQuery = sQuery +"ISNULL(DETAIL5,'') DETAIL5,ISNULL(DETAIL6,'') DETAIL6,ISNULL(DETAIL7,'') DETAIL7, ISNULL(DETAILLABEL,'') DETAILLABEL";
         ...
         pageDetails = (String)insmp.get(IDBConstants.DETAILLABEL);
...
<TABLE border="0" width="100%" cellspacing="0" cellpadding="0"
	...
	<TR>
 <TH BGCOLOR="#669900" COLSPAN="11"><font color="white" size="3"><%=pageDetails %></font></TH>
	</TR>
</TABLE>
<B>
<CENTER><%=res%>
...
<TABLE border="0" CELLSPACING="0" WIDTH="100%"  align="center">
	<TR>
		...
		<TD align="left"><p><font size="3"> <%=detail1.toString()%></font></p></TD>
	</TR>
	<TR>
		<TH WIDTH="25%" ALIGN="right"></TH>
		<TD align="left"><p><font size="3"> <%=detail2.toString()%></font></p></TD>
	</TR><TR>
		<TH WIDTH="25%" ALIGN="right"></TH>
		<TD align="left"><p><font size="3"> <%=detail3.toString()%></font></p></TD>
	</TR><TR>
		<TH WIDTH="25%" ALIGN="right"></TH>
		<TD align="left"><p><font size="3"> <%=detail4.toString()%></font></p></TD>
	</TR><TR>
		<TH WIDTH="25%" ALIGN="right"></TH>
		<TD align="left"><p><font size="3"> <%=detail5.toString()%></font></p></TD>
	</TR>
	<TR>
		<TH WIDTH="25%" ALIGN="right"></TH>
		<TD align="left"><p><font size="3"> <%=detail6.toString()%></font></p></TD>
	</TR>
	<TR>
		<TH WIDTH="25%" ALIGN="right"></TH>
		<TD align="left"><a href="http://<%=detail7.toString()%>"   target="main"><font size="3" color="Blue"><%=detail7.toString()%></font></a></TD>
	</TR>
	<TR>
		<TD COLSPAN=2><BR>
		</TD>
