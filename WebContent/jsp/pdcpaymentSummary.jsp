...
<%
	...
	String title = "PDC Issued Summary";
	...
	boolean displayProcessPayment=false,displaySummaryEdit=false,displaySummaryExport=false;
	if(systatus.equalsIgnoreCase("ACCOUNTING")) {
		displayProcessPayment = ub.isCheckValAcc("newPDCPaymentMade", plant,username);
		displaySummaryEdit = ub.isCheckValAcc("editPDCPaymentMade", plant,username);
		displaySummaryExport = ub.isCheckValAcc("exportPDCPaymentMade", plant,username);
	}
...
<div class="container-fluid m-t-20">
	...
	<!-- Muruganantham Modified on 16.02.2022 -->
            <ul class="breadcrumb backpageul">      	
                ...
                <li><label>PDC Issued Summary</label></li>                                   
            </ul>             
    <!-- Muruganantham Modified on 16.02.2022 -->
		<div class="box-header menu-drop">
			...
			<% if (displayProcessPayment) { %>
              <button type="button" class="btn btn-default" onClick="window.location.href='../banking/pdcpayprocess'" style="background-color: rgb(214, 72, 48);color: rgb(255, 255, 255);" > Process Payment</button>&nbsp;       
              <% } %>       
              </div>
      ...
      <div class="ShowSingle">
		...
		function getParameters(){
			return {
				...
				"SUPPLIER":SUPPLIER,"CHEQUENO":CHEQUENO,"BANK":BANK,"CMD":"GET_PDC_PAYMENT",TYPE:"SUMM"
			}
		}
		function onGo(){
			debugger;
			...
			if(FROM_DATE != null     && FROM_DATE != "") { flag = true;}
			   ...
			   var groupColumn = 1;	
			   var displaySummaryEdit = document.form.displaySummaryEdit.value;
			    if (tablepdcpayment){
					        	...
					        	if(typeof data.PDC[0].ID === 'undefined'){
					        		return [];
					        			...
					        			if(displaySummaryEdit == 'true'){
					        				data.PDC[dataIndex]['EDIT'] = '<a href="../banking/editpdcpay?TRANID=' +lineno+'"><i class="fa fa-pencil-square-o"></i></a>';
					        			}else{
