...
<%
String title = "Rental Order Details With Price";
%>
...
function onView(){
     ...
     document.form1.action="printLoanOrderInvoice.jsp";
...
function onRePrint(){
    ...
    document.form1.action="/track/DynamicFileServlet?action=printLOANORDWITHBATCHWITHPRICE&ORDERNO="+ORDERNO;
    document.form1.submit();
}
...
function onRePrintWithOutBatch(){
    ...
    if(flag == "false"){ alert("Please Enter Order No"); return false;}
	form1.setAttribute("target", "_blank");
    document.form1.action="/track/DynamicFileServlet?action=printLOANORDWITHOUTBATCHWITHPRICE&ORDERNO="+ORDERNO;
    document.form1.submit();
}
...
<script language="JavaScript" type="text/javascript" src="js/calendar.js"></script>
  ...
  <% 
        ...
        String TRANDT="",ORDERNO="",result="",  chkString= "",SHIPPINGCUSTOMER="";
 ...
 <div class="form-group">
  ...
  <div id="tableIssueSummary_wrapper" class="dataTables_wrapper form-inline dt-bootstrap no-footer">
    ...
    <th style="background-color: #eaeafa; color:#333; text-align: left;">Line No</th>
     <th style="background-color: #eaeafa; color:#333; text-align: left;">Order Type</th>
    ...
    <th style="background-color: #eaeafa; color:#333; text-align: left;">UOM</th>
     <th style="background-color: #eaeafa; color:#333; text-align: left;">Employee</th>
      <th style="background-color: #eaeafa; color:#333; text-align: left;">Status</th>
    </tr>
   ...
   <%
          ...
          for (int iCnt =0; iCnt<QryList.size(); iCnt++){
            ...
            String bgcolor = ((iCnt == 0) || (iCnt % 2 == 0)) ? "#FFFFFF"  : "#dddddd";
             ...
             rowData[rowData.length] = '<%=(String)lineArr.get("JUBNUM")%>';
