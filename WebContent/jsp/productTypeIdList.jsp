...
<h3 class="panel-title">PRODUCT TYPE ID LIST</h3> 
</div>
</div>
...
%>
  <TR>
		<td class="main2" style="font-weight: bold" align="left">&nbsp;<a href="#"
			onClick="window.opener.form.PRD_TYPE_ID.disabled = false;window.opener.form.PRD_TYPE_ID.value='<%=prdclsid%>';window.opener.form.PRD_TYPE_DESC.value='<%=desc%>';window.opener.form.PRD_TYPE_ID1.value='<%=prdclsid%>'; window.close();"><%=prdclsid%></a></td>
