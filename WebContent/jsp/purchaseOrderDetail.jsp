...
<%
	String title = "Purchase Order Detail";
...
<div class="container-fluid m-t-20">
	...
	<!-- Muruganantham Modified on 16.02.2022 -->
             <ul class="breadcrumb backpageul">      	
                  ...
                  <li><label>Purchase Order Detail</label></li>                                   
             </ul>   
     <!-- Muruganantham Modified on 16.02.2022 --> 
		<div class="box-header menu-drop">
			...
			<div class=" pull-right">
				...
				<%if (!poheader.getAPPROVAL_STATUS().equalsIgnoreCase("CREATE APPROVAL PENDING") && !poheader.getAPPROVAL_STATUS().equalsIgnoreCase("EDIT APPROVAL PENDING")&& !poheader.getAPPROVAL_STATUS().equalsIgnoreCase("DELETE APPROVAL PENDING")){ %>
				...
				<%if (!poheader.getORDER_STATUS().equalsIgnoreCase("FORCE CLOSE") && !poheader.getAPPROVAL_STATUS().equalsIgnoreCase("CREATE APPROVAL PENDING") && !poheader.getAPPROVAL_STATUS().equalsIgnoreCase("EDIT APPROVAL PENDING")&& !poheader.getAPPROVAL_STATUS().equalsIgnoreCase("DELETE APPROVAL PENDING")){ %>
				<button type="button" class="btn btn-default" data-toggle="tooltip"  
						data-placement="bottom" title="Edit">
						<a href="../purchaseorder/edit?pono=<%=pono%>"><i class="fa fa-pencil" aria-hidden="true"></i></a>
					</button>
					<%}}%>
				</div>
				<div class="btn-group" role="group">
				 <%if(displayPrintPdf){ %>
					...
					<ul class="dropdown-menu" style="min-width: 0px;">
						<li id="" onClick="submitFormPrint('Print Inbound Order');"><a href="#">Print Purchase Order</a></li>
						<li id="" onClick="submitFormPrint('Print Inbound Order With Cost');"><a href="#">Print Purchase Order With Cost</a></li>
				...
				<h1 style="font-size: 18px; cursor: pointer; vertical-align:middle;" class="box-title pull-right"
					onclick="window.location.href='../purchaseorder/summary'">
