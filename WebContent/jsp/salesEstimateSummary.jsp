...
<script type="text/javascript" src="../jsp/js/salesEstimateSummary.js"></script>
<center>
	<h2>
...
<div class="container-fluid m-t-20">
	...
	<!-- Muruganantham Modified on 16.02.2022 -->
            <ol class="breadcrumb backpageul">      	
                ...
                <li><label>Sales Estimate Summary</label></li>                                   
            </ol>             
    <!-- Muruganantham Modified on 16.02.2022 -->
		<div class="box-header menu-drop">
             ...
             onClick="window.location.href='../salesestimate/import'">
	              ...
	              <%if(displaySummaryNew){ %>
	              	<button type="button" class="btn btn-default" 
	              	onClick="window.location.href='../salesestimate/new'" 
...
//			"lengthMenu": [[100, 500, 1000, 2500], [100, 500, 1000, "All"]],
		        ...
		        "dataSrc": function(data){
		        	if(typeof data.ORDERS[0] === 'undefined'){
		        		...
		        		for(var dataIndex = 0; dataIndex < data.ORDERS.length; dataIndex ++){
		        			...
		        			data.ORDERS[dataIndex]['ESTNO'] = '<a href="../salesestimate/detail?estno='+data.ORDERS[dataIndex]['ESTNO']+'">'+data.ORDERS[dataIndex]['ESTNO']+'</a>';
    	...
    	$("#tableSalesEstimateSummary_filter.dataTables_filter").append($("#searchType")); $.fn.dataTable.ext.search.push(function (settings, data, dataIndex) {
        ...
        $('.dataTables_filter input').on('keyup', function () {
        	tableSalesEstimateSummary.draw();
        });
    }
}
