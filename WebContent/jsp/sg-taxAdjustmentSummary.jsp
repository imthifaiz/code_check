		...
		<!-- <font face="Proxima Nova" > -->                
              <table id="tableBillSummary" class="table table-bordred table-striped">                   
                   <thead>
	                   ...
	                   <th style="font-size: smaller;">GST AUTHORITY</th>
	                   <th style="font-size: smaller;">REF #</th>
	                   <th style="font-size: smaller;">GST AMOUNT</th>
...
<script LANGUAGE="JavaScript">
		...
		function getTable(){
		   return '<TABLE>'+
		          ...
		          '<TH><font color="#ffffff" align="left"><b>GST AUTHORITY</TH>'+
		          '<TH><font color="#ffffff" align="left"><b>REF</TH>'+		          
				  '<TH><font color="#ffffff" align="left"><b>GST AMOUNT</TH>'+
 ...
 function getConfirmation(){
	   return confirm("Are you sure about removeing this gst adjustment?");
	}
 </script>
