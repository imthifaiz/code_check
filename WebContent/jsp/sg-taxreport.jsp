...
businesslist.add("Tax Filing Summary");
businesslist.add("Tax Filing Detailed Summary");
businesslist.add("Tax Liability Report");
...
%>
 ...
 <div class="container-fluid m-t-20">
    ...
    <div class="col-md-4">
    <h4>  <!-- <i class="fa fa-shopping-bag" aria-hidden="true"></i> --> Tax Filing Reports </h4>
    <%java.util.Hashtable htMenuItems = (java.util.Hashtable)menuListWithSequence.get(66); //	Sixty Seven row
    java.util.Map htMenuItemDetail = (java.util.Map)htMenuItems.get(1);//	Second column
  	...
  	<!-- <div class="col-md-12" style="height: 28px;padding: 0px;" ><div class="mspan"><i class="fa fa-star-o" aria-hidden="true"></i><span class="menu-link pl-1" onclick="location.href='sg-taxreturnfillSummary.jsp'">Tax Filing Summary</span></div></div>
  	<div class="col-md-12" style="height: 28px;padding: 0px;" ><div class="mspan"><i class="fa fa-star-o" aria-hidden="true"></i><span class="menu-link pl-1" onclick="location.href='sg-taxreturnDetailedSummary.jsp'">Tax Filing detailed Summary</span></div></div>
  	<div class="col-md-12" style="height: 28px;padding: 0px;" ><div class="mspan"><i class="fa fa-star-o" aria-hidden="true"></i><span class="menu-link pl-1" onclick="location.href='sg-taxreturnTaxLiabilityReport.jsp'">Tax Liability Report</span></div></div> -->
