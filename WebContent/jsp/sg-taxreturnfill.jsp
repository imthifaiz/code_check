...
<script type="text/javascript" src="../jsp/js/tabulator.min.js"></script>
   <script type="text/javascript" src="../jsp/js/sg-taxreturnfill.js"></script>
  <style>
...
<form id="form1" name="form1">
  ...
  <div class="container-fluid m-t-20">
    ...
    <!-- Muruganantham Modified on 16.02.2022 --> 
        <div class="box-header menu-drop">
              ...
              <h1 style="font-size: 18px;cursor:pointer;" class="box-title pull-right" onclick="window.location.href='../tax/sg-gstreturnsummary'">
		...
		<div class="box-header menu-drop">
			...
			<a class="btn btn-default pull-left" href="../tax/sg-gstreturnsummary"><i class="fa fa-cog"></i> GST Returns</a>	
 ...
 <div class="box-body">
			...
			<div class="row return-criteria">
				<div class="col-lg-7 mt-4"> 
					<div class="row inline-fields">
						<div class="col-lg-5 text-muted">GST Period</div> 
					...
					<div class="row inline-fields">
						<div class="col-lg-5 text-muted">GST Basis</div> 
	...
	<div class="text-center">
		...
		<h3 class="reports-headerspacing">Inland Revenue Authority of Singapore</h3> 
		<h5><span>From </span>&nbsp;<span id="inFrom"></span>&nbsp; <span>To </span>&nbsp;<span id="inTo"></span> </h5>
	</div>
	<div class="tax-main-block_sales">
		<!-- <div class="row">
			<label class="tax-return-header">Inland Revenue Authority of Singapore</label>
		</div> -->
...
<div id="sg-taxreturnfilepopup" class="modal fade" role="dialog">
		...
		<form class="form-horizontal" name="taxfilepopup" method="post">
			...
			<div class="modal-content">
				...
				<div class="row form-group">
						...
						<div class="col-sm-6">
						<INPUT class="form-control datepicker" id="filedon" type="TEXT" value="<%=curDate%>" size="30" MAXLENGTH="10" name="filedon"/>
						</div>
				</div>
				</div>
...
<%@include file="sg-taximportadjustment.jsp"%>
