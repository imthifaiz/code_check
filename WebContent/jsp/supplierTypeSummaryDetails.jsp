...
<%
String title = "Supplier Type Details";
%>
...
String res        = "";
String sSupplierTypeId  ="",sDesc  =   "",action =   "",isActive="";
...
sDesc  = strUtils.replaceCharacters2Recv(strUtils.fString(request.getParameter("SUPPLIER_TYPE_DESC")));
 ...
 <div class="box-body">
  ...
  <form class="form-horizontal" name="form1" method="post">
    <div class="form-group">
      <label class="control-label col-sm-4" for="Supplier Type ID">Supplier Type ID:</label>
      <div class="col-sm-4">
    ...
    <div class="form-group">
      <label class="control-label col-sm-4" for="Supplier Type Description">Supplier Type Description:</label>
      <div class="col-sm-4">          
        <INPUT  class="form-control" name="SUPPLIER_TYPE_DESC" type="TEXT" value="<%=sDesc %>"
