...
<jsp:param name="context-type" value="0" />
</jsp:include>
...
$(".inventrycontents").click(function(){
	...
	window.location.href = "/inventory/DashboardServlet?ACTION=LOGIN_TRANSFER&LOGPAGE=INVENTORY";
});

$(".accountcontents").click(function(){
	//window.location.href='../home';
	window.location.href = "/accounting/DashboardServlet?ACTION=LOGIN_TRANSFER&LOGPAGE=ACCOUNTING";
});

$(".payrollcontents").click(function(){
	//window.location.href='PayrollHome.jsp';
	window.location.href = "/payroll/DashboardServlet?ACTION=LOGIN_TRANSFER&LOGPAGE=PAYROLL";
});
</script>
    <!-- /.content -->
