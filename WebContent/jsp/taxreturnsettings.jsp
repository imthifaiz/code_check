...
<%@ include file="header.jsp"%>
 ...
 <div class="box-body">
 	...
 	<div class="alert" align="center" style="width:50%;background-color: #d2d6de;">Is your business registered for TAX? <input type="radio" id="isregyes" name="isreg" value="yes">
  ...
  <label for="no">No</label></div>
	...
	<input type="hidden" name="taxid"/>
		<div class="form-group">
		 	<label class="control-label text-dashed-underline col-sm-4 required">Tax Registration Number (TRN)</label>
			 <div class="col-sm-2">
		...
		<div class="form-group">
			 <label class="control-label col-sm-4 required">VAT Registered On</label>
			 <div class="col-sm-4">
			  <input class="form-control datepicker" name="vatregdate" type = "TEXT"  size="20" >
			  </div>
		</div>	
		<div class="form-group">
			 <label class="control-label col-sm-4 required">Generate First Tax Return From</label>
			 <div class="col-sm-4">
