...
<html>
<head>
<title>Consignment Order Customer List</title>
<meta charset="utf-8">
...
<h3 class="panel-title">Consignment Order Customer List</h3> 
</div>
</div>
...
mLogger.setLoggerConstans(loggerDetailsHasMap);
    ...
    String sBGColor = "";
    try{
    	ArrayList arrCust = custUtils.getToAssingeListStartsWithName(sCustName,plant);
   		for(int i =0; i<arrCust.size(); i++) {
        	sBGColor = ((i == 0) || (i % 2 == 0)) ? "#FFFFFF" : "#dddddd";
        	Map arrCustLine = (Map)arrCust.get(i);
        	String sCustCode     = (String)arrCustLine.get("ASSIGNENO");
        	String sCustName1     = strUtils.removeQuotes((String)arrCustLine.get("ASSIGNENAME"));
