<div id="uae-taxreturncustompopup" class="modal fade" role="dialog">
	<div class="modal-dialog">
		...
		<input type="hidden" name="modaltaxheaderid" id="modaltaxheaderid"/>
			...
			<div class="modal-content">
	        	...
	        	<label class="control-label col-form-label col-sm-4 required">VAT Return Start Date</label>
	        	<div class="col-sm-6">
				...
				<div class="row form-group">
						<label class="control-label col-form-label col-sm-4 required"
							for="Date">VAT Return End Date</label>
						<div class="col-sm-6">
						<INPUT class="form-control datepicker" id="vatenddate" type="TEXT" size="30" MAXLENGTH="10" name="vatenddate" placeholder="Select End Date"/>
						</div>
				</div>
				</div>
