<div id="uae-taxreturnpaymentpopup" class="modal fade" role="dialog">
		...
		<input type="hidden" name="modaltaxreturndate" id="modaltaxreturndate"/>
			...
			<div class="modal-content">
				<div class="modal-header">
					...
					<h4 class="modal-title">Record Tax Payment</h4>
				</div>
	        	...
	        	<div class="row form-group">
	        	<label class="control-label col-form-label col-sm-4">Total Tax Payable</label>
	        	<div class="col-sm-6">
