...
<script type="text/javascript" src="js/tabulator.min.js"></script>
   <script type="text/javascript" src="js/uae-taxreturnpayments.js"></script>
...
<%@include file="uae-taxreturnpaymentpopup.jsp"%>
