...
<script type="text/javascript" src="../jsp/js/tabulator.min.js"></script>
   <script type="text/javascript" src="../jsp/js/uae-taxreturnsummary.js"></script>
  <style>
	 ...
	 <div class="box"> 
		...
		<div class="box-header menu-drop">
			<button type="button" class="btn btn-default pull-right" data-toggle="modal"
				data-target="#create_account_modal" onclick="generateTaxReturn()">Generate VAT Return</button>
			<a class="btn btn-default pull-left" href="../tax/gstsetting"><i class="fa fa-cog"></i> VAT Return Settings</a>	
