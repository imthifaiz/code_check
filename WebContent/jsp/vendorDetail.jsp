...
String sCustCode  = "",
       ...
       sZip       = "",
       sCons      = "Y";
 String sContactName ="",supplier_type_id="", sDesgination="",sTelNo="",sHpNo="",sFax="",sEmail="",sRemarks="",sPayTerms="",sPayInDays="",isActive="",sRcbno="";
...
List suppliertypelist=custUtil.getVendorTypeList("",plant," AND ISACTIVE ='Y'");
		...
		supplier_type_id= (String) arrCust.get(21);
 ...
 <div class="box-body">
  ...
  <form class="form-horizontal" name="form" method="post">
    <div class="form-group">
      <label class="control-label col-form-label col-sm-2" for="Create Supplier ID">Supplier Id</label>
      <div class="col-sm-4">
    ...
    <div class="form-group">
      <label class="control-label col-form-label col-sm-2" for="Supplier Name">Supplier Name</label>
      <div class="col-sm-4">
        ...
        <INPUT  class="form-control" name="CUST_NAME" type="TEXT" value= "<%=sCustName%>"
    	  ...
    	  <div class="form-group">
      <label class="control-label col-form-label col-sm-2" for="Supplier Type">Supplier Type</label>
      <div class="col-sm-4">           	
  	
  <SELECT NAME="SUPPLIER_TYPE_ID" class="form-control" data-toggle="dropdown" disabled="disabled" data-placement="right" size="1">
			<OPTION selected value="NOSUPPLIERTYPE">Choose</OPTION>
			<%       for (int i =0; i<suppliertypelist.size(); i++){
  			Map map = (Map) suppliertypelist.get(i);
   			String ssuppliertypeid   = (String) map.get("SUPPLIER_TYPE_ID");
  			String desc   = (String) map.get("SUPPLIER_TYPE_DESC");%>
			<OPTION value="<%=ssuppliertypeid %>" <%if(supplier_type_id.equalsIgnoreCase(ssuppliertypeid)){%> selected <%}%>><%=desc%></OPTION>
			<%}%>
    ...
    <div class="form-group">
      ...
      <div class="col-sm-4">
        ...
        <INPUT  class="form-control" name="RCBNO" type="TEXT" value= "<%=sRcbno%>" readonly
			size="50" MAXLENGTH=100 readonly>
      </div>
    </div>
      ...
      <div class="col-sm-4">          
        <INPUT name="TELNO" type="TEXT" value="<%=sTelNo%>" size="50" class="form-control" readonly
			MAXLENGTH="30">
      </div>
    </div>  	
    ...
    <div class="form-group">
      ...
      <div class="col-sm-4">          
        <INPUT name="FAX" type="TEXT" value="<%=sFax%>" size="50" readonly
    ...
    <div class="form-group">
      	...
      	<div class="col-sm-4">  
      	<INPUT name="CUSTOMEREMAIL" type="TEXT" value="<%=CUSTOMEREMAIL%>" readonly size="50" MAXLENGTH=50 class="form-control">
      	</div>
      	</div>
        ...
        <div class="form-group">
      	...
      	<div class="col-sm-4">  
    	<INPUT name="WEBSITE" type="TEXT" value="<%=WEBSITE%>" readonly size="50" MAXLENGTH=50 class="form-control">
      	</div>
    	</div>
    ...
    <div class="tab-content">
      ...
      <div class="col-sm-4">  
        ...
        <INPUT name="ADDR1" type="TEXT" value="<%=sAddr1%>" size="50" readonly
    ...
    <div class="form-group">
      ...
      <div class="col-sm-4">
        ...
        <INPUT name="ADDR2" type="TEXT" value="<%=sAddr2%>" size="50" readonly
			MAXLENGTH=50 class="form-control">
      </div>
    </div>
    <div class="form-group">
      ...
      <div class="col-sm-4">
        ...
        <INPUT name="ADDR3" type="TEXT" value="<%=sAddr3%>" size="50" readonly
			MAXLENGTH=50 class="form-control">
      </div>
    </div>
    <div class="form-group">
      ...
      <div class="col-sm-4"> 
        ...
        <INPUT name="ADDR4" type="TEXT" value="<%=sAddr4%>" size="50" readonly
    ...
    <div class="form-group">
      ...
      <div class="col-sm-4">           
        <INPUT name="STATE" type="TEXT" value="<%=sState%>" size="50" readonly
			MAXLENGTH=50 class="form-control">
      </div>
    </div>
    <div class="form-group">
      ...
      <div class="col-sm-4">  
       ...
       <INPUT name="COUNTRY" type="TEXT" value="<%=sCountry%>" readonly
    ...
    <div class="form-group">
      ...
      <div class="col-sm-4">
        ...
        <INPUT name="ZIP" type="TEXT" value="<%=sZip%>" size="50" readonly
      ...
      <div class="col-sm-4">
       ...
       <INPUT name="CONTACTNAME" type="TEXT" class="form-control" readonly
    ...
    <div class="form-group">
      ...
      <div class="col-sm-4">
        ...
        <INPUT name="DESGINATION" type="TEXT" class="form-control" readonly
    	...
    	<div class="form-group">
      	...
      	<div class="col-sm-4">  
        <INPUT name="WORKPHONE" type="TEXT" value="<%=WORKPHONE%>" readonly size="50" MAXLENGTH=50 class="form-control">
      	</div>
    	</div>
    ...
    <div class="form-group">
      ...
      <div class="col-sm-4">
        ...
        <INPUT name="HPNO" type="TEXT" value="<%=sHpNo%>" readonly size="50" class="form-control" onkeypress="return isNumber(event)"
			MAXLENGTH="30">
      </div>
    </div>  
    ...
    <div class="form-group">
      ...
      <div class="col-sm-4"> 
        ...
        <INPUT name="EMAIL" type="TEXT" value="<%=sEmail%>" readonly size="50"
			MAXLENGTH="50" class="form-control">
      </div>
    </div>
   ...
   <div class="form-group">  
    ...
    <div class="form-inline">
    	    ...
    	    <input name="PMENT_DAYS" type="TEXT" value="<%=sPayInDays%>" readonly
  ...
  <div class="form-group">
      	...
      	<div class="col-sm-4">  
        <INPUT name="FACEBOOK" type="TEXT" value="<%=FACEBOOK%>" readonly	size="50" MAXLENGTH=50 class="form-control">
      	</div>
    	</div>
        ...
        <div class="form-group">
      	...
      	<div class="col-sm-4">  
        <INPUT name="TWITTER" type="TEXT" value="<%=TWITTER%>" readonly	size="50" MAXLENGTH=50 class="form-control">
      	</div>
    	</div>
        ...
        <div class="form-group">
      	...
      	<div class="col-sm-4">  
        <INPUT name="LINKEDIN" type="TEXT" value="<%=LINKEDIN%>" readonly	size="50" MAXLENGTH=50 class="form-control">
      	</div>
    	</div>
        ...
        <div class="form-group">
      	...
      	<div class="col-sm-4">  
        <INPUT name="SKYPE" type="TEXT" value="<%=SKYPE%>" readonly	size="50" MAXLENGTH=50 class="form-control">
      	</div>
    	</div>
  ...
  <div class="col-sm-offset-2 col-sm-8">
    ...
    <label class="radio-inline">
      ...
      <div class="col-sm-4"> 
        ...
        <INPUT name="REMARKS" type="TEXT" value="<%=sRemarks%>" readonly
  ...
  <div class="form-group">        
      ...
      <button type="button" class="Submit btn btn-default" onClick="window.location.href='vendorSummary.jsp'"><b>Back</b></button>&nbsp;&nbsp;
