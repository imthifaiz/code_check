...
<%
String title = "Inventory Summary With Goods Receipt / Goods Issue";
%>
...
FROM_DATE = StrUtils.fString(request.getParameter("FROMDATE"));
TO_DATE = StrUtils.fString(request.getParameter("TODATE"));
...
<div class="container-fluid m-t-20">
	<div class="box">
	 ...
	 <ul class="breadcrumb backpageul">    
                ...
                <li><label>Inventory Summary With Goods Receipt / Goods Issue</label></li>                                   
            </ul>
        <!-- Thanzith Modified on 23.02.2022 --> 
...
<div class="box-body">
<FORM class="form-horizontal" name="form1" method="post" action="viewInventoryIncomingOutgoingQty.jsp">
              	...
              	<table id="tableInventorySummary"
					...
					<thead>
		                <tr role="row">
		                    ...
		                    <th style="font-size: smaller;">TOTAL RECEIVED.QTY</th>
							<th style="font-size: smaller;">TOTAL ISUUED.QTY</th>
							<th style="font-size: smaller;">STOCK ON HAND</th>
...
function getParameters(){
	return {
		...
		"FROM_DATE":fromDt,
		"TO_DATE":toDt,
		"ACTION": "VIEW_INV_SUMMARY_RECEIVED_ISUUED_REPORT",
		"PLANT":"<%=PLANT%>"
	}
}  
		        ...
		        "dataSrc": function(data){
		        	if(typeof data.items[0].ITEM === 'undefined'){
		        		...
		        		for(var dataIndex = 0; dataIndex < data.items.length; dataIndex ++){
							data.items[dataIndex]['ITEM'] = '<a href="../inventory/incomingoutgoingqtydetail?ITEM='+data.items[dataIndex]['ITEM']+'&FROMDATE='+fromDt+'&TODATE='+toDt+'">'+data.items[dataIndex]['ITEM']+'</a>';
		        		}
		        		return data.items;
		        	}
		        }
