...
<%
String title = "Inventory Summary Opening/Closing Stock";
%>
...
<div class="container-fluid m-t-20">
	<div class="box">
	 ...
	 <ul class="breadcrumb backpageul">    
                ...
                <li><label>Inventory Summary Opening/Closing Stock</label></li>                                   
            </ul>
        <!-- Thanzith Modified on 23.02.2022 --> 
...
function getParameters(){
	return {
		...
		"FROM_DATE":fromDt,
		"TO_DATE":toDt,
		"ACTION": "VIEW_INV_SUMMARY_OPEN_CLOSE_REPORT",
		"PLANT":"<%=PLANT%>"
	}
}  
