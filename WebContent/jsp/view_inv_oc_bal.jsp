...
<%
String title = "Inventory Summary With Opening/Closing Stock";
%>
...
function ExportReport()
{
  document.form1.action = "/track/ReportServlet?action=ExportInvOpenClosingQty";
   document.form1.submit();
	...
	/*document.form1.action="InventoryExcel.jsp?xlAction=GenerateInvXLOCBal";
	  document.form1.submit();*/
...
<input type="hidden" name="PRD_TYPE_ID1" value="">
 ...
 <div id="tableInventorySummary_wrapper" class="dataTables_wrapper form-inline dt-bootstrap no-footer">
          ...
          <TH style="background-color: #eaeafa; color:#333; ">Issue Received</TH>
          <TH style="background-color: #eaeafa; color:#333; ">Closing Qty</TH>
           <TH style="background-color: #eaeafa; color:#333; ">Later Receive</TH>
  ...
  var productId, desc, prdBrand, prdClass, prdType, fromDt, toDt,  groupRowColSpan = 6;
function getParameters(){
	return { 
		...
		"ACTION": "VIEW_INV_SUMMARY_OPEN_CLOSE_BAL",
		"PLANT":"<%=PLANT%>"
	}
}  
...
function onGo(){
    ...
    if (tableInventorySummary){
	    ...
	    tableInventorySummary = $('#tableInventorySummary').DataTable({
			...
			"columnDefs": [{"className": "t-right", "targets": [12]}],
...
function getTable(){
            return '<TABLE WIDTH="90%"  border="0" cellspacing="1" cellpadding = 2 align = "center">'+
                    ...
                    '<TH><font color="#ffffff" align="left"><b>Issue Reversed</TH>'+
