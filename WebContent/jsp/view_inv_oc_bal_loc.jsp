...
<%
String title = "Inventory Summary With Opening/Closing Stock For Location";
%>
...
<INPUT name="INV_REP_TYPE" type = "hidden" value="INVOPENCLS_BYLOC">
  ...
  <div class="form-group">    	 
       ...
       <div class="col-sm-3">
      	    <div class="input-group">
    		<INPUT class="form-control" name="PRD_BRAND_ID" type = "TEXT" value="<%=PRD_BRAND_ID%>" size="30"  MAXLENGTH=20>
...
<font><i class="glyphicon glyphicon-star" style="font-size: 10px; top:-6px; color: #e50000"></i>&nbsp;<b>Note : This report may not be accurate, if you import inventory stock on hand through excel.</b></font>
   ...
   <div id="VIEW_RESULT_HERE" class="table-responsive">
 	<div id="tableInventorySummary_wrapper" class="dataTables_wrapper form-inline dt-bootstrap no-footer">
          ...
          <TH style="background-color: #eaeafa; color:#333; ">Product Class ID</TH>
          <TH style="background-color: #eaeafa; color:#333; ">Product Type ID</TH>
          <TH style="background-color: #eaeafa; color:#333; ">Product Brand ID</TH>
  ...
  var productId, desc, prdBrand, prdClass, prdType, fromDt, toDt, loc, loctype,  groupRowColSpan = 6;
function getParameters(){
	return { 
		...
		"ACTION": "VIEW_INV_SUMMARY_OPEN_CLOSE_BAL_LOC",
		"PLANT":"<%=PLANT%>"
	}
}  
...
function onGo(){
     ...
     if (tableInventorySummary){
 	    ...
 	    tableInventorySummary = $('#tableInventorySummary').DataTable({
 			...
 			"columnDefs": [{"className": "t-right", "targets": [16]}],
...
function getTable(){
            return '<TABLE WIDTH="90%"  border="0" cellspacing="1" cellpadding = 2 align = "center">'+
            		'<TR><td colspan =19 align=right ><b>**Note : This report may not be accurate, if you import inventory stock on hand through excel.</b></td><TR>'+
                    '<TR BGCOLOR="#000066">'+
