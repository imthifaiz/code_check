...
<div class="container-fluid m-t-20">
	<div class="box">
	 ...
	 <ul class="breadcrumb backpageul">    
                ...
                <li><label>Activity Logs Summary</label></li>                                   
            </ul>
        <!-- Thanzith Modified on 23.02.2022 --> 
...
<!-- 									class="table table-bordered table-hover dataTable no-footer" -->
  ...
  <script type="text/javascript">
		var plant = '<%=PLANT%>'; 
		var tabletype;
		var FROM_DATE,TO_DATE,USER,JOBNO,ORDERNO,ITEM,DESC,BATCH,REASONCODE,CUSTOMER,LOC_TYPE_ID,LOC_TYPE_ID2,LOC_TYPE_ID3,LOC,DIRTYPE,TYPE,PRD_CLS_ID,PRD_TYPE_ID,PRD_BRAND_ID,PRD_DEPT_ID,REMARKS, groupRowColSpan = 6;
		...
		function getParameters(){
			return {
				...
				"REMARKS":REMARKS,
				"PLANT":plant,
				"action":"GET_ACTIVITY_FOR_SUMMARY"
			}
		}
		function onGo(){
			FROM_DATE=document.form.FROM_DATE.value;
			TO_DATE=document.form.TO_DATE.value;
			JOBNO=document.form.JOBNO.value;
			ORDERNO=document.form.ORDERNO.value;
			ITEM=document.form.ITEM.value;
			DESC=document.form.DESC.value;
			BATCH=document.form.BATCH.value;
			USER=document.form.USER.value;
			REASONCODE=document.form.REASONCODE.value;
			CUSTOMER=document.form.CUSTOMER.value;
			LOC_TYPE_ID=document.form.LOC_TYPE_ID.value;
			LOC_TYPE_ID2=document.form.LOC_TYPE_ID2.value;
			LOC_TYPE_ID3=document.form.LOC_TYPE_ID3.value;
			LOC=document.form.LOC_0.value;
			DIRTYPE=document.form.DIRTYPE.value;
			...
			REMARKS=document.form.REMARKS.value;
...
// 						"lengthMenu": [[100, 500, 1000, 2500], [100, 500, 1000, "All"]],
						"ajax": {
					        ...
					        "dataSrc": function(data){
					        	if(typeof data.CUSTOMERTYPELIST[0].DATE === 'undefined'){
					        		return [];
					        	}else {				     
