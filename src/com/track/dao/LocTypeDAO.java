...
public class LocTypeDAO extends BaseDAO {
	private MLogger mLogger = new MLogger();
	private boolean printQuery = MLoggerConstant.LocTypeDAO_PRINTPLANTMASTERQUERY;
	private boolean printLog = MLoggerConstant.LocTypeDAO_PRINTPLANTMASTERLOG;
	...
	public ArrayList getLocTypeDetailsTwo(String loctypeid, String plant,
			String extraCon) throws Exception {
		...
		try {
			...
			boolean flag = false;
			String sQry = "select distinct LOC_TYPE_ID2,LOC_TYPE_DESC2,ISACTIVE from "
					+ "["
					+ plant
					+ "_"
					+ "LOC_TYPE_MST2] where LOC_TYPE_ID2 like '"
					+ loctypeid
					+ "%'   OR LOC_TYPE_DESC2 like '"+loctypeid+"%'" + extraCon
					+ " ORDER BY LOC_TYPE_ID2 ";
			this.mLogger.query(this.printQuery, sQry);
	...
	//imti added for loc3 serach box
	public ArrayList getLocTypeDetailsThree(String loctypeid, String plant,
			String extraCon) throws Exception {
		...
		try {
			...
			boolean flag = false;
			String sQry = "select distinct LOC_TYPE_ID3,LOC_TYPE_DESC3,ISACTIVE from "
					+ "["
					+ plant
					+ "_"
					+ "LOC_TYPE_MST3] where LOC_TYPE_ID3 like '"
					+ loctypeid
					+ "%'   OR LOC_TYPE_DESC3 like '"+loctypeid+"%'" + extraCon
					+ " ORDER BY LOC_TYPE_ID3 ";
			this.mLogger.query(this.printQuery, sQry);
