...
public class OrderStatusDAO extends BaseDAO {
	...
	private boolean printQuery = MLoggerConstant.OrderStatusDAO_PRINTPLANTMASTERQUERY;
	private boolean printLog = MLoggerConstant.OrderStatusDAO_PRINTPLANTMASTERLOG;
	...
	public boolean insertIntoOrdStatusMst(Hashtable ht) throws Exception {
	...
	public boolean isExists(Hashtable ht) throws Exception {
		...
		try {
			...
			sql.append(" 1 ");
			sql.append(" ");
			sql.append(" FROM " + "[" + ht.get("PLANT") + "_" + "ORD_STATUS_MST"
					+ "]");
	...
	public boolean updateOrdStatusMst(Hashtable htUpdate, Hashtable htCondition)
			throws Exception {
		...
		try {
			...
			String stmt = "UPDATE " + "[" + htCondition.get("PLANT") + "_"
					+ "ORD_STATUS_MST" + "]" + sUpdate + sCondition;
	...
	public boolean deleteOrdStatusId(java.util.Hashtable ht) throws Exception {
	...
	public ArrayList getOrdStatusDetails(String ordstatusid, String plant,
		...
		try {
			...
			boolean flag = false;
			String sQry = "select distinct STATUS_ID,STATUS_DESC,ISACTIVE from "
					+ "["
					+ plant
					+ "_"
					+ "ORD_STATUS_MST] where STATUS_ID like '"
					+ ordstatusid
					+ "%'   " + extraCon
					+ " ORDER BY STATUS_ID ";
