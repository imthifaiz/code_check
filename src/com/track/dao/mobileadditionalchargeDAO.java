...
public class mobileadditionalchargeDAO extends BaseDAO {
	public static String TABLE_NAME = "MOBILEADDITIONALCHARGE";
	
	private boolean printQuery = 
		MLoggerConstant.mobileadditionalcharge_PRINTPLANTMASTERQUERY;
	private boolean printLog = MLoggerConstant.mobileadditionalchargeUtil_PRINTPLANTMASTERLOG;
	private boolean printInfo = MLoggerConstant.mobileadditionalchargeUti_PRINTPLANTMASTERINFO;
 ...
 public mobileadditionalchargeDAO ()
 {
 ...
 public Map selectRow(String query, Hashtable ht) throws Exception {
		...
		try {
			...
			StringBuffer sql = new StringBuffer(" SELECT " + query + " from "
					+ "[" + ht.get("PLANT") + "_" + "MOBILEADDITIONALCHARGE" + "]");
			sql.append(" WHERE ");
 ...
 public ArrayList selectAdditionalCharge(String query, Hashtable ht, String extCondi)
	throws Exception {
...
return alData;
 ...
 public ArrayList getAdditionalChargeDetails(String aCurrency, String plant)
	throws Exception {
...
return arrCust;
 ...
 public ArrayList getAdditionalChargeByDisplay(String display, String plant)
	throws Exception {
PreparedStatement ps = null;
ResultSet rs = null;
ArrayList arrCust = new ArrayList();
...
try {
	con = DbBean.getConnection();
	String sQry = "SELECT APPLICABLE,CHARGE,MINVALUE,DESCRIPTION,REMARK FROM "
			+ "["
			+ plant
			+ "_"
			+ "CURRENCYMST"
...
return arrCust;
	...
	public boolean updateAdditionalCharge(Hashtable htUpdate, Hashtable htCondition)
	throws Exception {
		...
		try {
			...
			String stmt = "UPDATE " + "[" + htUpdate.get("PLANT") + "_"
					+ "MOBILEADDITIONALCHARGE" + "] " + sUpdate + sCondition;
