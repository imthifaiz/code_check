...
public class DoHdr {
	...
	@DBTable(columnName ="ISFROMPEPPOL")
	private short ISFROMPEPPOL;
	
	@DBTable(columnName ="SALESORDERUUID") 
	private String SALESORDERUUID;
	
	@DBTable(columnName ="ISINVOICED")
	private short ISINVOICED;
	
	@DBTable(columnName ="INVOICEDID") 
	...
	public short getISFROMPEPPOL() {
		return ISFROMPEPPOL;
	}

	public void setISFROMPEPPOL(short iSFROMPEPPOL) {
		ISFROMPEPPOL = iSFROMPEPPOL;
	}
	...
	public String toString() {
		return "DoHdr [PLANT=" + PLANT + ", DONO=" + DONO + ", ORDERTYPE=" + ORDERTYPE + ", DELDATE=" + DELDATE
				...
				+ APP_CUST_ORDER_STATUS + ", ID=" + ID + ", UKEY=" + UKEY + ", REASON=" + REASON + ", ISFROMPEPPOL="
				+ ISFROMPEPPOL + ", SALESORDERUUID=" + SALESORDERUUID + ", ISINVOICED=" + ISINVOICED + ", INVOICEDID="
				+ INVOICEDID + "]";
	}	
