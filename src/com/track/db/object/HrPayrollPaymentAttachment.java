...
public class HrPayrollPaymentAttachment {
	...
	public String toString() {
		return "HrPayrollPaymentAttachment [PLANT=" + PLANT + ", ID=" + ID + ", PAYHDRID=" + PAYHDRID + ", FileType="
				+ FileType + ", FileName=" + FileName + ", FileSize=" + FileSize + ", FilePath=" + FilePath + ", CRAT="
				+ CRAT + ", CRBY=" + CRBY + ", UPAT=" + UPAT + ", UPBY=" + UPBY + "]";
	}
