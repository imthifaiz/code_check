...
public class MultiPoEstDet {
	...
	public String toString() {
		return "multiPoEstDet [PLANT=" + PLANT + ", POMULTIESTNO=" + POMULTIESTNO + ", POMULTIESTLNNO=" + POMULTIESTLNNO + ", TAXTREATMENT=" + TAXTREATMENT + ", CustCode=" + CustCode + ", CustName=" + CustName + ", CURRENCYID=" + CURRENCYID + ","
				+ "LNSTAT=" + LNSTAT + ", ITEM=" + ITEM + ", ItemDesc=" + ItemDesc + ", TRANDATE=" + TRANDATE + ", UNITCOST=" + UNITCOST + ", QTYOR="
				+ QTYOR + ", QTYRC=" + QTYRC + ", UNITMO=" + UNITMO + ", CRAT=" + CRAT + ", CRBY=" + CRBY + ", UPAT="
				+ UPAT + ", UPBY=" + UPBY + ", USERFLD1=" + USERFLD1 + ", USERFLD2=" + USERFLD2 + ", USERFLD3="
				+ USERFLD3 + ", USERFLD4=" + USERFLD4 + ", COMMENT1=" + COMMENT1 + ", CURRENCYUSEQT=" + CURRENCYUSEQT
				+ ", PRODGST=" + PRODGST + ", PRODUCTDELIVERYDATE=" + PRODUCTDELIVERYDATE + ", DISCOUNT=" + DISCOUNT
				+ ", DISCOUNT_TYPE=" + DISCOUNT_TYPE + ", ACCOUNT_NAME=" + ACCOUNT_NAME + ", TAX_TYPE=" + TAX_TYPE
				+ ", UNITCOST_AOD=" + UNITCOST_AOD + ", EXPIREDATE=" + EXPIREDATE + ",ID = "+ID+"]";
	}	
}
