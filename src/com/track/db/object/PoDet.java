...
public class PoDet {
	...
	public String toString() {
		return "PoDet [UKEY=" + UKEY + ", PLANT=" + PLANT + ", PONO=" + PONO + ", POLNNO=" + POLNNO + ", LNSTAT="
				+ LNSTAT + ", ITEM=" + ITEM + ", ItemDesc=" + ItemDesc + ", TRANDATE=" + TRANDATE + ", UNITCOST="
				+ UNITCOST + ", QTYOR=" + QTYOR + ", QTYRC=" + QTYRC + ", UNITMO=" + UNITMO + ", CRAT=" + CRAT
				+ ", CRBY=" + CRBY + ", UPAT=" + UPAT + ", UPBY=" + UPBY + ", USERFLD1=" + USERFLD1 + ", USERFLD2="
				+ USERFLD2 + ", USERFLD3=" + USERFLD3 + ", USERFLD4=" + USERFLD4 + ", COMMENT1=" + COMMENT1
				+ ", CURRENCYUSEQT=" + CURRENCYUSEQT + ", PRODGST=" + PRODGST + ", PRODUCTDELIVERYDATE="
