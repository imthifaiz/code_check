...
public class PoEstDet {
	...
	public String toString() {
		return "PoEstDet [PLANT=" + PLANT + ", POESTNO=" + POESTNO + ", POESTLNNO=" + POESTLNNO + ", LNSTAT=" + LNSTAT + ", ITEM="
				+ ITEM + ", ItemDesc=" + ItemDesc + ", TRANDATE=" + TRANDATE + ", UNITCOST=" + UNITCOST + ", QTYOR="
				...
				+ ", UNITCOST_AOD=" + UNITCOST_AOD + ",ID = "+ID+",POMULTIESTLNNO = "+POMULTIESTLNNO+",POMULTIESTNO = "+POMULTIESTNO+"]";
	}	
}
