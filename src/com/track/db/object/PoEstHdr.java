...
public class PoEstHdr {
	...
	public String toString() {
		return "PoEstHdr [PLANT=" + PLANT + ", POESTNO=" + POESTNO + ", STATUS=" + STATUS + ", ORDERTYPE=" + ORDERTYPE
				+ ", DELDATE=" + DELDATE + ", CRAT=" + CRAT + ", CRBY=" + CRBY + ", UPAT=" + UPAT + ", UPBY=" + UPBY
				+ ", CustCode=" + CustCode + ", CustName=" + CustName + ", JobNum=" + JobNum + ", POMULTIESTNO=" + POMULTIESTNO + ", PersonInCharge="
				...
				+ CURRENCYUSEQT + ", PROJECTID=" + PROJECTID + ", TRANSPORTID=" + TRANSPORTID + ",EMPNO=" + EMPNO + ", EXPIREDATE=" + EXPIREDATE + ",  PAYMENT_TERMS=" + PAYMENT_TERMS 
				+ ", SHIPCONTACTNAME="+SHIPCONTACTNAME+ SHIPCONTACTNAME + ", SHIPDESGINATION=" + SHIPDESGINATION + ", SHIPWORKPHONE=" + SHIPWORKPHONE
				...
				+ SHIPADDR4 + ", SHIPSTATE=" + SHIPSTATE + ", SHIPZIP=" + SHIPZIP
				+ ",ID = "+ID+"]";
	}
