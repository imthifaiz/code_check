...
public class PosPrd_BrandPromotionDet {
	...
	@DBTable(columnName ="BUY_PRD_BRAND_ID")   
	private String BUY_PRD_BRAND_ID;
	...
	public String getBUY_PRD_BRAND_ID() {
		return BUY_PRD_BRAND_ID;
	}

	public void setBUY_PRD_BRAND_ID(String bUY_PRD_BRAND_ID) {
		BUY_PRD_BRAND_ID = bUY_PRD_BRAND_ID;
	}
	...
	public String toString() {
		return "PosPrd_ClassPromotionDet [PLANT=" + PLANT + ", ID=" + ID + ", LNNO=" + LNNO + ", HDRID="
				+ HDRID + ", BUY_PRD_BRAND_ID=" + BUY_PRD_BRAND_ID + ", BUY_QTY=" + BUY_QTY + ", GET_ITEM=" + GET_ITEM + ", GET_QTY="
