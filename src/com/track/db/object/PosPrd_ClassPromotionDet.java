...
public class PosPrd_ClassPromotionDet {
	...
	@DBTable(columnName ="BUY_PRD_CLS_ID")   
	private String BUY_PRD_CLS_ID;
	...
	public String getBUY_PRD_CLS_ID() {
		return BUY_PRD_CLS_ID;
	}

	public void setBUY_PRD_CLS_ID(String bUY_PRD_CLS_ID) {
		BUY_PRD_CLS_ID = bUY_PRD_CLS_ID;
	}
	...
	public String toString() {
		return "PosPrd_ClassPromotionDet [PLANT=" + PLANT + ", ID=" + ID + ", LNNO=" + LNNO + ", HDRID="
				+ HDRID + ", BUY_PRD_CLS_ID=" + BUY_PRD_CLS_ID + ", BUY_QTY=" + BUY_QTY + ", GET_ITEM=" + GET_ITEM + ", GET_QTY="
