...
public String toString() {
	return "estHdr [PLANT=" + PLANT + ", DONO=" + DONO + ", ORDERTYPE=" + ORDERTYPE +", ORDDATE=" + ORDDATE + ", DELDATE=" + DELDATE
			+ ", STATUS=" + STATUS +  ", CRAT=" + CRAT + ", CRBY=" + CRBY + ", UPAT="
			...
			+ ", DELIVERYDATE=" + DELIVERYDATE + ", EXPIREDATE=" + EXPIREDATE + ",SHIPCONTACTNAME=" + SHIPCONTACTNAME + ", SHIPDESGINATION=" + SHIPDESGINATION + ", SHIPWORKPHONE=" + SHIPWORKPHONE  
			...
			+ 	 SHIPADDR4 + " , SHIPSTATE=" + SHIPSTATE + ", SHIPZIP=" + SHIPZIP + " ,TIMESLOTS=" + TIMESLOTS + ", OUTBOUND_GST=" + OUTBOUND_GST
			...
			+ ", ADJUSTMENT=" + ADJUSTMENT+ ", ITEM_RATES=" + ITEM_RATES + ", PROJECTID=" + PROJECTID + ", ISSHIPPINGTAX=" + ISSHIPPINGTAX 
			+ ", ISORDERDISCOUNTTAX=" + ISORDERDISCOUNTTAX + ", ISDISCOUNTTAX=" + ISDISCOUNTTAX + ", TAXID=" + TAXID 
			+ ", ORDERDISCOUNTTYPE=" + ORDERDISCOUNTTYPE + ", CURRENCYUSEQT=" + CURRENCYUSEQT +  "]"; 
	}
