...
public class DBConnectionManager {
	...
	private void init() {
		...
		try {
			InputStream is = new FileInputStream(MLoggerConstant.PROPS_FOLDER + "/track/config/track.properties");
	...
	private void logg(String s) {
		if (DEBUG) {
			System.out.println("com.track.gates.DBConnectionManager::" + s);
		}
	}
}
