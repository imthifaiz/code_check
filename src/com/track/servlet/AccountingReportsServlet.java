...
public class AccountingReportsServlet extends HttpServlet implements IMLogger {
	...
	if(action.equalsIgnoreCase("reports")) {
			...
			try {
				...
				RequestDispatcher rd = request.getRequestDispatcher("/jsp/accountingreports.jsp");
