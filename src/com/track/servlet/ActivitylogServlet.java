...
@WebServlet("/reports/*")
public class ActivitylogServlet extends HttpServlet implements IMLogger {
	...
	if(action.equalsIgnoreCase("activitylogs")) {
			
			try {
				String msg = StrUtils.fString(request.getParameter("msg"));
				request.setAttribute("Msg", msg);
				RequestDispatcher rd = request.getRequestDispatcher("/jsp/view_movhis_list.jsp?action=view_movhis_list.jsp");
	...
	if(action.equalsIgnoreCase("activitylogs")) {
			...
			try {
				String msg = StrUtils.fString(request.getParameter("msg"));
				request.setAttribute("Msg", msg);
				RequestDispatcher rd = request.getRequestDispatcher("/jsp/view_movhis_list.jsp");
			rd.forward(request, response);
		} catch (Exception e) {
			e.printStackTrace();
		}
