...
@WebServlet("/invlocation/*")
public class AssignInventoryLocationServlet extends HttpServlet implements IMLogger {
	...
	if(action.equalsIgnoreCase("assignInvLocation")) {
			
			try {
				String msg = StrUtils.fString(request.getParameter("msg"));
				request.setAttribute("Msg", msg);
				RequestDispatcher rd = request.getRequestDispatcher("/jsp/AssignInventoryLocation.jsp?action=AssignInventoryLocation.jsp");
