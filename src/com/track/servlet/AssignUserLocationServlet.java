...
public class AssignUserLocationServlet extends HttpServlet implements IMLogger {
	...
	if(action.equalsIgnoreCase("assignuser")) {
			...
			try {
				...
				RequestDispatcher rd = request.getRequestDispatcher("/jsp/AssignUserLocation.jsp?action=AssignUserLocation.jsp");
