...
@WebServlet("/billofmaterials/*")
public class BillOfMaterialsFormulaServlet extends HttpServlet implements IMLogger {
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		if(action.equalsIgnoreCase("new")) {
			...
			try {
				...
				RequestDispatcher rd = request.getRequestDispatcher("/jsp/create_kitbom.jsp");
	...
	if(action.equalsIgnoreCase("summary")) {
			...
			try {
				...
				RequestDispatcher rd = request.getRequestDispatcher("/jsp/kitbomsummary.jsp");
			rd.forward(request, response);
		} catch (Exception e) {
			e.printStackTrace();
		}
	...
	if(action.equalsIgnoreCase("edit")) {
			String msg= "";
			try {RequestDispatcher rd = request.getRequestDispatcher("/jsp/maint_kitbom.jsp");
			request.setAttribute("Msg", msg);
			rd.forward(request, response);
		} catch (Exception e) {
			e.printStackTrace();
	...
	if(action.equalsIgnoreCase("copy")) {
		String msg= "";
		try {RequestDispatcher rd = request.getRequestDispatcher("/jsp/copy_kitbom.jsp");
		request.setAttribute("Msg", msg);
		rd.forward(request, response);
		} catch (Exception e) {
			e.printStackTrace();
