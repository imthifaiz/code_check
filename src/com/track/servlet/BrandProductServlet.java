...
public class BrandProductServlet extends HttpServlet implements IMLogger {
	...
	if(action.equalsIgnoreCase("summary")) {
			...
			try {
				String responseMsg = StrUtils.fString(request.getParameter("response"));
				...
				RequestDispatcher rd = request.getRequestDispatcher("/jsp/prdBrandSummary.jsp");
...
if(action.equalsIgnoreCase("summary")) {
	...
	if(action.equalsIgnoreCase("new")) {
		...
		try {
			...
			RequestDispatcher rd = request.getRequestDispatcher("/jsp/create_prdBrand.jsp?SAVE_RED=");
		rd.forward(request, response);
	} catch (Exception e) {
		e.printStackTrace();
	}
	...
	if(action.equalsIgnoreCase("edit")) {
		...
		try {
			String msg = StrUtils.fString(request.getParameter("msg"));
			request.setAttribute("Msg", msg);
			RequestDispatcher rd = request.getRequestDispatcher("/jsp/maint_prdBrand.jsp");
		rd.forward(request, response);
	} catch (Exception e) {
		e.printStackTrace();
	}
