...
@WebServlet("/coo/*")
public class COOServlet extends HttpServlet implements IMLogger {
...
if(action.equalsIgnoreCase("new")) {
		...
		try {
			...
			RequestDispatcher rd = request.getRequestDispatcher("/jsp/createcoo.jsp");
...
if(action.equalsIgnoreCase("edit")) {
	...
	try {
		String msg = StrUtils.fString(request.getParameter("msg"));
		request.setAttribute("Msg", msg);
		RequestDispatcher rd = request.getRequestDispatcher("/jsp/editcoo.jsp");
	rd.forward(request, response);
} catch (Exception e) {
	e.printStackTrace();
}
