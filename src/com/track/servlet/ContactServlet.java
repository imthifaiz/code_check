...
@WebServlet("/contact/*")
public class ContactServlet extends HttpServlet implements IMLogger {
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		if(action.equalsIgnoreCase("summary")) {
					try {
						...
						RequestDispatcher rd = request.getRequestDispatcher("/jsp/ContactSummary.jsp");
		...
		if(action.equalsIgnoreCase("edit")) {
			try {
				...
				RequestDispatcher rd = request.getRequestDispatcher("/jsp/ContactEdit.jsp");
			rd.forward(request, response);
		} catch (Exception e) {
			e.printStackTrace();
		}
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		if(action.equalsIgnoreCase("summary")) {
			...
			if(action.equalsIgnoreCase("new")) {
				try {
					...
					request.setAttribute("Msg", msg);
					request.setAttribute("result", result);	
					RequestDispatcher rd = request.getRequestDispatcher("/jsp/CreateContacts.jsp"); 
				rd.forward(request, response);
			} catch (Exception e) {
				e.printStackTrace();
			}
		...
		if(action.equalsIgnoreCase("import")) {
			try {
				String msg = StrUtils.fString(request.getParameter("msg"));
				request.setAttribute("Msg", msg);
				RequestDispatcher rd = request.getRequestDispatcher("/jsp/importContactExcel.jsp");
			rd.forward(request, response);
		} catch (Exception e) {
			e.printStackTrace();
		}
