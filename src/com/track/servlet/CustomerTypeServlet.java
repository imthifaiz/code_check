...
@WebServlet("/customertype/*")
public class CustomerTypeServlet extends HttpServlet implements IMLogger {
...
if(action.equalsIgnoreCase("summary")) {
			...
			try {
				...
				RequestDispatcher rd = request.getRequestDispatcher("/jsp/customerTypeSummary.jsp");
...
if(action.equalsIgnoreCase("summary")) {
	...
	if(action.equalsIgnoreCase("new")) {
		...
		try {
			String msg = StrUtils.fString(request.getParameter("msg"));
			request.setAttribute("Msg", msg);
			RequestDispatcher rd = request.getRequestDispatcher("/jsp/createCustomerType.jsp");
		rd.forward(request, response);
	} catch (Exception e) {
		e.printStackTrace();
	}
	 ...
	 {
	   String minseq=""; 
	   String sBatchSeq="",customerTypeID="",sUserId="";
		...
		JSONObject json = new JSONObject();
	      ...
	      if (exitFlag==false)
	       ...
	       else
	       {
			...
			json.put("CUSTOMERTYPE", customerTypeID);
	...
	if(action.equalsIgnoreCase("edit")) {
		...
		try {
			String msg = StrUtils.fString(request.getParameter("msg"));
			request.setAttribute("Msg", msg);
			RequestDispatcher rd = request.getRequestDispatcher("/jsp/maintCustomerType.jsp");
		rd.forward(request, response);
	} catch (Exception e) {
		e.printStackTrace();
	}
