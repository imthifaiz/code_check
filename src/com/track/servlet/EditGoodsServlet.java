...
public class EditGoodsServlet extends HttpServlet implements IMLogger {
...
if(action.equalsIgnoreCase("goodsreceiptprintout")) {
		
		
		try {
			String msg = StrUtils.fString(request.getParameter("msg"));
			request.setAttribute("Msg", msg);
			RequestDispatcher rd = request.getRequestDispatcher("/jsp/editPosReceiveHdr.jsp");
		rd.forward(request, response);
	} catch (Exception e) {
		e.printStackTrace();
	}
}
if(action.equalsIgnoreCase("goodsshiftclosereceiptprintout")) {
	
	
	try {
		String msg = StrUtils.fString(request.getParameter("msg"));
		request.setAttribute("Msg", msg);
		RequestDispatcher rd = request.getRequestDispatcher("/jsp/editPosShiftCloseReceiptPrintout.jsp");
	rd.forward(request, response);
} catch (Exception e) {
	e.printStackTrace();
}
...
if(action.equalsIgnoreCase("goodsissueprintout")) {
	
	
	try {
		String msg = StrUtils.fString(request.getParameter("msg"));
		request.setAttribute("Msg", msg);
		RequestDispatcher rd = request.getRequestDispatcher("/jsp/editPosIssueHdr.jsp");
	rd.forward(request, response);
} catch (Exception e) {
	e.printStackTrace();
}
...
if(action.equalsIgnoreCase("stockmoveprintout")) {
	
	
	try {
		String msg = StrUtils.fString(request.getParameter("msg"));
		request.setAttribute("Msg", msg);
		RequestDispatcher rd = request.getRequestDispatcher("/jsp/editPosMoveHdr.jsp");
	rd.forward(request, response);
} catch (Exception e) {
	e.printStackTrace();
}
