...
@WebServlet("/footer/*")
public class FooterServlet extends HttpServlet implements IMLogger {
...
if(action.equalsIgnoreCase("new")) {
		...
		try {
			...
			RequestDispatcher rd = request.getRequestDispatcher("/jsp/createfooter.jsp");
...
if(action.equalsIgnoreCase("edit")) {
	...
	try {
		String msg = StrUtils.fString(request.getParameter("msg"));
		request.setAttribute("Msg", msg);
		RequestDispatcher rd = request.getRequestDispatcher("/jsp/editfooter.jsp");
	rd.forward(request, response);
} catch (Exception e) {
	e.printStackTrace();
}
