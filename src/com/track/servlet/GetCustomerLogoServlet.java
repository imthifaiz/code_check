 ...
 */
@WebServlet("/GetCustomerLogoServlet")
public final class GetCustomerLogoServlet extends HttpServlet {
	private static final long serialVersionUID = 1L;

	/**
	 * @see HttpServlet#HttpServlet()
	 */
	public GetCustomerLogoServlet() {
		super();
	}
...
//		File logoFile = new File(MLoggerConstant.PROPS_FOLDER + "/track/Logos/" + request.getSession(false).getAttribute("PLANT").toString().toLowerCase() + "Logo.GIF");
//		if (!logoFile.exists()) {
//			logoFile = new File(MLoggerConstant.PROPS_FOLDER + "/track/Logos/" + request.getSession(false).getAttribute("PLANT").toString().toLowerCase() + "Logo.gif");
//			if (!logoFile.exists()) {
//				logoFile = new File(MLoggerConstant.PROPS_FOLDER + "/track/Logos/NoLogo.JPG");
//			}
//		}
		Optional<File> optionalLogoFile = findFileIgnoreCase(MLoggerConstant.PROPS_FOLDER + "/track/Logos/", request.getSession(false).getAttribute("PLANT").toString().toLowerCase() + "Logo.GIF");
		File logoFile = null;
