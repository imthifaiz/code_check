...
@WebServlet("/incoterms/*")
public class IncotermServlet extends HttpServlet implements IMLogger {
...
if(action.equalsIgnoreCase("new")) {
		...
		try {
			...
			RequestDispatcher rd = request.getRequestDispatcher("/jsp/createincoterms.jsp");
...
if(action.equalsIgnoreCase("edit")) {
	...
	try {
		String msg = StrUtils.fString(request.getParameter("msg"));
		request.setAttribute("Msg", msg);
		RequestDispatcher rd = request.getRequestDispatcher("/jsp/editincoterms.jsp");
	rd.forward(request, response);
} catch (Exception e) {
	e.printStackTrace();
}
