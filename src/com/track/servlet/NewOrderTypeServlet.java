...
@WebServlet("/ordertype/*")
public class NewOrderTypeServlet extends HttpServlet implements IMLogger {
	...
	if(action.equalsIgnoreCase("edit")) {
		...
		try {
			...
			RequestDispatcher rd = request.getRequestDispatcher("/jsp/maint_orderType.jsp");
...
if(action.equalsIgnoreCase("summary")) {
		...
		try {
			String msg = StrUtils.fString(request.getParameter("msg"));
			request.setAttribute("Msg", msg);
			RequestDispatcher rd = request.getRequestDispatcher("/jsp/OrderTypeSummary.jsp");
		rd.forward(request, response);
	} catch (Exception e) {
		e.printStackTrace();
	}
...
if(action.equalsIgnoreCase("detail")) {
	...
	try {
		String msg = StrUtils.fString(request.getParameter("msg"));
		request.setAttribute("Msg", msg);
		RequestDispatcher rd = request.getRequestDispatcher("/jsp/OrderTypeDetail.jsp");
	rd.forward(request, response);
} catch (Exception e) {
	e.printStackTrace();
}
...
if(action.equalsIgnoreCase("new")) {
		...
		try {
			String msg = StrUtils.fString(request.getParameter("msg"));
			request.setAttribute("Msg", msg);
			RequestDispatcher rd = request.getRequestDispatcher("/jsp/OrderType_View.jsp");
		rd.forward(request, response);
	} catch (Exception e) {
		e.printStackTrace();
	}
