...
public class PaymentModeServlet extends HttpServlet implements IMLogger {
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		if(action.equalsIgnoreCase("edit")) {
			...
			try {
				...
				RequestDispatcher rd = request.getRequestDispatcher("/jsp/editpaymentmode.jsp");
	  ...
	  if(action.equalsIgnoreCase("new")) {
		  ...
		  try {
				String msg = StrUtils.fString(request.getParameter("msg"));
				request.setAttribute("Msg", msg);
				RequestDispatcher rd = request.getRequestDispatcher("/jsp/createpaymentmode.jsp");
			rd.forward(request, response);
		} catch (Exception e) {
			e.printStackTrace();
		}
