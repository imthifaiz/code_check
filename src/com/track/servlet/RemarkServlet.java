...
@WebServlet("/remarks/*")
public class RemarkServlet extends HttpServlet implements IMLogger {
...
if(action.equalsIgnoreCase("new")) {
		...
		try {
			...
			RequestDispatcher rd = request.getRequestDispatcher("/jsp/createremarks.jsp");
...
if(action.equalsIgnoreCase("edit")) {
	...
	try {
		String msg = StrUtils.fString(request.getParameter("msg"));
		request.setAttribute("Msg", msg);
		RequestDispatcher rd = request.getRequestDispatcher("/jsp/editremarks.jsp");
	rd.forward(request, response);
} catch (Exception e) {
	e.printStackTrace();
}
