...
@WebServlet("/suppliertype/*")
public class SupplierTypeServlet extends HttpServlet implements IMLogger {
...
if(action.equalsIgnoreCase("summary")) {
			...
			try {
				...
				RequestDispatcher rd = request.getRequestDispatcher("/jsp/supplierTypeSummary.jsp");
...
if(action.equalsIgnoreCase("summary")) {
	...
	if(action.equalsIgnoreCase("new")) {
		...
		try {
			String msg = StrUtils.fString(request.getParameter("msg"));
			request.setAttribute("Msg", msg);
			RequestDispatcher rd = request.getRequestDispatcher("/jsp/createSupplierType.jsp");
		rd.forward(request, response);
	} catch (Exception e) {
		e.printStackTrace();
	}
	 ...
	 {
	   String minseq="";  String sBatchSeq="",supplierTypeID="",sUserId="";
	      ...
	      if (exitFlag==false)
	       ...
	       else
	       {
	           ...
	           // boolean updateFlag=_TblControlDAO.update(updateQyery.toString(),htTblCntUpdate,"",plant);
	            ...
	            json.put("SUPPLIERTYPE", supplierTypeID);
	...
	if(action.equalsIgnoreCase("edit")) {
		...
		try {
			String msg = StrUtils.fString(request.getParameter("msg"));
			request.setAttribute("Msg", msg);
			RequestDispatcher rd = request.getRequestDispatcher("/jsp/maintSupplierType.jsp");
		rd.forward(request, response);
	} catch (Exception e) {
		e.printStackTrace();
	}
