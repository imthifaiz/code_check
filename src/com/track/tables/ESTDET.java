...
public class ESTDET {
	private boolean printQuery = MLoggerConstant.ESTDET_PRINTPLANTMASTERQUERY;
	private boolean printLog = MLoggerConstant.ESTDET_PRINTPLANTMASTERLOG;
	sqlBean sb;
	Generator gn;
	String sPLANT = "SIS";
	String sDONO = "";
	...
	/**
	 * constructor method ESTDET sb - SQL Bean gn - Utilites
	 */
	public ESTDET() throws Exception {
		sb = new sqlBean();
		gn = new Generator();
	}
	...
	/**
	 * Insert Command - ESTDET
	 * 
	 * 
	 */
	public int insertESTDET() throws Exception {
		String sql;
...
//		ResultSet rs = null;
		...
		try {
			...
			sql = "Insert into " + sPLANT + "_ESTDET values ('" + sPLANT + "','" + sDONO
	...
	/**
	 * Update Function - ESTDET
	 * 
	 * 
	 */
	public int updateESTDET() throws Exception {
		String sql;
		Connection con = getDBConnection();
//		ResultSet rs = null;
		int returnCode = 1;
		...
		try {
			sql = "Update " + sPLANT + "_ESTDET set LNSTAT= '" + sLNSTAT + "',ITEM= '" + sITEM
	...
	/**
	 * Select FunctionESTDET
	 * 
	 * 
	 */
	public void selectESTDET() throws Exception {
		String q = "";
		Connection con = getDBConnection();
		try {
			Statement stmt = con.createStatement();
			q = "select * from " + sPLANT + "_ESTDET where PLANT= '" + sPLANT + "' and DONO= '"
...
//			int n = 1;
	...
	public void selectESTDET(String plant) throws Exception {
		String q = "";
		Connection con = getDBConnection();
		try {
			Statement stmt = con.createStatement();
			q = "select * from " + plant + "_ESTDET where PLANT= '" + plant + "' and DONO= '"
					+ sDONO + "' and DOLNNO= '" + sDOLNNO + "'";
			this.mLogger.query(this.printQuery, q);
			ResultSet rs = stmt.executeQuery(q);
//			int n = 1;
...
//				sUSRKEY3 = rs.getString("USRKEY3");
	...
	/**
	 * Delete Function -- ESTDET
	 * 
	 * 
	 */
	public int deleteESTDET() throws Exception {
		String sql;
		Connection con = getDBConnection();
//		ResultSet rs = null;
		int returnCode = 1;
		...
		try {
			sql = "delete from " + sPLANT + "_ESTDET where PLANT= '" + sPLANT + "' and DONO= '"
					+ sDONO + "' and DOLNNO= '" + sDOLNNO + "'";
			sb.setmLogger(mLogger);
			returnCode = sb.insertRecords(sql);
		} catch (Exception e) {
	...
	public int deleteESTDET(String aDONO, String aDOLNNO) throws Exception {
		String sql;
		Connection con = getDBConnection();
//		ResultSet rs = null;
		int returnCode = 1;
		...
		try {
			sql = "delete from ESTDET where PLANT= 'sis' and DONO= '" + aDONO
					+ "' and DOLNNO= '" + aDOLNNO + "'";
			sb.setmLogger(mLogger);
			returnCode = sb.insertRecords(sql);
		} catch (Exception e) {
	...
	public int deleteESTDET(String aDONO, String aDOLNNO, String plant)
			throws Exception {
		String sql;
		Connection con = getDBConnection();
//		ResultSet rs = null;
		...
		try {
			sql = "delete from [" + plant + "_" + "ESTDET] where PLANT= '"
	...
	public int deleteESTDET(String aDONO) throws Exception {
		String sql;
		Connection con = getDBConnection();
//		ResultSet rs = null;
		int returnCode = 1;
		...
		try {
			sql = "delete from ESTDET where PLANT= 'COM' and DONO= '" + aDONO
					+ "'";
			sb.setmLogger(mLogger);
			returnCode = sb.insertRecords(sql);
		} catch (Exception e) {
...
//		int returnCode = 1;
	...
	public String listESTDET(String aDONO) throws Exception {
...
//		NumberFormat formatter = new DecimalFormat("#,##0.00#");
		...
		try {
			...
			q = "select dono,dolnno,item,userfld1 from ESTDET " + where;
			sb.setmLogger(mLogger);
			this.mLogger.query(this.printQuery, q);
			ResultSet rs = stmt.executeQuery(q);
			while (rs.next()) {
		...
		MLogger.log(-1, this.getClass() + " listESTDET()");
		return result;
	}
...
//		Vector vecWhr = new Vector();
		...
		try {
			Statement stmt = con.createStatement();
			q = "select item,class,attrib,qtyac from ESTDET where dono ='"
					+ sREFNO + "'";
			this.mLogger.query(this.printQuery, q);
			ResultSet rs = stmt.executeQuery(q);
			int cnt = 1;
...
//		Vector vecWhr = new Vector();
		...
		try {
			Statement stmt = con.createStatement();
			q = "select item,class,attrib,qtyac,deldate from ESTDET where dono ='"
					+ sREFNO + "'";
			this.mLogger.query(this.printQuery, q);
			ResultSet rs = stmt.executeQuery(q);
			int cnt = 1;
...
//		int cnt = 0;
		...
		try {
			Statement stmt = con.createStatement();
			q = "select max(cast(dolnno as int))+1 from " + "[" + "ESTDET" + "]"
					+ " where dono = '" + aDONO + "'";
	...
	public String getUpdateSql() throws Exception {
		String sql;
		sql = "Update ESTDET set LNSTAT= '" + sLNSTAT + "',ITEM= '" + sITEM
	...
	public int updateESTDET(String aDONO, String aDOLNNO, float qty,
...
//		StrUtils su = new StrUtils();
		...
		try {
			sql = "UPDATE ESTDET SET QTYOR = " + qty + ",USERTIME1 = '"
	...
	public String getUpdateSql(String dono, String lnno, float issQty)
			throws Exception {
		String sql = "";
		sql = "Update ESTDET set QTYIS =  " + issQty + ",QTYAC = 0"
