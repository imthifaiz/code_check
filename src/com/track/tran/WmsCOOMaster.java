...
public class WmsCOOMaster implements WmsTran, IMLogger{
	...
	private boolean process(Map mapObject) throws Exception {
		try {
			...
			if(result){
				...
				htRecvHis.put("REMARKS",mapObject.get(IDBConstants.COO));
