...
public class WmsFooterMaster implements WmsTran, IMLogger {
	...
	private boolean process(Map mapObject) throws Exception {
		try {
			...
			if(result){
				...
				//htRecvHis.put(IDBConstants.USERFLD1, "");
				//htRecvHis.put(IDBConstants.USERFLD5, "");
				//htRecvHis.put(IDBConstants.USERFLD6, "");
				htRecvHis.put("REMARKS",mapObject.get(IDBConstants.FOOTER));
				//htRecvHis.put("USERFLG6", "");	
