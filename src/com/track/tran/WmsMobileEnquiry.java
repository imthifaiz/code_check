...
public class WmsMobileEnquiry implements WmsTran, IMLogger {
	...
	public boolean processdohdr(Map map) throws Exception {
		...
		try {
			...
			ht
					.put(IDBConstants.USER_ID, (String) map
			...
			ht.put(IDBConstants.ORDERTYPE, IDBConstants.ORDERTYPE_ENQUIRY);
