...
public class WmsReceiveMaterial implements WmsTran, IMLogger {
	...
	*/
	public boolean processPodetForReceive(Map map) throws Exception {
		...
		try {
			...
			htRecvDet.put(IDBConstants.CUSTOMER_NAME, su.InsertQuotes((String)map
			...
			pohashtable.put(IDBConstants.PODET_PONUM, map
					.get(IConstants.PODET_PONUM));
			...
			if(nonstocktype.equalsIgnoreCase("Y"))	
		    {
//				htRecvDet.put("RECQTY", String.valueOf(map.get(IConstants.RECV_QTY))); //commented by imthi
